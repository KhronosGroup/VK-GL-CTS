...
TessellationShaderPointsgl_PointSize::TessellationShaderPointsgl_PointSize(Context &context,
    ...
    : TestCaseBase(context, extParams, "point_rendering",
                   "Verifies point size used to render points is taken from"
                   " the right stage")
    , m_fbo_id(0)
    , m_to_id(0)
    , m_vao_id(0)
                                                                         ...
                                                                         unsigned int run_n_vertices)
{
    ...
    TessellationShaderUtils::getTessellationLevelAfterVertexSpacing(
        ...
        nullptr); /* out_clamped_and_rounded */
    ...
    if (run.primitive_mode == TESSELLATION_SHADER_PRIMITIVE_MODE_ISOLINES)
    {
        ...
        TessellationShaderUtils::getTessellationLevelAfterVertexSpacing(
            actual_vs_mode, run.outer[1], gl_max_tess_gen_level_value, nullptr, /* out_clamped */
    ...
    {
        TessellationShaderUtils::getTessellationLevelAfterVertexSpacing(
            actual_vs_mode, actual_inner_levels[n], gl_max_tess_gen_level_value, nullptr, /* out_clamped */
    ...
    if (run.primitive_mode != TESSELLATION_SHADER_PRIMITIVE_MODE_ISOLINES)
    {
        ...
        {
            TessellationShaderUtils::getTessellationLevelAfterVertexSpacing(
                actual_vs_mode, run.outer[n], gl_max_tess_gen_level_value, nullptr, /* out_clamped */
    ...
    case TESSELLATION_SHADER_PRIMITIVE_MODE_TRIANGLES:
    {
        ...
        else
        {
            ...
            {
                TessellationShaderUtils::getTessellationLevelAfterVertexSpacing(
                    run.vertex_spacing, 2.0f, gl_max_tess_gen_level_value, nullptr, /* out_clamped */
                                                                                  ...
                                                                                  unsigned int run_n_vertices)
{
    ...
    if (n_duplicate_vertices != 0)
    {
        ...
        m_testCtx.getLog() << tcu::TestLog::Message
                           << "Duplicate vertices found for the following tesselelation"

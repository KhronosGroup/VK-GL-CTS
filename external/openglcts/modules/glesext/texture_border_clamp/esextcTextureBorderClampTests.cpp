...
/*!
 * \file esextcTextureBorderClampTests.cpp
 * \brief Test group for texture border clamp tests
 */ /*-------------------------------------------------------------------*/

#include "esextcTextureBorderClampTests.hpp"
 ...
 **/
TextureBorderClampTests::TextureBorderClampTests(glcts::Context& context, const ExtParameters& extParams)
	: TestCaseGroupBase(context, extParams, "texture_border_clamp", "Texture Border Clamp Tests")
{
	/* No implementation needed */
}

/** Initializes test cases for texture border clamp tests
 **/

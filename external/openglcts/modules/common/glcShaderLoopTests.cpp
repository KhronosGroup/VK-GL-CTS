...
static ShaderEvalFunc getLoopEvalFunc(int numIters)
{
    ...
    DE_ASSERT(false && "Invalid loop iteration count.");
    return NULL;
}
...
void ShaderLoopCase::setup(uint32_t programID)
{
    DE_UNREF(programID);
}

void ShaderLoopCase::setupUniforms(uint32_t programID, const Vec4 &constCoords)
{
    DE_UNREF(programID);

...
tcu::TestNode::IterateResult RenderbufferCase::iterate(void)
{
    ...
    else
    {
        ...
        gl.getFramebufferAttachmentParameteriv(GL_FRAMEBUFFER, GL_DEPTH, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE,
                                               &hasDepthBuffer);
        gl.getFramebufferAttachmentParameteriv(GL_FRAMEBUFFER, GL_STENCIL, GL_FRAMEBUFFER_ATTACHMENT_OBJECT_TYPE,
                                               &hasStencilBuffer);

...
#define LOCAL_STRUCT_CASE(NAME, DESCRIPTION, SHADER_SRC, EVAL_FUNC_BODY)                                  \
	...
	LOCAL_STRUCT_CASE(basic, "Basic struct usage", LineStream() << "${HEADER}"
																<< "uniform int ui_one;"
																<< ""
																<< "struct S {"
																<< "    mediump float   a;"
	...
	LOCAL_STRUCT_CASE(nested, "Nested struct", LineStream() << "${HEADER}"
															<< "uniform int ui_zero;"
															<< "uniform int ui_one;"
															<< ""
															<< "struct T {"
	...
	LOCAL_STRUCT_CASE(array_member, "Struct with array member", LineStream()
																	<< "${HEADER}"
																	<< "uniform int ui_one;"
																	<< ""
																	<< "struct S {"
	...
	LOCAL_STRUCT_CASE(parameter, "Struct as a function parameter", LineStream()
																	   << "${HEADER}"
																	   << "uniform int ui_one;"
																	   << ""
																	   << "struct S {"
	...
	LOCAL_STRUCT_CASE(return, "Struct as a return value", LineStream() << "${HEADER}"
																	   << "uniform int ui_one;"
																	   << ""
																	   << "struct S {"
																	   << "    mediump float   a;"
	...
	LOCAL_STRUCT_CASE(return_nested, "Nested struct", LineStream()
														  << "${HEADER}"
														  << "uniform int ui_zero;"
														  << "uniform int ui_one;"
														  << ""
...
#define UNIFORM_STRUCT_CASE(NAME, DESCRIPTION, TEXTURES, SHADER_SRC, SET_UNIFORMS_BODY, EVAL_FUNC_BODY)      \
	...
	UNIFORM_STRUCT_CASE(basic, "Basic struct usage", false, LineStream() << "${HEADER}"
																		 << "uniform int ui_one;"
																		 << ""
																		 << "struct S {"
																		 << "    mediump float   a;"
	...
	UNIFORM_STRUCT_CASE(nested, "Nested struct", false, LineStream() << "${HEADER}"
																	 << "uniform int ui_zero;"
																	 << "uniform int ui_one;"
																	 << ""
																	 << "struct T {"

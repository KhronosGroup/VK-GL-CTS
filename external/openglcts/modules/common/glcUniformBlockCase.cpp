...
{
    return static_cast<int>(glu::getDataTypeScalarSize(type) * sizeof(uint32_t));
}
...
int getDataTypeByteAlignment(glu::DataType type)
{
    ...
    case glu::TYPE_UINT:
    case glu::TYPE_BOOL:
        return static_cast<int>(1 * sizeof(uint32_t));

    case glu::TYPE_FLOAT_VEC2:
    case glu::TYPE_INT_VEC2:
    case glu::TYPE_UINT_VEC2:
    case glu::TYPE_BOOL_VEC2:
        return static_cast<int>(2 * sizeof(uint32_t));
    ...
    case glu::TYPE_BOOL_VEC4:
        return static_cast<int>(4 * sizeof(uint32_t));
...
int getDataTypeArrayStride(glu::DataType type)
{
    ...
    int vec4Alignment = static_cast<int>(sizeof(uint32_t) * 4);
...
{
    const int vec4Alignment = static_cast<int>(sizeof(uint32_t) * 4);

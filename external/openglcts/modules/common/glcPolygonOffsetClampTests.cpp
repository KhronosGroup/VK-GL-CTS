...
void PolygonOffsetClampZeroInfinityTestCase::init()
{
    ...
    m_testValues.push_back(
        PolygonOffsetClampValues(0.0f, -1000.0f / 65536.0f, -INFINITY));              // Min Offset, infinity clamp case
    m_testValues.push_back(PolygonOffsetClampValues(0.0f, 1000.0f / 65536.0f, 0.0f)); // Max offset, zero clamp case
    m_testValues.push_back(
        PolygonOffsetClampValues(0.0f, 1000.0f / 65536.0f, INFINITY)); // Max Offset, infinity clamp case
}

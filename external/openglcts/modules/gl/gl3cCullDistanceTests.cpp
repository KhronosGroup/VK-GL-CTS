    ...
    for (glw::GLuint n_shader_index = 0; n_shader_index < n_shaders_configuration; n_shader_index++)
    {
        if (shaders_configuration[n_shader_index].use)
        {
            ...
            case GL_TESS_CONTROL_SHADER:
            {
                ...
                CullDistance::Utilities::replaceAll(shader_source, std::string("TEMPLATE_EXTENSIONS"),
            ...
            CullDistance::Utilities::replaceAll(shader_source, std::string("TEMPLATE_EXTENSIONS"), std::string(""));
                                                     ...
                                                     bool fetch_culldistance_from_fs)
{
    ...
    DE_UNREF(n_not_clipped_vertices_real);
        ...
        if (!all_vertices_are_clipped)
        {
            ...
            if (fetch_culldistance_from_fs)
            {
                     ...
                     n_primitive_vertex++)
                {
                    ...
                    glw::GLint sum_hash =
                        glw::GLint(sum /
                                   glw::GLfloat((clipdistances_array_size + culldistances_array_size) *
                                                (clipdistances_array_size + culldistances_array_size + 1)) *

...
bool ErrorsTest::TestErrorsOfClearNamedBufferData()
{
    ...
    try
    {
        ...
        {
            (void)(glw::GLbyte *)m_pMapNamedBufferRange(buffer, 0, sizeof(dummy_data),
                                                        GL_MAP_READ_BIT | GL_MAP_PERSISTENT_BIT);
            GLU_EXPECT_NO_ERROR(gl.getError(), "glMapNamedBuffer failed.");
...
bool ErrorsTest::TestErrorsOfCopyNamedBufferSubData()
{
    ...
    try
    {
        ...
        {
            (void)(glw::GLbyte *)m_pMapNamedBufferRange(buffer_r, 0, sizeof(dummy_data),
                                                        GL_MAP_READ_BIT | GL_MAP_PERSISTENT_BIT);
            GLU_EXPECT_NO_ERROR(gl.getError(), "glMapNamedBuffer failed.");
        ...
        {
            (void)(glw::GLbyte *)m_pMapNamedBufferRange(buffer_w, 0, sizeof(dummy_data),
                                                        GL_MAP_READ_BIT | GL_MAP_PERSISTENT_BIT);
            GLU_EXPECT_NO_ERROR(gl.getError(), "glMapNamedBuffer failed.");
...
bool ErrorsTest::TestErrorsOfFlushMappedNamedBufferRange()
{
    ...
    try
    {
        ...
        {
            (void)(glw::GLbyte *)m_pMapNamedBufferRange(buffer, 0, sizeof(dummy_data) / 2,
                                                        GL_MAP_WRITE_BIT | GL_MAP_FLUSH_EXPLICIT_BIT);
            GLU_EXPECT_NO_ERROR(gl.getError(), "glMapNamedBuffer failed.");

...
SamplerTest::SamplerTest(deqp::Context &context)
    : deqp::TestCase(context, "sampler", "Fetch using sampler test")
    , m_po(0)
    , m_to(0)
    , m_fbo(0)
    , m_rbo(0)
...
const struct SamplerTest::Configuration SamplerTest::s_configurations[] = {
    ...
    /* Shadow textures. */
    {GL_TEXTURE_1D, "sampler1DShadow", "vec4(texture(texture_input, vec3(0.0)), 0.0, 0.0, 0.0)", {0.f, 0.f, 0.f, 0.f}},
    {GL_TEXTURE_2D, "sampler2DShadow", "vec4(texture(texture_input, vec3(0.0)), 0.0, 0.0, 0.0)", {0.f, 0.f, 0.f, 0.f}},
    {GL_TEXTURE_CUBE_MAP,
     "samplerCubeShadow",

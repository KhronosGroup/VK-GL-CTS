...
public:
    TransformFeedbackOverflowQueryErrorInvalidIndex(deqp::Context &context,
        ...
        : TransformFeedbackOverflowQueryErrorBase(
              context, api, name,
              "Verifies whether an INVALID_VALUE error is properly generated if GetQueryIndexediv "
...
protected:
    ...
    virtual void init()
    {
        ...
        if (canTestOverflow())
        {
            ...
            m_checker_program = new glu::ShaderProgram(m_context.getRenderContext(),
                                                       glu::makeVtxFragSources(minimalVsh(), minimalFsh()));

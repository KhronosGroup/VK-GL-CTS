...
bool TransformFeedbackBaseTestCase::createTransformBuffer(const int size, const GLint buffer, const GLint index)
{
    const glw::Functions &gl = m_context.getRenderContext().getFunctions();
...
bool TransformFeedbackBaseTestCase::compareArrays(const GLfloat *const d1, const int s1, const GLfloat *d2, int s2)
{
    if (!d1 || !d2)
        return false;
...
void TransformFeedbackBaseTestCase::buildTransformFeedbackProgram(const char *vsSource, const char *gsSource,
                                                                  const char *fsSource)
{
    const glw::Functions &gl = m_context.getRenderContext().getFunctions();
...
const char **TransformFeedbackMultipleStreamsTestCase::varyings()
{
    static const char *vars[] = {
        "pos0", "gl_SkipComponents4", "gl_NextBuffer", "gl_SkipComponents4", "pos1",
    };
...
{
    static const char *vars[] = {
        "gl_SkipComponents1", "value1", "gl_NextBuffer", "gl_SkipComponents2", "value2", "gl_NextBuffer",
        "gl_SkipComponents3", "value3", "gl_NextBuffer", "gl_SkipComponents4", "value4",
    };

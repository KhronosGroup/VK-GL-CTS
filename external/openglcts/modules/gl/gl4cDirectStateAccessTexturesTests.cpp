                                                           ...
                                                           glw::GLsizei height, glw::GLsizei depth)
{
    ...
    else
    {
        ...
        {
            m_context.getTestContext().getLog()
                << tcu::TestLog::Message << "glTextureStorage" << D << "D unexpectedly generated error "
                << glu::getErrorStr(error) << " during test with levels " << levels << ", internal format "
                << internalformat << " width=" << width << " height=" << height << " depth=" << depth << "."
                << tcu::TestLog::EndMessage;
                                                            ...
                                                            const glw::GLvoid *data)
{
    ...
    if (I)
    {
        ...
        {
            m_context.getTestContext().getLog()
                << tcu::TestLog::Message << "glTextureSubImage" << D << "D unexpectedly generated error "
                << glu::getErrorStr(error) << " during test with level " << level << ", width=" << width
                << ", height=" << height << ", depth=" << depth << " format " << glu::getTextureFormatStr(format)
                << " and type " << glu::getTypeStr(type) << "." << tcu::TestLog::EndMessage;
...
bool StorageAndSubImageTest<T, S, N, D, I>::CreateTexture()
{
    ...
    {
        /* Data setup. */
        if (TextureSubImage(TextureTarget(), m_to, 0, TestReferenceDataWidth(), TestReferenceDataHeight(),
 ...
 */
template <typename T, glw::GLint S, bool N, glw::GLuint D, bool I>
void StorageAndSubImageTest<T, S, N, D, I>::PrepareProgram(const glw::GLchar *variable_declaration,
                                                           const glw::GLchar *tail)
{
    /* Shortcut for GL functionality */
    const glw::Functions &gl = m_context.getRenderContext().getFunctions();
...
bool StorageMultisampleTest<T, S, N, D>::PrepareFramebufferMultisample(const glw::GLenum internal_format)
{
    ...
    {
    case 2:
        gl.textureStorage2DMultisample(m_to_ms, 1, internal_format, TestReferenceDataWidth(), TestReferenceDataHeight(),
                                       false);
        break;
    case 3:
        gl.textureStorage3DMultisample(m_to_ms, 1, internal_format, TestReferenceDataWidth(), TestReferenceDataHeight(),
                                       TestReferenceDataDepth(), false);
        break;
    default:
        DE_FATAL("invalid texture dimension");
        return false;
 ...
 */
template <typename T, glw::GLint S, bool N, glw::GLuint D>
glw::GLuint StorageMultisampleTest<T, S, N, D>::PrepareProgram(const glw::GLchar *variable_declaration,
                                                               const glw::GLchar *tail)
{
    /* Shortcut for GL functionality */
    const glw::Functions &gl = m_context.getRenderContext().getFunctions();
...
static const unsigned char data_0x8dbb_2D_8[] = {34, 237, 94, 207, 252, 29, 75, 25};

static const unsigned char data_0x8dbb_3D_32[] = {34,  237, 94,  207, 252, 29,  75,  25,  34,  237, 44,
                                                  173, 101, 230, 139, 254, 34,  237, 176, 88,  174, 127,
                                                  248, 206, 34,  237, 127, 209, 211, 203, 100, 150};

static const unsigned char data_0x8dbc_2D_8[] = {127, 0, 233, 64, 0, 42, 71, 231};

static const unsigned char data_0x8dbc_3D_32[] = {127, 0,   233, 64,  0,   42,  71, 231, 127, 0,  20,
                                                  227, 162, 33,  246, 1,   127, 0,  143, 57,  86, 0,
                                                  136, 53,  127, 0,   192, 62,  48, 69,  29,  138};

static const unsigned char data_0x8dbd_2D_16[] = {34, 237, 94, 207, 252, 29,  75, 25,
                                                  28, 242, 94, 111, 44,  101, 35, 145};

static const unsigned char data_0x8dbd_3D_64[] = {
    34,  237, 94,  207, 252, 29,  75,  25,  28,  242, 94,  111, 44,  101, 35,  145, 34,  237, 44,  173, 101, 230,
    139, 254, 28,  242, 170, 45,  98,  236, 202, 228, 34,  237, 176, 88,  174, 127, 248, 206, 28,  242, 164, 148,
    178, 25,  252, 206, 34,  237, 127, 209, 211, 203, 100, 150, 28,  242, 79,  216, 149, 3,   101, 87};

static const unsigned char data_0x8dbe_2D_16[] = {127, 0, 233, 64, 0, 42, 71, 231, 127, 0, 233, 144, 23, 163, 100, 115};

static const unsigned char data_0x8dbe_3D_64[] = {
    127, 0,   233, 64, 0,   42, 71,  231, 127, 0,  233, 144, 23,  163, 100, 115, 127, 0,  20,  227, 162, 33,
    246, 1,   127, 0,  94,  98, 190, 84,  55,  1,  127, 0,   143, 57,  86,  0,   136, 53, 127, 0,   163, 45,
    113, 232, 131, 53, 127, 0,  192, 62,  48,  69, 29,  138, 127, 0,   128, 182, 138, 61, 157, 204};

static const unsigned char data_0x8e8c_2D_16[] = {144, 43,  143, 15,  254, 15,  152, 153,
                                                  153, 153, 89,  143, 140, 166, 183, 113};

static const unsigned char data_0x8e8c_3D_64[] = {
    144, 43,  143, 15,  254, 15,  152, 153, 153, 153, 89,  143, 140, 166, 183, 113, 144, 43,  143, 15,  254, 15,
    152, 153, 153, 153, 55,  48,  102, 244, 186, 241, 144, 43,  143, 15,  254, 15,  152, 153, 153, 153, 231, 54,
    211, 92,  240, 14,  144, 121, 253, 241, 193, 15,  152, 153, 153, 153, 25,  41,  102, 244, 248, 135};

static const unsigned char data_0x8e8d_2D_16[] = {144, 43,  143, 15,  254, 15,  152, 153,
                                                  153, 153, 89,  143, 140, 166, 183, 113};
...
static const unsigned char data_0x8e8e_2D_16[] = {67,  155, 82,  120, 142, 7,   31,  124,
                                                  224, 255, 165, 221, 239, 223, 122, 223};

static const unsigned char data_0x8e8e_3D_64[] = {
    67, 155, 82, 120, 142, 7,  31,  124, 224, 255, 165, 221, 239, 223, 122, 223, 35, 30,  124, 240, 209, 166,
    20, 158, 11, 250, 24,  21, 0,   2,   34,  2,   35,  30,  124, 240, 209, 166, 20, 158, 5,   88,  2,   1,
    34, 165, 0,  241, 35,  30, 124, 240, 209, 166, 20,  158, 33,  34,  32,  0,   81, 129, 175, 80};

static const unsigned char data_0x8e8f_2D_16[] = {131, 54,  165, 148, 26,  47,  62,  248,
                                                  176, 254, 149, 203, 222, 206, 187, 173};

static const unsigned char data_0x8e8f_3D_64[] = {
    131, 54,  165, 148, 26, 47,  62,  248, 176, 254, 149, 203, 222, 206, 187, 173, 99,  188, 248, 224, 163, 77,
    41,  165, 24,  250, 36, 70,  18,  20,  53,  3,   99,  188, 248, 224, 163, 77,  41,  165, 42,  68,  19,  18,
    67,  166, 16,  244, 99, 188, 248, 224, 163, 77,  41,  165, 48,  83,  65,  33,  100, 66,  175, 65};

static const unsigned char data_GL_COMPRESSED_R11_EAC_2D_8[] = {146, 253, 99, 81, 202, 222, 63, 243};

static const unsigned char data_GL_COMPRESSED_R11_EAC_3D_32[] = {146, 253, 99,  81,  202, 222, 63,  243, 146, 253, 169,
                                                                 188, 102, 31,  246, 55,  146, 253, 123, 247, 62,  71,
                                                                 139, 131, 146, 253, 248, 63,  248, 208, 230, 213};

static const unsigned char data_GL_COMPRESSED_RG11_EAC_2D_16[] = {146, 253, 99,  81, 202, 222, 63,  243,
                                                                  140, 254, 110, 0,  160, 130, 207, 180};

static const unsigned char data_GL_COMPRESSED_RG11_EAC_3D_64[] = {
    146, 253, 99,  81,  202, 222, 63,  243, 140, 254, 110, 0,   160, 130, 207, 180, 146, 253, 169, 188, 102, 31,
    246, 55,  140, 254, 2,   73,  46,  104, 102, 39,  146, 253, 123, 247, 62,  71,  139, 131, 140, 254, 155, 121,
    68,  17,  1,   27,  146, 253, 248, 63,  248, 208, 230, 213, 140, 254, 240, 60,  19,  214, 73,  0};

static const unsigned char data_GL_COMPRESSED_RGB8_ETC2_2D_8[] = {168, 122, 150, 252, 234, 35, 0, 0};

static const unsigned char data_GL_COMPRESSED_RGB8_ETC2_3D_32[] = {
    168, 122, 150, 252, 234, 35, 0, 0, 168, 122, 150, 253, 31, 140, 0, 0,
    138, 167, 105, 252, 196, 87, 0, 0, 138, 167, 105, 253, 49, 248, 0, 0};

static const unsigned char data_GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2_2D_8[] = {83, 83, 75, 252, 240, 240, 15, 4};

static const unsigned char data_GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2_3D_32[] = {
    83,  83,  75,  252, 240, 240, 15, 4,  107, 99,  99,  253, 240, 240, 14, 15,
    135, 135, 135, 252, 240, 240, 15, 15, 108, 108, 108, 253, 240, 248, 11, 11};

static const unsigned char data_GL_COMPRESSED_RGBA8_ETC2_EAC_2D_16[] = {127, 245, 255, 244, 146, 255, 244, 146,
                                                                        168, 122, 150, 252, 234, 35,  0,   0};

static const unsigned char data_GL_COMPRESSED_RGBA8_ETC2_EAC_3D_64[] = {
    127, 245, 255, 244, 146, 255, 244, 146, 168, 122, 150, 252, 234, 35,  0,   0,   127, 245, 255, 244, 146, 255,
    244, 146, 168, 122, 150, 253, 31,  140, 0,   0,   127, 245, 255, 244, 146, 255, 244, 146, 138, 167, 105, 252,
    196, 87,  0,   0,   127, 245, 255, 244, 146, 255, 244, 146, 138, 167, 105, 253, 49,  248, 0,   0};

static const unsigned char data_GL_COMPRESSED_SIGNED_R11_EAC_2D_8[] = {73, 221, 99, 81, 201, 222, 63, 241};

static const unsigned char data_GL_COMPRESSED_SIGNED_R11_EAC_3D_32[] = {
    73, 221, 99, 81,  201, 222, 63,  241, 73, 221, 165, 156, 102, 31,  246, 55,
    73, 221, 59, 247, 62,  39,  139, 131, 73, 221, 248, 63,  248, 208, 226, 205};

static const unsigned char data_GL_COMPRESSED_SIGNED_RG11_EAC_2D_16[] = {73, 221, 99,  81, 201, 222, 63, 241,
                                                                         66, 191, 110, 0,  96,  131, 77, 180};

static const unsigned char data_GL_COMPRESSED_SIGNED_RG11_EAC_3D_64[] = {
    73,  221, 99,  81,  201, 222, 63,  241, 66,  191, 110, 0,   96, 131, 77,  180, 73,  221, 165, 156, 102, 31,
    246, 55,  66,  191, 2,   73,  54,  100, 102, 38,  73,  221, 59, 247, 62,  39,  139, 131, 66,  191, 155, 105,
    132, 16,  129, 27,  73,  221, 248, 63,  248, 208, 226, 205, 66, 191, 208, 60,  11,  218, 73,  0};

static const unsigned char data_GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC_2D_16[] = {127, 245, 255, 244, 146, 255, 244, 146,
                                                                               150, 122, 168, 252, 234, 35,  0,   0};

static const unsigned char data_GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC_3D_64[] = {
    127, 245, 255, 244, 146, 255, 244, 146, 150, 122, 168, 252, 234, 35,  0,   0,   127, 245, 255, 244, 146, 255,
    244, 146, 150, 122, 168, 253, 31,  140, 0,   0,   127, 245, 255, 244, 146, 255, 244, 146, 105, 167, 138, 252,
    196, 87,  0,   0,   127, 245, 255, 244, 146, 255, 244, 146, 105, 167, 138, 253, 49,  248, 0,   0};

static const unsigned char data_GL_COMPRESSED_SRGB8_ETC2_2D_8[] = {168, 122, 150, 252, 234, 35, 0, 0};

static const unsigned char data_GL_COMPRESSED_SRGB8_ETC2_3D_32[] = {
    168, 122, 150, 252, 234, 35, 0, 0, 168, 122, 150, 253, 31, 140, 0, 0,
    138, 167, 105, 252, 196, 87, 0, 0, 138, 167, 105, 253, 49, 248, 0, 0};

static const unsigned char data_GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2_2D_8[] = {75,  83,  83, 252,
                                                                                       240, 240, 15, 4};

static const unsigned char data_GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2_3D_32[] = {
    75,  83,  83,  252, 240, 240, 15, 4,  99,  99,  107, 253, 240, 240, 14, 15,
    135, 135, 135, 252, 240, 240, 15, 15, 108, 108, 108, 253, 240, 248, 11, 11};
...
static CompressedData compressed_images[] = {
    ...
    {GL_COMPRESSED_RGB8_ETC2, data_GL_COMPRESSED_RGB8_ETC2_2D_8, sizeof data_GL_COMPRESSED_RGB8_ETC2_2D_8, 2},
    {GL_COMPRESSED_SRGB8_ETC2, data_GL_COMPRESSED_SRGB8_ETC2_2D_8, sizeof data_GL_COMPRESSED_SRGB8_ETC2_2D_8, 2},
    {GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2, data_GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2_2D_8,
     sizeof data_GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2_2D_8, 2},
    {GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2, data_GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2_2D_8,
    ...
    {GL_COMPRESSED_R11_EAC, data_GL_COMPRESSED_R11_EAC_2D_8, sizeof data_GL_COMPRESSED_R11_EAC_2D_8, 2},
    {GL_COMPRESSED_SIGNED_R11_EAC, data_GL_COMPRESSED_SIGNED_R11_EAC_2D_8,
     sizeof data_GL_COMPRESSED_SIGNED_R11_EAC_2D_8, 2},
    {GL_COMPRESSED_RG11_EAC, data_GL_COMPRESSED_RG11_EAC_2D_16, sizeof data_GL_COMPRESSED_SIGNED_RG11_EAC_2D_16, 2},
    ...
    {GL_COMPRESSED_RGB8_ETC2, data_GL_COMPRESSED_RGB8_ETC2_3D_32, sizeof data_GL_COMPRESSED_RGB8_ETC2_3D_32, 3},
    {GL_COMPRESSED_SRGB8_ETC2, data_GL_COMPRESSED_SRGB8_ETC2_3D_32, sizeof data_GL_COMPRESSED_SRGB8_ETC2_3D_32, 3},
    {GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2, data_GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2_3D_32,
     sizeof data_GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2_3D_32, 3},
    {GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2, data_GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2_3D_32,
     sizeof data_GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2_3D_32, 3},
    {GL_COMPRESSED_R11_EAC, data_GL_COMPRESSED_R11_EAC_3D_32, sizeof data_GL_COMPRESSED_R11_EAC_3D_32, 3},
    ...
    {GL_COMPRESSED_RG11_EAC, data_GL_COMPRESSED_RG11_EAC_3D_64, sizeof data_GL_COMPRESSED_RG11_EAC_3D_64, 3},
...
bool CompressedSubImageTest::PrepareReferenceData(glw::GLenum internalformat)
{
    ...
    if (!TextureImage<D>(internalformat))
    {
        ...
        {
            if (internalformat == compressed_images[i].iformat && D == compressed_images[i].dimensions)
            {
    ...
    else
    {
        ...
        {
            /* Query texture size. */
            gl.getTexLevelParameteriv(TextureTarget<D>(), 0, GL_TEXTURE_COMPRESSED_IMAGE_SIZE,
...
void CompressedSubImageTest::PrepareCompressedStorage<1>(glw::GLenum internalformat)
{
    ...
    gl.compressedTexImage1D(TextureTarget<1>(), 0, internalformat, s_texture_width * s_block_count, 0,
                            s_texture_width * s_block_count, 0);
    GLU_EXPECT_NO_ERROR(gl.getError(), "glCompressedTexImage1D has failed");
}
...
void CompressedSubImageTest::PrepareCompressedStorage<2>(glw::GLenum internalformat)
{
    ...
    gl.compressedTexImage2D(TextureTarget<2>(), 0, internalformat, size_x, size_y, 0, size, 0);
    GLU_EXPECT_NO_ERROR(gl.getError(), "glCompressedTexImage2D has failed");
}
...
void CompressedSubImageTest::PrepareCompressedStorage<3>(glw::GLenum internalformat)
{
    ...
    gl.compressedTexImage3D(TextureTarget<3>(), 0, internalformat, size_x, size_y, size_z, 0, size, 0);
    GLU_EXPECT_NO_ERROR(gl.getError(), "glCompressedTexImage3D has failed");
}
                                                   ...
                                                   glw::GLint x, glw::GLint y, glw::GLsizei width)
{
    ...
    {
        m_context.getTestContext().getLog()
            << tcu::TestLog::Message << "glCopyTextureSubImage1D unexpectedly generated error "
                                                   ...
                                                   glw::GLsizei height)
{
    ...
    {
        m_context.getTestContext().getLog()
            << tcu::TestLog::Message << "glCopyTextureSubImage2D unexpectedly generated error "
            << glu::getErrorStr(error) << ". Test fails." << tcu::TestLog::EndMessage;
                                                   ...
                                                   glw::GLsizei width, glw::GLsizei height)
{
    ...
    {
        m_context.getTestContext().getLog()
            << tcu::TestLog::Message << "glCopyTextureSubImage3D unexpectedly generated error "
            << glu::getErrorStr(error) << ". Test fails." << tcu::TestLog::EndMessage;
...
bool GetSetParameterTest::CheckErrorAndLog(const glw::GLchar *fname, glw::GLenum pname)
{
    ...
    {
        m_context.getTestContext().getLog()
            << tcu::TestLog::Message << fname << " unexpectedly generated error " << glu::getErrorStr(error)
            << " during test of pname " << glu::getTextureParameterStr(pname) << ". Test fails."
            << tcu::TestLog::EndMessage;
...
bool GetSetParameterTest::CompareAndLog(glw::GLint value_src, glw::GLint value_dst, glw::GLenum pname)
{
    if (value_src != value_dst)
    {
        m_context.getTestContext().getLog()
            ...
            << " is equal to " << value_dst << ", however " << value_src << " was expected. Test fails."
            << tcu::TestLog::EndMessage;
...
bool DefaultsTest::CompareAndLog(glw::GLint value_ref, glw::GLint value_dst, glw::GLenum pname)
{
    if (value_ref != value_dst)
    {
        m_context.getTestContext().getLog()
            << tcu::TestLog::Message << "Queried value of pname " << glu::getTextureParameterStr(pname)
            << " is equal to " << value_dst << ", however " << value_ref << " was expected. Test fails."
            << tcu::TestLog::EndMessage;
...
/** Reference data. */
const glw::GLubyte GetImageTest::s_texture_data[] = {
...
tcu::TestNode::IterateResult GetLevelParameterTest::iterate()
{
    ...
    try
    {
        ...
        static const glw::GLenum pnames[]     = {GL_TEXTURE_WIDTH,           GL_TEXTURE_HEIGHT,     GL_TEXTURE_DEPTH,
                                                 GL_TEXTURE_INTERNAL_FORMAT, GL_TEXTURE_RED_TYPE,   GL_TEXTURE_GREEN_TYPE,
                                       ...
                                       const glw::GLchar *function_name, const glw::GLchar *log)
{
    ...
    if (expected_error != (error = gl.getError()))
    {
        context.getTestContext().getLog()
            ...
            << glu::getErrorStr(expected_error) << " was expected if " << log << tcu::TestLog::EndMessage;
...
tcu::TestNode::IterateResult ImageQueryErrorsTest::iterate()
{
    ...
    try
    {
        ...
        gl.getCompressedTextureImage(texture_2D_compressed, 0, s_reference_size,
                                     glu::BufferOffsetAsPointer(s_reference_size - 1));
        is_ok &= CheckErrorAndLog(m_context, GL_INVALID_OPERATION, "glGetCompressedTextureImage",

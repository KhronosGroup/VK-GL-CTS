    ...
    virtual long Run()
    {
        ...
        }
        {
            const GLchar *const v[16] = {
                ...
                "StageData.attrib[8]",  "StageData.attrib[9]",  "StageData.attrib[10]", "StageData.attrib[11]",
                "StageData.attrib[12]", "StageData.attrib[13]", "StageData.attrib[14]", "StageData.attrib[15]"};
...
protected:
    ...
    virtual long Run()
    {
        ...
        {
            const GLchar *const v[16] = {
                "StageData.attribi[0]",  "StageData.attribi[1]",  "StageData.attribi[2]",  "StageData.attribi[3]",
                "StageData.attribi[4]",  "StageData.attribi[5]",  "StageData.attribi[6]",  "StageData.attribi[7]",
                "StageData.attribui[0]", "StageData.attribui[1]", "StageData.attribui[2]", "StageData.attribui[3]",
                "StageData.attribui[4]", "StageData.attribui[5]", "StageData.attribui[6]", "StageData.attribui[7]"};
            glTransformFeedbackVaryings(m_po, 16, v, GL_INTERLEAVED_ATTRIBS);
        }
        glLinkProgram(m_po);
        if (!CheckProgram(m_po))
...
public:
    ...
    bool stateVerify()
    {
        ...
        if (reinterpret_cast<uintptr_t>(pp) != array_pointer)
        {
            m_context.getTestContext().getLog()
                << tcu::TestLog::Message << "GL_VERTEX_ATTRIB_ARRAY_POINTER(" << index << ") is "
                << reinterpret_cast<uintptr_t>(pp) << " should be " << array_pointer << tcu::TestLog::EndMessage;
            status = false;
        }

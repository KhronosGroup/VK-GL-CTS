...
gl4cts::ConditionalRenderInverted::CoverageTest::CoverageTest(deqp::Context &context)
    : deqp::TestCase(context, "coverage", "Conditional Render Inverted Coverage Test")
    , m_qo_id(0)
{
    /* Intentionally left blank. */
}
...
tcu::TestNode::IterateResult gl4cts::ConditionalRenderInverted::CoverageTest::iterate()
{
    ...
    else
    {
        ...
        {
            m_context.getTestContext().getLog()
                << tcu::TestLog::Message << "The Conditional Render Inverted Coverage Test has failed."
                << tcu::TestLog::EndMessage;
...
bool gl4cts::ConditionalRenderInverted::CoverageTest::test(glw::GLenum mode)
{
    ...
    {
        m_context.getTestContext().getLog()
            << tcu::TestLog::Message << "glBeginConditionalRender failed when used with mode "
...
tcu::TestNode::IterateResult gl4cts::ConditionalRenderInverted::FunctionalTest::iterate()
{
    ...
    else
    {
        ...
        {
            m_context.getTestContext().getLog()
                << tcu::TestLog::Message << "The Conditional Render Inverted Functional Test has failed."
                << tcu::TestLog::EndMessage;

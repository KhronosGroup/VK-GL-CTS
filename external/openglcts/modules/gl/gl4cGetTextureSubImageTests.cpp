...
/** The functions checks that GL_INVALID_VALUE error is generated by GetTextureSubImage if texture is not the
 *  name of an existing texture object.The functions checks that GL_INVALID_VALUE error is generated by
 *  GetCompressedTextureSubImage if texture is not the name of an existing texture object.
...
/** The functions checks that GL_INVALID_OPERATION error is generated if texture is the

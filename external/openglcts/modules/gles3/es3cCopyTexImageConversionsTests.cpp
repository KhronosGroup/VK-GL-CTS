            ...
            &result_bottomleft_pixel_data, &result_bottomright_pixel_data, &channels_to_compare))
        {
            ...
            else
            {
                ...
                else if (m_source_attachment_type != GL_RENDERBUFFER)
                {
                    ...
                    {
                        m_testCtx.getLog() << tcu::TestLog::Message
                                           << "Source and destination should be of the same data type - "
                                                         ...
                                                         GLenum result_internalformat)
{
    ...
    PixelData *reference_pixels[] = {
        &reference_bl_pixel_data,
        &reference_br_pixel_data,
        &reference_tl_pixel_data,
        &reference_tr_pixel_data,
    };
                    ...
                    n_bits_for_channel_3 == 16)
                {
                    ...
                    *result_traveller16 = channels[3]->unsigned_short_data;
                        ...
                        n_bits_for_channel_3 == 4)
                    {
                        ...
                        *result_traveller16 = (channels[0]->unsigned_byte_data << 12) +
                                              (channels[1]->unsigned_byte_data << 8) +
                            ...
                            n_bits_for_channel_3 == 8)
                        {
                            ...
                            *result_traveller = channels[3]->unsigned_byte_data;
                                ...
                                n_bits_for_channel_3 == 1)
                            {
                                ...
                                *result_traveller16 =
                                    (channels[0]->unsigned_byte_data << 11) + (channels[1]->unsigned_byte_data << 6) +
                                ...
                                // RGB10A2_REV
                                if (n_bits_for_channel_0 == 2 && n_bits_for_channel_1 == 10 &&
                                    n_bits_for_channel_2 == 10 && n_bits_for_channel_3 == 10)
                                {
                                    unsigned int *result_traveller32 = (unsigned int *)result_traveller;
                                    ...
                                    *result_traveller32 = (channels[0]->unsigned_byte_data << 30) +
                                                          ...
                                                          (channels[2]->unsigned_short_data << 10) +
                                                          channels[3]->unsigned_short_data;
                ...
                if (n_bits_for_channel_0 == 8 && n_bits_for_channel_1 == 8 && n_bits_for_channel_2 == 8)
                {
                    ...
                    *result_traveller = channels[2]->unsigned_byte_data;
                    ...
                    if (n_bits_for_channel_0 == 5 && n_bits_for_channel_1 == 6 && n_bits_for_channel_2 == 5)
                    {
                        ...
                        *result_traveller16 = (channels[0]->unsigned_byte_data << 11) +
                                              (channels[1]->unsigned_byte_data << 5) +
    ...
    GLint max_epsilon_a)
{
    m_testCtx.getLog() << tcu::TestLog::Message << "Conversion failed for source  ["
                       ...
                       << ", " << reference_pixel_g << ", " << reference_pixel_b << ", " << reference_pixel_a
                       ...
                       << getInternalformatString(result_internalformat) << "]\nType used for glReadPixels(): ["
                       << glu::getTypeStr(result_type).toString() << "]\nMaximum epsilon:   [" << max_epsilon_r << ", "
                       << max_epsilon_g << ", " << max_epsilon_b << ", " << max_epsilon_a << "]"
                       << tcu::TestLog::EndMessage;
}

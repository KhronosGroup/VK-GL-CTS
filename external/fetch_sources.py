...
PACKAGES = [
    ...
    GitRepo(
        ...
        "a71a4f76a31551abb4a28b79c87228f4dad5efa3",
        "spirv-tools"),
    GitRepo(
        "https://gitlab.khronos.org/GLSL/glslang.git",
        "git@gitlab.khronos.org:GLSL/glslang.git",
        "4409b6de6ba5e12677de9d662dda3ee37479c32d",
        "glslang",

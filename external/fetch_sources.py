...
PACKAGES = [
    ...
    GitRepo(
        ...
        "4d10fb91d71f0bffb50157c12315fa5d41806612",
        "spirv-tools"),
    GitRepo(
        "https://gitlab.khronos.org/GLSL/glslang.git",
        "git@gitlab.khronos.org:GLSL/glslang.git",
        "7310ffa2921b8e5e2f6f9911f3ea1d1a090a6c23",
        "glslang",

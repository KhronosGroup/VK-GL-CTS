...
PACKAGES = [
    ...
    GitRepo(
        ...
        "8c30b2517cdb1dac1f8f8685cbbbf6832000c0cc",
        "spirv-tools"),
    GitRepo(
        "https://gitlab.khronos.org/GLSL/glslang.git",
        "git@gitlab.khronos.org:GLSL/glslang.git",
        "c2f5dae5046bc821227d3c22a964ec293ef4ebd9",
        "glslang",

...
PACKAGES = [
    ...
    GitRepo(
        ...
        "fd6525b6acac202cd9457266f8444457381a4920",
        "spirv-tools"),
    GitRepo(
        "https://gitlab.khronos.org/GLSL/glslang.git",
        "git@gitlab.khronos.org:GLSL/glslang.git",
        "5d3960e09d53c70a7c503ccadbeb6d849e173f52",
        "glslang",

...
Following command line options MUST be used when running CTS:
	...
	--deqp-caselist-file=<vulkancts>/external/vulkancts/mustpass/1.1.5/vk-default.txt
...
### Android
	...
	adb push <vulkancts>/external/vulkancts/mustpass/1.1.5/vk-default.txt /sdcard/vk-default.txt
	adb shell
...
and path to current mustpass list. For example:
	...
	python external/vulkancts/scripts/verify_submission.py VK_11_Khronos_1/ external/vulkancts/mustpass/1.1.5/vk-default.txt

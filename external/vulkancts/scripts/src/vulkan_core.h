...
typedef enum VkStructureType {
    ...
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_EXTENDED_TYPES_FEATURES_KHR = 1000175000,
...
typedef struct VkPhysicalDeviceSubgroupExtendedTypesFeaturesKHR {
    VkStructureType    sType;
    void*              pNext;
    VkBool32           shaderSubgroupExtendedTypes;
} VkPhysicalDeviceSubgroupExtendedTypesFeaturesKHR;

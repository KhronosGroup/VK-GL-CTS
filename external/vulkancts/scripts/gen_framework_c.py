...
VULKAN_H = { "" : [    os.path.join(VULKAN_HEADERS_INCLUDE_DIR, "vk_video", "vulkan_video_codecs_common.h"),
                                ...
                                ####os.path.join(VULKAN_HEADERS_INCLUDE_DIR, "vk_video", "vulkan_video_codec_vp9std.h"),            ### TODO to uncomment (in 4 places in this file)
                                ####os.path.join(VULKAN_HEADERS_INCLUDE_DIR, "vk_video", "vulkan_video_codec_vp9std_decode.h"),     ### TODO to uncomment
...
if __name__ == "__main__":
    ...
    videoTargets = [
        ...
        ###'vulkan_video_codec_vp9std.h',                   ### TODO to uncomment
        ###'vulkan_video_codec_vp9std_decode.h',            ### TODO to uncomment
    ]

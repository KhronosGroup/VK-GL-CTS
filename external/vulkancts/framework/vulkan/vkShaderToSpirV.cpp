...
void getDefaultBuiltInResources (TBuiltInResource* builtin)
{
	...
	builtin->maxMeshWorkGroupSizeY_EXT					= 1;
	builtin->maxMeshWorkGroupSizeZ_EXT					= 1;
	builtin->maxTaskWorkGroupSizeX_EXT					= 1024;
	builtin->maxTaskWorkGroupSizeY_EXT					= 1;
	builtin->maxTaskWorkGroupSizeZ_EXT					= 1;

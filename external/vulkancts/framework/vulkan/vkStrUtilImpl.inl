...
const char* getResultName (VkResult value)
{
	switch (value)
	{
		...
		case VK_ERROR_INVALID_DEVICE_ADDRESS:						return "VK_ERROR_INVALID_DEVICE_ADDRESS";
...
const char* getStructureTypeName (VkStructureType value)
{
	switch (value)
	{
		...
		case VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_CREATE_INFO:								return "VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_CREATE_INFO";
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_EXTENDED_TYPES_FEATURES:				return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_EXTENDED_TYPES_FEATURES";
...
std::ostream& operator<< (std::ostream& s, const VkPhysicalDeviceSubgroupExtendedTypesFeatures& value)
{
	s << "VkPhysicalDeviceSubgroupExtendedTypesFeatures = {\n";
	s << "\tsType = " << value.sType << '\n';
	s << "\tpNext = " << value.pNext << '\n';
...
std::ostream& operator<< (std::ostream& s, const VkBufferDeviceAddressCreateInfo& value)
{
	s << "VkBufferDeviceAddressCreateInfo = {\n";
	s << "\tsType = " << value.sType << '\n';
	s << "\tpNext = " << value.pNext << '\n';

...
public:
    ...
    size_t structCount() const
    {
        return m_structs.size();
    }

    size_t batchStructCount() const
    {
        return m_batchStructCount;
    }
    void batchStructCount(const size_t &value);

    size_t batchGeomCount() const
    {
        return m_batchGeomCount;
    }
    void batchGeomCount(const size_t &value)
    {
     ...
     */
    void batchCreate(const DeviceInterface &vk, const VkDevice device, Allocator &allocator);

...
struct RequiredExtension
{
    ...
    explicit RequiredExtension(const std::string &name_, tcu::Maybe<uint32_t> minVersion_ = tcu::nothing<uint32_t>(),
                               tcu::Maybe<uint32_t> maxVersion_ = tcu::nothing<uint32_t>())
        : name(name_)
...
struct RequiredLayer
{
    ...
    explicit RequiredLayer(const std::string &name_, tcu::Maybe<uint32_t> minSpecVersion_ = tcu::nothing<uint32_t>(),
                           tcu::Maybe<uint32_t> maxSpecVersion_ = tcu::nothing<uint32_t>(),
                           tcu::Maybe<uint32_t> minImplVersion_ = tcu::nothing<uint32_t>(),
                           tcu::Maybe<uint32_t> maxImplVersion_ = tcu::nothing<uint32_t>())
        : name(name_)

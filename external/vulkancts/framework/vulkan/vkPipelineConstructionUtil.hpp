...
{
public:
    GraphicsPipelineWrapper(const DeviceInterface &vk, VkDevice device,
    ...
    GraphicsPipelineWrapper &setDepthClipControl(
    ...
    GraphicsPipelineWrapper &setupVertexInputStete(
        const VkPipelineVertexInputStateCreateInfo *vertexInputState     = DE_NULL,
    ...
    GraphicsPipelineWrapper &setupPreRasterizationShaderState(
        ...
        const VkShaderModule geometryShaderModule = DE_NULL, const VkSpecializationInfo *specializationInfo = DE_NULL,
    ...
    GraphicsPipelineWrapper &setupFragmentShaderState(
        ...
        const VkSpecializationInfo *specializationInfo = DE_NULL, const VkPipelineCache partPipelineCache = DE_NULL,
        PipelineCreationFeedbackCreateInfoWrapper partCreationFeedback = PipelineCreationFeedbackCreateInfoWrapper());

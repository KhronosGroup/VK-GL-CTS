...
virtual VkResult			getAccelerationStructureHandleNV				(VkDevice device, VkAccelerationStructureNV accelerationStructure, uintptr_t dataSize, void* pData) const = 0;

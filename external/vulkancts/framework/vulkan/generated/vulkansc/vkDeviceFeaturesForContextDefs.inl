...
const vk::VkPhysicalDeviceTextureCompressionASTCHDRFeaturesEXT&			Context::getTextureCompressionASTCHDRFeatures		(void) const { return m_device->getTextureCompressionASTCHDRFeatures();			}
...
const vk::VkPhysicalDeviceGlobalPriorityQueryFeaturesEXT&				Context::getGlobalPriorityQueryFeatures				(void) const { return m_device->getGlobalPriorityQueryFeatures();				}
...
const vk::VkPhysicalDeviceImageRobustnessFeaturesEXT&					Context::getImageRobustnessFeatures					(void) const { return m_device->getImageRobustnessFeatures();					}

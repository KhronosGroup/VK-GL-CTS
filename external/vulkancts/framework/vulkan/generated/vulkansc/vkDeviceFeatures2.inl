...
tcu::TestStatus testPhysicalDeviceFeatureGlobalPriorityQueryFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance        instance        (createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&        vki                (instance.getDriver());
	...
	const bool										isGlobalPriorityQueryFeaturesEXT = checkExtension(properties, "VK_KHR_global_priority") || context.contextSupports(vk::ApiVersion(1, 1, 4, 0));
	...
	for (int ndx = 0; ndx < count; ++ndx)
	{
		...
		deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
		extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
		extFeatures.pNext = &deviceGlobalPriorityQueryFeaturesEXT[ndx];
...
tcu::TestStatus testPhysicalDeviceFeatureVertexAttributeDivisorFeaturesEXT (Context& context)
{
	...
	const bool											isVertexAttributeDivisorFeaturesEXT = checkExtension(properties, "VK_KHR_vertex_attribute_divisor") || context.contextSupports(vk::ApiVersion(1, 1, 4, 0));
...
tcu::TestStatus testPhysicalDeviceFeatureTextureCompressionASTCHDRFeaturesEXT (Context& context)
{
	...
	for (int ndx = 0; ndx < count; ++ndx)
	{
		...
		deviceTextureCompressionASTCHDRFeaturesEXT[ndx].pNext = nullptr;
...
tcu::TestStatus testPhysicalDeviceFeatureIndexTypeUint8FeaturesEXT (Context& context)
{
	...
	const bool									isIndexTypeUint8FeaturesEXT = checkExtension(properties, "VK_KHR_index_type_uint8");
...
tcu::TestStatus testPhysicalDeviceFeatureShaderDemoteToHelperInvocationFeaturesEXT (Context& context)
{
	...
	for (int ndx = 0; ndx < count; ++ndx)
	{
		...
		deviceShaderDemoteToHelperInvocationFeaturesEXT[ndx].pNext = nullptr;
...
tcu::TestStatus testPhysicalDeviceFeatureSubgroupSizeControlFeaturesEXT (Context& context)
{
	...
	for (int ndx = 0; ndx < count; ++ndx)
	{
		...
		deviceSubgroupSizeControlFeaturesEXT[ndx].pNext = nullptr;
...
tcu::TestStatus testPhysicalDeviceFeatureLineRasterizationFeaturesEXT (Context& context)
{
	...
	const bool										isLineRasterizationFeaturesEXT = checkExtension(properties, "VK_KHR_line_rasterization");
...
tcu::TestStatus testPhysicalDeviceFeatureImageRobustnessFeaturesEXT (Context& context)
{
	...
	for (int ndx = 0; ndx < count; ++ndx)
	{
		...
		deviceImageRobustnessFeaturesEXT[ndx].pNext = nullptr;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderTerminateInvocationFeaturesKHR (Context& context)
{
	...
	for (int ndx = 0; ndx < count; ++ndx)
	{
		...
		deviceShaderTerminateInvocationFeaturesKHR[ndx].pNext = nullptr;
...
tcu::TestStatus testPhysicalDeviceFeatureSynchronization2FeaturesKHR (Context& context)
{
	...
	for (int ndx = 0; ndx < count; ++ndx)
	{
		...
		deviceSynchronization2FeaturesKHR[ndx].pNext = nullptr;
...
void addSeparateFeatureTests (tcu::TestCaseGroup* testGroup)
{
	...
	addFunctionCase(testGroup, "global_priority_query_features_ext", testPhysicalDeviceFeatureGlobalPriorityQueryFeaturesEXT);

...
#define VK_HEADER_VERSION_COMPLETE										(static_cast<uint32_t>	((VK_MAKE_API_VERSION(0, 1, 0, 22))))
...
#define VK_COMPUTE_OCCUPANCY_PRIORITY_HIGH_NV							(static_cast<float>		(0.75f))
#define VK_COMPUTE_OCCUPANCY_PRIORITY_LOW_NV							(static_cast<float>		(0.25f))
#define VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV							(static_cast<float>		(0.50f))

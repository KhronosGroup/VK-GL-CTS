...
VK_DEFINE_PLATFORM_TYPE(NvSciSyncAttrList,			int32_t)
VK_DEFINE_PLATFORM_TYPE(NvSciSyncObj,				int32_t)
VK_DEFINE_PLATFORM_TYPE(NvSciSyncFence,				int32_t)
VK_DEFINE_PLATFORM_TYPE(NvSciBufAttrList,			int32_t)
VK_DEFINE_PLATFORM_TYPE(NvSciBufObj,				int32_t)

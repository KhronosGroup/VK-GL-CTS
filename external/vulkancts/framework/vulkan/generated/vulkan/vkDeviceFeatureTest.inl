...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestClusterAccelerationStructureFeaturesNV (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceClusterAccelerationStructureFeaturesNV>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceClusterAccelerationStructureFeaturesNV, clusterAccelerationStructure),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceClusterAccelerationStructureFeaturesNV*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestComputeOccupancyPriorityFeaturesNV (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceComputeOccupancyPriorityFeaturesNV>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceComputeOccupancyPriorityFeaturesNV, computeOccupancyPriority),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceComputeOccupancyPriorityFeaturesNV*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestCooperativeMatrixConversionFeaturesQCOM (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceCooperativeMatrixConversionFeaturesQCOM>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceCooperativeMatrixConversionFeaturesQCOM, cooperativeMatrixConversion),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceCooperativeMatrixConversionFeaturesQCOM*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestCooperativeVectorFeaturesNV (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceCooperativeVectorFeaturesNV>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceCooperativeVectorFeaturesNV, cooperativeVector),
        FEATURE_ITEM (VkPhysicalDeviceCooperativeVectorFeaturesNV, cooperativeVectorTraining),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceCooperativeVectorFeaturesNV*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 2, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestCopyMemoryIndirectFeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceCopyMemoryIndirectFeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceCopyMemoryIndirectFeaturesKHR, indirectMemoryCopy),
        FEATURE_ITEM (VkPhysicalDeviceCopyMemoryIndirectFeaturesKHR, indirectMemoryToImageCopy),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceCopyMemoryIndirectFeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 2, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestCustomResolveFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceCustomResolveFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceCustomResolveFeaturesEXT, customResolve),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceCustomResolveFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestDataGraphFeaturesARM (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceDataGraphFeaturesARM>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceDataGraphFeaturesARM, dataGraph),
        FEATURE_ITEM (VkPhysicalDeviceDataGraphFeaturesARM, dataGraphUpdateAfterBind),
        FEATURE_ITEM (VkPhysicalDeviceDataGraphFeaturesARM, dataGraphSpecializationConstants),
        FEATURE_ITEM (VkPhysicalDeviceDataGraphFeaturesARM, dataGraphDescriptorBuffer),
        FEATURE_ITEM (VkPhysicalDeviceDataGraphFeaturesARM, dataGraphShaderModule),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceDataGraphFeaturesARM*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 5, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestDenseGeometryFormatFeaturesAMDX (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceDenseGeometryFormatFeaturesAMDX>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceDenseGeometryFormatFeaturesAMDX, denseGeometryFormat),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceDenseGeometryFormatFeaturesAMDX*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestDescriptorBufferTensorFeaturesARM (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceDescriptorBufferTensorFeaturesARM>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceDescriptorBufferTensorFeaturesARM, descriptorBufferTensorDescriptors),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceDescriptorBufferTensorFeaturesARM*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestDescriptorHeapFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceDescriptorHeapFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceDescriptorHeapFeaturesEXT, descriptorHeap),
        FEATURE_ITEM (VkPhysicalDeviceDescriptorHeapFeaturesEXT, descriptorHeapCaptureReplay),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceDescriptorHeapFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 2, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestFormatPackFeaturesARM (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceFormatPackFeaturesARM>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceFormatPackFeaturesARM, formatPack),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceFormatPackFeaturesARM*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestFragmentDensityMapLayeredFeaturesVALVE (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceFragmentDensityMapLayeredFeaturesVALVE>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceFragmentDensityMapLayeredFeaturesVALVE, fragmentDensityMapLayered),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceFragmentDensityMapLayeredFeaturesVALVE*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestFragmentDensityMapOffsetFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceFragmentDensityMapOffsetFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceFragmentDensityMapOffsetFeaturesEXT, fragmentDensityMapOffset),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceFragmentDensityMapOffsetFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestInternallySynchronizedQueuesFeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceInternallySynchronizedQueuesFeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceInternallySynchronizedQueuesFeaturesKHR, internallySynchronizedQueues),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceInternallySynchronizedQueuesFeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestMaintenance10FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceMaintenance10FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceMaintenance10FeaturesKHR, maintenance10),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceMaintenance10FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestMaintenance11FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceMaintenance11FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceMaintenance11FeaturesKHR, maintenance11),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceMaintenance11FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestMaintenance9FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceMaintenance9FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceMaintenance9FeaturesKHR, maintenance9),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceMaintenance9FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestMemoryDecompressionFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceMemoryDecompressionFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceMemoryDecompressionFeaturesEXT, memoryDecompression),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceMemoryDecompressionFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPartitionedAccelerationStructureFeaturesNV (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePartitionedAccelerationStructureFeaturesNV>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePartitionedAccelerationStructureFeaturesNV, partitionedAccelerationStructure),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePartitionedAccelerationStructureFeaturesNV*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPerformanceCountersByRegionFeaturesARM (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePerformanceCountersByRegionFeaturesARM>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePerformanceCountersByRegionFeaturesARM, performanceCountersByRegion),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePerformanceCountersByRegionFeaturesARM*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPipelineCacheIncrementalModeFeaturesSEC (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePipelineCacheIncrementalModeFeaturesSEC>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePipelineCacheIncrementalModeFeaturesSEC, pipelineCacheIncrementalMode),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePipelineCacheIncrementalModeFeaturesSEC*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPresentId2FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePresentId2FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePresentId2FeaturesKHR, presentId2),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePresentId2FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPresentMeteringFeaturesNV (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePresentMeteringFeaturesNV>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePresentMeteringFeaturesNV, presentMetering),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePresentMeteringFeaturesNV*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPresentModeFifoLatestReadyFeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR, presentModeFifoLatestReady),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPresentTimingFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePresentTimingFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePresentTimingFeaturesEXT, presentTiming),
        FEATURE_ITEM (VkPhysicalDevicePresentTimingFeaturesEXT, presentAtAbsoluteTime),
        FEATURE_ITEM (VkPhysicalDevicePresentTimingFeaturesEXT, presentAtRelativeTime),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePresentTimingFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 3, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPresentWait2FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePresentWait2FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePresentWait2FeaturesKHR, presentWait2),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePresentWait2FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestPushConstantBankFeaturesNV (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDevicePushConstantBankFeaturesNV>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDevicePushConstantBankFeaturesNV, pushConstantBank),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDevicePushConstantBankFeaturesNV*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestRayTracingInvocationReorderFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceRayTracingInvocationReorderFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceRayTracingInvocationReorderFeaturesEXT, rayTracingInvocationReorder),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceRayTracingInvocationReorderFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestRayTracingLinearSweptSpheresFeaturesNV (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceRayTracingLinearSweptSpheresFeaturesNV>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceRayTracingLinearSweptSpheresFeaturesNV, spheres),
        FEATURE_ITEM (VkPhysicalDeviceRayTracingLinearSweptSpheresFeaturesNV, linearSweptSpheres),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceRayTracingLinearSweptSpheresFeaturesNV*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 2, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestShader64BitIndexingFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceShader64BitIndexingFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceShader64BitIndexingFeaturesEXT, shader64BitIndexing),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceShader64BitIndexingFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestShaderBfloat16FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceShaderBfloat16FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceShaderBfloat16FeaturesKHR, shaderBFloat16Type),
        FEATURE_ITEM (VkPhysicalDeviceShaderBfloat16FeaturesKHR, shaderBFloat16DotProduct),
        FEATURE_ITEM (VkPhysicalDeviceShaderBfloat16FeaturesKHR, shaderBFloat16CooperativeMatrix),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceShaderBfloat16FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 3, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestShaderFloat8FeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceShaderFloat8FeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceShaderFloat8FeaturesEXT, shaderFloat8),
        FEATURE_ITEM (VkPhysicalDeviceShaderFloat8FeaturesEXT, shaderFloat8CooperativeMatrix),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceShaderFloat8FeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 2, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestShaderFmaFeaturesKHR (Context& context)
{
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceShaderFmaFeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceShaderFmaFeaturesKHR, shaderFmaFloat16),
        FEATURE_ITEM (VkPhysicalDeviceShaderFmaFeaturesKHR, shaderFmaFloat32),
        FEATURE_ITEM (VkPhysicalDeviceShaderFmaFeaturesKHR, shaderFmaFloat64),
        };
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestShaderLongVectorFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceShaderLongVectorFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceShaderLongVectorFeaturesEXT, longVector),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceShaderLongVectorFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestShaderSubgroupPartitionedFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceShaderSubgroupPartitionedFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceShaderSubgroupPartitionedFeaturesEXT, shaderSubgroupPartitioned),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceShaderSubgroupPartitionedFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestShaderUniformBufferUnsizedArrayFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceShaderUniformBufferUnsizedArrayFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceShaderUniformBufferUnsizedArrayFeaturesEXT, shaderUniformBufferUnsizedArray),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceShaderUniformBufferUnsizedArrayFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestShaderUntypedPointersFeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceShaderUntypedPointersFeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceShaderUntypedPointersFeaturesKHR, shaderUntypedPointers),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceShaderUntypedPointersFeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestSwapchainMaintenance1FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR, swapchainMaintenance1),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestTensorFeaturesARM (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceTensorFeaturesARM>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceTensorFeaturesARM, tensorNonPacked),
        FEATURE_ITEM (VkPhysicalDeviceTensorFeaturesARM, shaderTensorAccess),
        FEATURE_ITEM (VkPhysicalDeviceTensorFeaturesARM, shaderStorageTensorArrayDynamicIndexing),
        FEATURE_ITEM (VkPhysicalDeviceTensorFeaturesARM, shaderStorageTensorArrayNonUniformIndexing),
        FEATURE_ITEM (VkPhysicalDeviceTensorFeaturesARM, descriptorBindingStorageTensorUpdateAfterBind),
        FEATURE_ITEM (VkPhysicalDeviceTensorFeaturesARM, tensors),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceTensorFeaturesARM*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 6, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestTextureCompressionASTC3DFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceTextureCompressionASTC3DFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceTextureCompressionASTC3DFeaturesEXT, textureCompressionASTC_3D),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceTextureCompressionASTC3DFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestTileMemoryHeapFeaturesQCOM (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceTileMemoryHeapFeaturesQCOM>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceTileMemoryHeapFeaturesQCOM, tileMemoryHeap),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceTileMemoryHeapFeaturesQCOM*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestTileShadingFeaturesQCOM (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceTileShadingFeaturesQCOM>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShading),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingFragmentStage),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingColorAttachments),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingDepthAttachments),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingStencilAttachments),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingInputAttachments),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingSampledAttachments),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingPerTileDraw),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingPerTileDispatch),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingDispatchTile),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingApron),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingAnisotropicApron),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingAtomicOps),
        FEATURE_ITEM (VkPhysicalDeviceTileShadingFeaturesQCOM, tileShadingImageProcessing),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceTileShadingFeaturesQCOM*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 14, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestUnifiedImageLayoutsFeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR, unifiedImageLayouts),
        FEATURE_ITEM (VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR, unifiedImageLayoutsVideo),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 2, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestVertexAttributeRobustnessFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT, vertexAttributeRobustness),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestVideoDecodeVP9FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceVideoDecodeVP9FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceVideoDecodeVP9FeaturesKHR, videoDecodeVP9),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceVideoDecodeVP9FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestVideoEncodeAV1FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceVideoEncodeAV1FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceVideoEncodeAV1FeaturesKHR, videoEncodeAV1),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceVideoEncodeAV1FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestVideoEncodeIntraRefreshFeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceVideoEncodeIntraRefreshFeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceVideoEncodeIntraRefreshFeaturesKHR, videoEncodeIntraRefresh),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceVideoEncodeIntraRefreshFeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestVideoEncodeQuantizationMapFeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR, videoEncodeQuantizationMap),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestVideoEncodeRgbConversionFeaturesVALVE (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE, videoEncodeRgbConversion),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestVideoMaintenance2FeaturesKHR (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceVideoMaintenance2FeaturesKHR>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceVideoMaintenance2FeaturesKHR, videoMaintenance2),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceVideoMaintenance2FeaturesKHR*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
tcu::TestStatus createDeviceWithUnsupportedFeaturesTestZeroInitializeDeviceMemoryFeaturesEXT (Context& context)
{
    const PlatformInterface&                vkp = context.getPlatformInterface();
    tcu::TestLog&                            log = context.getTestContext().getLog();
    tcu::ResultCollector                    resultCollector            (log);
    ...
    if (const void* featuresStruct = findStructureInChain(const_cast<const void*>(deviceFeatures2.pNext), getStructureType<VkPhysicalDeviceZeroInitializeDeviceMemoryFeaturesEXT>()))
    {
        static const Feature features[] =
        {
        FEATURE_ITEM (VkPhysicalDeviceZeroInitializeDeviceMemoryFeaturesEXT, zeroInitializeDeviceMemory),
        };
        auto* supportedFeatures = reinterpret_cast<const VkPhysicalDeviceZeroInitializeDeviceMemoryFeaturesEXT*>(featuresStruct);
        checkFeatures(vkp, instance, instanceDriver, physicalDevice, 1, features, supportedFeatures, queueFamilyIndex, queueCount, queuePriority, numErrors, resultCollector, &extensionNames, emptyDeviceFeatures, isSubProcess, context.getUsedApiVersion(), commandLine);
    }
...
void addSeparateUnsupportedFeatureTests (tcu::TestCaseGroup* testGroup)
{
	...
	addFunctionCase(testGroup, "cluster_acceleration_structure_features_nv", createDeviceWithUnsupportedFeaturesTestClusterAccelerationStructureFeaturesNV);
	...
	addFunctionCase(testGroup, "compute_occupancy_priority_features_nv", createDeviceWithUnsupportedFeaturesTestComputeOccupancyPriorityFeaturesNV);
	...
	addFunctionCase(testGroup, "cooperative_matrix_conversion_features_qcom", createDeviceWithUnsupportedFeaturesTestCooperativeMatrixConversionFeaturesQCOM);
	...
	addFunctionCase(testGroup, "cooperative_vector_features_nv", createDeviceWithUnsupportedFeaturesTestCooperativeVectorFeaturesNV);
	addFunctionCase(testGroup, "copy_memory_indirect_features_khr", createDeviceWithUnsupportedFeaturesTestCopyMemoryIndirectFeaturesKHR);
	...
	addFunctionCase(testGroup, "custom_resolve_features_ext", createDeviceWithUnsupportedFeaturesTestCustomResolveFeaturesEXT);
	...
	addFunctionCase(testGroup, "descriptor_buffer_tensor_features_arm", createDeviceWithUnsupportedFeaturesTestDescriptorBufferTensorFeaturesARM);
	addFunctionCase(testGroup, "descriptor_heap_features_ext", createDeviceWithUnsupportedFeaturesTestDescriptorHeapFeaturesEXT);
	...
	addFunctionCase(testGroup, "format_pack_features_arm", createDeviceWithUnsupportedFeaturesTestFormatPackFeaturesARM);
	...
	addFunctionCase(testGroup, "fragment_density_map_layered_features_valve", createDeviceWithUnsupportedFeaturesTestFragmentDensityMapLayeredFeaturesVALVE);
	addFunctionCase(testGroup, "fragment_density_map_offset_features_ext", createDeviceWithUnsupportedFeaturesTestFragmentDensityMapOffsetFeaturesEXT);
	...
	addFunctionCase(testGroup, "internally_synchronized_queues_features_khr", createDeviceWithUnsupportedFeaturesTestInternallySynchronizedQueuesFeaturesKHR);
	...
	addFunctionCase(testGroup, "maintenance10_features_khr", createDeviceWithUnsupportedFeaturesTestMaintenance10FeaturesKHR);
	addFunctionCase(testGroup, "maintenance11_features_khr", createDeviceWithUnsupportedFeaturesTestMaintenance11FeaturesKHR);
	...
	addFunctionCase(testGroup, "maintenance9_features_khr", createDeviceWithUnsupportedFeaturesTestMaintenance9FeaturesKHR);
	...
	addFunctionCase(testGroup, "memory_decompression_features_ext", createDeviceWithUnsupportedFeaturesTestMemoryDecompressionFeaturesEXT);
	...
	addFunctionCase(testGroup, "partitioned_acceleration_structure_features_nv", createDeviceWithUnsupportedFeaturesTestPartitionedAccelerationStructureFeaturesNV);
	...
	addFunctionCase(testGroup, "pipeline_cache_incremental_mode_features_sec", createDeviceWithUnsupportedFeaturesTestPipelineCacheIncrementalModeFeaturesSEC);
	...
	addFunctionCase(testGroup, "present_id2_features_khr", createDeviceWithUnsupportedFeaturesTestPresentId2FeaturesKHR);
	addFunctionCase(testGroup, "present_id_features_khr", createDeviceWithUnsupportedFeaturesTestPresentIdFeaturesKHR);
	addFunctionCase(testGroup, "present_metering_features_nv", createDeviceWithUnsupportedFeaturesTestPresentMeteringFeaturesNV);
	addFunctionCase(testGroup, "present_mode_fifo_latest_ready_features_khr", createDeviceWithUnsupportedFeaturesTestPresentModeFifoLatestReadyFeaturesKHR);
	...
	addFunctionCase(testGroup, "push_constant_bank_features_nv", createDeviceWithUnsupportedFeaturesTestPushConstantBankFeaturesNV);
	...
	addFunctionCase(testGroup, "ray_tracing_invocation_reorder_features_ext", createDeviceWithUnsupportedFeaturesTestRayTracingInvocationReorderFeaturesEXT);
	...
	addFunctionCase(testGroup, "shader64_bit_indexing_features_ext", createDeviceWithUnsupportedFeaturesTestShader64BitIndexingFeaturesEXT);
	...
	addFunctionCase(testGroup, "shader_float8_features_ext", createDeviceWithUnsupportedFeaturesTestShaderFloat8FeaturesEXT);
	...
	addFunctionCase(testGroup, "shader_uniform_buffer_unsized_array_features_ext", createDeviceWithUnsupportedFeaturesTestShaderUniformBufferUnsizedArrayFeaturesEXT);
	addFunctionCase(testGroup, "shader_untyped_pointers_features_khr", createDeviceWithUnsupportedFeaturesTestShaderUntypedPointersFeaturesKHR);
	...
	addFunctionCase(testGroup, "swapchain_maintenance1_features_khr", createDeviceWithUnsupportedFeaturesTestSwapchainMaintenance1FeaturesKHR);
	addFunctionCase(testGroup, "synchronization2_features", createDeviceWithUnsupportedFeaturesTestSynchronization2Features);
	addFunctionCase(testGroup, "tensor_features_arm", createDeviceWithUnsupportedFeaturesTestTensorFeaturesARM);
	...
	addFunctionCase(testGroup, "texture_compression_astc3_d_features_ext", createDeviceWithUnsupportedFeaturesTestTextureCompressionASTC3DFeaturesEXT);
	...
	addFunctionCase(testGroup, "tile_memory_heap_features_qcom", createDeviceWithUnsupportedFeaturesTestTileMemoryHeapFeaturesQCOM);
	...
	addFunctionCase(testGroup, "tile_shading_features_qcom", createDeviceWithUnsupportedFeaturesTestTileShadingFeaturesQCOM);
	...
	addFunctionCase(testGroup, "unified_image_layouts_features_khr", createDeviceWithUnsupportedFeaturesTestUnifiedImageLayoutsFeaturesKHR);
	...
	addFunctionCase(testGroup, "video_decode_vp9_features_khr", createDeviceWithUnsupportedFeaturesTestVideoDecodeVP9FeaturesKHR);
	addFunctionCase(testGroup, "video_encode_av1_features_khr", createDeviceWithUnsupportedFeaturesTestVideoEncodeAV1FeaturesKHR);
	addFunctionCase(testGroup, "video_encode_intra_refresh_features_khr", createDeviceWithUnsupportedFeaturesTestVideoEncodeIntraRefreshFeaturesKHR);
	addFunctionCase(testGroup, "video_encode_quantization_map_features_khr", createDeviceWithUnsupportedFeaturesTestVideoEncodeQuantizationMapFeaturesKHR);
	addFunctionCase(testGroup, "video_encode_rgb_conversion_features_valve", createDeviceWithUnsupportedFeaturesTestVideoEncodeRgbConversionFeaturesVALVE);
	...
	addFunctionCase(testGroup, "video_maintenance2_features_khr", createDeviceWithUnsupportedFeaturesTestVideoMaintenance2FeaturesKHR);

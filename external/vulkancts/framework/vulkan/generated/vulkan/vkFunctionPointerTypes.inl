...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdUpdateMemoryKHRFunc)												(VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR dstRange, VkAddressCopyFlagsKHR dstCopyFlags, VkDeviceSize dataSize, const void* pData);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdFillMemoryKHRFunc)													(VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR dstRange, VkAddressCopyFlagsKHR dstCopyFlags, uint32_t data);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBindIndexBuffer3KHRFunc)											(VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR addressRange, VkIndexType indexType);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBindVertexBuffers3KHRFunc)											(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkStridedDeviceAddressRangeKHR* pRanges);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawIndirect2KHRFunc)												(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRangeKHR addressRange, uint32_t drawCount);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawIndexedIndirect2KHRFunc)										(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRangeKHR addressRange, uint32_t drawCount);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawIndirectCount2KHRFunc)											(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRangeKHR addressRange, VkDeviceAddressRangeKHR countAddressRange, uint32_t maxDrawCount);

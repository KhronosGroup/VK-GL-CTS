...
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* GetMemoryMetalHandleEXTFunc)											(VkDevice device, const VkMemoryGetMetalHandleInfoEXT* pGetMetalHandleInfo, pt::MTLResource_id* pHandle);
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* GetMemoryMetalHandlePropertiesEXTFunc)									(VkDevice device, VkExternalMemoryHandleTypeFlagBits handleType, pt::MTLResource_id handle, VkMemoryMetalHandlePropertiesEXT* pMemoryMetalHandleProperties);

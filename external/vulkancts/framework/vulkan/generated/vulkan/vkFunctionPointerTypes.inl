...
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* AcquireImageOHOSFunc)														(VkDevice device, VkImage image, int32_t nativeFenceFd, VkSemaphore semaphore, VkFence fence);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBeginRenderingFunc)														(VkCommandBuffer commandBuffer, const VkRenderingInfo* pRenderingInfo);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBeginTransformFeedback2EXTFunc)											(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBindIndexBuffer2Func)													(VkCommandBuffer commandBuffer, VkBuffer buffer, VkDeviceSize offset, VkDeviceSize size, VkIndexType indexType);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBindIndexBuffer3KHRFunc)												(VkCommandBuffer commandBuffer, const VkBindIndexBuffer3InfoKHR* pInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBindTransformFeedbackBuffers2EXTFunc)									(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBindTransformFeedbackBuffer2InfoEXT* pBindingInfos);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBindVertexBuffers2Func)													(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBuffer* pBuffers, const VkDeviceSize* pOffsets, const VkDeviceSize* pSizes, const VkDeviceSize* pStrides);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdBindVertexBuffers3KHRFunc)												(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBindVertexBuffer3InfoKHR* pBindingInfos);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdCopyImageToBuffer2Func)													(VkCommandBuffer commandBuffer, const VkCopyImageToBufferInfo2* pCopyImageToBufferInfo);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdCopyImageToMemoryKHRFunc)												(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdCopyMemoryKHRFunc)														(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryInfoKHR* pCopyMemoryInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdCopyMemoryToImageKHRFunc)												(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdCopyQueryPoolResultsToMemoryKHRFunc)									(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, const VkStridedDeviceAddressRangeKHR* pDstRange, VkAddressCommandFlagsKHR dstFlags, VkQueryResultFlags queryResultFlags);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDecompressMemoryEXTFunc)												(VkCommandBuffer commandBuffer, const VkDecompressMemoryInfoEXT* pDecompressMemoryInfoEXT);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDecompressMemoryIndirectCountEXTFunc)									(VkCommandBuffer commandBuffer, VkMemoryDecompressionMethodFlagsEXT decompressionMethod, VkDeviceAddress indirectCommandsAddress, VkDeviceAddress indirectCommandsCountAddress, uint32_t maxDecompressionCount, uint32_t stride);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDispatchIndirect2KHRFunc)												(VkCommandBuffer commandBuffer, const VkDispatchIndirect2InfoKHR* pInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawIndexedIndirect2KHRFunc)											(VkCommandBuffer commandBuffer, const VkDrawIndirect2InfoKHR* pInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawIndexedIndirectCount2KHRFunc)										(VkCommandBuffer commandBuffer, const VkDrawIndirectCount2InfoKHR* pInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawIndirect2KHRFunc)													(VkCommandBuffer commandBuffer, const VkDrawIndirect2InfoKHR* pInfo);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawIndirectByteCount2EXTFunc)											(VkCommandBuffer commandBuffer, uint32_t instanceCount, uint32_t firstInstance, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfo, uint32_t counterOffset, uint32_t vertexStride);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawIndirectCount2KHRFunc)												(VkCommandBuffer commandBuffer, const VkDrawIndirectCount2InfoKHR* pInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawMeshTasksIndirect2EXTFunc)											(VkCommandBuffer commandBuffer, const VkDrawIndirect2InfoKHR* pInfo);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdDrawMeshTasksIndirectCount2EXTFunc)										(VkCommandBuffer commandBuffer, const VkDrawIndirectCount2InfoKHR* pInfo);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdEndRenderingFunc)														(VkCommandBuffer commandBuffer);
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdEndTransformFeedback2EXTFunc)											(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdFillMemoryKHRFunc)														(VkCommandBuffer commandBuffer, const VkDeviceAddressRangeKHR* pDstRange, VkAddressCommandFlagsKHR dstFlags, uint32_t data);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdUpdateMemoryKHRFunc)													(VkCommandBuffer commandBuffer, const VkDeviceAddressRangeKHR* pDstRange, VkAddressCommandFlagsKHR dstFlags, VkDeviceSize dataSize, const void* pData);
...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdWriteMarkerToMemoryAMDFunc)												(VkCommandBuffer commandBuffer, const VkMemoryMarkerInfoAMD* pInfo);
...
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* EnumeratePhysicalDeviceGroupsFunc)											(VkInstance instance, uint32_t* pPhysicalDeviceGroupCount, VkPhysicalDeviceGroupProperties* pPhysicalDeviceGroupProperties);
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* EnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARMFunc)		(VkPhysicalDevice physicalDevice, uint32_t queueFamilyIndex, uint32_t* pCounterCount, VkPerformanceCounterARM* pCounters, VkPerformanceCounterDescriptionARM* pCounterDescriptions);
...
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* GetMemoryNativeBufferOHOSFunc)												(VkDevice device, const VkMemoryGetNativeBufferInfoOHOS* pInfo, struct OH_NativeBuffer** pBuffer);
...
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* GetNativeBufferPropertiesOHOSFunc)											(VkDevice device, const struct OH_NativeBuffer* buffer, VkNativeBufferPropertiesOHOS* pProperties);
...
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* GetSwapchainGrallocUsageOHOSFunc)											(VkDevice device, VkFormat format, VkImageUsageFlags imageUsage, uint64_t* grallocUsage);
...
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* QueueSignalReleaseImageOHOSFunc)											(VkQueue queue, uint32_t waitSemaphoreCount, const VkSemaphore* pWaitSemaphores, VkImage image, int32_t* pNativeFenceFd);

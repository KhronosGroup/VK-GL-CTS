...
typedef VKAPI_ATTR void					(VKAPI_CALL* CmdUpdatePipelineIndirectBufferFunc)									(VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline);

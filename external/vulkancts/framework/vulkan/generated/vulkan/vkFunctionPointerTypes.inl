...
typedef VKAPI_ATTR VkResult				(VKAPI_CALL* ReleaseCapturedPipelineDataKHRFunc)									(VkDevice device, const VkCapturedPipelineDataInfoKHR* pInfo, const VkAllocationCallbacks* pAllocator);

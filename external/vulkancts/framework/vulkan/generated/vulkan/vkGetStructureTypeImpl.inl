...
template<> VkStructureType getStructureType<VkPhysicalDevicePipelineBinariesFeaturesKHR> (void)
{
	return VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARIES_FEATURES_KHR;
}

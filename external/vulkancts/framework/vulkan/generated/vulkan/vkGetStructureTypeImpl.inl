...
template<> VkStructureType getStructureType<VkPhysicalDeviceUniformBufferUnsizedArrayFeaturesEXT> (void)
{
	return VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_UNSIZED_ARRAY_FEATURES_EXT;
}

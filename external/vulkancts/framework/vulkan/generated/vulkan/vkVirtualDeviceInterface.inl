...
virtual VkResult			cmdBeginGpaSampleAMD									(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession, const VkGpaSampleBeginInfoAMD* pGpaSampleBeginInfo, uint32_t* pSampleID) const = 0;
virtual VkResult			cmdBeginGpaSessionAMD									(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession) const = 0;
...
virtual void				cmdBeginTransformFeedback2EXT							(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos) const = 0;
...
virtual void				cmdBindIndexBuffer3KHR									(VkCommandBuffer commandBuffer, const VkBindIndexBuffer3InfoKHR* pInfo) const = 0;
...
virtual void				cmdBindResourceHeapEXT									(VkCommandBuffer commandBuffer, const VkBindHeapInfoEXT* pBindInfo) const = 0;
virtual void				cmdBindSamplerHeapEXT									(VkCommandBuffer commandBuffer, const VkBindHeapInfoEXT* pBindInfo) const = 0;
...
virtual void				cmdBindTransformFeedbackBuffers2EXT						(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBindTransformFeedbackBuffer2InfoEXT* pBindingInfos) const = 0;
...
virtual void				cmdBindVertexBuffers3KHR								(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBindVertexBuffer3InfoKHR* pBindingInfos) const = 0;
...
virtual void				cmdCopyGpaSessionResultsAMD								(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession) const = 0;
...
virtual void				cmdCopyImageToMemoryKHR									(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo) const = 0;
virtual void				cmdCopyMemoryIndirectKHR								(VkCommandBuffer commandBuffer, const VkCopyMemoryIndirectInfoKHR* pCopyMemoryIndirectInfo) const = 0;
virtual void				cmdCopyMemoryKHR										(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryInfoKHR* pCopyMemoryInfo) const = 0;
...
virtual void				cmdCopyMemoryToImageIndirectKHR							(VkCommandBuffer commandBuffer, const VkCopyMemoryToImageIndirectInfoKHR* pCopyMemoryToImageIndirectInfo) const = 0;
virtual void				cmdCopyMemoryToImageKHR									(VkCommandBuffer commandBuffer, const VkCopyDeviceMemoryImageInfoKHR* pCopyMemoryInfo) const = 0;
...
virtual void				cmdDispatchIndirect2KHR									(VkCommandBuffer commandBuffer, const VkDispatchIndirect2InfoKHR* pInfo) const = 0;
...
virtual void				cmdDrawIndexedIndirect2KHR								(VkCommandBuffer commandBuffer, const VkDrawIndirect2InfoKHR* pInfo) const = 0;
...
virtual void				cmdDrawIndexedIndirectCount2KHR							(VkCommandBuffer commandBuffer, const VkDrawIndirectCount2InfoKHR* pInfo) const = 0;
...
virtual void				cmdDrawIndirect2KHR										(VkCommandBuffer commandBuffer, const VkDrawIndirect2InfoKHR* pInfo) const = 0;
virtual void				cmdDrawIndirectByteCount2EXT							(VkCommandBuffer commandBuffer, uint32_t instanceCount, uint32_t firstInstance, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfo, uint32_t counterOffset, uint32_t vertexStride) const = 0;
...
virtual void				cmdDrawIndirectCount2KHR								(VkCommandBuffer commandBuffer, const VkDrawIndirectCount2InfoKHR* pInfo) const = 0;
...
virtual void				cmdDrawMeshTasksIndirect2EXT							(VkCommandBuffer commandBuffer, const VkDrawIndirect2InfoKHR* pInfo) const = 0;
virtual void				cmdDrawMeshTasksIndirectCount2EXT						(VkCommandBuffer commandBuffer, const VkDrawIndirectCount2InfoKHR* pInfo) const = 0;
...
virtual void				cmdEndGpaSampleAMD										(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession, uint32_t sampleID) const = 0;
virtual VkResult			cmdEndGpaSessionAMD										(VkCommandBuffer commandBuffer, VkGpaSessionAMD gpaSession) const = 0;
...
virtual void				cmdEndRendering2KHR										(VkCommandBuffer commandBuffer, const VkRenderingEndInfoKHR* pRenderingEndInfo) const = 0;
virtual void				cmdEndTransformFeedback2EXT								(VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos) const = 0;
...
virtual void				cmdFillMemoryKHR										(VkCommandBuffer commandBuffer, const VkDeviceAddressRangeKHR* pDstRange, VkAddressCommandFlagsKHR dstFlags, uint32_t data) const = 0;
...
virtual void				cmdPushDataEXT											(VkCommandBuffer commandBuffer, const VkPushDataInfoEXT* pPushDataInfo) const = 0;
...
virtual void				cmdUpdateMemoryKHR										(VkCommandBuffer commandBuffer, const VkDeviceAddressRangeKHR* pDstRange, VkAddressCommandFlagsKHR dstFlags, VkDeviceSize dataSize, const void* pData) const = 0;
...
virtual void				cmdWriteMarkerToMemoryAMD								(VkCommandBuffer commandBuffer, const VkMemoryMarkerInfoAMD* pInfo) const = 0;
...
virtual VkResult			createGpaSessionAMD										(VkDevice device, const VkGpaSessionCreateInfoAMD* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkGpaSessionAMD* pGpaSession) const = 0;
...
virtual void				destroyGpaSessionAMD									(VkDevice device, VkGpaSessionAMD gpaSession, const VkAllocationCallbacks* pAllocator) const = 0;
...
virtual VkResult			getGpaDeviceClockInfoAMD								(VkDevice device, VkGpaDeviceGetClockInfoAMD* pInfo) const = 0;
virtual VkResult			getGpaSessionResultsAMD									(VkDevice device, VkGpaSessionAMD gpaSession, uint32_t sampleID, size_t* pSizeInBytes, void* pData) const = 0;
virtual VkResult			getGpaSessionStatusAMD									(VkDevice device, VkGpaSessionAMD gpaSession) const = 0;
...
virtual VkResult			getImageOpaqueCaptureDataEXT							(VkDevice device, uint32_t imageCount, const VkImage* pImages, VkHostAddressRangeEXT* pDatas) const = 0;
...
virtual VkResult			getTensorOpaqueCaptureDataARM							(VkDevice device, uint32_t tensorCount, const VkTensorARM* pTensors, VkHostAddressRangeEXT* pDatas) const = 0;
...
virtual VkResult			registerCustomBorderColorEXT							(VkDevice device, const VkSamplerCustomBorderColorCreateInfoEXT* pBorderColor, VkBool32 requestIndex, uint32_t* pIndex) const = 0;
...
virtual VkResult			resetGpaSessionAMD										(VkDevice device, VkGpaSessionAMD gpaSession) const = 0;
...
virtual VkResult			setGpaDeviceClockModeAMD								(VkDevice device, VkGpaDeviceClockModeInfoAMD* pInfo) const = 0;
...
virtual void				unregisterCustomBorderColorEXT							(VkDevice device, uint32_t index) const = 0;
...
virtual VkResult			writeResourceDescriptorsEXT								(VkDevice device, uint32_t resourceCount, const VkResourceDescriptorInfoEXT* pResources, const VkHostAddressRangeEXT* pDescriptors) const = 0;
virtual VkResult			writeSamplerDescriptorsEXT								(VkDevice device, uint32_t samplerCount, const VkSamplerCreateInfo* pSamplers, const VkHostAddressRangeEXT* pDescriptors) const = 0;

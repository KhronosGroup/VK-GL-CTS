...
virtual void				cmdUpdateMemoryKHR										(VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR dstRange, VkAddressCopyFlagsKHR dstCopyFlags, VkDeviceSize dataSize, const void* pData) const = 0;
virtual void				cmdFillMemoryKHR										(VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR dstRange, VkAddressCopyFlagsKHR dstCopyFlags, uint32_t data) const = 0;
...
virtual void				cmdBindIndexBuffer3KHR									(VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR addressRange, VkIndexType indexType) const = 0;
virtual void				cmdBindVertexBuffers3KHR								(VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkStridedDeviceAddressRangeKHR* pRanges) const = 0;
virtual void				cmdDrawIndirect2KHR										(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRangeKHR addressRange, uint32_t drawCount) const = 0;
virtual void				cmdDrawIndexedIndirect2KHR								(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRangeKHR addressRange, uint32_t drawCount) const = 0;
virtual void				cmdDrawIndirectCount2KHR								(VkCommandBuffer commandBuffer, VkStridedDeviceAddressRangeKHR addressRange, VkDeviceAddressRangeKHR countAddressRange, uint32_t maxDrawCount) const = 0;

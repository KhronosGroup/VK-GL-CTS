...
virtual void				cmdCopyQueryPoolResultsToMemoryKHR						(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, VkStridedDeviceAddressRangeKHR dstRange, VkAddressCommandFlagsKHR dstFlags, VkQueryResultFlags queryResultFlags) const = 0;
...
virtual void				cmdFillMemoryKHR										(VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR dstRange, VkAddressCommandFlagsKHR dstFlags, uint32_t data) const = 0;
...
virtual void				cmdUpdateMemoryKHR										(VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR dstRange, VkAddressCommandFlagsKHR dstFlags, VkDeviceSize dataSize, const void* pData) const = 0;

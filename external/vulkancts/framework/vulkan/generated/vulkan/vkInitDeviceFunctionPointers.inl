...
m_vk.cmdBeginGpaSampleAMD = (CmdBeginGpaSampleAMDFunc) GET_PROC_ADDR("vkCmdBeginGpaSampleAMD");
m_vk.cmdBeginGpaSessionAMD = (CmdBeginGpaSessionAMDFunc) GET_PROC_ADDR("vkCmdBeginGpaSessionAMD");
...
m_vk.cmdBeginTransformFeedback2EXT = (CmdBeginTransformFeedback2EXTFunc) GET_PROC_ADDR("vkCmdBeginTransformFeedback2EXT");
...
m_vk.cmdBindIndexBuffer3KHR = (CmdBindIndexBuffer3KHRFunc) GET_PROC_ADDR("vkCmdBindIndexBuffer3KHR");
...
m_vk.cmdBindVertexBuffers3KHR = (CmdBindVertexBuffers3KHRFunc) GET_PROC_ADDR("vkCmdBindVertexBuffers3KHR");
...
m_vk.cmdCopyGpaSessionResultsAMD = (CmdCopyGpaSessionResultsAMDFunc) GET_PROC_ADDR("vkCmdCopyGpaSessionResultsAMD");
...
m_vk.cmdCopyImageToMemoryKHR = (CmdCopyImageToMemoryKHRFunc) GET_PROC_ADDR("vkCmdCopyImageToMemoryKHR");
m_vk.cmdCopyMemoryIndirectKHR = (CmdCopyMemoryIndirectKHRFunc) GET_PROC_ADDR("vkCmdCopyMemoryIndirectKHR");
m_vk.cmdCopyMemoryKHR = (CmdCopyMemoryKHRFunc) GET_PROC_ADDR("vkCmdCopyMemoryKHR");
...
m_vk.cmdCopyMemoryToImageKHR = (CmdCopyMemoryToImageKHRFunc) GET_PROC_ADDR("vkCmdCopyMemoryToImageKHR");
...
m_vk.cmdCopyQueryPoolResultsToMemoryKHR = (CmdCopyQueryPoolResultsToMemoryKHRFunc) GET_PROC_ADDR("vkCmdCopyQueryPoolResultsToMemoryKHR");
...
m_vk.cmdDrawIndexedIndirect2KHR = (CmdDrawIndexedIndirect2KHRFunc) GET_PROC_ADDR("vkCmdDrawIndexedIndirect2KHR");
if (usedApiVersion >= VK_MAKE_API_VERSION(0, 1, 2, 0))
...
m_vk.cmdDrawIndexedIndirectCount2KHR = (CmdDrawIndexedIndirectCount2KHRFunc) GET_PROC_ADDR("vkCmdDrawIndexedIndirectCount2KHR");
m_vk.cmdDrawIndirect = (CmdDrawIndirectFunc) GET_PROC_ADDR("vkCmdDrawIndirect");
m_vk.cmdDrawIndirect2KHR = (CmdDrawIndirect2KHRFunc) GET_PROC_ADDR("vkCmdDrawIndirect2KHR");
m_vk.cmdDrawIndirectByteCount2EXT = (CmdDrawIndirectByteCount2EXTFunc) GET_PROC_ADDR("vkCmdDrawIndirectByteCount2EXT");
...
m_vk.cmdDrawIndirectCount2KHR = (CmdDrawIndirectCount2KHRFunc) GET_PROC_ADDR("vkCmdDrawIndirectCount2KHR");
...
m_vk.cmdEndGpaSampleAMD = (CmdEndGpaSampleAMDFunc) GET_PROC_ADDR("vkCmdEndGpaSampleAMD");
m_vk.cmdEndGpaSessionAMD = (CmdEndGpaSessionAMDFunc) GET_PROC_ADDR("vkCmdEndGpaSessionAMD");
...
m_vk.cmdEndTransformFeedback2EXT = (CmdEndTransformFeedback2EXTFunc) GET_PROC_ADDR("vkCmdEndTransformFeedback2EXT");
...
m_vk.cmdFillMemoryKHR = (CmdFillMemoryKHRFunc) GET_PROC_ADDR("vkCmdFillMemoryKHR");
...
m_vk.cmdUpdateMemoryKHR = (CmdUpdateMemoryKHRFunc) GET_PROC_ADDR("vkCmdUpdateMemoryKHR");
...
m_vk.cmdWriteMarkerToMemoryAMD = (CmdWriteMarkerToMemoryAMDFunc) GET_PROC_ADDR("vkCmdWriteMarkerToMemoryAMD");
...
m_vk.createGpaSessionAMD = (CreateGpaSessionAMDFunc) GET_PROC_ADDR("vkCreateGpaSessionAMD");
...
m_vk.destroyGpaSessionAMD = (DestroyGpaSessionAMDFunc) GET_PROC_ADDR("vkDestroyGpaSessionAMD");
...
m_vk.getGpaDeviceClockInfoAMD = (GetGpaDeviceClockInfoAMDFunc) GET_PROC_ADDR("vkGetGpaDeviceClockInfoAMD");
m_vk.getGpaSessionResultsAMD = (GetGpaSessionResultsAMDFunc) GET_PROC_ADDR("vkGetGpaSessionResultsAMD");
m_vk.getGpaSessionStatusAMD = (GetGpaSessionStatusAMDFunc) GET_PROC_ADDR("vkGetGpaSessionStatusAMD");
...
m_vk.resetGpaSessionAMD = (ResetGpaSessionAMDFunc) GET_PROC_ADDR("vkResetGpaSessionAMD");
if (usedApiVersion >= VK_MAKE_API_VERSION(0, 1, 2, 0))
...
m_vk.setGpaDeviceClockModeAMD = (SetGpaDeviceClockModeAMDFunc) GET_PROC_ADDR("vkSetGpaDeviceClockModeAMD");

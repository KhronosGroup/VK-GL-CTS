...
// Contains const pNext const vk::VkPhysicalDevicePresentationPropertiesOHOS&	getPresentationPropertiesOHOS					(void) const;
...
const vk::VkPhysicalDeviceTileShadingPropertiesQCOM&							getTileShadingPropertiesQCOM					(void) const;

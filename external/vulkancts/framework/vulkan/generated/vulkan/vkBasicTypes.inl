...
#define VK_HEADER_VERSION_COMPLETE										(static_cast<uint32_t>	((VK_MAKE_API_VERSION(0, 1, 4, 358))))
...
VK_DEFINE_NON_DISPATCHABLE_HANDLE	(VkGpaSessionAMD,					HANDLE_TYPE_GPA_SESSION_AMD);
...
enum VkAccelerationStructureSerializedBlockTypeKHR
{
	...
	VK_ACCELERATION_STRUCTURE_SERIALIZED_BLOCK_TYPE_KHR_LAST,
...
enum VkDescriptorMappingSourceEXT
{
	...
	VK_DESCRIPTOR_MAPPING_SOURCE_EXT_LAST,
...
enum VkDeviceFaultAddressTypeKHR
{
	...
	VK_DEVICE_FAULT_ADDRESS_TYPE_KHR_LAST,
...
enum VkGpaDeviceClockModeAMD
{
	...
	VK_GPA_DEVICE_CLOCK_MODE_AMD_LAST,
...
enum VkImageTilingControlEXT
{
	...
	VK_IMAGE_TILING_CONTROL_EXT_LAST,
...
enum VkRayTracingInvocationReorderModeEXT
{
	...
	VK_RAY_TRACING_INVOCATION_REORDER_MODE_EXT_LAST,
...
typedef uint32_t VkAddressCommandFlagsKHR;
...
typedef uint64_t VkFormatFeatureFlagBits4KHR;


typedef uint64_t VkFormatFeatureFlags4KHR;
...
typedef uint32_t VkGpaSqShaderStageFlagsAMD;
...
typedef uint64_t VkImageCreateFlags2KHR;
...
typedef uint64_t VkImageUsageFlags2KHR;
...
typedef uint32_t VkSpirvResourceTypeFlagsEXT;
...
typedef uint32_t VkDataGraphOpticalFlowCreateFlagsARM;

typedef uint32_t VkDataGraphOpticalFlowExecuteFlagsARM;

typedef uint32_t VkDataGraphOpticalFlowGridSizeFlagsARM;

typedef uint32_t VkDataGraphOpticalFlowImageUsageFlagsARM;

typedef uint64_t VkDataGraphPipelineDispatchFlagsARM;

typedef uint64_t VkDataGraphPipelineSessionCreateFlagsARM;

typedef uint32_t VkDataGraphTOSAQualityFlagsARM;
...
typedef uint32_t VkDeviceFaultFlagsKHR;
...
typedef uint32_t VkGpaPerfBlockPropertiesFlagsAMD;
...
typedef uint32_t VkPerformanceCounterDescriptionFlagsARM;

typedef uint32_t VkPerformanceCounterDescriptionFlagsKHR;

typedef uint32_t VkPhysicalDeviceGpaPropertiesFlagsAMD;
...
typedef uint32_t VkShaderInstrumentationValuesFlagsARM;
...
typedef uint32_t VkUbmSurfaceCreateFlagsSEC;
...
typedef uint32_t VkVideoEncodePerPartitionFeedbackFlagsKHR;

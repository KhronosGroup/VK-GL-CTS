...
const vk::VkPhysicalDeviceExtendedSparseAddressSpacePropertiesNV&	Context::getExtendedSparseAddressSpaceProperties	(void) const { return m_device->getExtendedSparseAddressSpaceProperties();		}

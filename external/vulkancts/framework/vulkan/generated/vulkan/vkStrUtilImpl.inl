...
const char* getStructureTypeName (VkStructureType value)
{
	switch (value)
	{
		...
		case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARIES_FEATURES_KHR:						return "VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARIES_FEATURES_KHR";
...
std::ostream& operator<< (std::ostream& s, const VkPhysicalDevicePipelineBinariesFeaturesKHR& value)
{
	s << "VkPhysicalDevicePipelineBinariesFeaturesKHR = {\n";
	s << "\tsType = " << value.sType << '\n';
	s << "\tpNext = " << value.pNext << '\n';

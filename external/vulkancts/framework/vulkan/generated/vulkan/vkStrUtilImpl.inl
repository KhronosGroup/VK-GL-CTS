...
const char* getDynamicStateName (VkDynamicState value)
{
	switch (value)
	{
		...
		case VK_DYNAMIC_STATE_RENDERING_ATTACHMENT_LOCATIONS_KHR:		return "VK_DYNAMIC_STATE_RENDERING_ATTACHMENT_LOCATIONS_KHR";
...
std::ostream& operator<< (std::ostream& s, const VkPhysicalDeviceDynamicRenderingLocalReadFeaturesKHR& value)
{
	...
	s << "\tdynamicStateRenderingAttachmentLocations = " << value.dynamicStateRenderingAttachmentLocations << '\n';
	s << '}';
	return s;
}

...
bool check_VK_ARM_render_pass_striped(const tcu::UVec2& v, const ExtPropVect& vIEP, const ExtPropVect& vDEP)
{
	...
	// depends attribute in xml: VK_KHR_get_physical_device_properties2,VK_KHR_synchronization2
...
static const std::tuple<deUint32, deUint32, const char*>	extensionRequiredCoreVersion[]	 =
{
	...
	std::make_tuple(1, 1, "VK_KHR_pipeline_binary"),
	...
	std::make_tuple(1, 0, "VK_NV_per_stage_descriptor_set"),
	...
	std::make_tuple(1, 0, "VK_KHR_maintenance6"),

...
bool check_VK_EXT_descriptor_heap(const tcu::UVec2& v, const ExtPropVect& vIEP, const ExtPropVect& vDEP)
{
	...
	// depends attribute in xml: (VK_KHR_extended_flags,VK_KHR_maintenance5)+(VK_KHR_buffer_device_address,VK_VERSION_1_2)
	return ((isSupported(vDEP, "VK_KHR_extended_flags") || (isCompatible(1, 4, v) || isSupported(vDEP, "VK_KHR_maintenance5"))) && (isSupported(vDEP, "VK_KHR_buffer_device_address") || isCompatible(1, 2, v)));
}

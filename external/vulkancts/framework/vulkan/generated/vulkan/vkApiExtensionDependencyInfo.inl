...
bool check_VK_KHR_device_address_commands(const tcu::UVec2& v, const ExtPropVect& vIEP, const ExtPropVect& vDEP)
{
	...
	return (((((isCompatible(1, 1, v) || isSupported(vIEP, "VK_KHR_get_physical_device_properties2"))) && (isCompatible(1, 2, v) || isSupported(vDEP, "VK_KHR_buffer_device_address")))) && (isCompatible(1, 3, v) || isSupported(vDEP, "VK_KHR_synchronization2")) && (isCompatible(1, 3, v) || isSupported(vDEP, "VK_EXT_extended_dynamic_state")));
}
...
bool check_VK_NV_low_latency2(const tcu::UVec2& v, const ExtPropVect& vIEP, const ExtPropVect& vDEP)
{
	...
	return isCompatible(1, 2, v) || (isCompatible(1, 2, v) || isSupported(vDEP, "VK_KHR_timeline_semaphore"));
}

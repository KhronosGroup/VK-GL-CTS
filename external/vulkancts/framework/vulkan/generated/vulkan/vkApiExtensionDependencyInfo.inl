...
static const std::tuple<uint32_t, uint32_t, uint32_t, const char*, const char*>	deviceExtensionDependencies[]	=
{
	...
	std::make_tuple(0, 1, 0, "VK_KHR_ray_tracing", "VK_KHR_get_physical_device_properties2"),
	std::make_tuple(0, 1, 0, "VK_KHR_ray_tracing", "VK_KHR_get_memory_requirements2"),
	std::make_tuple(0, 1, 0, "VK_KHR_ray_tracing", "VK_EXT_descriptor_indexing"),
	std::make_tuple(0, 1, 0, "VK_KHR_ray_tracing", "VK_KHR_buffer_device_address"),
	std::make_tuple(0, 1, 0, "VK_KHR_ray_tracing", "VK_KHR_deferred_host_operations"),
	std::make_tuple(0, 1, 0, "VK_KHR_ray_tracing", "VK_KHR_pipeline_library"),
	std::make_tuple(0, 1, 1, "VK_KHR_ray_tracing", "VK_EXT_descriptor_indexing"),
	std::make_tuple(0, 1, 1, "VK_KHR_ray_tracing", "VK_KHR_buffer_device_address"),
	std::make_tuple(0, 1, 1, "VK_KHR_ray_tracing", "VK_KHR_deferred_host_operations"),
	std::make_tuple(0, 1, 1, "VK_KHR_ray_tracing", "VK_KHR_pipeline_library"),
	std::make_tuple(0, 1, 2, "VK_KHR_ray_tracing", "VK_KHR_deferred_host_operations"),
	std::make_tuple(0, 1, 2, "VK_KHR_ray_tracing", "VK_KHR_pipeline_library"),
...
static const std::tuple<uint32_t, uint32_t, const char*>	extensionRequiredCoreVersion[]	 =
{
	...
	std::make_tuple(1, 0, "VK_KHR_ray_tracing"),

...
CmdBindIndexBuffer3KHRFunc									cmdBindIndexBuffer3KHR;
CmdBindVertexBuffers3KHRFunc								cmdBindVertexBuffers3KHR;
CmdDrawIndirect2KHRFunc										cmdDrawIndirect2KHR;
CmdDrawIndexedIndirect2KHRFunc								cmdDrawIndexedIndirect2KHR;
CmdDispatchIndirect2KHRFunc									cmdDispatchIndirect2KHR;
CmdCopyMemoryKHRFunc										cmdCopyMemoryKHR;
CmdCopyMemoryToImageKHRFunc									cmdCopyMemoryToImageKHR;
CmdCopyImageToMemoryKHRFunc									cmdCopyImageToMemoryKHR;
CmdUpdateMemoryKHRFunc										cmdUpdateMemoryKHR;
CmdFillMemoryKHRFunc										cmdFillMemoryKHR;
CmdCopyQueryPoolResultsToMemoryKHRFunc						cmdCopyQueryPoolResultsToMemoryKHR;
CmdDrawIndirectCount2KHRFunc								cmdDrawIndirectCount2KHR;
CmdDrawIndexedIndirectCount2KHRFunc							cmdDrawIndexedIndirectCount2KHR;
CmdBeginConditionalRendering2EXTFunc						cmdBeginConditionalRendering2EXT;
CmdBindTransformFeedbackBuffers2EXTFunc						cmdBindTransformFeedbackBuffers2EXT;
CmdBeginTransformFeedback2EXTFunc							cmdBeginTransformFeedback2EXT;
CmdEndTransformFeedback2EXTFunc								cmdEndTransformFeedback2EXT;
CmdDrawIndirectByteCount2EXTFunc							cmdDrawIndirectByteCount2EXT;
...
CmdWriteMarkerToMemoryAMDFunc								cmdWriteMarkerToMemoryAMD;
...
CreateGpaSessionAMDFunc										createGpaSessionAMD;
DestroyGpaSessionAMDFunc									destroyGpaSessionAMD;
SetGpaDeviceClockModeAMDFunc								setGpaDeviceClockModeAMD;
GetGpaDeviceClockInfoAMDFunc								getGpaDeviceClockInfoAMD;
CmdBeginGpaSessionAMDFunc									cmdBeginGpaSessionAMD;
CmdEndGpaSessionAMDFunc										cmdEndGpaSessionAMD;
CmdBeginGpaSampleAMDFunc									cmdBeginGpaSampleAMD;
CmdEndGpaSampleAMDFunc										cmdEndGpaSampleAMD;
GetGpaSessionStatusAMDFunc									getGpaSessionStatusAMD;
GetGpaSessionResultsAMDFunc									getGpaSessionResultsAMD;
ResetGpaSessionAMDFunc										resetGpaSessionAMD;
CmdCopyGpaSessionResultsAMDFunc								cmdCopyGpaSessionResultsAMD;
WriteSamplerDescriptorsEXTFunc								writeSamplerDescriptorsEXT;
WriteResourceDescriptorsEXTFunc								writeResourceDescriptorsEXT;
CmdBindSamplerHeapEXTFunc									cmdBindSamplerHeapEXT;
CmdBindResourceHeapEXTFunc									cmdBindResourceHeapEXT;
CmdPushDataEXTFunc											cmdPushDataEXT;
GetImageOpaqueCaptureDataEXTFunc							getImageOpaqueCaptureDataEXT;
RegisterCustomBorderColorEXTFunc							registerCustomBorderColorEXT;
UnregisterCustomBorderColorEXTFunc							unregisterCustomBorderColorEXT;
GetTensorOpaqueCaptureDataARMFunc							getTensorOpaqueCaptureDataARM;

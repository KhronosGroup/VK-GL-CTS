...
VkResult DeviceDriver::releaseCapturedPipelineDataKHR (VkDevice device, VkPipeline pipeline, const VkAllocationCallbacks* pAllocator) const
{
	return m_vk.releaseCapturedPipelineDataKHR(device, pipeline, pAllocator);
}

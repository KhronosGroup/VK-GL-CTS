...
const vk::VkPhysicalDeviceDisplacementMicromapFeaturesNV&					Context::getDisplacementMicromapFeaturesNV					(void) const { return m_device->getDisplacementMicromapFeaturesNV();				}

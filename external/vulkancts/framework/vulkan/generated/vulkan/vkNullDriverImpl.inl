...
VKAPI_ATTR void VKAPI_CALL cmdBeginTransformFeedback2EXT (VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(firstCounterRange);
	DE_UNREF(counterRangeCount);
	DE_UNREF(pCounterInfos);
}
...
VKAPI_ATTR void VKAPI_CALL cmdBindTransformFeedbackBuffers2EXT (VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBindTransformFeedbackBuffer2InfoEXT* pBindingInfos)
{
	DE_UNREF(commandBuffer);
...
VKAPI_ATTR void VKAPI_CALL cmdBindVertexBuffers3KHR (VkCommandBuffer commandBuffer, uint32_t firstBinding, uint32_t bindingCount, const VkBindVertexBuffer3InfoKHR* pBindingInfos)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(firstBinding);
	DE_UNREF(bindingCount);
...
VKAPI_ATTR void VKAPI_CALL cmdCopyQueryPoolResultsToMemoryKHR (VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, const VkStridedDeviceAddressRangeKHR* pDstRange, VkAddressCommandFlagsKHR dstFlags, VkQueryResultFlags queryResultFlags)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(queryPool);
	DE_UNREF(firstQuery);
...
VKAPI_ATTR void VKAPI_CALL cmdDrawIndirectByteCount2EXT (VkCommandBuffer commandBuffer, uint32_t instanceCount, uint32_t firstInstance, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfo, uint32_t counterOffset, uint32_t vertexStride)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(instanceCount);
	DE_UNREF(firstInstance);
	DE_UNREF(pCounterInfo);
...
VKAPI_ATTR void VKAPI_CALL cmdDrawMeshTasksIndirectCount2EXT (VkCommandBuffer commandBuffer, const VkDrawIndirectCount2InfoKHR* pInfo)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(pInfo);
}
...
VKAPI_ATTR void VKAPI_CALL cmdEndTransformFeedback2EXT (VkCommandBuffer commandBuffer, uint32_t firstCounterRange, uint32_t counterRangeCount, const VkBindTransformFeedbackBuffer2InfoEXT* pCounterInfos)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(firstCounterRange);
	DE_UNREF(counterRangeCount);
...
VKAPI_ATTR void VKAPI_CALL cmdFillMemoryKHR (VkCommandBuffer commandBuffer, const VkDeviceAddressRangeKHR* pDstRange, VkAddressCommandFlagsKHR dstFlags, uint32_t data)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(pDstRange);
	DE_UNREF(dstFlags);
...
VKAPI_ATTR void VKAPI_CALL cmdUpdateMemoryKHR (VkCommandBuffer commandBuffer, const VkDeviceAddressRangeKHR* pDstRange, VkAddressCommandFlagsKHR dstFlags, VkDeviceSize dataSize, const void* pData)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(pDstRange);
	DE_UNREF(dstFlags);

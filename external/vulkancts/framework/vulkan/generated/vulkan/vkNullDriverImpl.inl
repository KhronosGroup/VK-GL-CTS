...
VKAPI_ATTR void VKAPI_CALL cmdCopyQueryPoolResultsToMemoryKHR (VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount, VkStridedDeviceAddressRangeKHR dstRange, VkAddressCommandFlagsKHR dstFlags, VkQueryResultFlags queryResultFlags)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(queryPool);
	DE_UNREF(firstQuery);
...
VKAPI_ATTR void VKAPI_CALL cmdFillMemoryKHR (VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR dstRange, VkAddressCommandFlagsKHR dstFlags, uint32_t data)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(dstRange);
	DE_UNREF(dstFlags);
...
VKAPI_ATTR void VKAPI_CALL cmdUpdateMemoryKHR (VkCommandBuffer commandBuffer, VkDeviceAddressRangeKHR dstRange, VkAddressCommandFlagsKHR dstFlags, VkDeviceSize dataSize, const void* pData)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(dstRange);
	DE_UNREF(dstFlags);

...
VKAPI_ATTR void VKAPI_CALL cmdUpdatePipelineIndirectBuffer (VkCommandBuffer commandBuffer, VkPipelineBindPoint pipelineBindPoint, VkPipeline pipeline)
{
	DE_UNREF(commandBuffer);
	DE_UNREF(pipelineBindPoint);
	DE_UNREF(pipeline);
...
static const tcu::StaticFunctionLibrary::Entry s_deviceFunctions[] =
{
	...
	VK_NULL_FUNC_ENTRY(vkCmdUpdatePipelineIndirectBuffer,							cmdUpdatePipelineIndirectBuffer),

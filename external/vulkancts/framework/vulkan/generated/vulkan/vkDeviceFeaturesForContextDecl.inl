...
const vk::VkPhysicalDeviceComputeOccupancyPriorityFeaturesNV&				getComputeOccupancyPriorityFeaturesNV				(void) const;
...
const vk::VkPhysicalDeviceCooperativeMatrixConversionFeaturesQCOM&			getCooperativeMatrixConversionFeaturesQCOM			(void) const;
...
const vk::VkPhysicalDeviceCopyMemoryIndirectFeaturesNV&						getCopyMemoryIndirectFeaturesNV						(void) const;
...
const vk::VkPhysicalDeviceDynamicRenderingLocalReadFeatures&				getDynamicRenderingLocalReadFeatures				(void) const;
...
const vk::VkPhysicalDeviceExtendedSparseAddressSpaceFeaturesNV&				getExtendedSparseAddressSpaceFeaturesNV				(void) const;
...
const vk::VkPhysicalDeviceFormatPackFeaturesARM&							getFormatPackFeaturesARM							(void) const;
...
const vk::VkPhysicalDeviceFragmentDensityMapLayeredFeaturesVALVE&			getFragmentDensityMapLayeredFeaturesVALVE			(void) const;
...
const vk::VkPhysicalDeviceMaintenance9FeaturesKHR&							getMaintenance9Features								(void) const;
const vk::VkPhysicalDeviceMapMemoryPlacedFeaturesEXT&						getMapMemoryPlacedFeaturesEXT						(void) const;
const vk::VkPhysicalDeviceMemoryDecompressionFeaturesEXT&					getMemoryDecompressionFeaturesEXT					(void) const;
...
const vk::VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG&				getRelaxedLineRasterizationFeaturesIMG				(void) const;
const vk::VkPhysicalDeviceRenderPassStripedFeaturesARM&						getRenderPassStripedFeaturesARM						(void) const;
...
const vk::VkPhysicalDeviceSchedulingControlsFeaturesARM&					getSchedulingControlsFeaturesARM					(void) const;
const vk::VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures&				getSeparateDepthStencilLayoutsFeatures				(void) const;
const vk::VkPhysicalDeviceShader64BitIndexingFeaturesEXT&					getShader64BitIndexingFeaturesEXT					(void) const;
...
const vk::VkPhysicalDeviceShaderExpectAssumeFeatures&						getShaderExpectAssumeFeatures						(void) const;
...
const vk::VkPhysicalDeviceShaderUniformBufferUnsizedArrayFeaturesEXT&		getShaderUniformBufferUnsizedArrayFeaturesEXT		(void) const;
...
const vk::VkPhysicalDeviceTileShadingFeaturesQCOM&							getTileShadingFeaturesQCOM							(void) const;
...
const vk::VkPhysicalDeviceVideoEncodeRgbConversionFeaturesVALVE&			getVideoEncodeRgbConversionFeaturesVALVE			(void) const;

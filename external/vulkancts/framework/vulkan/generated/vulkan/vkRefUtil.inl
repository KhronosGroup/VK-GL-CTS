...
Move<VkMicromapEXT>					createMicromap2EXT					(const DeviceInterface& vk, VkDevice device, const VkMicromapCreateInfo2EXT* pCreateInfo, const VkAllocationCallbacks* pAllocator = nullptr);

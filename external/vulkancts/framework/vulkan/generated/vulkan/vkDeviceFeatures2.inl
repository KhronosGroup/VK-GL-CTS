...
tcu::TestStatus testPhysicalDeviceFeatureAddressBindingReportFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceAddressBindingReportFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ADDRESS_BINDING_REPORT_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureAttachmentFeedbackLoopDynamicStateFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceAttachmentFeedbackLoopDynamicStateFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureAttachmentFeedbackLoopLayoutFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceAttachmentFeedbackLoopLayoutFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureBorderColorSwizzleFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceBorderColorSwizzleFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BORDER_COLOR_SWIZZLE_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureComputeShaderDerivativesFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceComputeShaderDerivativesFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureCooperativeMatrixFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceCooperativeMatrixFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureDepthBiasControlFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceDepthBiasControlFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_BIAS_CONTROL_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureDepthClampControlFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceDepthClampControlFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_CONTROL_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureDepthClampZeroOneFeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceDepthClampZeroOneFeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceDepthClampZeroOneFeaturesKHR));
        deviceDepthClampZeroOneFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_KHR;
        deviceDepthClampZeroOneFeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceDepthClampZeroOneFeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceDepthClampZeroOneFeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceDepthClampZeroOneFeaturesKHR[0].depthClampZeroOne != deviceDepthClampZeroOneFeaturesKHR[1].depthClampZeroOne)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceDepthClampZeroOneFeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureDepthClipControlFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceDepthClipControlFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLIP_CONTROL_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureDescriptorBufferFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceDescriptorBufferFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureDescriptorHeapFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceDescriptorHeapFeaturesEXT deviceDescriptorHeapFeaturesEXT[count];
    const bool                                isDescriptorHeapFeaturesEXT = checkExtension(properties, "VK_EXT_descriptor_heap");

    if (!isDescriptorHeapFeaturesEXT)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceDescriptorHeapFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceDescriptorHeapFeaturesEXT));
        deviceDescriptorHeapFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_HEAP_FEATURES_EXT;
        deviceDescriptorHeapFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceDescriptorHeapFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceDescriptorHeapFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceDescriptorHeapFeaturesEXT[0].descriptorHeap != deviceDescriptorHeapFeaturesEXT[1].descriptorHeap ||
        deviceDescriptorHeapFeaturesEXT[0].descriptorHeapCaptureReplay != deviceDescriptorHeapFeaturesEXT[1].descriptorHeapCaptureReplay)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceDescriptorHeapFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureDeviceGeneratedCommandsFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceDeviceGeneratedCommandsFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureDynamicRenderingUnusedAttachmentsFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceDynamicRenderingUnusedAttachmentsFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureExtendedDynamicState3FeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceExtendedDynamicState3FeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_3_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureExtendedFlagsFeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceExtendedFlagsFeaturesKHR deviceExtendedFlagsFeaturesKHR[count];
    const bool                               isExtendedFlagsFeaturesKHR = checkExtension(properties, "VK_KHR_extended_flags");

    if (!isExtendedFlagsFeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceExtendedFlagsFeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceExtendedFlagsFeaturesKHR));
        deviceExtendedFlagsFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_FLAGS_FEATURES_KHR;
        deviceExtendedFlagsFeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceExtendedFlagsFeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceExtendedFlagsFeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceExtendedFlagsFeaturesKHR[0].extendedFlags != deviceExtendedFlagsFeaturesKHR[1].extendedFlags)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceExtendedFlagsFeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureFaultFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceFaultFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FAULT_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureFragmentDensityMapOffsetFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceFragmentDensityMapOffsetFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceFragmentDensityMapOffsetFeaturesEXT));
        deviceFragmentDensityMapOffsetFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_EXT;
        deviceFragmentDensityMapOffsetFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceFragmentDensityMapOffsetFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceFragmentDensityMapOffsetFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceFragmentDensityMapOffsetFeaturesEXT[0].fragmentDensityMapOffset != deviceFragmentDensityMapOffsetFeaturesEXT[1].fragmentDensityMapOffset)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceFragmentDensityMapOffsetFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureFragmentShaderBarycentricFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceFragmentShaderBarycentricFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureFrameBoundaryFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceFrameBoundaryFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAME_BOUNDARY_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureGlobalPriorityQueryFeatures (Context& context)
{
    ...
    const bool                                  isGlobalPriorityQueryFeatures = checkExtension(properties, "VK_KHR_global_priority") || checkExtension(properties, "VK_EXT_global_priority_query") || context.contextSupports(vk::ApiVersion(0, 1, 4, 0));
...
tcu::TestStatus testPhysicalDeviceFeatureGraphicsPipelineLibraryFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceGraphicsPipelineLibraryFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GRAPHICS_PIPELINE_LIBRARY_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureImage2DViewOf3DFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceImage2DViewOf3DFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_2D_VIEW_OF_3D_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureImageCompressionControlFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceImageCompressionControlFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_COMPRESSION_CONTROL_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureImageCompressionControlSwapchainFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceImageCompressionControlSwapchainFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureImageSlicedViewOf3DFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceImageSlicedViewOf3DFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_SLICED_VIEW_OF_3D_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureImageViewMinLodFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceImageViewMinLodFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_VIEW_MIN_LOD_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureLegacyDitheringFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceLegacyDitheringFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_DITHERING_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureLegacyVertexAttributesFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceLegacyVertexAttributesFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureMaintenance10FeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceMaintenance10FeaturesKHR deviceMaintenance10FeaturesKHR[count];
    const bool                               isMaintenance10FeaturesKHR = checkExtension(properties, "VK_KHR_maintenance10");

    if (!isMaintenance10FeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceMaintenance10FeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceMaintenance10FeaturesKHR));
        deviceMaintenance10FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_10_FEATURES_KHR;
        deviceMaintenance10FeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceMaintenance10FeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceMaintenance10FeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceMaintenance10FeaturesKHR[0].maintenance10 != deviceMaintenance10FeaturesKHR[1].maintenance10)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceMaintenance10FeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}

tcu::TestStatus testPhysicalDeviceFeatureMaintenance11FeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceMaintenance11FeaturesKHR deviceMaintenance11FeaturesKHR[count];
    const bool                               isMaintenance11FeaturesKHR = checkExtension(properties, "VK_KHR_maintenance11");

    if (!isMaintenance11FeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceMaintenance11FeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceMaintenance11FeaturesKHR));
        deviceMaintenance11FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_11_FEATURES_KHR;
        deviceMaintenance11FeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceMaintenance11FeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceMaintenance11FeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceMaintenance11FeaturesKHR[0].maintenance11 != deviceMaintenance11FeaturesKHR[1].maintenance11)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceMaintenance11FeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureMaintenance7FeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceMaintenance7FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureMaintenance8FeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceMaintenance8FeaturesKHR deviceMaintenance8FeaturesKHR[count];
    const bool                              isMaintenance8FeaturesKHR = checkExtension(properties, "VK_KHR_maintenance8");

    if (!isMaintenance8FeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceMaintenance8FeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceMaintenance8FeaturesKHR));
        deviceMaintenance8FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_8_FEATURES_KHR;
        deviceMaintenance8FeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceMaintenance8FeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceMaintenance8FeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceMaintenance8FeaturesKHR[0].maintenance8 != deviceMaintenance8FeaturesKHR[1].maintenance8)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceMaintenance8FeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}

tcu::TestStatus testPhysicalDeviceFeatureMaintenance9FeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceMaintenance9FeaturesKHR deviceMaintenance9FeaturesKHR[count];
    const bool                              isMaintenance9FeaturesKHR = checkExtension(properties, "VK_KHR_maintenance9");

    if (!isMaintenance9FeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceMaintenance9FeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceMaintenance9FeaturesKHR));
        deviceMaintenance9FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_FEATURES_KHR;
        deviceMaintenance9FeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceMaintenance9FeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceMaintenance9FeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceMaintenance9FeaturesKHR[0].maintenance9 != deviceMaintenance9FeaturesKHR[1].maintenance9)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceMaintenance9FeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureMapMemoryPlacedFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceMapMemoryPlacedFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAP_MEMORY_PLACED_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureMemoryDecompressionFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceMemoryDecompressionFeaturesEXT deviceMemoryDecompressionFeaturesEXT[count];
    const bool                                     isMemoryDecompressionFeaturesEXT = checkExtension(properties, "VK_NV_memory_decompression") || checkExtension(properties, "VK_EXT_memory_decompression");

    if (!isMemoryDecompressionFeaturesEXT)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceMemoryDecompressionFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceMemoryDecompressionFeaturesEXT));
        deviceMemoryDecompressionFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_FEATURES_EXT;
        deviceMemoryDecompressionFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceMemoryDecompressionFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceMemoryDecompressionFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceMemoryDecompressionFeaturesEXT[0].memoryDecompression != deviceMemoryDecompressionFeaturesEXT[1].memoryDecompression)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceMemoryDecompressionFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureMeshShaderFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceMeshShaderFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureMultisampledRenderToSingleSampledFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceMultisampledRenderToSingleSampledFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureMutableDescriptorTypeFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceMutableDescriptorTypeFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureNestedCommandBufferFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceNestedCommandBufferFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NESTED_COMMAND_BUFFER_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureNonSeamlessCubeMapFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceNonSeamlessCubeMapFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NON_SEAMLESS_CUBE_MAP_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureOpacityMicromapFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceOpacityMicromapFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPACITY_MICROMAP_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeaturePageableDeviceLocalMemoryFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        devicePageableDeviceLocalMemoryFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PAGEABLE_DEVICE_LOCAL_MEMORY_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeaturePipelineBinaryFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        devicePipelineBinaryFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeaturePipelinePropertiesFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        devicePipelinePropertiesFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROPERTIES_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeaturePortabilitySubsetFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        devicePortabilitySubsetFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeaturePresentId2FeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDevicePresentId2FeaturesKHR devicePresentId2FeaturesKHR[count];
    const bool                            isPresentId2FeaturesKHR = checkExtension(properties, "VK_KHR_present_id2");

    if (!isPresentId2FeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&devicePresentId2FeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDevicePresentId2FeaturesKHR));
        devicePresentId2FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR;
        devicePresentId2FeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &devicePresentId2FeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << devicePresentId2FeaturesKHR[0] << TestLog::EndMessage;

    if (
        devicePresentId2FeaturesKHR[0].presentId2 != devicePresentId2FeaturesKHR[1].presentId2)
    {
        TCU_FAIL("Mismatch between VkPhysicalDevicePresentId2FeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeaturePresentWait2FeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDevicePresentWait2FeaturesKHR devicePresentWait2FeaturesKHR[count];
    const bool                              isPresentWait2FeaturesKHR = checkExtension(properties, "VK_KHR_present_wait2");

    if (!isPresentWait2FeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&devicePresentWait2FeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDevicePresentWait2FeaturesKHR));
        devicePresentWait2FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR;
        devicePresentWait2FeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &devicePresentWait2FeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << devicePresentWait2FeaturesKHR[0] << TestLog::EndMessage;

    if (
        devicePresentWait2FeaturesKHR[0].presentWait2 != devicePresentWait2FeaturesKHR[1].presentWait2)
    {
        TCU_FAIL("Mismatch between VkPhysicalDevicePresentWait2FeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeaturePrimitivesGeneratedQueryFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        devicePrimitivesGeneratedQueryFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIMITIVES_GENERATED_QUERY_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureRGBA10X6FormatsFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceRGBA10X6FormatsFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RGBA10X6_FORMATS_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureRasterizationOrderAttachmentAccessFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceRasterizationOrderAttachmentAccessFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureRayTracingInvocationReorderFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceRayTracingInvocationReorderFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceRayTracingInvocationReorderFeaturesEXT));
        deviceRayTracingInvocationReorderFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_INVOCATION_REORDER_FEATURES_EXT;
        deviceRayTracingInvocationReorderFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceRayTracingInvocationReorderFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceRayTracingInvocationReorderFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceRayTracingInvocationReorderFeaturesEXT[0].rayTracingInvocationReorder != deviceRayTracingInvocationReorderFeaturesEXT[1].rayTracingInvocationReorder)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceRayTracingInvocationReorderFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureRayTracingMaintenance1FeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceRayTracingMaintenance1FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_MAINTENANCE_1_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureRayTracingPositionFetchFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceRayTracingPositionFetchFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_POSITION_FETCH_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureRobustness2FeaturesKHR (Context& context)
{
    ...
    const bool                             isRobustness2FeaturesKHR = checkExtension(properties, "VK_KHR_robustness2") || checkExtension(properties, "VK_EXT_robustness2");
...
tcu::TestStatus testPhysicalDeviceFeatureShader64BitIndexingFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceShader64BitIndexingFeaturesEXT deviceShader64BitIndexingFeaturesEXT[count];
    const bool                                     isShader64BitIndexingFeaturesEXT = checkExtension(properties, "VK_EXT_shader_64bit_indexing");

    if (!isShader64BitIndexingFeaturesEXT)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceShader64BitIndexingFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceShader64BitIndexingFeaturesEXT));
        deviceShader64BitIndexingFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_64_BIT_INDEXING_FEATURES_EXT;
        deviceShader64BitIndexingFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceShader64BitIndexingFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceShader64BitIndexingFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceShader64BitIndexingFeaturesEXT[0].shader64BitIndexing != deviceShader64BitIndexingFeaturesEXT[1].shader64BitIndexing)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceShader64BitIndexingFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureShaderFloat8FeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceShaderFloat8FeaturesEXT deviceShaderFloat8FeaturesEXT[count];
    const bool                              isShaderFloat8FeaturesEXT = checkExtension(properties, "VK_EXT_shader_float8");

    if (!isShaderFloat8FeaturesEXT)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceShaderFloat8FeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceShaderFloat8FeaturesEXT));
        deviceShaderFloat8FeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT8_FEATURES_EXT;
        deviceShaderFloat8FeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceShaderFloat8FeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceShaderFloat8FeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceShaderFloat8FeaturesEXT[0].shaderFloat8 != deviceShaderFloat8FeaturesEXT[1].shaderFloat8 ||
...
tcu::TestStatus testPhysicalDeviceFeatureShaderLongVectorFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceShaderLongVectorFeaturesEXT deviceShaderLongVectorFeaturesEXT[count];
    const bool                                  isShaderLongVectorFeaturesEXT = checkExtension(properties, "VK_EXT_shader_long_vector");

    if (!isShaderLongVectorFeaturesEXT)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceShaderLongVectorFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceShaderLongVectorFeaturesEXT));
        deviceShaderLongVectorFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_LONG_VECTOR_FEATURES_EXT;
        deviceShaderLongVectorFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceShaderLongVectorFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceShaderLongVectorFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceShaderLongVectorFeaturesEXT[0].longVector != deviceShaderLongVectorFeaturesEXT[1].longVector)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceShaderLongVectorFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureShaderMaximalReconvergenceFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceShaderMaximalReconvergenceFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MAXIMAL_RECONVERGENCE_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderModuleIdentifierFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceShaderModuleIdentifierFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MODULE_IDENTIFIER_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderObjectFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceShaderObjectFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_OBJECT_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderQuadControlFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceShaderQuadControlFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_QUAD_CONTROL_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderRelaxedExtendedInstructionFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceShaderRelaxedExtendedInstructionFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderReplicatedCompositesFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceShaderReplicatedCompositesFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_REPLICATED_COMPOSITES_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderSplitBarrierFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceShaderSplitBarrierFeaturesEXT deviceShaderSplitBarrierFeaturesEXT[count];
    const bool                                    isShaderSplitBarrierFeaturesEXT = checkExtension(properties, "VK_EXT_shader_split_barrier");

    if (!isShaderSplitBarrierFeaturesEXT)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceShaderSplitBarrierFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceShaderSplitBarrierFeaturesEXT));
        deviceShaderSplitBarrierFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SPLIT_BARRIER_FEATURES_EXT;
        deviceShaderSplitBarrierFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceShaderSplitBarrierFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceShaderSplitBarrierFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceShaderSplitBarrierFeaturesEXT[0].shaderSplitBarrier != deviceShaderSplitBarrierFeaturesEXT[1].shaderSplitBarrier)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceShaderSplitBarrierFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureShaderSubgroupUniformControlFlowFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceShaderSubgroupUniformControlFlowFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderTileImageFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceShaderTileImageFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TILE_IMAGE_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureShaderUniformBufferUnsizedArrayFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceShaderUniformBufferUnsizedArrayFeaturesEXT deviceShaderUniformBufferUnsizedArrayFeaturesEXT[count];
    const bool                                                 isShaderUniformBufferUnsizedArrayFeaturesEXT = checkExtension(properties, "VK_EXT_shader_uniform_buffer_unsized_array");

    if (!isShaderUniformBufferUnsizedArrayFeaturesEXT)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceShaderUniformBufferUnsizedArrayFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceShaderUniformBufferUnsizedArrayFeaturesEXT));
        deviceShaderUniformBufferUnsizedArrayFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_UNIFORM_BUFFER_UNSIZED_ARRAY_FEATURES_EXT;
        deviceShaderUniformBufferUnsizedArrayFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceShaderUniformBufferUnsizedArrayFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceShaderUniformBufferUnsizedArrayFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceShaderUniformBufferUnsizedArrayFeaturesEXT[0].shaderUniformBufferUnsizedArray != deviceShaderUniformBufferUnsizedArrayFeaturesEXT[1].shaderUniformBufferUnsizedArray)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceShaderUniformBufferUnsizedArrayFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureSubpassMergeFeedbackFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceSubpassMergeFeedbackFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_MERGE_FEEDBACK_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureUnifiedImageLayoutsFeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR deviceUnifiedImageLayoutsFeaturesKHR[count];
    const bool                                     isUnifiedImageLayoutsFeaturesKHR = checkExtension(properties, "VK_KHR_unified_image_layouts");

    if (!isUnifiedImageLayoutsFeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceUnifiedImageLayoutsFeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR));
        deviceUnifiedImageLayoutsFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFIED_IMAGE_LAYOUTS_FEATURES_KHR;
        deviceUnifiedImageLayoutsFeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceUnifiedImageLayoutsFeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceUnifiedImageLayoutsFeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceUnifiedImageLayoutsFeaturesKHR[0].unifiedImageLayouts != deviceUnifiedImageLayoutsFeaturesKHR[1].unifiedImageLayouts ||
        deviceUnifiedImageLayoutsFeaturesKHR[0].unifiedImageLayoutsVideo != deviceUnifiedImageLayoutsFeaturesKHR[1].unifiedImageLayoutsVideo)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureVertexAttributeRobustnessFeaturesEXT (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceVertexAttributeRobustnessFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT;
...
tcu::TestStatus testPhysicalDeviceFeatureVideoDecodeVP9FeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceVideoDecodeVP9FeaturesKHR deviceVideoDecodeVP9FeaturesKHR[count];
    const bool                                isVideoDecodeVP9FeaturesKHR = checkExtension(properties, "VK_KHR_video_decode_vp9");

    if (!isVideoDecodeVP9FeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceVideoDecodeVP9FeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceVideoDecodeVP9FeaturesKHR));
        deviceVideoDecodeVP9FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_DECODE_VP9_FEATURES_KHR;
        deviceVideoDecodeVP9FeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceVideoDecodeVP9FeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceVideoDecodeVP9FeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceVideoDecodeVP9FeaturesKHR[0].videoDecodeVP9 != deviceVideoDecodeVP9FeaturesKHR[1].videoDecodeVP9)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceVideoDecodeVP9FeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureVideoEncodeAV1FeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceVideoEncodeAV1FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureVideoEncodeQuantizationMapFeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceVideoEncodeQuantizationMapFeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_QUANTIZATION_MAP_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureVideoMaintenance1FeaturesKHR (Context& context)
{
    ...
    for (int ndx = 0; ndx < count; ++ndx)
    {
        ...
        deviceVideoMaintenance1FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_1_FEATURES_KHR;
...
tcu::TestStatus testPhysicalDeviceFeatureVideoMaintenance2FeaturesKHR (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceVideoMaintenance2FeaturesKHR deviceVideoMaintenance2FeaturesKHR[count];
    const bool                                   isVideoMaintenance2FeaturesKHR = checkExtension(properties, "VK_KHR_video_maintenance2");

    if (!isVideoMaintenance2FeaturesKHR)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceVideoMaintenance2FeaturesKHR[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceVideoMaintenance2FeaturesKHR));
        deviceVideoMaintenance2FeaturesKHR[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_2_FEATURES_KHR;
        deviceVideoMaintenance2FeaturesKHR[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceVideoMaintenance2FeaturesKHR[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceVideoMaintenance2FeaturesKHR[0] << TestLog::EndMessage;

    if (
        deviceVideoMaintenance2FeaturesKHR[0].videoMaintenance2 != deviceVideoMaintenance2FeaturesKHR[1].videoMaintenance2)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceVideoMaintenance2FeaturesKHR");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
tcu::TestStatus testPhysicalDeviceFeatureZeroInitializeDeviceMemoryFeaturesEXT (Context& context)
{
    const VkPhysicalDevice        physicalDevice = context.getPhysicalDevice();
    const CustomInstance          instance(createCustomInstanceWithExtension(context, "VK_KHR_get_physical_device_properties2"));
    const InstanceDriver&         vki(instance.getDriver());
    ...
    VkPhysicalDeviceZeroInitializeDeviceMemoryFeaturesEXT deviceZeroInitializeDeviceMemoryFeaturesEXT[count];
    const bool                                            isZeroInitializeDeviceMemoryFeaturesEXT = checkExtension(properties, "VK_EXT_zero_initialize_device_memory");

    if (!isZeroInitializeDeviceMemoryFeaturesEXT)
        return tcu::TestStatus::pass("Querying not supported");

    for (int ndx = 0; ndx < count; ++ndx)
    {
        deMemset(&deviceZeroInitializeDeviceMemoryFeaturesEXT[ndx], 0xFF * ndx, sizeof(VkPhysicalDeviceZeroInitializeDeviceMemoryFeaturesEXT));
        deviceZeroInitializeDeviceMemoryFeaturesEXT[ndx].sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_DEVICE_MEMORY_FEATURES_EXT;
        deviceZeroInitializeDeviceMemoryFeaturesEXT[ndx].pNext = nullptr;

        deMemset(&extFeatures.features, 0xcd, sizeof(extFeatures.features));
        extFeatures.sType = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2;
        extFeatures.pNext = &deviceZeroInitializeDeviceMemoryFeaturesEXT[ndx];

        vki.getPhysicalDeviceFeatures2(physicalDevice, &extFeatures);
    }

    log << TestLog::Message << deviceZeroInitializeDeviceMemoryFeaturesEXT[0] << TestLog::EndMessage;

    if (
        deviceZeroInitializeDeviceMemoryFeaturesEXT[0].zeroInitializeDeviceMemory != deviceZeroInitializeDeviceMemoryFeaturesEXT[1].zeroInitializeDeviceMemory)
    {
        TCU_FAIL("Mismatch between VkPhysicalDeviceZeroInitializeDeviceMemoryFeaturesEXT");
    }
    return tcu::TestStatus::pass("Querying succeeded");
}
...
void addSeparateFeatureTests (tcu::TestCaseGroup* testGroup)
{
	...
	addFunctionCase(testGroup, "descriptor_heap_features_ext", testPhysicalDeviceFeatureDescriptorHeapFeaturesEXT);
	...
	addFunctionCase(testGroup, "maintenance10_features_khr", testPhysicalDeviceFeatureMaintenance10FeaturesKHR);
	addFunctionCase(testGroup, "maintenance11_features_khr", testPhysicalDeviceFeatureMaintenance11FeaturesKHR);
	...
	addFunctionCase(testGroup, "maintenance8_features_khr", testPhysicalDeviceFeatureMaintenance8FeaturesKHR);
	addFunctionCase(testGroup, "maintenance9_features_khr", testPhysicalDeviceFeatureMaintenance9FeaturesKHR);
	addFunctionCase(testGroup, "map_memory_placed_features_ext", testPhysicalDeviceFeatureMapMemoryPlacedFeaturesEXT);
	addFunctionCase(testGroup, "memory_decompression_features_ext", testPhysicalDeviceFeatureMemoryDecompressionFeaturesEXT);
	...
	addFunctionCase(testGroup, "ray_tracing_invocation_reorder_features_ext", testPhysicalDeviceFeatureRayTracingInvocationReorderFeaturesEXT);
	...
	addFunctionCase(testGroup, "shader_split_barrier_features_ext", testPhysicalDeviceFeatureShaderSplitBarrierFeaturesEXT);
	...
	addFunctionCase(testGroup, "shader_uniform_buffer_unsized_array_features_ext", testPhysicalDeviceFeatureShaderUniformBufferUnsizedArrayFeaturesEXT);
	...
	addFunctionCase(testGroup, "unified_image_layouts_features_khr", testPhysicalDeviceFeatureUnifiedImageLayoutsFeaturesKHR);
	...
	addFunctionCase(testGroup, "video_maintenance2_features_khr", testPhysicalDeviceFeatureVideoMaintenance2FeaturesKHR);

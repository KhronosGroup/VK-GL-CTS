...
tcu::TestStatus testPhysicalDeviceFeatureMemoryDecompressionFeaturesEXT (Context& context)
{
    ...
    const bool                                     isMemoryDecompressionFeaturesEXT = checkExtension(properties, "VK_EXT_memory_decompression") || checkExtension(properties, "VK_NV_memory_decompression");

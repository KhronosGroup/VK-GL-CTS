...
const vk::VkPhysicalDeviceSubgroupExtendedTypesFeatures&				Context::getSubgroupExtendedTypesFeatures				(void) const { return m_device->getSubgroupExtendedTypesFeatures();				}

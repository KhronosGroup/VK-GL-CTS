                       ...
                       const VkCommandPool *externalCommandPool, uint32_t baseMipLevel)
{
    ...
    copyBufferToImage(vk, *cmdBuffer, buffer, bufferSize, copyRegions, imageAspectFlags, mipLevels, arrayLayers,
                      destImage, destImageLayout, destImageDstStageFlags, baseMipLevel);
...
void copyImageToBuffer(const DeviceInterface &vk, VkCommandBuffer cmdBuffer, VkImage image, VkBuffer buffer,
                       ...
                       VkImageAspectFlags barrierAspect, VkImageAspectFlags copyAspect, VkPipelineStageFlags srcMask)
{
    ...
    vk.cmdPipelineBarrier(cmdBuffer, srcMask, VK_PIPELINE_STAGE_TRANSFER_BIT, 0u, 0u, DE_NULL, 0u, DE_NULL, 1u,
                          &imageBarrier);

...
tcu::TestStatus createDestroyObjectTest(Context &context, typename Object::Parameters params)
{
...

    {
        ...
        de::MovePtr<DeviceDriver> deviceInterface = de::MovePtr<DeviceDriver>(new DeviceDriver(
            context.getPlatformInterface(), customInstance, device.get(), context.getUsedApiVersion()));
...
tcu::TestCaseGroup *createAddressBindingReportTests(tcu::TestContext &testCtx)
{
    ...
    addressBindingReportTests->addChild(

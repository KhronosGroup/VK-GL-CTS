...
public:
    BaseTestInstance(Context &ctx, BindingCaseParameters params) : TestInstance(ctx), m_params(params)
    {
        ...
        m_logicalDeviceInterface = de::MovePtr<DeviceDriver>(new DeviceDriver(
            m_context.getPlatformInterface(), m_context.getInstance(), getDevice(), m_context.getUsedApiVersion()));

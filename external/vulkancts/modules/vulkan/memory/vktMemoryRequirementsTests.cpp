...
VkMemoryRequirements getDeviceImageMemoryRequirementsKHR(const DeviceInterface &vk, const VkDevice device,
                                                         const VkImageCreateInfo &createInfo, void *next = DE_NULL)
{
...
{
    const VkFormat multiplaneFormats[] = {VK_FORMAT_G8_B8_R8_3PLANE_420_UNORM_KHR,
                                          VK_FORMAT_G8_B8R8_2PLANE_420_UNORM_KHR,
                                          VK_FORMAT_G8_B8_R8_3PLANE_422_UNORM_KHR,
                                          VK_FORMAT_G8_B8R8_2PLANE_422_UNORM_KHR,
                                          VK_FORMAT_G8_B8_R8_3PLANE_444_UNORM_KHR,
                ...
                if (isMultiplaneImageSupported(vki, physicalDevice, imageInfo))
                {
                    ...
                    for (uint32_t planeNdx = 0; planeNdx < (uint32_t)getPlaneCount(format); planeNdx++)
                    {
                        VkMemoryRequirements2 requirements = {
                            VK_STRUCTURE_TYPE_MEMORY_REQUIREMENTS_2_KHR, DE_NULL, {0u, 0u, 0u}};
                        ...
                        else
                        {
                            const VkImagePlaneMemoryRequirementsInfo aspectInfo = {
                                VK_STRUCTURE_TYPE_IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO_KHR, DE_NULL, aspect};
                                         ...
                                         "No supported memory types"))
                        {
                            ...
                            for (uint32_t memoryTypeIndex = 0;
                                 (0x1u << memoryTypeIndex) <= requirements.memoryRequirements.memoryTypeBits;
                                 memoryTypeIndex++)
                            {
                                if (result.check(memoryTypeIndex < memoryProperties.memoryTypeCount,
                            ...
                            result.check(params.tiling != VK_IMAGE_TILING_LINEAR || hasHostVisibleType,

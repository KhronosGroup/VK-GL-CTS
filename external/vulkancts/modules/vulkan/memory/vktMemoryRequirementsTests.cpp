...
protected:
    virtual void addFunctionTestCase(tcu::TestCaseGroup *group, const std::string &name, VkBufferCreateFlags arg0) = 0;
...
protected:
    virtual void addFunctionTestCase(tcu::TestCaseGroup *group, const std::string &name, VkBufferCreateFlags arg0);
...
void BufferMemoryRequirementsDedicatedAllocation::addFunctionTestCase(tcu::TestCaseGroup *group,
                                                                      const std::string &name, VkBufferCreateFlags arg0)
{
...
protected:
    virtual void addFunctionTestCase(tcu::TestCaseGroup *group, const std::string &name,
...
protected:
    virtual void addFunctionTestCase(tcu::TestCaseGroup *group, const std::string &name, const ImageTestParams arg0);
...
tcu::TestStatus testMultiplaneImages(Context &context, ImageTestParams params)
{
    ...
    for (const VkFormat format : formats::planarFormats)
    {
...
tcu::TestCaseGroup *createRequirementsTests(tcu::TestContext &testCtx)
{
    ...
    requirementsGroup->addChild(
        createTestGroup(testCtx, "memory_property_flags", populateMemoryPropertyFlagsTestGroup));
#ifndef CTS_USES_VULKANSC

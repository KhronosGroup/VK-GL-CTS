...
template <>
void MSCase<MSCaseCentroidQualifierInsidePrimitive>::checkSupport(Context &) const
{
}
...
tcu::TestCaseGroup *createMultisampleInterpolationTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> reInterpolationGroup(
        new tcu::TestCaseGroup(testCtx, "reinterpolation_consistency", "Test consistency in reinterpolation"));
    std::vector<std::string> requirements;
    requirements.push_back("Features.sampleRateShading");
    reInterpolationGroup->addChild(cts_amber::createAmberTestCase(testCtx, "interpolate_at_centroid", "", "pipeline",
                                                                  "reinterpolate_at_centroid.amber", requirements));

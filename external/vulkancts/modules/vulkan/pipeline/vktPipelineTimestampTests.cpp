...
void TimestampTestInstance::createCustomDeviceWithTransferOnlyQueue(void)
{
    ...
    m_customDevice    = vkt::createCustomDevice(m_context.getTestContext().getCommandLine().isValidationEnabled(),
                                                m_context.getPlatformInterface(), m_context.getInstance(), vki,

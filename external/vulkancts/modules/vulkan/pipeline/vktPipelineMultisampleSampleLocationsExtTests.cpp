...
protected:
    ...
    void drawPatternChangeReference(void)
    {
        ...
        GraphicsPipelineWrapper pipeline(vk, device, m_params.pipelineConstructionType);
        preparePipelineWrapper(pipeline, std::vector<VkDynamicState>(), *pipelineLayout, rt.getRenderPass(),
                               *vertexModule, *fragmentModule,
                               /*subpass index*/ 0u, viewport, scissor, m_params.numSamples,
                               /*use sample locations*/ true, sampleLocationsInfo, useDepth(), useStencil(),
                               VERTEX_INPUT_VEC4_VEC4, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, stencilOpStateDrawOnce(),
    ...
    void drawRenderPasses(void)
    {
        ...
        if (useSecondaryCmdBuffer())
        {
            ...
            beginSecondaryCommandBuffer(vk, *secondaryCmdBuffer[1], rt[1].getRenderPass(), /*subpass*/ 0u,
                                        rt[1].getFramebuffer());
            recordSecondPassContents(*secondaryCmdBuffer[1], pipelines[1].getPipeline(), sampleLocationsInfo[1],
                                     clearColor1, clearDepthStencil0, scissor);
        ...
        else
        {
            ...
            recordSecondPassContents(currentCmdBuffer, pipelines[1].getPipeline(), sampleLocationsInfo[1], clearColor1,
    ...
    void drawSubpasses(void)
    {
        ...
        else
        {
            ...
            recordSecondPassContents(*cmdBuffer, pipelines[1].getPipeline(), sampleLocationsInfo[1], clearColor1,
                                     clearDepthStencil0, scissor);
        }
    ...
    void drawSameSubpass(void)
    {
        ...
        if (useSecondaryCmdBuffer())
        {
            ...
            recordSecondPassContents(*secondaryCmdBuffer, pipelines[1].getPipeline(), sampleLocationsInfo[1],
                                     clearColor1, clearDepthStencil0, scissor);

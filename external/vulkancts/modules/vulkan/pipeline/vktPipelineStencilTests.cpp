...
public:
    ...
    StencilTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
{
public:
    StencilTestInstance(Context &context, VkFormat stencilFormat, const VkStencilOpState &stencilOpStatesFront,
                        const VkStencilOpState &stencilOpStatesBack, const bool colorAttachmentEnable,
                        const bool separateDepthStencilLayouts);
...
StencilTest::StencilTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
                         VkFormat stencilFormat, const VkStencilOpState &stencilOpStateFront,
                         const VkStencilOpState &stencilOpStateBack, const bool colorAttachmentEnable,
                         const bool separateDepthStencilLayouts)
...
TestInstance *StencilTest::createInstance(Context &context) const
{
    return new StencilTestInstance(context, m_stencilFormat, m_stencilOpStateFront, m_stencilOpStateBack,
                                   m_colorAttachmentEnable, m_separateDepthStencilLayouts);
}
...
StencilTestInstance::StencilTestInstance(Context &context, VkFormat stencilFormat,
...
tcu::TestCaseGroup *createStencilTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> noColorAttachmentTests(
        new tcu::TestCaseGroup(testCtx, "nocolor", "Stencil tests with no color attachment"));
         ...
         colorAttachmentEnabledIdx++)
    {
        ...
        de::MovePtr<tcu::TestCaseGroup> formatTests(
            new tcu::TestCaseGroup(testCtx, "format", "Uses different stencil formats"));
                 ...
                 ++separateDepthStencilLayouts)
            {
                ...
                de::MovePtr<tcu::TestCaseGroup> formatTest(new tcu::TestCaseGroup(
                    ...
                    (getFormatCaseName(stencilFormat) + ((useSeparateDepthStencilLayouts) ? "_separate_layouts" : ""))
                        .c_str(),
                    (std::string("Uses format ") + getFormatName(stencilFormat) +
                ...
                de::MovePtr<tcu::TestCaseGroup> stencilStateTests;
                {
                    ...
                    stencilStateTests =
                        de::MovePtr<tcu::TestCaseGroup>(new tcu::TestCaseGroup(testCtx, "states", desc.str().c_str()));
                }
                ...
                for (uint32_t failOpNdx = 0u; failOpNdx < DE_LENGTH_OF_ARRAY(stencilOps); failOpNdx++)
                {
                    ...
                    for (uint32_t passOpNdx = 0u; passOpNdx < DE_LENGTH_OF_ARRAY(stencilOps); passOpNdx++)
                    {
                        ...
                        de::MovePtr<tcu::TestCaseGroup> passOpTest(
                            new tcu::TestCaseGroup(testCtx, passOpName.c_str(), ""));
                        ...
                        for (uint32_t dFailOpNdx = 0u; dFailOpNdx < DE_LENGTH_OF_ARRAY(stencilOps); dFailOpNdx++)
                        {
                                 ...
                                 compareOpNdx++)
                            {
                                ...
                                const std::string caseDesc =
                                    getStencilStateSetDescription(stencilStateFront, stencilStateBack);

                                dFailOpTest->addChild(new StencilTest(testCtx, caseName, caseDesc, stencilFormat,

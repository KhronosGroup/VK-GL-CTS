...
void PushDescriptorBufferGraphicsTestInstance::init(void)
{
    ...
    // Create pipeline
    {
        ...
        m_graphicsPipelines = makeGraphicsPipeline(
    ...
    // Create command buffer
    {
        ...
        for (uint32_t quadNdx = 0; quadNdx < m_params.numCalls; quadNdx++)
        {
            ...
            m_vkd.cmdPushDescriptorSetKHR(*m_cmdBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, *m_pipelineLayout, 0, 1,
                                          &writeDescriptorSet);
...
void PushDescriptorImageGraphicsTestInstance::init(void)
{
    ...
    // Create command buffer
    {
        ...
        for (uint32_t quadNdx = 0; quadNdx < m_params.numCalls; quadNdx++)
        {
            ...
            m_vkd.cmdPushDescriptorSetKHR(*m_cmdBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, *m_pipelineLayout, 0,
...
void PushDescriptorTexelBufferGraphicsTestInstance::init(void)
{
    ...
    // Create command buffer
    {
        ...
        for (uint32_t quadNdx = 0; quadNdx < m_params.numCalls; quadNdx++)
        {
            ...
            m_vkd.cmdPushDescriptorSetKHR(*m_cmdBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, *m_pipelineLayout, 0, 1u,
                                          &writeDescriptorSet);
            m_vkd.cmdDraw(*m_cmdBuffer, 6, 1, 6 * quadNdx, 0);
        }
...
void PushDescriptorInputAttachmentGraphicsTestInstance::init(void)
{
    ...
    for (uint32_t pipelineIdx = 0; pipelineIdx < 2; pipelineIdx++)
    {
        ...
        m_graphicsPipelines.push_back(VkPipelineSp(new Unique<VkPipeline>(makeGraphicsPipeline(
            m_vkd,                   // const DeviceInterface&                        vk
            *m_device,               // const VkDevice                                device
            *m_pipelineLayout,       // const VkPipelineLayout                        pipelineLayout
            *m_vertexShaderModule,   // const VkShaderModule                            vertexShaderModule
...
{
    const TestParams params[] = {{VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER, 0u, 1u},

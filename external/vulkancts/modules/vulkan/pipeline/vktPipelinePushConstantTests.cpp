...
{
public:
    PushConstantComputeTestInstance(Context &context, const PushConstantData pushConstantRange);
...
tcu::TestCaseGroup *createPushConstantTests(tcu::TestContext &testCtx)
{
    ...
    computeTests->addChild(new PushConstantComputeTest(testCtx, computeParams[0].name, computeParams[0].description,
                                                       computeParams[0].range));

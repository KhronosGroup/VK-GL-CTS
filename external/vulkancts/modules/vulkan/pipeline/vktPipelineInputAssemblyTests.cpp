...
PrimitiveTopologyTest::PrimitiveTopologyTest(tcu::TestContext &testContext, const std::string &name,
    ...
    : InputAssemblyTest(testContext, name, description, pipelineConstructionType, primitiveTopology, 10, false,
                        indexType)
{
}
...
PrimitiveRestartTest::PrimitiveRestartTest(tcu::TestContext &testContext, const std::string &name,
    ...
    : InputAssemblyTest(testContext, name, description, pipelineConstructionType, primitiveTopology, 10, true,
                        indexType)
{

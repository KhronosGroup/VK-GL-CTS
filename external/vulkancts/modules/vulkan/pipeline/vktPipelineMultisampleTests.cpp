...
{
public:
    MultisampleTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
{
public:
    RasterizationSamplesTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
{
public:
    MinSampleShadingTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
{
public:
    SampleMaskTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
{
public:
    AlphaToOneTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
{
public:
    AlphaToCoverageTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
public:
    AlphaToCoverageNoColorAttachmentTest(tcu::TestContext &testContext, const std::string &name,
                                         const std::string &description, VkSampleCountFlagBits rasterizationSamples,
...
public:
    SampleMaskWithConservativeTest(tcu::TestContext &testContext, const std::string &name,
                                   const std::string &description, const VkSampleCountFlagBits rasterizationSamples,
...
{
public:
    SampleMaskWithDepthTestTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
{
public:
    MultisampleRenderer(Context &context, const VkFormat colorFormat, const tcu::IVec2 &renderSize,
    ...
    MultisampleRenderer(Context &context, const VkFormat colorFormat, const VkFormat depthStencilFormat,
...
{
public:
    RasterizationSamplesInstance(Context &context, VkPrimitiveTopology topology, float pointSize,
...
{
public:
    MinSampleShadingInstance(Context &context, VkPrimitiveTopology topology, float pointSize,
                             const std::vector<Vertex4RGBA> &vertices,
                             const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
...
{
public:
    MinSampleShadingDisabledInstance(Context &context, VkPrimitiveTopology topology, float pointSize,
                                     const std::vector<Vertex4RGBA> &vertices,
                                     const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                     const VkPipelineColorBlendAttachmentState &blendState,
                                     ImageBackingMode backingMode, const bool useFragmentShadingRate);
...
{
public:
    SampleMaskInstance(Context &context, VkPrimitiveTopology topology, float pointSize,
                       const std::vector<Vertex4RGBA> &vertices,
                       const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                       const VkPipelineColorBlendAttachmentState &blendState, ImageBackingMode backingMode,
                       const bool useFragmentShadingRate);
...
{
public:
    AlphaToOneInstance(Context &context, VkPrimitiveTopology topology, const std::vector<Vertex4RGBA> &vertices,
                       const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                       const VkPipelineColorBlendAttachmentState &blendState, ImageBackingMode backingMode,
                       const bool useFragmentShadingRate);
...
{
public:
    AlphaToCoverageInstance(Context &context, VkPrimitiveTopology topology, const std::vector<Vertex4RGBA> &vertices,
                            const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
...
{
public:
    AlphaToCoverageNoColorAttachmentInstance(Context &context, VkPrimitiveTopology topology,
                                             const std::vector<Vertex4RGBA> &vertices,
                                             const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                             const VkPipelineColorBlendAttachmentState &blendState,
                                             GeometryType geometryType, ImageBackingMode backingMode,
...
{
public:
    AlphaToCoverageColorUnusedAttachmentInstance(Context &context, VkPrimitiveTopology topology,
                                                 const std::vector<Vertex4RGBA> &vertices,
                                                 const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                                 const VkPipelineColorBlendAttachmentState &blendState,
                                                 GeometryType geometryType, ImageBackingMode backingMode,
...
{
public:
    SampleMaskWithConservativeInstance(Context &context, const VkSampleCountFlagBits rasterizationSamples,
                                       const bool enableMinSampleShading, const float minSampleShading,
                                       const bool enableSampleMask, const VkSampleMask sampleMask,
                                       const VkConservativeRasterizationModeEXT conservativeRasterizationMode,
...
{
public:
    SampleMaskWithDepthTestInstance(Context &context, const VkSampleCountFlagBits rasterizationSamples,
                                    const bool enablePostDepthCoverage, const bool useFragmentShadingRate);
...
MultisampleTest::MultisampleTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
                                 const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                 const VkPipelineColorBlendAttachmentState &blendState, GeometryType geometryType,
...
RasterizationSamplesTest::RasterizationSamplesTest(tcu::TestContext &testContext, const std::string &name,
                                                   ...
                                                   const bool useFragmentShadingRate)
    : MultisampleTest(testContext, name, description, getRasterizationSamplesStateParams(rasterizationSamples),
...
TestInstance *RasterizationSamplesTest::createMultisampleTestInstance(
    ...
    const VkPipelineColorBlendAttachmentState &colorBlendState) const
{
    return new RasterizationSamplesInstance(context, topology, pointSize, vertices, multisampleStateParams,
                                            colorBlendState, m_modeFlags, m_backingMode, m_useFragmentShadingRate);
}
...
MinSampleShadingTest::MinSampleShadingTest(tcu::TestContext &testContext, const std::string &name,
                                           const std::string &description, VkSampleCountFlagBits rasterizationSamples,
                                           float minSampleShading, GeometryType geometryType, float pointSize,
                                           ImageBackingMode backingMode, const bool minSampleShadingEnabled,
                                           const bool useFragmentShadingRate)
    : MultisampleTest(testContext, name, description,
    ...
    const VkPipelineColorBlendAttachmentState &colorBlendState) const
{
    if (m_minSampleShadingEnabled)
        return new MinSampleShadingInstance(context, topology, pointSize, vertices, multisampleStateParams,
                                            colorBlendState, m_backingMode, m_useFragmentShadingRate);
    else
        return new MinSampleShadingDisabledInstance(context, topology, pointSize, vertices, multisampleStateParams,
                                                    colorBlendState, m_backingMode, m_useFragmentShadingRate);
}
...
SampleMaskTest::SampleMaskTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
                               VkSampleCountFlagBits rasterizationSamples, const std::vector<VkSampleMask> &sampleMask,
                               GeometryType geometryType, float pointSize, ImageBackingMode backingMode,
                               const bool useFragmentShadingRate)
    : MultisampleTest(testContext, name, description, getSampleMaskStateParams(rasterizationSamples, sampleMask),
                      getDefaultColorBlendAttachmentState(), geometryType, pointSize, backingMode,
                      useFragmentShadingRate)
    , m_backingMode(backingMode)
{
...
{
    DE_UNREF(pointSize);
    return new SampleMaskInstance(context, topology, pointSize, vertices, multisampleStateParams, colorBlendState,
...
AlphaToOneTest::AlphaToOneTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
                               VkSampleCountFlagBits rasterizationSamples, ImageBackingMode backingMode,
                               const bool useFragmentShadingRate)
    : MultisampleTest(testContext, name, description, getAlphaToOneStateParams(rasterizationSamples),
...
AlphaToCoverageTest::AlphaToCoverageTest(tcu::TestContext &testContext, const std::string &name,
                                         ...
                                         GeometryType geometryType, ImageBackingMode backingMode,
                                         const bool useFragmentShadingRate)
    : MultisampleTest(testContext, name, description, getAlphaToCoverageStateParams(rasterizationSamples),
...
{
    DE_UNREF(pointSize);
    return new AlphaToCoverageInstance(context, topology, vertices, multisampleStateParams, colorBlendState,
                                       m_geometryType, m_backingMode, m_useFragmentShadingRate);
}
...
AlphaToCoverageNoColorAttachmentTest::AlphaToCoverageNoColorAttachmentTest(
    ...
    const bool useFragmentShadingRate)
    : MultisampleTest(testContext, name, description, getStateParams(rasterizationSamples),
                      getDefaultColorBlendAttachmentState(), geometryType, 1.0f, backingMode, useFragmentShadingRate)
    , m_geometryType(geometryType)
    , m_backingMode(backingMode)
{
...
{
    DE_UNREF(pointSize);
    return new AlphaToCoverageNoColorAttachmentInstance(context, topology, vertices, multisampleStateParams,
                                                        colorBlendState, m_geometryType, m_backingMode,
                                                        m_useFragmentShadingRate);
}
...
{
    DE_UNREF(pointSize);
    return new AlphaToCoverageColorUnusedAttachmentInstance(context, topology, vertices, multisampleStateParams,
                                                            colorBlendState, m_geometryType, m_backingMode,
                                                            m_useFragmentShadingRate);
}
...
TestInstance *SampleMaskWithConservativeTest::createInstance(Context &context) const
{
    return new SampleMaskWithConservativeInstance(
        context, m_rasterizationSamples, m_enableMinSampleShading, m_minSampleShading, m_enableSampleMask, m_sampleMask,
    ...
    , m_useFragmentShadingRate(useFragmentShadingRate)
{
    if (m_modeFlags != 0)
    {
        ...
        m_multisampleRenderer = de::MovePtr<MultisampleRenderer>(new MultisampleRenderer(
            context, m_colorFormat, depthStencilFormat, m_renderSize, useDepth, useStencil, 2u, pTopology, pVertices,
            multisampleStateParams, blendState, RENDER_TYPE_RESOLVE, backingMode, m_useFragmentShadingRate));
    }
    else
    {
        m_multisampleRenderer = de::MovePtr<MultisampleRenderer>(
            new MultisampleRenderer(context, m_colorFormat, m_renderSize, topology, vertices, multisampleStateParams,
...
MinSampleShadingInstance::MinSampleShadingInstance(Context &context, VkPrimitiveTopology topology, float pointSize,
                                                   const std::vector<Vertex4RGBA> &vertices,
                                                   const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                                   const VkPipelineColorBlendAttachmentState &colorBlendState,
                                                   ImageBackingMode backingMode, const bool useFragmentShadingRate)
...
tcu::TestStatus MinSampleShadingInstance::iterate(void)
{
    ...
    // Render and resolve without sample shading
    {
        ...
        MultisampleRenderer renderer(m_context, m_colorFormat, m_renderSize, m_primitiveTopology, m_vertices,
                                     multisampleStateParms, m_colorBlendState, RENDER_TYPE_RESOLVE, m_backingMode,
                                     m_useFragmentShadingRate);
    ...
    {
        MultisampleRenderer renderer(m_context, m_colorFormat, m_renderSize, m_primitiveTopology, m_vertices,
                                     m_multisampleStateParams, m_colorBlendState, RENDER_TYPE_COPY_SAMPLES,
                                     m_backingMode, m_useFragmentShadingRate);
        renderer.render();
...
SampleMaskInstance::SampleMaskInstance(Context &context, VkPrimitiveTopology topology, float pointSize,
                                       const std::vector<Vertex4RGBA> &vertices,
                                       const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                       const VkPipelineColorBlendAttachmentState &blendState,
                                       ImageBackingMode backingMode, const bool useFragmentShadingRate)
...
tcu::TestStatus SampleMaskInstance::iterate(void)
{
    ...
    // Render with all flags off
    {
        ...
        MultisampleRenderer renderer(m_context, m_colorFormat, m_renderSize, m_primitiveTopology, m_vertices,
                                     multisampleParams, m_colorBlendState, RENDER_TYPE_RESOLVE, m_backingMode,
                                     m_useFragmentShadingRate);
...
tcu::TestStatus testRasterSamplesConsistency(Context &context, MultisampleTestParams params)
{
    ...
    for (int samplesNdx = 1; samplesNdx < DE_LENGTH_OF_ARRAY(samples); samplesNdx++)
    {
        ...
        MultisampleRenderer renderer(context, VK_FORMAT_R8G8B8A8_UNORM, tcu::IVec2(32, 32),
                                     VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST, vertices, multisampleStateParams,
                                     getDefaultColorBlendAttachmentState(), RENDER_TYPE_RESOLVE, params.backingMode,
...
AlphaToOneInstance::AlphaToOneInstance(Context &context, VkPrimitiveTopology topology,
                                       const std::vector<Vertex4RGBA> &vertices,
                                       const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                       const VkPipelineColorBlendAttachmentState &blendState,
                                       ImageBackingMode backingMode, const bool useFragmentShadingRate)
...
AlphaToCoverageInstance::AlphaToCoverageInstance(Context &context, VkPrimitiveTopology topology,
                                                 const std::vector<Vertex4RGBA> &vertices,
                                                 const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                                 const VkPipelineColorBlendAttachmentState &blendState,
                                                 GeometryType geometryType, ImageBackingMode backingMode,
...
tcu::TestStatus AlphaToCoverageInstance::verifyImage(const tcu::ConstPixelBufferAccess &result)
{
    ...
    for (int y = 0; y < m_renderSize.y(); y++)
    {
        for (int x = 0; x < m_renderSize.x(); x++)
        {
            ...
            {
                std::ostringstream message;
                message << "Pixel is not below the threshold value (" << result.getPixel(x, y).x() << " > "
                        << maxColorValue << ")";
                return tcu::TestStatus::fail(message.str());
            }
        }
...
AlphaToCoverageNoColorAttachmentInstance::AlphaToCoverageNoColorAttachmentInstance(
    Context &context, VkPrimitiveTopology topology, const std::vector<Vertex4RGBA> &vertices,
    const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
...
tcu::TestStatus AlphaToCoverageNoColorAttachmentInstance::iterate(void)
{
    ...
    de::MovePtr<tcu::TextureLevel> result;
    MultisampleRenderer renderer(m_context, m_colorFormat, m_depthStencilFormat, m_renderSize, true, false, 1u,
                                 &m_primitiveTopology, &m_vertices, m_multisampleStateParams, m_colorBlendState,
                                 RENDER_TYPE_DEPTHSTENCIL_ONLY, m_backingMode, m_useFragmentShadingRate, 1.0f);
...
tcu::TestStatus AlphaToCoverageColorUnusedAttachmentInstance::iterate(void)
{
    ...
    de::MovePtr<tcu::TextureLevel> result;
    MultisampleRenderer renderer(m_context, m_colorFormat, m_renderSize, m_primitiveTopology, m_vertices,
                                 m_multisampleStateParams, m_colorBlendState, RENDER_TYPE_UNUSED_ATTACHMENT,
                                 m_backingMode, m_useFragmentShadingRate);
...
SampleMaskWithConservativeInstance::SampleMaskWithConservativeInstance(
    Context &context, const VkSampleCountFlagBits rasterizationSamples, const bool enableMinSampleShading,
    const float minSampleShading, const bool enableSampleMask, const VkSampleMask sampleMask,
...
tcu::TestStatus SampleMaskWithConservativeInstance::iterate(void)
{
...

    {
        MultisampleRenderer renderer(
            m_context, m_colorFormat, m_depthStencilFormat, m_renderSize, m_useDepth, m_useStencil, m_useConservative,
            m_useFragmentShadingRate, 1u, &m_topology, &m_vertices, m_multisampleStateParams, m_blendState,
            m_rasterizationConservativeStateCreateInfo, RENDER_TYPE_RESOLVE, m_imageBackingMode, m_depthClearValue);
        noSampleshadingImage = renderer.render();
    }

    {
        ...
        MultisampleRenderer mRenderer(m_context, m_colorFormat, m_renderSize, VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP,
                                      m_vertices, m_multisampleStateParams, colorBlendState, RENDER_TYPE_COPY_SAMPLES,
                                      IMAGE_BACKING_MODE_REGULAR, m_useFragmentShadingRate);
        mRenderer.render();
...
tcu::TestStatus SampleMaskWithDepthTestInstance::iterate(void)
{
    ...
    MultisampleRenderer renderer(m_context, m_colorFormat, m_depthStencilFormat, m_renderSize, m_useDepth, m_useStencil,
                                 1u, &m_topology, &m_vertices, m_multisampleStateParams, m_blendState, m_renderType,
                                 m_imageBackingMode, m_useFragmentShadingRate, m_depthClearValue);
    result = renderer.render();
...
MultisampleRenderer::MultisampleRenderer(Context &context, const VkFormat colorFormat, const tcu::IVec2 &renderSize,
                                         const VkPrimitiveTopology topology, const std::vector<Vertex4RGBA> &vertices,
                                         const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
                                         const VkPipelineColorBlendAttachmentState &blendState,
                                         const RenderType renderType, const ImageBackingMode backingMode,
...
MultisampleRenderer::MultisampleRenderer(
    Context &context, const VkFormat colorFormat, const VkFormat depthStencilFormat, const tcu::IVec2 &renderSize,
    const bool useDepth, const bool useStencil, const uint32_t numTopologies, const VkPrimitiveTopology *pTopology,
    const std::vector<Vertex4RGBA> *pVertices, const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
    const VkPipelineColorBlendAttachmentState &blendState, const RenderType renderType,
    const ImageBackingMode backingMode, const bool useFragmentShadingRate, const float depthClearValue)
    : m_context(context)
    , m_bindSemaphore(createSemaphore(context.getDeviceInterface(), context.getDevice()))
    , m_colorFormat(colorFormat)
...
MultisampleRenderer::MultisampleRenderer(
    Context &context, const VkFormat colorFormat, const VkFormat depthStencilFormat, const tcu::IVec2 &renderSize,
    const bool useDepth, const bool useStencil, const bool useConservative, const bool useFragmentShadingRate,
    const uint32_t numTopologies, const VkPrimitiveTopology *pTopology, const std::vector<Vertex4RGBA> *pVertices,
    const VkPipelineMultisampleStateCreateInfo &multisampleStateParams,
    const VkPipelineColorBlendAttachmentState &blendState,
    const VkPipelineRasterizationConservativeStateCreateInfoEXT &conservativeStateCreateInfo,
                                     ...
                                     const VkPrimitiveTopology *pTopology, const std::vector<Vertex4RGBA> *pVertices)
{
    ...
    if (m_renderType == RENDER_TYPE_COPY_SAMPLES)
    {
        m_copySampleVertexShaderModule =
            createShaderModule(vk, vkDevice, m_context.getBinaryCollection().get("quad_vert"), 0);
        m_copySampleFragmentShaderModule =
            createShaderModule(vk, vkDevice, m_context.getBinaryCollection().get("copy_sample_frag"), 0);
    }
        ...
        for (uint32_t subpassIdx = 0; subpassIdx < numSubpasses; subpassIdx++)
            for (uint32_t i = 0u; i < numTopologies; ++i)
            {
                ...
                const VkGraphicsPipelineCreateInfo pipelineCreateInfo{
                    ...
                    m_useFragmentShadingRate ? &shadingRateStateCreateInfo :
                                               DE_NULL, // const void*                                        pNext
                    0u,                                 // VkPipelineCreateFlags                            flags
                    (uint32_t)pipelineShaderStageParams
                        .size(),                   // uint32_t                                            stageCount
                    ...
                    *m_renderPass,             // VkRenderPass                                        renderPass
                    subpassIdx,                // uint32_t                                            subpass
                    DE_NULL,                   // VkPipeline                                        basePipelineHandle
                    0                          // int32_t basePipelineIndex;
                };

                m_graphicsPipelines.push_back(VkPipelineSp(
                    new Unique<VkPipeline>(createGraphicsPipeline(vk, vkDevice, DE_NULL, &pipelineCreateInfo))));
            }
    }
    ...
    if (m_renderType == RENDER_TYPE_COPY_SAMPLES)
    {
        // Create pipelines for copying samples to single sampled images
        {
            ...
            for (size_t i = 0; i < m_perSampleImages.size(); ++i)
            {
                ...
                m_copySamplePipelines.push_back(VkPipelineSp(new Unique<VkPipeline>(makeGraphicsPipeline(
                    ...
                    *m_renderPass,                     // const VkRenderPass                            renderPass
                    ...
                    1u + (uint32_t)i,                     // const uint32_t                                subpass
    ...
    // Create command buffer
    {
        ...
        beginRenderPass(vk, *m_cmdBuffer, *m_renderPass, *m_framebuffer,
                        makeRect2D(0, 0, m_renderSize.x(), m_renderSize.y()), (uint32_t)clearValues.size(),
                        &clearValues[0]);
...
public:
    ...
    VariableRateTestCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
...
VariableRateTestCase::VariableRateTestCase(tcu::TestContext &testCtx, const std::string &name,
...
tcu::TestStatus VariableRateTestInstance::iterate(void)
{
    ...
    renderPassCreateInfo.pSubpasses =
        ((m_params.nonEmptyFramebuffer && m_params.unusedAttachment) ? &unusedAttachmentSubpassDescription :
                                                                       &emptySubpassDescription);
    ...
    for (size_t i = 0; i < m_params.subpassCounts.size(); ++i)
    {
        ...
        const vk::VkGraphicsPipelineCreateInfo graphicsPipelineCreateInfo = {
            ...
            static_cast<uint32_t>(i),       // uint32_t subpass;
            DE_NULL,                        // VkPipeline basePipelineHandle;
            0,                              // int32_t basePipelineIndex;
        };
...
tcu::TestCaseGroup *createMultisampleTests(tcu::TestContext &testCtx, bool useFragmentShadingRate)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> multisampleTests(
        new tcu::TestCaseGroup(testCtx, groupName[useFragmentShadingRate], ""));

    // Rasterization samples tests
    {
        de::MovePtr<tcu::TestCaseGroup> rasterizationSamplesTests(
            new tcu::TestCaseGroup(testCtx, "raster_samples", ""));
        ...
        for (int samplesNdx = 0; samplesNdx < DE_LENGTH_OF_ARRAY(samples); samplesNdx++)
        {
            ...
            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "primitive_triangle", "", samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_TRIANGLE, 1.0f,
                IMAGE_BACKING_MODE_REGULAR, 0u, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "primitive_line", "", samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_LINE, 1.0f,
                IMAGE_BACKING_MODE_REGULAR, 0u, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "primitive_point_1px", "", samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_POINT, 1.0f,
                IMAGE_BACKING_MODE_REGULAR, 0u, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "primitive_point", "", samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_POINT, 3.0f,
                IMAGE_BACKING_MODE_REGULAR, 0u, useFragmentShadingRate));

            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "depth", "", samples[samplesNdx], GEOMETRY_TYPE_INVISIBLE_TRIANGLE, 1.0f,
                IMAGE_BACKING_MODE_REGULAR, TEST_MODE_DEPTH_BIT, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "stencil", "", samples[samplesNdx], GEOMETRY_TYPE_INVISIBLE_TRIANGLE, 1.0f,
                IMAGE_BACKING_MODE_REGULAR, TEST_MODE_STENCIL_BIT, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "depth_stencil", "", samples[samplesNdx], GEOMETRY_TYPE_INVISIBLE_TRIANGLE, 1.0f,
                IMAGE_BACKING_MODE_REGULAR, TEST_MODE_DEPTH_BIT | TEST_MODE_STENCIL_BIT, useFragmentShadingRate));

            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "primitive_triangle_sparse", "", samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_TRIANGLE, 1.0f,
                IMAGE_BACKING_MODE_SPARSE, 0u, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(testCtx, "primitive_line_sparse", "",
                                                                samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_LINE, 1.0f,
                                                                IMAGE_BACKING_MODE_SPARSE, 0u, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(testCtx, "primitive_point_1px_sparse", "",
                                                                samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_POINT, 1.0f,
                                                                IMAGE_BACKING_MODE_SPARSE, 0u, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(testCtx, "primitive_point_sparse", "",
                                                                samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_POINT, 3.0f,
                                                                IMAGE_BACKING_MODE_SPARSE, 0u, useFragmentShadingRate));

            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "depth_sparse", "", samples[samplesNdx], GEOMETRY_TYPE_INVISIBLE_TRIANGLE, 1.0f,
                IMAGE_BACKING_MODE_SPARSE, TEST_MODE_DEPTH_BIT, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "stencil_sparse", "", samples[samplesNdx], GEOMETRY_TYPE_INVISIBLE_TRIANGLE, 1.0f,
                IMAGE_BACKING_MODE_SPARSE, TEST_MODE_STENCIL_BIT, useFragmentShadingRate));
            samplesTests->addChild(new RasterizationSamplesTest(
                testCtx, "depth_stencil_sparse", "", samples[samplesNdx], GEOMETRY_TYPE_INVISIBLE_TRIANGLE, 1.0f,
                IMAGE_BACKING_MODE_SPARSE, TEST_MODE_DEPTH_BIT | TEST_MODE_STENCIL_BIT, useFragmentShadingRate));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> rasterSamplesConsistencyTests(
            new tcu::TestCaseGroup(testCtx, "raster_samples_consistency", ""));
        ...
        addFunctionCaseWithPrograms(rasterSamplesConsistencyTests.get(), "unique_colors_check_sparse", "",
    ...
    // minSampleShading tests
    {
        ...
        {
            de::MovePtr<tcu::TestCaseGroup> minSampleShadingTests(
                new tcu::TestCaseGroup(testCtx, "min_sample_shading", ""));

            for (int configNdx = 0; configNdx < DE_LENGTH_OF_ARRAY(testConfigs); configNdx++)
            {
                const TestConfig &testConfig = testConfigs[configNdx];
                de::MovePtr<tcu::TestCaseGroup> minShadingValueTests(
                    new tcu::TestCaseGroup(testCtx, testConfigs[configNdx].name, ""));
                ...
                for (int samplesNdx = 0; samplesNdx < DE_LENGTH_OF_ARRAY(samples); samplesNdx++)
                {
                    ...
                    de::MovePtr<tcu::TestCaseGroup> samplesTests(
                        new tcu::TestCaseGroup(testCtx, caseName.str().c_str(), ""));

                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "primitive_triangle", "", samples[samplesNdx], testConfig.minSampleShading,
                        GEOMETRY_TYPE_OPAQUE_TRIANGLE, 1.0f, IMAGE_BACKING_MODE_REGULAR, true, useFragmentShadingRate));
                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "primitive_line", "", samples[samplesNdx], testConfig.minSampleShading,
                        GEOMETRY_TYPE_OPAQUE_LINE, 1.0f, IMAGE_BACKING_MODE_REGULAR, true, useFragmentShadingRate));
                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "primitive_point_1px", "", samples[samplesNdx], testConfig.minSampleShading,
                        GEOMETRY_TYPE_OPAQUE_POINT, 1.0f, IMAGE_BACKING_MODE_REGULAR, true, useFragmentShadingRate));
                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "primitive_point", "", samples[samplesNdx], testConfig.minSampleShading,
                        GEOMETRY_TYPE_OPAQUE_POINT, 3.0f, IMAGE_BACKING_MODE_REGULAR, true, useFragmentShadingRate));

                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "primitive_triangle_sparse", "", samples[samplesNdx], testConfig.minSampleShading,
                        GEOMETRY_TYPE_OPAQUE_TRIANGLE, 1.0f, IMAGE_BACKING_MODE_SPARSE, true, useFragmentShadingRate));
                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "primitive_line_sparse", "", samples[samplesNdx], testConfig.minSampleShading,
                        GEOMETRY_TYPE_OPAQUE_LINE, 1.0f, IMAGE_BACKING_MODE_SPARSE, true, useFragmentShadingRate));
                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "primitive_point_1px_sparse", "", samples[samplesNdx], testConfig.minSampleShading,
                        GEOMETRY_TYPE_OPAQUE_POINT, 1.0f, IMAGE_BACKING_MODE_SPARSE, true, useFragmentShadingRate));
                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "primitive_point_sparse", "", samples[samplesNdx], testConfig.minSampleShading,
                        GEOMETRY_TYPE_OPAQUE_POINT, 3.0f, IMAGE_BACKING_MODE_SPARSE, true, useFragmentShadingRate));
        ...
        {
            de::MovePtr<tcu::TestCaseGroup> minSampleShadingTests(
                new tcu::TestCaseGroup(testCtx, "min_sample_shading_enabled", ""));
            ...
            for (int configNdx = 0; configNdx < DE_LENGTH_OF_ARRAY(testConfigs); configNdx++)
            {
                ...
                for (int samplesNdx = 0; samplesNdx < DE_LENGTH_OF_ARRAY(samples); samplesNdx++)
                {
                    ...
                    samplesTests->addChild(new MinSampleShadingTest(
                        testCtx, "quad", "", samples[samplesNdx], testConfig.minSampleShading,
        ...
        {
            de::MovePtr<tcu::TestCaseGroup> minSampleShadingTests(
                new tcu::TestCaseGroup(testCtx, "min_sample_shading_disabled", ""));
    ...
    // SampleMask tests
    {
        ...
        {
            const TestConfig &testConfig = testConfigs[configNdx];
            de::MovePtr<tcu::TestCaseGroup> sampleMaskValueTests(
                new tcu::TestCaseGroup(testCtx, testConfig.name, testConfig.description));
            ...
            for (int samplesNdx = 0; samplesNdx < DE_LENGTH_OF_ARRAY(samples); samplesNdx++)
            {
                ...
                samplesTests->addChild(new SampleMaskTest(testCtx, "primitive_triangle", "", samples[samplesNdx], mask,
                                                          GEOMETRY_TYPE_OPAQUE_TRIANGLE, 1.0f,
                                                          IMAGE_BACKING_MODE_REGULAR, useFragmentShadingRate));
                samplesTests->addChild(new SampleMaskTest(testCtx, "primitive_line", "", samples[samplesNdx], mask,
                                                          GEOMETRY_TYPE_OPAQUE_LINE, 1.0f, IMAGE_BACKING_MODE_REGULAR,
                                                          useFragmentShadingRate));
                samplesTests->addChild(new SampleMaskTest(testCtx, "primitive_point_1px", "", samples[samplesNdx], mask,
                                                          GEOMETRY_TYPE_OPAQUE_POINT, 1.0f, IMAGE_BACKING_MODE_REGULAR,
                                                          useFragmentShadingRate));
                samplesTests->addChild(new SampleMaskTest(testCtx, "primitive_point", "", samples[samplesNdx], mask,
                                                          GEOMETRY_TYPE_OPAQUE_POINT, 3.0f, IMAGE_BACKING_MODE_REGULAR,
                                                          useFragmentShadingRate));

                samplesTests->addChild(new SampleMaskTest(testCtx, "primitive_triangle_sparse", "", samples[samplesNdx],
                                                          mask, GEOMETRY_TYPE_OPAQUE_TRIANGLE, 1.0f,
                ...
                samplesTests->addChild(new SampleMaskTest(testCtx, "primitive_line_sparse", "", samples[samplesNdx],
                                                          mask, GEOMETRY_TYPE_OPAQUE_LINE, 1.0f,
                                                          IMAGE_BACKING_MODE_SPARSE, useFragmentShadingRate));
                samplesTests->addChild(new SampleMaskTest(testCtx, "primitive_point_1px_sparse", "",
                                                          samples[samplesNdx], mask, GEOMETRY_TYPE_OPAQUE_POINT, 1.0f,
                                                          IMAGE_BACKING_MODE_SPARSE, useFragmentShadingRate));
                samplesTests->addChild(new SampleMaskTest(testCtx, "primitive_point_sparse", "", samples[samplesNdx],
                                                          mask, GEOMETRY_TYPE_OPAQUE_POINT, 3.0f,
                                                          IMAGE_BACKING_MODE_SPARSE, useFragmentShadingRate));
    ...
    // AlphaToCoverageEnable tests
    {
        ...
        for (int samplesNdx = 0; samplesNdx < DE_LENGTH_OF_ARRAY(samples); samplesNdx++)
        {
            ...
            samplesTests->addChild(new AlphaToCoverageTest(testCtx, "alpha_opaque", "", samples[samplesNdx],
                                                           GEOMETRY_TYPE_OPAQUE_QUAD, IMAGE_BACKING_MODE_REGULAR,
                                                           useFragmentShadingRate));
            samplesTests->addChild(new AlphaToCoverageTest(testCtx, "alpha_translucent", "", samples[samplesNdx],
                                                           GEOMETRY_TYPE_TRANSLUCENT_QUAD, IMAGE_BACKING_MODE_REGULAR,
                                                           useFragmentShadingRate));
            samplesTests->addChild(new AlphaToCoverageTest(testCtx, "alpha_invisible", "", samples[samplesNdx],
                                                           GEOMETRY_TYPE_INVISIBLE_QUAD, IMAGE_BACKING_MODE_REGULAR,
                                                           useFragmentShadingRate));

            samplesTests->addChild(new AlphaToCoverageTest(testCtx, "alpha_opaque_sparse", "", samples[samplesNdx],
            ...
            samplesTests->addChild(new AlphaToCoverageTest(testCtx, "alpha_translucent_sparse", "", samples[samplesNdx],
                                                           GEOMETRY_TYPE_TRANSLUCENT_QUAD, IMAGE_BACKING_MODE_SPARSE,
                                                           useFragmentShadingRate));
            samplesTests->addChild(new AlphaToCoverageTest(testCtx, "alpha_invisible_sparse", "", samples[samplesNdx],
                                                           GEOMETRY_TYPE_INVISIBLE_QUAD, IMAGE_BACKING_MODE_SPARSE,
                                                           useFragmentShadingRate));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> alphaToCoverageNoColorAttachmentTests(
        ...
        for (int samplesNdx = 0; samplesNdx < DE_LENGTH_OF_ARRAY(samples); samplesNdx++)
        {
            ...
            samplesTests->addChild(new AlphaToCoverageNoColorAttachmentTest(
                testCtx, "alpha_opaque", "", samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_QUAD, IMAGE_BACKING_MODE_REGULAR,
                useFragmentShadingRate));
            samplesTests->addChild(new AlphaToCoverageNoColorAttachmentTest(
                testCtx, "alpha_opaque_sparse", "", samples[samplesNdx], GEOMETRY_TYPE_OPAQUE_QUAD,
                IMAGE_BACKING_MODE_SPARSE, useFragmentShadingRate));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> alphaToCoverageColorUnusedAttachmentTests(
        ...
        for (int samplesNdx = 0; samplesNdx < DE_LENGTH_OF_ARRAY(samples); samplesNdx++)
        {
            ...
            samplesTests->addChild(new AlphaToCoverageColorUnusedAttachmentTest(
                ...
                IMAGE_BACKING_MODE_SPARSE, useFragmentShadingRate));
            samplesTests->addChild(new AlphaToCoverageColorUnusedAttachmentTest(
                testCtx, "alpha_invisible", "", samples[samplesNdx], GEOMETRY_TYPE_INVISIBLE_QUAD,
                IMAGE_BACKING_MODE_REGULAR, useFragmentShadingRate));
            samplesTests->addChild(new AlphaToCoverageColorUnusedAttachmentTest(
                testCtx, "alpha_invisible_sparse", "", samples[samplesNdx], GEOMETRY_TYPE_INVISIBLE_QUAD,
                IMAGE_BACKING_MODE_SPARSE, useFragmentShadingRate));
    ...
    // Sample mask with and without vk_ext_post_depth_coverage
    {
        ...
        de::MovePtr<tcu::TestCaseGroup> sampleMaskWithDepthTestGroup(
            new tcu::TestCaseGroup(testCtx, "sample_mask_with_depth_test", ""));
        ...
        for (int ndx = 0; ndx < DE_LENGTH_OF_ARRAY(standardSamplesSet); ++ndx)
        {
            ...
            sampleMaskWithDepthTestGroup->addChild(new SampleMaskWithDepthTestTest(
                testCtx, caseName.str(), "", standardSamplesSet[ndx], false, useFragmentShadingRate));

            caseName << "_post_depth_coverage";
            sampleMaskWithDepthTestGroup->addChild(new SampleMaskWithDepthTestTest(
                testCtx, caseName.str(), "", standardSamplesSet[ndx], true, useFragmentShadingRate));
        }
...

    {
        ...
        de::MovePtr<tcu::TestCaseGroup> conservativeGroup(
            new tcu::TestCaseGroup(testCtx, "conservative_with_full_coverage", ""));
            ...
            for (int samplesNdx = 0; samplesNdx < DE_LENGTH_OF_ARRAY(standardSamplesSet); ++samplesNdx)
            {
                ...
                for (int configNdx = 0; configNdx < DE_LENGTH_OF_ARRAY(testConfigs); configNdx++)
                {
                    ...
                    modesGroup->addChild(new SampleMaskWithConservativeTest(
                        testCtx, caseName + testConfig.name, testConfig.description, standardSamplesSet[samplesNdx],
...

    {
        ...
        {
            de::MovePtr<tcu::TestCaseGroup> variableRateGroup(
                new tcu::TestCaseGroup(testCtx, "variable_rate", "Tests for multisample variable rate in subpasses"));
        ...
        {
            de::MovePtr<tcu::TestCaseGroup> mixedCountGroup(new tcu::TestCaseGroup(
                testCtx, "mixed_count", "Tests for mixed sample count in empty subpass and framebuffer"));
            ...
            for (const auto &comb : combs)
            {
                ...
                for (const auto flag : unusedAttachmentFlag)
                {
                    ...
                    const std::string desc = "Framebuffer with " + fbCountStr + " samples, subpass with " +
                                             emptyCountStr + " samples and " + descSuffix;

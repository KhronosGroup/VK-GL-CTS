...
tcu::TestStatus ZExportIterate(Context &context, const ZExportParams params)
{
    ...
    pipelineWrapper.setDefaultRasterizationState()
        ...
        .setupFragmentShaderState(*pipelineLayout, *renderPass, 0u, *fragShader, &dsStateInfo,
                                  &multisampleStateCreateInfo)
    ...
    beginRenderPass(ctx.vkd, cmdBuffer, renderPass.get(), framebuffer.get(), scissors.at(0u), de::sizeU32(clearValues),
                                           ...
                                           bool useFragmentShadingRate)
{
...
#ifndef CTS_USES_VULKANSC
    {
        TestCaseGroupPtr rasterSamplesConsistencyTests(
    ...
    // SampleMask tests
    {
        ...
        {
            const TestConfig &testConfig = testConfigs[configNdx];
            TestCaseGroupPtr sampleMaskValueTests(
    ...
    // Sample mask with and without vk_ext_post_depth_coverage
    {
        ...
        TestCaseGroupPtr sampleMaskWithDepthTestGroup(
...

    {
        ...
        {
            TestCaseGroupPtr variableRateGroup(
        ...
        {
            TestCaseGroupPtr mixedCountGroup(new tcu::TestCaseGroup(
        ...
        {
            TestCaseGroupPtr zExportGroup(new tcu::TestCaseGroup(
                testCtx, "z_export",

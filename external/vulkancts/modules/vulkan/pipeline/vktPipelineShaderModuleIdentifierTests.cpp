        ...
        for (uint32_t i = 0; i < pipelineCount32; ++i)
        {
            ...
            wrapper.setDefaultPatchControlPoints(patchCPs)
                ...
                .setupPreRasterizationShaderState2(
                    ...
                    geomSpecInfo.get(), nullptr, PipelineRenderingCreateInfoWrapper(), pipelineCache.get())
        ...
        for (const auto &tescModule : tescModules)
        {
            ...
            try
            {
                wrapper->setDefaultPatchControlPoints(patchCPs)
                    .setupVertexInputState(&vertexInputState, &inputAssemblyState, pipelineCache.get())
                    .setupPreRasterizationShaderState2(
                        rpViewports, rpScissors, pipelineLayout.get(), renderPass.get(), 0u, vertModule.get(),
                        &rasterizationState, tescModule.get(), teseModule.get(), DE_NULL, nullptr, nullptr, nullptr,
        ...
        try
        {
            wrapper->setDefaultPatchControlPoints(patchCPs)
                ...
                .setupPreRasterizationShaderState3(
                    ...
                    PipelineShaderStageModuleIdentifierCreateInfoWrapper(), nullptr, nullptr, nullptr, nullptr, nullptr,

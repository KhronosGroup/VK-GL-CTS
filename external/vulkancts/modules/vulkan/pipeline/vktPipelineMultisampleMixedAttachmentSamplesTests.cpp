...
void preparePipelineWrapper(
    ...
    const VkShaderModule vertexModule, const VkShaderModule fragmentModule, const bool useVertexInput,
                                                                 ...
                                                                 bool useFragmentShadingRate)
{
    return createTestGroup(testCtx, "mixed_attachment_samples",
                           ...
                           createMixedAttachmentSamplesTestsInGroup, pipelineConstructionType, useFragmentShadingRate);
}

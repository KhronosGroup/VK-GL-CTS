...
{
public:
    SlicedViewTestCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
...
{
    TestCaseGroupPtr imageTests(
        new tcu::TestCaseGroup(testCtx, "sliced_view_of_3d_image", "Sliced view of 3D image tests"));
    ...
    // Mip level test cases.
    {
        ...
        TestCaseGroupPtr mipLevelTests(
            new tcu::TestCaseGroup(testCtx, "mip_level", "3D slice test cases using mip levels"));

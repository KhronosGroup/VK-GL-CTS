...
tcu::TestStatus ComputeTestInstance::iterate(void)
{
    ...
    const Unique<VkPipeline> pipeline(makeComputePipeline(vk, device, *pipelineLayout, (VkPipelineCreateFlags)0u,
                                                          *shaderModule, (VkPipelineShaderStageCreateFlags)0u,
                                                          pSpecInfo));
...
tcu::TestStatus GraphicsTestInstance::iterate(void)
{
    ...
    graphicsPipeline.setDefaultRasterizationState()
        ...
        .setupFragmentShaderState(*pipelineLayout, *renderPass, 0u, *fragShaderModule, DE_NULL, DE_NULL, DE_NULL,
                                  pSpecInfo)

...
public:
    SamplerTest(tcu::TestContext &testContext, const char *name, const char *description,
                ...
                int imageSize, float samplerLod, bool separateStencilUsage, bool sampleStencil);
...
SamplerAddressModesTest::SamplerAddressModesTest(
    tcu::TestContext &testContext, const char *name, const char *description,
    PipelineConstructionType pipelineConstructionType, SamplerViewType imageViewType, VkFormat imageFormat,
    VkSamplerAddressMode addressU, VkSamplerAddressMode addressV, VkSamplerAddressMode addressW,
    VkBorderColor borderColor, rr::GenericVec4 customBorderColorValue, bool customBorderColorFormatless,
    bool separateStencilUsage, bool sampleStencil)
    : SamplerTest(testContext, name, description, pipelineConstructionType, imageViewType, imageFormat, 8, 0.0f,

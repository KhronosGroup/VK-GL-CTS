...
tcu::TestStatus testWithSizeReduction(Context &context, const CaseDef &caseDef)
{
    ...
    // For each image layer or slice (3D), create an attachment and a pipeline
    {
        ...
        for (int subpassNdx = 0; subpassNdx < numSlices; ++subpassNdx)
        {
            ...
            pipelines.emplace_back(vk, device, caseDef.pipelineConstructionType,
                                             ...
                                             PipelineConstructionType pipelineConstructionType)
{
    ...
    renderToImageTests->addChild(createTestGroup(testCtx, "core", "Core render to image tests",
                                                 addCoreRenderToImageTests, pipelineConstructionType));

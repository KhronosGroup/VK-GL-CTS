...
vk::Move<vk::VkRenderPass> makeTestRenderPass(const vk::DeviceInterface &vk, const vk::VkDevice device,
...
vk::Move<vk::VkFramebuffer> makeTestFramebuffer(const vk::DeviceInterface &vk, const vk::VkDevice device,
                                                const vk::Move<vk::VkRenderPass> &renderPass,
...
{
public:
    PipelineCacheTestCase(tcu::TestContext &context, const char *name, const char *description,
                                                       ...
                                                       vk::PipelineConstructionType pipelineConstructionType)
{
    de::MovePtr<tcu::TestCaseGroup> testGroup(
        new tcu::TestCaseGroup(testCtx, "pipeline_cache", "Test pipeline cache with different robustness enabled"));

...
void AddSingleTestCaseStatic(const std::string &name, const std::string &description, const std::vector<bool> mask,
                             bool inverse, tcu::TestCaseGroup *orderingGroup, tcu::TestContext &testCtx)
{
...
tcu::TestCaseGroup *createColorWriteEnableTests(tcu::TestContext &testCtx)
{
    ...
    for (int orderingIdx = 0; orderingIdx < DE_LENGTH_OF_ARRAY(kOrderingCases); ++orderingIdx)
    {
        ...
        AddSingleTestCaseDynamic("enable_all", "Dynamically enable writes to all color attachments", mask_all, false,
                                 orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("enable_first", "Dynamically enable writes to the first color attachment", mask_first,
        ...
        AddSingleTestCaseDynamic("enable_second", "Dynamically enable writes to the second color attachment",
                                 mask_second, false, orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("enable_last", "Dynamically enable writes to the last color attachment", mask_last,
                                 false, orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("enable_first_and_second",
                                 "Dynamically enable writes to the first two color attachments", mask_first_and_second,
                                 false, orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("enable_second_and_last",
                                 "Dynamically enable writes to the second and last color attachments",
                                 mask_second_and_last, false, orderingGroup.get(), testCtx, kOrdering);

        AddSingleTestCaseDynamic("disable_all", "Dynamically disable writes to all color attachments", mask_all, true,
                                 orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("disable_first", "Dynamically disable writes to the first color attachment",
                                 mask_first, true, orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("disable_second", "Dynamically disable writes to the second color attachment",
                                 mask_second, true, orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("disable_last", "Dynamically disable writes to the last color attachment", mask_last,
                                 true, orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("disable_first_and_second",
                                 "Dynamically disable writes to the first two color attachments", mask_first_and_second,
                                 true, orderingGroup.get(), testCtx, kOrdering);
        AddSingleTestCaseDynamic("disable_second_and_last",
                                 "Dynamically disable writes to the second and last color attachments",
                                 mask_second_and_last, true, orderingGroup.get(), testCtx, kOrdering);
    ...
    AddSingleTestCaseStatic("enable_all", "Statically enable writes to all color attachments", mask_all, false,
                            staticOrderingGroup.get(), testCtx);
    AddSingleTestCaseStatic("enable_first", "Statically enable writes to the first color attachment", mask_first, false,
                            staticOrderingGroup.get(), testCtx);
    ...
    AddSingleTestCaseStatic("enable_last", "Statically enable writes to the last color attachment", mask_last, false,
                            staticOrderingGroup.get(), testCtx);
    AddSingleTestCaseStatic("enable_first_and_second", "Statically enable writes to the first two color attachments",
                            mask_first_and_second, false, staticOrderingGroup.get(), testCtx);
    AddSingleTestCaseStatic("enable_second_and_last",
                            "Statically enable writes to the second and last color attachments", mask_second_and_last,
                            false, staticOrderingGroup.get(), testCtx);

    AddSingleTestCaseStatic("disable_all", "Statically disable writes to all color attachments", mask_all, true,
                            staticOrderingGroup.get(), testCtx);
    ...
    AddSingleTestCaseStatic("disable_second", "Statically disable writes to the second color attachment", mask_second,
                            true, staticOrderingGroup.get(), testCtx);
    AddSingleTestCaseStatic("disable_last", "Statically disable writes to the last color attachment", mask_last, true,
                            staticOrderingGroup.get(), testCtx);
    AddSingleTestCaseStatic("disable_first_and_second", "Statically disable writes to the first two color attachments",
                            mask_first_and_second, true, staticOrderingGroup.get(), testCtx);
    AddSingleTestCaseStatic("disable_second_and_last",
                            "Statically disable writes to the second and last color attachments", mask_second_and_last,
                            true, staticOrderingGroup.get(), testCtx);

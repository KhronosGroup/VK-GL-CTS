...
public:
    ...
    tcu::TestStatus verifyAttachment(const uint32_t attachmentIndex, const uint32_t attachmentCount,
...
tcu::TestStatus ColorWriteEnable2Instance::verifyAttachment(const uint32_t attachmentIndex,

...
#define ADD_SUBRESOURCE_RANGE_TESTS(TEST_CASES)                                                                        \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            ...
            rangeTests->addChild(new ImageViewTest(testCtx, config.name, desc.str().c_str(), pipelineConstructionType, \
                                                   viewType, imageFormat, config.samplerLod, componentMapping,         \
                                                   config.subresourceRange));                                          \
        }                                                                                                              \
    } while (false)

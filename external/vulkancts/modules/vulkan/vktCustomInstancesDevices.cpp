...
bool VideoDevice::isVideoEncodeOperation(const VideoCodecOperationFlags videoCodecOperationFlags)
{
    ...
    const vk::VkVideoCodecOperationFlagsKHR encodeOperations =
        vk::VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_EXT | vk::VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_EXT;
...
const uint32_t &VideoDevice::getQueueFamilyIndexTransfer(void)
{
#ifndef CTS_USES_VULKANSC
...
const uint32_t &VideoDevice::getQueueFamilyIndexDecode(void)
{
#ifndef CTS_USES_VULKANSC
...
const uint32_t &VideoDevice::getQueueFamilyIndexEncode(void)
{
#ifndef CTS_USES_VULKANSC
...
const uint32_t &VideoDevice::getQueueFamilyVideo(void)
{
#ifndef CTS_USES_VULKANSC

...
void checkProtectedContextSupport(Context &context, bool useYCbCr = false, bool useProtectedAccess = false);
...
de::MovePtr<vk::BufferWithMemory> makeBuffer(ProtectedContext &context, ProtectionMode protectionMode,
                                             const uint32_t queueFamilyIdx, uint32_t size, vk::VkBufferUsageFlags flags,

                                                         ...
                                                         CmdBufferType cmdBufferType)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> staticTests(
        new tcu::TestCaseGroup(testCtx, "static", (desc + " with static input").c_str()));
    ...
    de::MovePtr<tcu::TestCaseGroup> randomTests(
        new tcu::TestCaseGroup(testCtx, "random", (desc + " with random input").c_str()));
    ...
    for (int ndx = 0; ndx < testCount; ++ndx)
    {
        ...
        randomTests->addChild(new FillUpdateCopyBufferTestCase<tcu::Vec4>(testCtx, name.c_str(), fillValue.uint, data,
                                                                          cmdType, cmdBufferType));
    }

    const std::string groupName = getCmdBufferTypeStr(cmdBufferType);
    de::MovePtr<tcu::TestCaseGroup> primaryGroup(new tcu::TestCaseGroup(
        testCtx, groupName.c_str(), (desc + " using " + groupName.c_str() + " command buffer").c_str()));
                                                           ...
                                                           CmdBufferType cmdBufferType)
{
    ...
    for (int ndx = 0; ndx < testCount; ++ndx)
    {
        ...
        randomTests->addChild(new FillUpdateCopyBufferTestCase<tcu::IVec4>(testCtx, name.c_str(), fillValue.uint, data,
                                                                           cmdType, cmdBufferType));
    }
                                                            ...
                                                            CmdBufferType cmdBufferType)
{
    ...
    for (int ndx = 0; ndx < testCount; ++ndx)
    {
        ...
        randomTests->addChild(new FillUpdateCopyBufferTestCase<tcu::UVec4>(testCtx, name.c_str(), fillValue, data,
                                                                           cmdType, cmdBufferType));
    }

    const std::string groupName = getCmdBufferTypeStr(cmdBufferType);
    de::MovePtr<tcu::TestCaseGroup> testGroup(new tcu::TestCaseGroup(
        testCtx, groupName.c_str(), (desc + " using " + groupName.c_str() + " command buffer").c_str()));

...
tcu::TestCaseGroup *createAttachmentLoadTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> loadStaticTests(
        new tcu::TestCaseGroup(testCtx, "static", "Attachment Load Op Tests with static input"));
    ...
    de::MovePtr<tcu::TestCaseGroup> loadRandomTests(
        new tcu::TestCaseGroup(testCtx, "random", "Attachment Load Op Tests with random input"));

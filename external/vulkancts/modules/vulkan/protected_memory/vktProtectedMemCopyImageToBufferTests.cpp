...
tcu::TestCaseGroup *createCopyImageToFloatBufferTests(tcu::TestContext &testCtx, CmdBufferType cmdBufferType)
{
    ...
    for (int ndx = 0; ndx < DE_LENGTH_OF_ARRAY(testData); ++ndx)
    {
        ...
        copyStaticTests->addChild(
            new CopyImageToBufferTestCase<tcu::Vec4>(testCtx, name.c_str(), testData[ndx].fillValue, testData[ndx].data,
                                                     cmdBufferType, vk::VK_FORMAT_R32G32B32A32_SFLOAT));
    }

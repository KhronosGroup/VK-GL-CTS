    ...
    for (size_t formatNdx = 0; formatNdx < DE_LENGTH_OF_ARRAY(testFormats); formatNdx++)
    {
        ...
        for (size_t shaderNdx = 0; shaderNdx < DE_LENGTH_OF_ARRAY(shaderTypes); shaderNdx++)
        {
            ...
            de::MovePtr<tcu::TestCaseGroup> shaderGroup(
                new tcu::TestCaseGroup(testCtx, shaderTypeName, "YCbCr conversion tests"));
            ...
            for (size_t modelNdx = 0; modelNdx < DE_LENGTH_OF_ARRAY(colorModels); modelNdx++)
            {
                ...
                de::MovePtr<tcu::TestCaseGroup> colorModelGroup(
                    new tcu::TestCaseGroup(testCtx, colorModelName, "YCbCr conversion tests"));
                ...
                for (size_t rangeNdx = 0; rangeNdx < DE_LENGTH_OF_ARRAY(colorRanges); rangeNdx++)
                {
                    ...
                    de::MovePtr<tcu::TestCaseGroup> colorRangeGroup(new tcu::TestCaseGroup(
                        testCtx, colorRangeName, ("Tests for color range " + std::string(colorRangeName)).c_str()));

...
{
    de::MovePtr<tcu::TestCaseGroup> protectedTests(
        new tcu::TestCaseGroup(testCtx, "protected_memory", "Protected Memory Tests"));

    // Attachment test case group
    {
        de::MovePtr<tcu::TestCaseGroup> attachmentTestGroup(
            new tcu::TestCaseGroup(testCtx, "attachment", "Protected Memory Attachment Tests"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> imageTestGroup(
            new tcu::TestCaseGroup(testCtx, "image", "Protected Memory Image Tests"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> bufferTestGroup(
            new tcu::TestCaseGroup(testCtx, "buffer", "Protected Memory Buffer Tests"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> interactionTestGroup(
            new tcu::TestCaseGroup(testCtx, "interaction", "Various tests which interacts with other extensions"));

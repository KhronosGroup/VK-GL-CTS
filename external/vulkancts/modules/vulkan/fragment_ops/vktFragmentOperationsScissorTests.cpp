    ...
    // Points
    {
        ...
        const TestSpec cases[] = {
            ...
            {"partially_inside",
             ...
             {areaFull, areaCropped, TEST_PRIMITIVE_POINTS}},
            {"outside", "Points fully outside the scissor area", {areaLeftHalf, areaRightHalf, TEST_PRIMITIVE_POINTS}},
        };

        for (int i = 0; i < DE_LENGTH_OF_ARRAY(cases); ++i)
            addFunctionCaseWithPrograms(primitiveGroup.get(), cases[i].name, cases[i].description, initPrograms, test,
                                        cases[i].caseDef);
    ...
    // Lines
    {
        ...
        const TestSpec cases[] = {
            ...
            {"partially_inside",
             ...
             {areaFull, areaCropped, TEST_PRIMITIVE_LINES}},
    ...
    // Triangles
    {
        ...
        const TestSpec cases[] = {
            ...
            {"partially_inside",
             ...
             {areaFull, areaCropped, TEST_PRIMITIVE_TRIANGLES}},
            {"outside",
             "Triangles fully outside the scissor area",
             {areaLeftHalf, areaRightHalf, TEST_PRIMITIVE_TRIANGLES}},
            {"crossing",
             "A triangle crossing the scissor area",
             {areaFull, areaCroppedMore, TEST_PRIMITIVE_BIG_TRIANGLE}},
        };

...
de::MovePtr<vk::DebugReportRecorder> createDebugReportRecorder(const vk::PlatformInterface &vkp,
                                                               ...
                                                               vk::VkInstance instance, bool printValidationErrors)
{
    if (isDebugReportSupported(vkp))
...
DefaultDevice::DefaultDevice(const PlatformInterface &vkPlatform, const tcu::CommandLine &cmdLine)
    ...
    , m_debugReportRecorder(
          cmdLine.isValidationEnabled() ?
              createDebugReportRecorder(vkPlatform, m_instanceInterface, *m_instance, cmdLine.printValidationErrors()) :

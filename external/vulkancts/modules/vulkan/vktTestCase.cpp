...
#include "vkDeviceFeaturesForDefaultDeviceDefs.inl"
    ...
    {
        return m_devicePropertiesFull.isDevicePropertyInitialized(sType);
    }
    ...
    {
        return m_devicePropertiesFull.getCoreProperties2();
    }
...
static uint32_t sanitizeApiVersion(uint32_t v)
{
...
DefaultDevice::DefaultDevice(const PlatformInterface &vkPlatform, const tcu::CommandLine &cmdLine)
    ...
    , m_devicePropertiesFull(m_instanceInterface, m_usedApiVersion, m_physicalDevice, m_instanceExtensions,
                             m_deviceExtensions)
...
void collectAndReportDebugMessages(vk::DebugReportRecorder &debugReportRecorder, Context &context)
{
    ...
    static const vk::VkDebugReportFlagsEXT logFlags =
        errorFlags | vk::VK_DEBUG_REPORT_WARNING_BIT_EXT | vk::VK_DEBUG_REPORT_PERFORMANCE_WARNING_BIT_EXT;

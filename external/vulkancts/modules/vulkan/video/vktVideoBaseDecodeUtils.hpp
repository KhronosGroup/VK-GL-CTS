...
public:
    ...
    FrameProcessor(DeviceContext *devctx, const char *clipName, VkVideoCodecOperationFlagBitsKHR codecOperation,
                   const VkExtensionProperties *extensionProperties, VideoBaseDecoder *decoder, tcu::TestLog &log)
        : m_devctx(devctx)
    ...
    FrameProcessor(DeviceContext *devctx, ese_read_buffer_func func, void *data,
                   VkVideoCodecOperationFlagBitsKHR codecOperation, const VkExtensionProperties *extensionProperties,
                   VideoBaseDecoder *decoder, tcu::TestLog &log)
        : m_devctx(devctx)

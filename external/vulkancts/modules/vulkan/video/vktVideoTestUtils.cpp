                              ...
                              VkVideoCapabilitiesKHR *pVideoCapabilities)
{
    ...
    if (videoLoggingEnabled())
    {
        ...
        {
            std::cout << "\t\t\t"
                      << "maxLevelIdc: " << pH264Capabilities->maxLevelIdc << std::endl;
            std::cout << "\t\t\t"
                      << "fieldOffsetGranularity: " << pH264Capabilities->fieldOffsetGranularity.x << " x "
                      << pH264Capabilities->fieldOffsetGranularity.y << std::endl;
            ;
        ...
        {
            std::cout << "\t\t\t"
                      << "maxLevelIdc: " << pH265Capabilities->maxLevelIdc << std::endl;
            if (strncmp(pVideoCapabilities->stdHeaderVersion.extensionName,

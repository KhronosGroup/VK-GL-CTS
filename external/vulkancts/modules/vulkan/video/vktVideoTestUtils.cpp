...
VideoBaseTestInstance::VideoBaseTestInstance(Context &context) : TestInstance(context), m_videoDevice(context)
{
}
...
const uint32_t &VideoBaseTestInstance::getQueueFamilyIndexTransfer(void)
{
    return m_videoDevice.getQueueFamilyIndexTransfer();
}

const uint32_t &VideoBaseTestInstance::getQueueFamilyIndexDecode(void)
{
    return m_videoDevice.getQueueFamilyIndexDecode();
}

const uint32_t &VideoBaseTestInstance::getQueueFamilyIndexEncode(void)
{
...
de::MovePtr<vector<uint8_t>> VideoBaseTestInstance::loadVideoDataClipA(void)
{
    return loadVideoData("vulkan/video/clip-a.h264");
}

de::MovePtr<vector<uint8_t>> VideoBaseTestInstance::loadVideoDataClipB(void)
{
    return loadVideoData("vulkan/video/clip-b.h264");
}

de::MovePtr<vector<uint8_t>> VideoBaseTestInstance::loadVideoDataClipC(void)
{
    return loadVideoData("vulkan/video/clip-c.h264");
}

de::MovePtr<vector<uint8_t>> VideoBaseTestInstance::loadVideoDataClipD(void)
{
    return loadVideoData("vulkan/video/clip-d.h265");
}

de::MovePtr<vector<uint8_t>> VideoBaseTestInstance::loadVideoDataClipH264G13(void)
{
    return loadVideoData("vulkan/video/jellyfish-250-mbps-4k-uhd-GOB-IPB13.h264");
}

de::MovePtr<vector<uint8_t>> VideoBaseTestInstance::loadVideoDataClipH265G13(void)
{
...
de::MovePtr<VkVideoEncodeH264CapabilitiesEXT> getVideoCapabilitiesExtensionH264E(void)
{
    const VkVideoEncodeH264CapabilitiesEXT videoCapabilitiesExtension = {
        ...
        false, //  VkBool32 motionVectorsOverPicBoundariesFlag;
    ...
    return de::MovePtr<VkVideoEncodeH264CapabilitiesEXT>(
        new VkVideoEncodeH264CapabilitiesEXT(videoCapabilitiesExtension));
}
...
de::MovePtr<VkVideoEncodeH265CapabilitiesEXT> getVideoCapabilitiesExtensionH265E(void)
{
    ...
    return de::MovePtr<VkVideoEncodeH265CapabilitiesEXT>(
        new VkVideoEncodeH265CapabilitiesEXT(videoCapabilitiesExtension));
}
    ...
    StdVideoH264ProfileIdc stdProfileIdc, VkVideoDecodeH264PictureLayoutFlagBitsKHR pictureLayout)
{
    VkVideoDecodeH264ProfileInfoKHR *videoCodecOperation =
        new VkVideoDecodeH264ProfileInfoKHR(getProfileOperationH264D(stdProfileIdc, pictureLayout));
...
{
    VkVideoEncodeH264ProfileInfoEXT *videoCodecOperation =
        new VkVideoEncodeH264ProfileInfoEXT(getProfileOperationH264E(stdProfileIdc));
    de::MovePtr<VkVideoEncodeH264ProfileInfoEXT> result =
        de::MovePtr<VkVideoEncodeH264ProfileInfoEXT>(videoCodecOperation);
...
de::MovePtr<VkVideoDecodeH265ProfileInfoKHR> getVideoProfileExtensionH265D(StdVideoH265ProfileIdc stdProfileIdc)
{
    VkVideoDecodeH265ProfileInfoKHR *videoCodecOperation =
        new VkVideoDecodeH265ProfileInfoKHR(getProfileOperationH265D(stdProfileIdc));
...
{
    VkVideoEncodeH265ProfileInfoEXT *videoCodecOperation =
        new VkVideoEncodeH265ProfileInfoEXT(getProfileOperationH265E(stdProfileIdc));
    de::MovePtr<VkVideoEncodeH265ProfileInfoEXT> result =
        de::MovePtr<VkVideoEncodeH265ProfileInfoEXT>(videoCodecOperation);
...
de::MovePtr<VkVideoSessionCreateInfoKHR> getVideoSessionCreateInfo(
    uint32_t queueFamilyIndex, const VkVideoProfileInfoKHR *videoProfile, const VkExtent2D &codedExtent,
    VkFormat pictureFormat, VkFormat referencePicturesFormat, uint32_t maxReferencePicturesSlotsCount,
    uint32_t maxReferencePicturesActiveCount)
{
    ...
    static const vk::VkExtensionProperties h264StdExtensionVersion = {
        VK_STD_VULKAN_VIDEO_CODEC_H264_DECODE_EXTENSION_NAME, VK_MAKE_VIDEO_STD_VERSION(1, 0, 0)};
    static const vk::VkExtensionProperties h265StdExtensionVersion = {
        VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_EXTENSION_NAME, VK_MAKE_VIDEO_STD_VERSION(1, 0, 0)};
    ...
    VkVideoSessionCreateInfoKHR *videoSessionCreateInfo = new VkVideoSessionCreateInfoKHR{
        ...
        videoProfile->videoCodecOperation == VK_VIDEO_CODEC_OPERATION_DECODE_H264_BIT_KHR ?
            ...
            &h265StdExtensionVersion, //  const VkExtensionProperties* pStdHeaderVersion;
    };
                              ...
                              const VkImageUsageFlags usage)
{
    ...
    const VkResult res =
        vk.getPhysicalDeviceImageFormatProperties2(physicalDevice, &imageFormatInfo, &imageFormatProperties);
...
VkVideoDecodeH264ProfileInfoKHR getProfileOperationH264D(StdVideoH264ProfileIdc stdProfileIdc,

                              ...
                              VkVideoCapabilitiesKHR *pVideoCapabilities)
{
    ...
    {
        std::cout << "\t\t\t"
                  << ((videoProfile.GetCodecType() == VK_VIDEO_CODEC_OPERATION_DECODE_H264_BIT_KHR ||
                       videoProfile.GetCodecType() == VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_KHR) ?
                          "h264" :
                          "h265")
                  << ((videoProfile.GetCodecType() == VK_VIDEO_CODEC_OPERATION_DECODE_H264_BIT_KHR ||
                       videoProfile.GetCodecType() == VK_VIDEO_CODEC_OPERATION_DECODE_H265_BIT_KHR) ?
                          " decode" :
                          " encode")
        ...
        {
            std::cout << "\t\t\t"
                      << "Use separate reference images" << std::endl;
        }
        ...
        if (videoProfile.GetCodecType() == VK_VIDEO_CODEC_OPERATION_DECODE_H264_BIT_KHR)
        {
            ...
            if (strncmp(pVideoCapabilities->stdHeaderVersion.extensionName,
                ...
                (pVideoCapabilities->stdHeaderVersion.specVersion !=
        ...
        else if (videoProfile.GetCodecType() == VK_VIDEO_CODEC_OPERATION_DECODE_H265_BIT_KHR)
        {
                 ...
                 VK_STD_VULKAN_VIDEO_CODEC_H265_DECODE_SPEC_VERSION))
            {
                ...
                return VK_ERROR_INCOMPATIBLE_DRIVER;
                 ...
                 videoProfile.GetCodecType() == VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_KHR)
        {
            std::cout << "\t\t\t"
                      << "flags: " << pVideoEncodeCapabilities->flags << std::endl;
            std::cout << "\t\t\t"
                      << "rateControlModes: " << pVideoEncodeCapabilities->rateControlModes << std::endl;
            std::cout << "\t\t\t"
                      << "maxRateControlLayers: " << pVideoEncodeCapabilities->maxRateControlLayers << std::endl;
            std::cout << "\t\t\t"
                      << "maxBitrate : " << pVideoEncodeCapabilities->maxBitrate << std::endl;
            std::cout << "\t\t\t"
                      << "maxQualityLevels: " << pVideoEncodeCapabilities->maxQualityLevels << std::endl;
            std::cout << "\t\t\t"
                      << "encodeInputPictureGranularity: "
                      << pVideoEncodeCapabilities->encodeInputPictureGranularity.width << " x "
                      << pVideoEncodeCapabilities->encodeInputPictureGranularity.height << std::endl;
            std::cout << "\t\t\t"
                      << "supportedEncodeFeedbackFlags: " << pVideoEncodeCapabilities->supportedEncodeFeedbackFlags
                      << std::endl;
        }
        else
        {

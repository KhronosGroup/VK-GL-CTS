...
VkResult VulkanVideoFrameBuffer::Create(DeviceContext *vkDevCtx, bool supportsQueries,
    ...
    VulkanVideoFrameBuffer::PictureResourceInfo *outputPictureResourceInfo, VkImageLayout newOutputImageLayerLayout)
{
    ...
    if ((uint32_t)referenceSlotIndex < m_perFrameDecodeImageSet.size())
    {
        ...
        dpbPictureResource->codedOffset = {
            0, 0}; // FIXME: This parameter must to be adjusted based on the interlaced mode.
...
int32_t VkVideoFrameBuffer::InitImagePool(const VkVideoProfileInfoKHR *pDecodeProfile, uint32_t numImages,
                                          ...
                                          const VkExtent2D &codedExtent, const VkExtent2D &maxImageExtent,

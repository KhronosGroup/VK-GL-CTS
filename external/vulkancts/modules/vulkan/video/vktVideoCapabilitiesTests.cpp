    ...
    , m_caseDef(data)
{
    ...
    case TEST_TYPE_H264_ENCODE_DPB_VIDEO_FORMAT_SUPPORT_QUERY:
        m_videoCodecOperation = VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_EXT;
        break;
    ...
    case TEST_TYPE_H265_ENCODE_DPB_VIDEO_FORMAT_SUPPORT_QUERY:
        m_videoCodecOperation = VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_EXT;
        break;
    default:
...
template <>
VkVideoEncodeH264ProfileInfoEXT VideoFormatPropertiesQueryTestInstance<
    VkVideoEncodeH264ProfileInfoEXT>::getProfileOperation(void)
{
...
VkVideoDecodeH265ProfileInfoKHR VideoFormatPropertiesQueryTestInstance<
    VkVideoDecodeH265ProfileInfoKHR>::getProfileOperation(void)
{
    return getProfileOperationH265D();
}

template <>
VkVideoEncodeH265ProfileInfoEXT VideoFormatPropertiesQueryTestInstance<
    VkVideoEncodeH265ProfileInfoEXT>::getProfileOperation(void)
{
...
typedef VideoFormatPropertiesQueryTestInstance<VkVideoEncodeH264ProfileInfoEXT>
...
typedef VideoFormatPropertiesQueryTestInstance<VkVideoEncodeH265ProfileInfoEXT>
    ...
    const VkVideoEncodeCapabilitiesKHR &videoEncodeCapabilitiesKHRSecond)
{
    ...
    const VkVideoEncodeRateControlModeFlagsKHR videoEncodeRateControlModeFlags =
        VK_VIDEO_ENCODE_RATE_CONTROL_MODE_NONE_BIT_KHR | VK_VIDEO_ENCODE_RATE_CONTROL_MODE_CBR_BIT_KHR |
    ...
    const VkVideoEncodeH264CapabilitiesEXT &videoCapabilitiesKHRSecond)
{
    const VkVideoEncodeH264CapabilityFlagsEXT videoCapabilityFlags =
        ...
        VK_VIDEO_ENCODE_H264_CAPABILITY_SCALING_LISTS_BIT_EXT | VK_VIDEO_ENCODE_H264_CAPABILITY_HRD_COMPLIANCE_BIT_EXT |
        ...
        VK_VIDEO_ENCODE_H264_CAPABILITY_TRANSFORM_8X8_BIT_EXT | VK_VIDEO_ENCODE_H264_CAPABILITY_CABAC_BIT_EXT |
    ...
    const VkVideoEncodeH264CapabilityFlagsEXT videoCapabilityFlagsEntropyReq =
        VK_VIDEO_ENCODE_H264_CAPABILITY_CABAC_BIT_EXT | VK_VIDEO_ENCODE_H264_CAPABILITY_CAVLC_BIT_EXT;
    const VkVideoEncodeH264CapabilityFlagsEXT videoCapabilityFlagsDeblockReq =
        VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_DISABLED_BIT_EXT |
        VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_ENABLED_BIT_EXT |
        VK_VIDEO_ENCODE_H264_CAPABILITY_DEBLOCKING_FILTER_PARTIAL_BIT_EXT;
    ...
    const VkVideoEncodeH264InputModeFlagsEXT videoInputModeFlagsReq =
        VK_VIDEO_ENCODE_H264_INPUT_MODE_FRAME_BIT_EXT | VK_VIDEO_ENCODE_H264_INPUT_MODE_SLICE_BIT_EXT;
    ...
    const VkVideoEncodeH264OutputModeFlagsEXT videoOutputModeFlagsReq =
        VK_VIDEO_ENCODE_H264_OUTPUT_MODE_FRAME_BIT_EXT | VK_VIDEO_ENCODE_H264_OUTPUT_MODE_SLICE_BIT_EXT;
    ...
    const bool inputNonVCL =
        0 != (videoCapabilitiesKHR.inputModeFlags & VK_VIDEO_ENCODE_H264_INPUT_MODE_NON_VCL_BIT_EXT);
    const bool outputFrame =
        0 != (videoCapabilitiesKHR.outputModeFlags & VK_VIDEO_ENCODE_H264_OUTPUT_MODE_FRAME_BIT_EXT);
    const bool outputSlice =
        0 != (videoCapabilitiesKHR.outputModeFlags & VK_VIDEO_ENCODE_H264_OUTPUT_MODE_SLICE_BIT_EXT);
    const bool outputNonVCL =
        0 != (videoCapabilitiesKHR.outputModeFlags & VK_VIDEO_ENCODE_H264_OUTPUT_MODE_NON_VCL_BIT_EXT);
    const bool validCombination =
        (inputFrame && outputFrame)                    // Input: Frame, Output : Frame
        ...
        || (inputFrame && inputNonVCL && outputFrame &&
            outputNonVCL) // Input: Frame and Non-VCL, Output : Frame and Non-VCL
        || (inputFrame && inputNonVCL && outputSlice &&
            outputNonVCL) // Input: Frame and Non-VCL, Output : Slice and Non-VCL
        || (inputSlice && inputNonVCL && outputSlice &&
            outputNonVCL); // Input: Slice and Non-VCL, Output : Slice and Non-VCL
    ...
    if ((videoCapabilitiesKHR.inputModeFlags & videoInputModeFlagsReq) == 0)
        TCU_FAIL("An implementation must support at least one of VK_VIDEO_ENCODE_H264_INPUT_MODE_FRAME_BIT_EXT or "
                 "VK_VIDEO_ENCODE_H264_INPUT_MODE_SLICE_BIT_EXT");
    ...
    if ((videoCapabilitiesKHR.outputModeFlags & videoOutputModeFlagsReq) == 0)
        TCU_FAIL("An implementation must support at least one of VK_VIDEO_ENCODE_H264_OUTPUT_MODE_FRAME_BIT_EXT or "
                 "VK_VIDEO_ENCODE_H264_OUTPUT_MODE_SLICE_BIT_EXT");
...
void VideoCapabilitiesQueryH265EncodeTestInstance::validateVideoCapabilitiesExt(
    const VkVideoEncodeH265CapabilitiesEXT &videoCapabilitiesKHR,
    const VkVideoEncodeH265CapabilitiesEXT &videoCapabilitiesKHRSecond)
{
    const VkVideoEncodeH265InputModeFlagsEXT videoInputModeFlags =
        VK_VIDEO_ENCODE_H265_INPUT_MODE_FRAME_BIT_EXT | VK_VIDEO_ENCODE_H265_INPUT_MODE_SLICE_SEGMENT_BIT_EXT |
        VK_VIDEO_ENCODE_H265_INPUT_MODE_NON_VCL_BIT_EXT;
    const VkVideoEncodeH265InputModeFlagsEXT videoInputModeFlagsReq =
        VK_VIDEO_ENCODE_H265_INPUT_MODE_FRAME_BIT_EXT | VK_VIDEO_ENCODE_H265_INPUT_MODE_SLICE_SEGMENT_BIT_EXT;
    const VkVideoEncodeH265OutputModeFlagsEXT videoOutputModeFlags =
        VK_VIDEO_ENCODE_H265_OUTPUT_MODE_FRAME_BIT_EXT | VK_VIDEO_ENCODE_H265_OUTPUT_MODE_SLICE_SEGMENT_BIT_EXT |
        VK_VIDEO_ENCODE_H265_OUTPUT_MODE_NON_VCL_BIT_EXT;
    const VkVideoEncodeH265OutputModeFlagsEXT videoOutputModeFlagsReq =
        VK_VIDEO_ENCODE_H265_OUTPUT_MODE_FRAME_BIT_EXT | VK_VIDEO_ENCODE_H265_OUTPUT_MODE_SLICE_SEGMENT_BIT_EXT;
    ...
    const VkVideoEncodeH265TransformBlockSizeFlagsEXT transformBlockSizes =
        VK_VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_4_BIT_EXT | VK_VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_8_BIT_EXT |
        VK_VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_16_BIT_EXT | VK_VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_32_BIT_EXT;
    const bool inputFrame = 0 != (videoCapabilitiesKHR.inputModeFlags & VK_VIDEO_ENCODE_H265_INPUT_MODE_FRAME_BIT_EXT);
    const bool inputSlice =
        0 != (videoCapabilitiesKHR.inputModeFlags & VK_VIDEO_ENCODE_H265_INPUT_MODE_SLICE_SEGMENT_BIT_EXT);
    const bool inputNonVCL =
        0 != (videoCapabilitiesKHR.inputModeFlags & VK_VIDEO_ENCODE_H265_INPUT_MODE_NON_VCL_BIT_EXT);
    const bool outputFrame =
        0 != (videoCapabilitiesKHR.outputModeFlags & VK_VIDEO_ENCODE_H265_OUTPUT_MODE_FRAME_BIT_EXT);
    const bool outputSlice =
        0 != (videoCapabilitiesKHR.outputModeFlags & VK_VIDEO_ENCODE_H265_OUTPUT_MODE_SLICE_SEGMENT_BIT_EXT);
    const bool outputNonVCL =
        0 != (videoCapabilitiesKHR.outputModeFlags & VK_VIDEO_ENCODE_H265_OUTPUT_MODE_NON_VCL_BIT_EXT);
    const bool validCombination =
        (inputFrame && outputFrame)                    // Input: Frame, Output : Frame
        || (inputFrame && outputFrame && outputNonVCL) // Input: Frame, Output : Frame and Non-VCL
        || (inputFrame && outputSlice)                 // Input: Frame, Output : Slice
    ...
    if ((videoCapabilitiesKHR.inputModeFlags & videoInputModeFlagsReq) == 0)
        TCU_FAIL("An implementation must support at least one of VK_VIDEO_ENCODE_H265_INPUT_MODE_FRAME_BIT_EXT or "
    ...
    if ((videoCapabilitiesKHR.outputModeFlags & videoOutputModeFlagsReq) == 0)
        TCU_FAIL("An implementation must support at least one of VK_VIDEO_ENCODE_H265_OUTPUT_MODE_FRAME_BIT_EXT or "
...
{
public:
    VideoCapabilitiesQueryTestCase(tcu::TestContext &context, const char *name, const char *desc,
...
VideoCapabilitiesQueryTestCase::VideoCapabilitiesQueryTestCase(tcu::TestContext &context, const char *name,
                                                               const char *desc, const CaseDef caseDef)
...
const char *getTestName(const TestType testType)
{
    ...
    case TEST_TYPE_H265_DECODE_DPB_VIDEO_FORMAT_SUPPORT_QUERY:
        return "h265_decode_spb_video_format_support_query";
    case TEST_TYPE_H265_ENCODE_SRC_VIDEO_FORMAT_SUPPORT_QUERY:
...
tcu::TestCaseGroup *createVideoCapabilitiesTests(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "capabilities", "Video encoding and decoding capability query tests"));

...
tcu::TestCaseGroup *createTests(tcu::TestContext &testCtx, const std::string &name)
{
...

    {
        ...
        syncGroup->addChild(
            createSynchronizationTests(testCtx, "encode_h264", VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_EXT));
        syncGroup->addChild(
            createSynchronizationTests(testCtx, "encode_h265", VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_EXT));
        syncGroup->addChild(

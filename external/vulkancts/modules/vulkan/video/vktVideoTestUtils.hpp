...
bool imageMatchesReferenceChecksum(const ycbcr::MultiPlaneImageData &multiPlaneImageData,
                                   const std::string &referenceChecksums);
...
VkVideoEncodeH264ProfileInfoEXT getProfileOperationH264Encode(
    StdVideoH264ProfileIdc stdProfileIdc = STD_VIDEO_H264_PROFILE_IDC_MAIN);
...
VkVideoEncodeH265ProfileInfoEXT getProfileOperationH265Encode(
    StdVideoH265ProfileIdc stdProfileIdc = STD_VIDEO_H265_PROFILE_IDC_MAIN);
...
public:
    ...
    bool PopulateProfileExt(VkBaseInStructure const *pVideoProfileExt)
    {
        ...
        {
            VkVideoEncodeH264ProfileInfoEXT const *pProfileExt =
                (VkVideoEncodeH264ProfileInfoEXT const *)pVideoProfileExt;
        ...
        {
            VkVideoEncodeH265ProfileInfoEXT const *pProfileExt =
                (VkVideoEncodeH265ProfileInfoEXT const *)pVideoProfileExt;

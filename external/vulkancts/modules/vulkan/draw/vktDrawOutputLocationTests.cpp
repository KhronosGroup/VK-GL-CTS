...
void checkSupport(Context &context, std::string testName)
{
        ...
        (testName.find("r8g8") != std::string::npos || testName.find("inputs-outputs-mod") != std::string::npos))
    {
        TCU_THROW(NotSupportedError,
                  "VK_KHR_portability_subset: Stride is not a multiple of minVertexInputBindingStrideAlignment");
    }
}
...
void createTests(tcu::TestCaseGroup *testGroup)
{
    ...
    // .array
    {
        ...
        static const std::string cases[] = {"b10g11r11-ufloat-pack32-highp",
    ...
    // .shuffle
    {
        tcu::TestCaseGroup *const shuffle =
            new tcu::TestCaseGroup(testCtx, "shuffle", "Test output location shuffling");
        static const char dataDir[] = "draw/output_location/shuffle";

        static const std::string cases[] = {"inputs-outputs", "inputs-outputs-mod"};

...
//	const VkPhysicalDevice					physicalDevice	= m_context.getPhysicalDevice();
	...
	de::MovePtr<vk::DeviceDriver>	deviceDriver = de::MovePtr<vk::DeviceDriver>(new vk::DeviceDriver(m_context.getPlatformInterface(), instance, *computeDevice, m_context.getUsedApiVersion(), m_context.getTestContext().getCommandLine()));
#else

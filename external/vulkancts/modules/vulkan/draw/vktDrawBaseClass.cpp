...
DrawTestsBaseClass::DrawTestsBaseClass(Context &context, const char *vertexShaderName, const char *fragmentShaderName,
                                       bool useDynamicRendering, vk::VkPrimitiveTopology topology)
...
void DrawTestsBaseClass::beginRender(const vk::VkSubpassContents content)
{
    ...
    if (m_useDynamicRendering)
    {
        ...
        vk::beginRendering(m_vk, *m_cmdBuffer, *m_colorTargetView, renderArea, clearColor, vk::VK_IMAGE_LAYOUT_GENERAL,

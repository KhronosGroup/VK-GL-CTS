...
struct DrawParams : DrawParamsBase
{
    ...
    DrawParams(const vk::VkPrimitiveTopology top, bool dynamicRendering, const uint32_t vertexC,
...
struct DrawIndexedParams : DrawParamsBase, IndexedParamsBase
{
    ...
    DrawIndexedParams(const vk::VkPrimitiveTopology top, bool dynamicRendering, const vk::VkIndexType indexT,
...
struct DrawIndirectParams : DrawParamsBase
{
    ...
    DrawIndirectParams(const vk::VkPrimitiveTopology top, bool dynamicRendering) : DrawParamsBase(top, dynamicRendering)
    {
    }
...
void populateSubGroup(tcu::TestCaseGroup *testGroup, const TestCaseParams caseParams)
{
    ...
    for (uint32_t primitiveCountIdx = 0; primitiveCountIdx < primitiveCountArrLength; ++primitiveCountIdx)
    {
        ...
        case DRAW_COMMAND_TYPE_DRAW:
        {
            ...
            testGroup->addChild(
                new DrawCase(testCtx, name.c_str(), "vkCmdDraw testcase.",
        ...
        case DRAW_COMMAND_TYPE_DRAW_INDEXED:
        {
            ...
            testGroup->addChild(
                new IndexedCase(testCtx, name.c_str(), "vkCmdDrawIndexed testcase.",
                                DrawIndexedParams(topology, useDynamicRendering, vk::VK_INDEX_TYPE_UINT32, vertexCount,
        ...
        case DRAW_COMMAND_TYPE_DRAW_INDEXED_INDIRECT:
        {
            ...
            DrawIndexedIndirectParams params =
                DrawIndexedIndirectParams(topology, useDynamicRendering, vk::VK_INDEX_TYPE_UINT32);
    ...
    for (uint32_t drawTypeIndex = 0; drawTypeIndex < DRAW_COMMAND_TYPE_DRAW_LAST; ++drawTypeIndex)
    {
        ...
        de::MovePtr<tcu::TestCaseGroup> topologyGroup(
            new tcu::TestCaseGroup(testGroup->getTestContext(), getDrawCommandTypeName(command),
                                   "Group for testing a specific draw command."));
        ...
        for (uint32_t topologyIdx = 0; topologyIdx != vk::VK_PRIMITIVE_TOPOLOGY_PATCH_LIST; ++topologyIdx)
        {
            ...
            addTestGroup(topologyGroup.get(), groupName, "Testcases with a specific topology.", populateSubGroup,
                         TestCaseParams(command, topology, useDynamicRendering));
        }

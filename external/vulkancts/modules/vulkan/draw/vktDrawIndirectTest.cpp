                    ...
                    tcu::TestCaseGroup *drawTypeGroup = new tcu::TestCaseGroup(m_testCtx, drawTypeStr.c_str());
                    {
                        ...
                        tcu::TestCaseGroup *indirectDrawParamCountGroup =
                            new tcu::TestCaseGroup(m_testCtx, "indirect_draw_param_count",
                                                   "Draws geometry with VK_KHR_draw_indirect_count extension and limit "
                                                   "draws count with call parameter");
                        ...
                        tcu::TestCaseGroup *indirectDrawCountInstancedGroup = new tcu::TestCaseGroup(
                            m_testCtx, "indirect_draw_count_instanced",
                        ...
                        tcu::TestCaseGroup *indirectDrawParamCountInstancedGroup =
                            new tcu::TestCaseGroup(m_testCtx, "indirect_draw_param_count_instanced",
                                                   "Draws an instanced geometry with VK_KHR_draw_indirect_count "
                                                   "extension and limit draws count with call parameter");
                        {

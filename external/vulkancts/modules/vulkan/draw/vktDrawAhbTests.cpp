...
{
    testGroup->addChild(new AhbTestCase(testGroup->getTestContext(), "triangle_list",
                                        "Draw triangle list to a single layer color buffer", DrawParams(9u, 1u)));

    testGroup->addChild(new AhbTestCase(testGroup->getTestContext(), "triangle_list_layers_3",
                                        "Draw triangle list to a color buffer with three layers",
                                        DrawParams(9u * 3u, 3u)));

    testGroup->addChild(new AhbTestCase(testGroup->getTestContext(), "triangle_list_layers_5",
                                        "Draw triangle list to a color buffer with five layers",
                                        DrawParams(9u * 5u, 5u)));

    testGroup->addChild(new AhbTestCase(testGroup->getTestContext(), "triangle_list_layers_8",

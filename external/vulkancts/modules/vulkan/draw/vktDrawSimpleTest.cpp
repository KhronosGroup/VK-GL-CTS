...
{
    {
        ...
        addChild(new InstanceFactory<SimpleDraw, FunctionSupport1<SimpleDraw::TestSpec>>(
            m_testCtx, "simple_draw_triangle_list", "Draws triangle list", testSpec,
            FunctionSupport1<SimpleDraw::TestSpec>::Args(checkSupport, testSpec)));
        testSpec.topology = vk::VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP;
        addChild(new InstanceFactory<SimpleDraw, FunctionSupport1<SimpleDraw::TestSpec>>(
            m_testCtx, "simple_draw_triangle_strip", "Draws triangle strip", testSpec,
            FunctionSupport1<SimpleDraw::TestSpec>::Args(checkSupport, testSpec)));
    }
    {
        ...
        addChild(new InstanceFactory<SimpleDrawInstanced, FunctionSupport1<SimpleDrawInstanced::TestSpec>>(
            m_testCtx, "simple_draw_instanced_triangle_list", "Draws an instanced triangle list", testSpec,
            FunctionSupport1<SimpleDrawInstanced::TestSpec>::Args(checkSupport, testSpec)));
        testSpec.topology = vk::VK_PRIMITIVE_TOPOLOGY_TRIANGLE_STRIP;
        addChild(new InstanceFactory<SimpleDrawInstanced, FunctionSupport1<SimpleDrawInstanced::TestSpec>>(
            m_testCtx, "simple_draw_instanced_triangle_strip", "Draws an instanced triangle strip", testSpec,
            FunctionSupport1<SimpleDrawInstanced::TestSpec>::Args(checkSupport, testSpec)));
    }
}

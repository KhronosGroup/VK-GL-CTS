...
void createAhbExternalFormatResolveDrawTests(tcu::TestCaseGroup *testGroup, const SharedGroupParams groupParams)
{
    ...
    tcu::TestCaseGroup *inputAttachment =
        new tcu::TestCaseGroup(testGroup->getTestContext(), "input_attachment", "Draw tests with input attachment");
    ...
    for (uint32_t i = 0; i < AndroidHardwareBufferInstance::Format::COUNT; ++i)
    {
        ...
        if (hasValidTextureFormat)
        {
            ...
            tcu::TestCaseGroup *formatGroup =
                new tcu::TestCaseGroup(testGroup->getTestContext(), formatName.c_str(), formatGroupDesc.c_str());

...
{
public:
    SparseQueueBindTest(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
...
void populateTestGroup(tcu::TestCaseGroup *group)
{
    const struct
    {
        ...
        },
        {
            ...
            "submit without any semaphores, signal a fence",
        },

        {
            ...
            "only sparse queue, wait for semaphore(s)",
        },
        {
        ...
        },
        {
            ...
            "only sparse queue, signal semaphore(s)",
        },
        {
        ...
        },
        {
            ...
            "only sparse queue, wait for and signal semaphore(s)",
        },
        {
...

        {
            ...
            "sparse and other queues, wait for semaphore(s)",
        },
        {
        ...
        },
        {
            ...
            "sparse and other queues, signal semaphore(s)",
        },
        {
        ...
        },
        {
            ...
            "sparse and other queues, wait for and signal semaphore(s)",
        },
        {
...

        {
            ...
            "call vkQueueBindSparse with zero bindInfos",
        },
        {
            "empty_fence",
            {
    ...
    for (int caseNdx = 0; caseNdx < DE_LENGTH_OF_ARRAY(cases); ++caseNdx)
        group->addChild(new SparseQueueBindTest(group->getTestContext(), cases[caseNdx].name,
                                                cases[caseNdx].description, cases[caseNdx].params));
}

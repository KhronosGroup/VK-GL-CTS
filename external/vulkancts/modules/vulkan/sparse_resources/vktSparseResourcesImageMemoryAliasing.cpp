...
{
public:
    ImageSparseMemoryAliasingCase(tcu::TestContext &testCtx, const std::string &name, const ImageType imageType,
...
{
    de::MovePtr<tcu::TestCaseGroup> testGroup(
        new tcu::TestCaseGroup(testCtx, "device_group_image_sparse_memory_aliasing"));

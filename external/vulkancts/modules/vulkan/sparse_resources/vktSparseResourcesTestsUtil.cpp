...
std::vector<TestFormat> getTestFormats(const ImageType &imageType)
{
    std::vector<TestFormat> results = {
        ...
        {VK_FORMAT_R16_UNORM},         {VK_FORMAT_R8_UNORM},           {VK_FORMAT_R16_SNORM},
        {VK_FORMAT_R8_SNORM},          {VK_FORMAT_R32G32_SINT},        {VK_FORMAT_R16G16_SINT},
        {VK_FORMAT_R8G8_SINT},         {VK_FORMAT_R32G32_UINT},        {VK_FORMAT_R16G16_UINT},
        {VK_FORMAT_R8G8_UINT},         {VK_FORMAT_R16G16_UNORM},       {VK_FORMAT_R8G8_UNORM},
        {VK_FORMAT_R16G16_SNORM},      {VK_FORMAT_R8G8_SNORM},         {VK_FORMAT_R32G32B32A32_SINT},
        {VK_FORMAT_R16G16B16A16_SINT}, {VK_FORMAT_R8G8B8A8_SINT},      {VK_FORMAT_R32G32B32A32_UINT},
        {VK_FORMAT_R16G16B16A16_UINT}, {VK_FORMAT_R8G8B8A8_UINT},      {VK_FORMAT_R16G16B16A16_UNORM},
        {VK_FORMAT_R8G8B8A8_UNORM},    {VK_FORMAT_R16G16B16A16_SNORM}, {VK_FORMAT_R8G8B8A8_SNORM}};

    if (imageType == IMAGE_TYPE_2D || imageType == IMAGE_TYPE_2D_ARRAY)
    {
        std::vector<TestFormat> ycbcrFormats = {{VK_FORMAT_G8B8G8R8_422_UNORM},

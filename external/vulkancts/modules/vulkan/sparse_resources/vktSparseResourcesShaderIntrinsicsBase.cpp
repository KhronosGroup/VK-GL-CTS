...
tcu::TestStatus SparseShaderIntrinsicsInstanceBase::iterate(void)
{
...

    {
        VkImageFormatProperties imageFormatProperties;
        if (instance.getPhysicalDeviceImageFormatProperties(
                physicalDevice, imageTexelsInfo.format, imageTexelsInfo.imageType, imageTexelsInfo.tiling,
                imageTexelsInfo.usage, imageTexelsInfo.flags, &imageFormatProperties) == VK_ERROR_FORMAT_NOT_SUPPORTED)
        {

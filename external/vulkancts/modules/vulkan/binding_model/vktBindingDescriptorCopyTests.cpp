...
{
public:
    DescriptorCopyTestCase(tcu::TestContext &context, const char *name, const char *desc,
...
DescriptorCommands::DescriptorCommands(PipelineType pipelineType) : m_pipelineType(pipelineType)
{
    // Reset counters
...
DescriptorCopyTestCase::DescriptorCopyTestCase(tcu::TestContext &context, const char *name, const char *desc,
                                               DescriptorCommandsSp commands)
...
{
    de::MovePtr<tcu::TestCaseGroup> descriptorCopyGroup(
        new tcu::TestCaseGroup(testCtx, "descriptor_copy", "Descriptor copy tests"));
...
#ifndef CTS_USES_VULKANSC
    addDescriptorCopyTests<InlineUniformBlockDescriptor>(testCtx, computeGroup, "inline_uniform_block",
                                                         PIPELINE_TYPE_COMPUTE);
#endif
    addDescriptorCopyTests<StorageBufferDescriptor>(testCtx, computeGroup, "storage_buffer", PIPELINE_TYPE_COMPUTE);
    addDescriptorCopyTests<CombinedImageSamplerDescriptor>(testCtx, computeGroup, "combined_image_sampler",
                                                           PIPELINE_TYPE_COMPUTE);
    addDescriptorCopyTests<StorageImageDescriptor>(testCtx, computeGroup, "storage_image", PIPELINE_TYPE_COMPUTE);
    addDescriptorCopyTests<UniformTexelBufferDescriptor>(testCtx, computeGroup, "uniform_texel_buffer",
                                                         PIPELINE_TYPE_COMPUTE);
    addDescriptorCopyTests<StorageTexelBufferDescriptor>(testCtx, computeGroup, "storage_texel_buffer",
                                                         PIPELINE_TYPE_COMPUTE);
    addDescriptorCopyTests<DynamicUniformBufferDescriptor>(testCtx, computeGroup, "uniform_buffer_dynamic",
                                                           PIPELINE_TYPE_COMPUTE);
    addDescriptorCopyTests<DynamicStorageBufferDescriptor>(testCtx, computeGroup, "storage_buffer_dynamic",
                                                           PIPELINE_TYPE_COMPUTE);
...
#ifndef CTS_USES_VULKANSC
    addDescriptorCopyTests<InlineUniformBlockDescriptor>(testCtx, graphicsGroup, "inline_uniform_block",
                                                         PIPELINE_TYPE_GRAPHICS);
#endif
    addDescriptorCopyTests<StorageBufferDescriptor>(testCtx, graphicsGroup, "storage_buffer", PIPELINE_TYPE_GRAPHICS);
    addDescriptorCopyTests<CombinedImageSamplerDescriptor>(testCtx, graphicsGroup, "combined_image_sampler",
                                                           PIPELINE_TYPE_GRAPHICS);
    addDescriptorCopyTests<StorageImageDescriptor>(testCtx, graphicsGroup, "storage_image", PIPELINE_TYPE_GRAPHICS);
    addDescriptorCopyTests<InputAttachmentDescriptor>(testCtx, graphicsGroup, "input_attachment",
                                                      PIPELINE_TYPE_GRAPHICS);
    addDescriptorCopyTests<UniformTexelBufferDescriptor>(testCtx, graphicsGroup, "uniform_texel_buffer",
                                                         PIPELINE_TYPE_GRAPHICS);
    addDescriptorCopyTests<StorageTexelBufferDescriptor>(testCtx, graphicsGroup, "storage_texel_buffer",
                                                         PIPELINE_TYPE_GRAPHICS);
    addDescriptorCopyTests<DynamicUniformBufferDescriptor>(testCtx, graphicsGroup, "uniform_buffer_dynamic",
                                                           PIPELINE_TYPE_GRAPHICS);
    addDescriptorCopyTests<DynamicStorageBufferDescriptor>(testCtx, graphicsGroup, "storage_buffer_dynamic",
                                                           PIPELINE_TYPE_GRAPHICS);

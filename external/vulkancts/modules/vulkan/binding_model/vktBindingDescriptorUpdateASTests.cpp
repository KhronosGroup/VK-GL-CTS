...
static Move<VkPipeline> makeComputePipeline(const DeviceInterface &vk, const VkDevice device,
...
{
public:
    BindingAccelerationStructureTestCase(tcu::TestContext &context, const char *name, const char *desc,
                                         const TestParams testParams);
...
tcu::TestCaseGroup *createDescriptorUpdateASTests(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "acceleration_structure", "Tests acceleration structure descriptor updates"));
        ...
        for (size_t updateMethodsNdx = 0; updateMethodsNdx < DE_LENGTH_OF_ARRAY(updateMethods); ++updateMethodsNdx)
        {
            de::MovePtr<tcu::TestCaseGroup> updateMethodsGroup(
                new tcu::TestCaseGroup(group->getTestContext(), updateMethods[updateMethodsNdx].name,
                                       updateMethods[updateMethodsNdx].description));

...
VkDevice getDevice(Context &context)
{
    if (!g_singletonDevice)
    {
        ...
        VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT mutableDescriptorTypeFeatures =
            initVulkanStructure(&rayQueryFeatures);
        VkPhysicalDeviceDescriptorIndexingFeatures descriptorIndexingFeatures =
            initVulkanStructure(&mutableDescriptorTypeFeatures);
...
{
    return createTestGroup(testCtx, "mutable_descriptor",
                           "Tests for VK_VALVE_mutable_descriptor_type and VK_EXT_mutable_descriptor_type",

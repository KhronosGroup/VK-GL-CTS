    ...
    const std::vector<de::SharedPtr<vk::Unique<vk::VkSampler>>> &samplers)
{
    const vk::VkDescriptorPoolSize poolSizes[] = {
        {vk::VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, (uint32_t)samplers.size()}};
                        ...
                        for (size_t tilingNdx = 0; tilingNdx < imageTilings.size(); tilingNdx++)
                        {
                            ...
                            for (size_t bindingNdx = 0; bindingNdx < samplerBindings.size(); bindingNdx++)
                            {
                                ...
                                const TestConfig config(shaderType, format, tiling, textureFilter,
                                                        ...
                                                        colorModel, identitySwizzle, srcSize, dstSize, samplerBinding);
                            ...
                            for (size_t tilingNdx = 0; tilingNdx < imageTilings.size(); tilingNdx++)
                            {
                                ...
                                for (size_t bindingNdx = 0; bindingNdx < samplerBindings.size(); bindingNdx++)
                                {
                                    ...
                                    const TestConfig config(shaderType, format, tiling, textureFilter,
                                                            ...
                                                            vk::VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE, textureFilter,
                                                            chromaLocation, chromaLocation, false, false, colorRange,
                                                            colorModel, identitySwizzle, srcSize, dstSize,
                                                            samplerBinding);
                            ...
                            for (size_t tilingNdx = 0; tilingNdx < imageTilings.size(); tilingNdx++)
                            {
                                ...
                                for (size_t bindingNdx = 0; bindingNdx < samplerBindings.size(); bindingNdx++)
                                {
                                    ...
                                    const TestConfig config(shaderType, format, tiling, vk::VK_FILTER_NEAREST,
                                                            ...
                                                            false, colorRange, colorModel, identitySwizzle, srcSize,
                                ...
                                for (size_t tilingNdx = 0; tilingNdx < imageTilings.size(); tilingNdx++)
                                {
                                    ...
                                    for (size_t bindingNdx = 0; bindingNdx < samplerBindings.size(); bindingNdx++)
                                    {
                                        ...
                                        const TestConfig config(shaderType, format, tiling, vk::VK_FILTER_NEAREST,
                                                                ...
                                                                false, false, colorRange, colorModel, identitySwizzle,
                                ...
                                for (size_t tilingNdx = 0; tilingNdx < imageTilings.size(); tilingNdx++)
                                {
...

                                    {
                                        ...
                                        const TestConfig config(
                                            shaderType, format, tiling, textureFilter,
                                            vk::VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE,
                                            vk::VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE, vk::VK_FILTER_LINEAR,
                                            xChromaOffset, yChromaOffset, explicitReconstruction, disjoint,
                                    ...
                                    {
                                        {
                                            ...
                                            const TestConfig config(shaderType, format, tiling, textureFilter,
                                                                    ...
                                                                    vk::VK_FILTER_NEAREST, xChromaOffset, yChromaOffset,
                                                                    explicitReconstruction, disjoint, defaultColorRange,
                                                                    defaultColorModel, identitySwizzle, srcSize,
                                                                    dstSize, 0);
                                ...
                                for (size_t tilingNdx = 0; tilingNdx < imageTilings.size(); tilingNdx++)
                                {
                                    ...
                                    const char *const tilingName(imageTilings[tilingNdx].name);
                                    {
                                        ...
                                        const TestConfig config(
                                            ...
                                            chromaLocation, chromaLocation, explicitReconstruction, disjoint,
                                            defaultColorRange, defaultColorModel, identitySwizzle, srcSize, dstSize, 0);
                                        ...
                                        {
                                            {
                                                ...
                                                const TestConfig config(shaderType, format, tiling, textureFilter,
                                                                        ...
                                                                        identitySwizzle, srcSize, dstSize, 0);
                    ...
                    for (size_t yChromaOffsetNdx = 0; yChromaOffsetNdx < chromaLocations.size(); yChromaOffsetNdx++)
                    {
                        ...
                        for (size_t tilingNdx = 0; tilingNdx < imageTilings.size(); tilingNdx++)
                        {
                            ...
                            const TestConfig config(
                                ...
                                false, defaultColorRange, defaultColorModel, identitySwizzle, srcSize, srcSize, 0);
            ...
            for (size_t tilingNdx = 0; tilingNdx < imageTilings.size(); tilingNdx++)
            {
                ...
                for (size_t bindingNdx = 0; bindingNdx < samplerBindings.size(); bindingNdx++)
                {
                    ...
                    const TestConfig config(
                        ...
                        false, colorRange, vk::VK_SAMPLER_YCBCR_MODEL_CONVERSION_LAST, identitySwizzle, srcSize,
                        dstSize, samplerBinding);

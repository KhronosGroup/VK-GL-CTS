...
struct YCbCrConversionTestBuilder
{
    ...
    void buildTests(tcu::TestCaseGroup *testGroup)
    {
            ...
            for (size_t modelNdx = 0; modelNdx < colorModels.size(); modelNdx++)
            {
                ...
                else
                {
                    for (size_t rangeNdx = 0; rangeNdx < colorRanges.size(); rangeNdx++)
                    {
                        ...
                        de::MovePtr<tcu::TestCaseGroup> colorRangeGroup(
                            new tcu::TestCaseGroup(testCtx, colorRangeName));
            ...
            // Chroma reconstruction tests
            {
                ...
                for (size_t textureFilterNdx = 0; textureFilterNdx < textureFilters.size(); textureFilterNdx++)
                {
                    ...
                    de::MovePtr<tcu::TestCaseGroup> textureFilterGroup(
                        new tcu::TestCaseGroup(testCtx, textureFilterName));
...

        {
            ...
            de::MovePtr<tcu::TestCaseGroup> oneToOneGroup(new tcu::TestCaseGroup(testCtx, "one_to_one"));
    ...
    void buildArrayOfSamplersTests(const vk::VkFormat &format, const UVec2 &srcSize, const UVec2 &dstSize,
                                   ...
                                   de::Random &rng)
    {
        de::MovePtr<tcu::TestCaseGroup> samplerArrayGroup(new tcu::TestCaseGroup(testCtx, "sampler_array"));
...
{
    return createTestGroup(testCtx, "conversion", initTests);
}

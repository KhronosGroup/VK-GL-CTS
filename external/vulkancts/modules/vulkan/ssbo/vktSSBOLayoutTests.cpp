            ...
            for (int basicTypeNdx = 0; basicTypeNdx < DE_LENGTH_OF_ARRAY(basicTypes); basicTypeNdx++)
            {
                ...
                if (!glu::dataTypeSupportsPrecisionModifier(type))
                    layoutGroup->addChild(new BlockBasicTypeCase(
                        ...
                        0, LOAD_FULL_MATRIX, STORE_FULL_MATRIX, m_usePhysStorageBuffer, m_readonly));
                else
                {
...
tcu::TestCaseGroup *createTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> readonlyGroup(
        new tcu::TestCaseGroup(testCtx, "readonly", "Readonly Shader Storage Buffer Tests"));

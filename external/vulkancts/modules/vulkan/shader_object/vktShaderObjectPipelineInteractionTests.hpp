#ifndef _VKTSHADEROBJECTPIPELINEINTERACTIONTESTS_HPP
#define _VKTSHADEROBJECTPIPELINEINTERACTIONTESTS_HPP
/*------------------------------------------------------------------------
...
#endif // _VKTSHADEROBJECTPIPELINEINTERACTIONTESTS_HPP

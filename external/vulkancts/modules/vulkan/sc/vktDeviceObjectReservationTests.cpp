...
void createImageViews(const DeviceInterface &vkd, const VkDevice device, const VkImage image,
...
public:
    ...
    void performTest(const DeviceInterface &vkd, VkDevice device) override
    {
        ...
        case TRC_IMAGE_VIEW:
        {
            ...
            createImageViews(vkd, device, image.get(), begin(imageViews) + VERIFYMAXVALUES_OBJECT_COUNT / 2,
                             end(imageViews));

...
tcu::TestCaseGroup *createObjectRefreshTests(tcu::TestContext &testCtx)
{
    ...
    addFunctionCaseWithPrograms(group.get(), "refresh_individual_objects", checkRefreshSupport, createComputeSource,
                                refreshIndividualObjects);
    addFunctionCaseWithPrograms(group.get(), "refresh_all_objects", checkRefreshSupport, createComputeSource,
                                refreshAllObjects);

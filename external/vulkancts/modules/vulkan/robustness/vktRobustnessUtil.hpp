...
vk::Move<vk::VkDevice> createRobustBufferAccessDevice(Context &context, vk::VkInstance instance,
...
bool isValueWithinBufferOrZero(const void *buffer, vk::VkDeviceSize bufferSize, const void *valuePtr,
                               size_t valueSizeInBytes);
...
{
public:
    TestEnvironment(Context &context, vk::VkInstance instance, const vk::InstanceInterface &instanceInterface,
                    vk::VkDevice device, vk::VkDescriptorSetLayout descriptorSetLayout,
...
public:
    ...
    GraphicsEnvironment(Context &context, vk::VkInstance instance, const vk::InstanceInterface &instanceInterface,
                        vk::VkDevice device, vk::VkDescriptorSetLayout descriptorSetLayout,
...
{
public:
    ComputeEnvironment(Context &context, vk::VkInstance instance, const vk::InstanceInterface &instanceInterface,
                       vk::VkDevice device, vk::VkDescriptorSetLayout descriptorSetLayout,
                       vk::VkDescriptorSet descriptorSet, bool testPipelineRobustness = false);

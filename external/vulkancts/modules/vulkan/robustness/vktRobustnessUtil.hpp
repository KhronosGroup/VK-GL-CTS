...
{
public:
    TestEnvironment(Context &context, vk::VkDevice device, vk::VkDescriptorSetLayout descriptorSetLayout,
...
public:
    ...
    GraphicsEnvironment(Context &context, vk::VkDevice device, vk::VkDescriptorSetLayout descriptorSetLayout,
...
{
public:
    ComputeEnvironment(Context &context, vk::VkDevice device, vk::VkDescriptorSetLayout descriptorSetLayout,
                       vk::VkDescriptorSet descriptorSet);

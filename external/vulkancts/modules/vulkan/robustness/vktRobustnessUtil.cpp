...
static vector<string> removeExtensions(const vector<string> &a, const vector<const char *> &b)
{
    vector<string> res;
...
Move<VkDevice> createRobustBufferAccessDevice(Context &context, VkInstance instance, const InstanceInterface &vki,
...
TestEnvironment::TestEnvironment(Context &context, VkInstance instance, const InstanceInterface &instanceInterface,
...
GraphicsEnvironment::GraphicsEnvironment(Context &context, VkInstance instance,
                                         const InstanceInterface &instanceInterface, VkDevice device,
    ...
    , m_colorFormat(VK_FORMAT_R8G8B8A8_UNORM)
{
    ...
    const VkPhysicalDevice physicalDevice =
        chooseDevice(m_instanceInterface, instance, context.getTestContext().getCommandLine());
...
ComputeEnvironment::ComputeEnvironment(Context &context, VkInstance instance,
                                       const InstanceInterface &instanceInterface, VkDevice device,
                                       VkDescriptorSetLayout descriptorSetLayout, VkDescriptorSet descriptorSet,

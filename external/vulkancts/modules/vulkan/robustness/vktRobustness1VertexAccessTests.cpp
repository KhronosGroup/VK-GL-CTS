...
{
public:
    Robustness1AccessInstance(TestContext &testCtx, Context &context, T device, DeviceDriverPtr deviceDriver,
...
template <typename T>
Robustness1AccessInstance<T>::Robustness1AccessInstance(TestContext &testCtx, Context &context, T device,
...
#ifndef CTS_USES_VULKANSC
    DeviceDriverPtr deviceDriver = DeviceDriverPtr(

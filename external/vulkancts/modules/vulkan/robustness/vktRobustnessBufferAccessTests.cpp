...
TestInstance *RobustBufferReadTest::createInstance(Context &context) const
{
    ...
    return new BufferReadInstance(context, device, deviceDriver, m_shaderType, m_shaderStage, m_bufferFormat,
                                  m_readFromStorage, m_readAccessRange, m_accessOutOfBackingMemory,
...
TestInstance *RobustBufferWriteTest::createInstance(Context &context) const
{
    ...
    return new BufferWriteInstance(context, device, deviceDriver, m_shaderType, m_shaderStage, m_bufferFormat,
                                   m_writeAccessRange, m_accessOutOfBackingMemory, m_testPipelineRobustness);
}

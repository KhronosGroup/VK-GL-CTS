...
TestInstance *RobustReadTest::createInstance(Context &context) const
{
    ...
    return new ReadInstance(context, device, deviceDriver, m_shaderType, m_shaderStage, m_bufferFormat,
...
TestInstance *RobustWriteTest::createInstance(Context &context) const
{
    ...
    return new WriteInstance(context, device, deviceDriver, m_shaderType, m_shaderStage, m_bufferFormat,
                             m_writeAccessRange, m_accessOutOfBackingMemory);
}

...
Move<VkDevice> createRobustBufferAccessVariablePointersDevice(Context &context, VkInstance instance,
...
{
public:
    AccessInstance(Context &context, std::shared_ptr<CustomInstanceWrapper> instanceWrapper, Move<VkDevice> device,
...
{
public:
    ReadInstance(Context &context, std::shared_ptr<CustomInstanceWrapper> instanceWrapper, Move<VkDevice> device,
#ifndef CTS_USES_VULKANSC
                 de::MovePtr<vk::DeviceDriver> deviceDriver,
#else
                 de::MovePtr<vk::DeviceDriverSC, vk::DeinitDeviceDeleter> deviceDriver,
...
{
public:
    WriteInstance(Context &context, std::shared_ptr<CustomInstanceWrapper> instanceWrapper, Move<VkDevice> device,
#ifndef CTS_USES_VULKANSC
                  de::MovePtr<vk::DeviceDriver> deviceDriver,
#else
                  de::MovePtr<vk::DeviceDriverSC, vk::DeinitDeviceDeleter> deviceDriver,
...
TestInstance *RobustReadTest::createInstance(Context &context) const
{
    ...
    auto device = createRobustBufferAccessVariablePointersDevice(context, instanceWrapper->instance,
                                                                 instanceWrapper->instance.getDriver());
#ifndef CTS_USES_VULKANSC
    de::MovePtr<vk::DeviceDriver> deviceDriver =
    ...
    return new ReadInstance(context, instanceWrapper, device, deviceDriver, m_shaderType, m_shaderStage, m_bufferFormat,
...
TestInstance *RobustWriteTest::createInstance(Context &context) const
{
    ...
    return new WriteInstance(context, instanceWrapper, device, deviceDriver, m_shaderType, m_shaderStage,
...
AccessInstance::AccessInstance(Context &context, std::shared_ptr<CustomInstanceWrapper> instanceWrapper,
    ...
    , m_accessOutOfBackingMemory(accessOutOfBackingMemory)
{
    ...
    createTestBuffer(context, vk, *m_device, outBufferAccessRange, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, memAlloc,
                     m_outBuffer, m_outBufferAlloc, m_outBufferAccess, &populateBufferWithDummy, DE_NULL);
...
ReadInstance::ReadInstance(Context &context, std::shared_ptr<CustomInstanceWrapper> instanceWrapper,
                           Move<VkDevice> device,
#ifndef CTS_USES_VULKANSC
                           de::MovePtr<vk::DeviceDriver> deviceDriver,
#else
    ...
    : AccessInstance(context, instanceWrapper, device, deviceDriver, shaderType, shaderStage, bufferFormat,
                     BUFFER_ACCESS_TYPE_READ_FROM_STORAGE, inBufferAccessRange,
                     RobustAccessWithPointersTest::s_numberOfBytesAccessed, accessOutOfBackingMemory)
{
}

// BufferWriteInstance

WriteInstance::WriteInstance(Context &context, std::shared_ptr<CustomInstanceWrapper> instanceWrapper,
                             Move<VkDevice> device,
#ifndef CTS_USES_VULKANSC
                             de::MovePtr<vk::DeviceDriver> deviceDriver,
#else
    ...
    : AccessInstance(context, instanceWrapper, device, deviceDriver, shaderType, shaderStage, bufferFormat,
                     BUFFER_ACCESS_TYPE_WRITE_TO_STORAGE, RobustAccessWithPointersTest::s_numberOfBytesAccessed,

...
{
public:
    DrawIndexedInstance(Context &context, Move<VkDevice> device, DeviceDriverPtr deviceDriver, TestMode mode,
...
DrawIndexedInstance::DrawIndexedInstance(Context &context, Move<VkDevice> device, DeviceDriverPtr deviceDriver,
                                         TestMode mode, uint32_t robustnessVersion)
...
protected:
    void createDeviceAndDriver(Context &context, Move<VkDevice> &device, DeviceDriverPtr &driver) const;
...
{
public:
    BindIndexBuffer2Instance(Context &c, Move<VkDevice> device, DeviceDriverPtr driver, const TestParams &params);
...
BindIndexBuffer2Instance::BindIndexBuffer2Instance(Context &c, Move<VkDevice> device, DeviceDriverPtr driver,
...
{
    de::MovePtr<tcu::TestCaseGroup> indexAccessTests(
        new tcu::TestCaseGroup(testCtx, "index_access", "Test access outside of the buffer for indices"));

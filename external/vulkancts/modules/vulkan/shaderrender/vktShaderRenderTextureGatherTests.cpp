...
vector<GatherArgs> generateBasic2DCaseIterations(GatherType gatherType, LevelMode levelMode,
...
public:
    TextureGather2DCase(tcu::TestContext &testCtx, const string &name, const string &description,
                        ...
                        const tcu::Sampler::FilterMode magFilter, const LevelMode levelMode, const int baseLevel,
...
void TextureGather2DCase::initPrograms(vk::SourceCollections &dst) const
{
    const vector<GatherArgs> iterations = generateBasic2DCaseIterations(
        m_baseParams.gatherType, m_baseParams.levelMode, m_baseParams.textureFormat,
...
{
    const vector<GatherArgs> iterations =
        generateBasic2DCaseIterations(m_baseParams.gatherType, m_baseParams.levelMode, m_baseParams.textureFormat,
...
vector<Gather2DArrayArgs> generate2DArrayCaseIterations(GatherType gatherType, LevelMode levelMode,
                                                        ...
                                                        const IVec2 &offsetRange, const IVec3 &textureSize)
{
    const vector<GatherArgs> basicIterations =
        generateBasic2DCaseIterations(gatherType, levelMode, textureFormat, offsetRange);
...
vector<GatherCubeArgs> generateCubeCaseIterations(GatherType gatherType, LevelMode levelMode,
                                                  const tcu::TextureFormat &textureFormat, const IVec2 &offsetRange)
{
    const vector<GatherArgs> basicIterations =
        generateBasic2DCaseIterations(gatherType, levelMode, textureFormat, offsetRange);
...
{
    const vector<GatherCubeArgs> iterations =
        generateCubeCaseIterations(m_baseParams.gatherType, m_baseParams.levelMode, m_baseParams.textureFormat,
                                   getOffsetRange(m_baseParams.offsetSize, context.getDeviceProperties().limits));
...
static inline TestCase *makeTextureGatherCase(
    ...
    LevelMode levelMode, int baseLevel, const IVec3 &textureSize, uint32_t flags = 0,
    const ImageBackingMode sparseCase = ShaderRenderCaseInstance::IMAGE_BACKING_MODE_REGULAR)
{
    ...
    case TEXTURETYPE_2D:
        return new TextureGather2DCase(testCtx, name, description, gatherType, offsetSize, textureFormat,
                                       shadowCompareMode, wrapS, wrapT, texSwizzle, minFilter, magFilter, levelMode,
                                       baseLevel, flags, textureSize.swizzle(0, 1), sparseCase);
    ...
    case TEXTURETYPE_2D_ARRAY:
        return new TextureGather2DArrayCase(testCtx, name, description, gatherType, offsetSize, textureFormat,
                                            ...
                                            levelMode, baseLevel, flags, textureSize, sparseCase);
    ...
    case TEXTURETYPE_CUBE:
        ...
        return new TextureGatherCubeCase(testCtx, name, description, textureFormat, shadowCompareMode, wrapS, wrapT,
                                         texSwizzle, minFilter, magFilter, levelMode, baseLevel, flags, textureSize.x(),
                                         sparseCase);

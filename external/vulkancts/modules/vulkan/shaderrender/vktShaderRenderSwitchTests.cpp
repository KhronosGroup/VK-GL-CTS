...
{
public:
    ShaderSwitchCase(tcu::TestContext &testCtx, const string &name, const string &description, bool isVertexCase,
...
ShaderSwitchCase::ShaderSwitchCase(tcu::TestContext &testCtx, const string &name, const string &description,
                                   bool isVertexCase, const string &vtxSource, const string &fragSource,
...
static de::MovePtr<ShaderSwitchCase> makeSwitchCase(tcu::TestContext &testCtx, const string &name, const string &desc,
                                        ...
                                        const bool skipDynamicType)
{
    ...
    for (int type = 0; type < SWITCHTYPE_LAST; type++)
    {
        ...
        addChild(makeSwitchCase(m_testCtx, (name + "_" + switchTypeNames[type] + "_vertex"), desc, (SwitchType)type,
                                true, switchBody)
                     .release());
        addChild(makeSwitchCase(m_testCtx, (name + "_" + switchTypeNames[type] + "_fragment"), desc, (SwitchType)type,
                                false, switchBody)
                     .release());
    }
}

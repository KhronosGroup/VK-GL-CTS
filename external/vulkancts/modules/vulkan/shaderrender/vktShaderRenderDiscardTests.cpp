...
{
public:
    ShaderDiscardCase(tcu::TestContext &testCtx, const char *name, const char *shaderSource,
                                               ...
                                               const std::string &discardStr)
{
    ...
    return de::MovePtr<ShaderDiscardCase>(
        new ShaderDiscardCase(testCtx, name.c_str(), shaderTemplate.specialize(params).c_str(), getEvalFunc(mode),

...
{
public:
    InvarianceTest(tcu::TestContext &ctx, const char *name, const char *desc, const std::string &vertexShader1,
...
InvarianceTest::InvarianceTest(tcu::TestContext &ctx, const char *name, const char *desc,
...
tcu::TestCaseGroup *createShaderInvarianceTests(tcu::TestContext &testCtx)
{
    ...
    static const std::string invariantDeclaration[] = {"invariant gl_Position;",
    ...
    for (int precNdx = 0; precNdx < DE_LENGTH_OF_ARRAY(precisions); ++precNdx)
    {
        ...
        tcu::TestCaseGroup *const group =
            new tcu::TestCaseGroup(testCtx, precisionName, "Invariance tests using the given precision.");
        ...
        for (uint32_t groupNdx = 0u; groupNdx < VAR_GROUP_SIZE; ++groupNdx)
        {
            ...
            varGroup[groupNdx]->addChild(new InvarianceTest(
                testCtx, "common_subexpression_0", "Shader shares a subexpression with an unrelated variable.",
                formatGLSL(
                    "${VERSION}"
            ...
            varGroup[groupNdx]->addChild(new InvarianceTest(
                testCtx, "common_subexpression_1", "Shader shares a subexpression with an unrelated variable.",
                formatGLSL("${VERSION}"
                           "${IN} ${IN_PREC} vec4 a_input;\n"
                           "${OUT} mediump vec4 v_unrelated;\n"
                           "${INVARIANT_DECLARATION}\n"
            ...
            varGroup[groupNdx]->addChild(new InvarianceTest(
                testCtx, "common_subexpression_2", "Shader shares a subexpression with an unrelated variable.",
                formatGLSL("${VERSION}"
                           "${IN} ${IN_PREC} vec4 a_input;\n"
                           "${OUT} mediump vec4 v_unrelated;\n"
                           "${INVARIANT_DECLARATION}\n"
        ...
        {
            varGroup[groupNdx]->addChild(new InvarianceTest(
                testCtx, "loop_0", "Invariant value set using a loop",
                formatGLSL(
                    "${VERSION}"
                    "${IN} ${IN_PREC} vec4 a_input;\n"
            ...
            varGroup[groupNdx]->addChild(new InvarianceTest(
                testCtx, "loop_1", "Invariant value set using a loop",
                formatGLSL(
                    "${VERSION}"
                    "${IN} ${IN_PREC} vec4 a_input;\n"
                    "${OUT} mediump vec4 v_unrelated;\n"
            ...
            varGroup[groupNdx]->addChild(
                new InvarianceTest(testCtx, "loop_2", "Invariant value set using a loop",
                                   formatGLSL("${VERSION}"
                                              "${IN} ${IN_PREC} vec4 a_input;\n"
                                              "${OUT} mediump vec4 v_unrelated;\n"
                                              "${INVARIANT_DECLARATION}\n"
            ...
            varGroup[groupNdx]->addChild(
                new InvarianceTest(testCtx, "loop_3", "Invariant value set using a loop",
                                   formatGLSL("${VERSION}"
                                              "${IN} ${IN_PREC} vec4 a_input;\n"
                                              "${OUT} mediump vec4 v_unrelated;\n"
                                              "${INVARIANT_DECLARATION}\n"
            ...
            varGroup[groupNdx]->addChild(
                new InvarianceTest(testCtx, "loop_4", "Invariant value set using a loop",
                                   formatGLSL("${VERSION}"
                                              "${IN} ${IN_PREC} vec4 a_input;\n"
                                              "${OUT} mediump vec4 v_unrelated;\n"
                                              "${INVARIANT_DECLARATION}\n"

...
{
public:
    ShaderMatrixCase(tcu::TestContext &testCtx, const std::string &name, const std::string &desc,
                     const ShaderInput &in0, const ShaderInput &in1, const MatrixOp op, bool isVertexCase);
...
ShaderMatrixCase::ShaderMatrixCase(tcu::TestContext &testCtx, const std::string &name, const std::string &desc,
                                   const ShaderInput &in0, const ShaderInput &in1, MatrixOp op, bool isVertexCase)
    : ShaderRenderCase(testCtx, name, desc, isVertexCase,
...
ShaderMatrixTests::ShaderMatrixTests(tcu::TestContext &testCtx) : TestCaseGroup(testCtx, "matrix", "Matrix Tests")
{
}
                ...
                for (int precNdx = 0; precNdx < DE_LENGTH_OF_ARRAY(precisions); precNdx++)
                {
                    ...
                    if (isOperationMatrixScalar(op))
                    {
                        ...
                        ShaderInput scalarIn(op == OP_DIV ? INPUTTYPE_UNIFORM : INPUTTYPE_DYNAMIC, TYPE_FLOAT,
                                             precision);
                        inGroup->addChild(new ShaderMatrixCase(m_testCtx, (baseName + "float_vertex").c_str(),
                                                               "Matrix-scalar case", matIn, scalarIn, op, true));
                        inGroup->addChild(new ShaderMatrixCase(m_testCtx, (baseName + "float_fragment").c_str(),
                    ...
                    if (isOperationMatrixVector(op))
                    {
                        ...
                        inGroup->addChild(new ShaderMatrixCase(
                            m_testCtx, (baseName + getDataTypeName(colVecType) + "_vertex").c_str(),
                            "Matrix-vector case", matIn, colVecIn, op, true));
                        inGroup->addChild(new ShaderMatrixCase(
                            m_testCtx, (baseName + getDataTypeName(colVecType) + "_fragment").c_str(),
                        ...
                        inGroup->addChild(new ShaderMatrixCase(m_testCtx, (vecMatName + "_vertex").c_str(),
                                                               "Vector-matrix case", rowVecIn, matIn, op, true));
                        inGroup->addChild(new ShaderMatrixCase(m_testCtx, (vecMatName + "_fragment").c_str(),
                    ...
                    if (isOperationArithmeticMatrixMatrix(op))
                    {
                        ...
                        for (int otherCols = 2; otherCols <= 4; otherCols++)
                        {
                            ...
                            inGroup->addChild(new ShaderMatrixCase(
                                m_testCtx, (baseName + getDataTypeName(otherMatIn.dataType) + "_vertex").c_str(),
                    ...
                    else if (isOperationComponentwiseMatrixMatrix(op))
                    {
                        ...
                        inGroup->addChild(new ShaderMatrixCase(m_testCtx, (baseName + matTypeName + "_vertex").c_str(),
                                                               "Matrix-matrix case", matIn, otherMatIn, op, true));
                        inGroup->addChild(new ShaderMatrixCase(m_testCtx,

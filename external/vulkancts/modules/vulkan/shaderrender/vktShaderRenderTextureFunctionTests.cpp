...
void ShaderTextureFunctionTests::init(void)
{
    ...
    createCaseGroup(this, "textureoffsetclamp", textureOffsetClampARBCases,
    ...
    createCaseGroup(this, "textureprojlodoffset", textureProjLodOffsetCases,
    ...
    createCaseGroup(this, "texturegradoffsetclamp", textureGradOffsetClampCases,
    ...
    createCaseGroup(this, "textureprojgradoffset", textureProjGradOffsetCases,

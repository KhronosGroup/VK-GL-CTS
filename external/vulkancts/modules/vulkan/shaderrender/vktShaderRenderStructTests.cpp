...
{
public:
    ShaderStructCase(tcu::TestContext &testCtx, const std::string &name, bool isVertexCase, ShaderEvalFunc evalFunc,
                     UniformSetupFunc setupUniformsFunc, const std::string &vertShaderSource,
...
static de::MovePtr<ShaderStructCase> createStructCase(tcu::TestContext &testCtx, const std::string &name,
                                                      bool isVertexCase, ShaderEvalFunc evalFunc,
                                                      UniformSetupFunc uniformFunc, const LineStream &shaderSrc)
{
    ...
    return de::MovePtr<ShaderStructCase>(
        new ShaderStructCase(testCtx, name, isVertexCase, evalFunc, uniformFunc, vertSrc, fragSrc));
}

class LocalStructTests : public tcu::TestCaseGroup
{
public:
    LocalStructTests(tcu::TestContext &testCtx) : TestCaseGroup(testCtx, "local")
    {
    }
...
#define LOCAL_STRUCT_CASE(NAME, SHADER_SRC, SET_UNIFORMS_BODY, EVAL_FUNC_BODY)                               \
    ...
    {                                                                                                        \
        ...
        addChild(createStructCase(m_testCtx, #NAME "_vertex", true, &Eval_##NAME::eval,                      \
                                  &SetUniforms_##NAME::setUniforms, SHADER_SRC)                              \
                     .release());                                                                            \
        addChild(createStructCase(m_testCtx, #NAME "_fragment", false, &Eval_##NAME::eval,                   \
                                  &SetUniforms_##NAME::setUniforms, SHADER_SRC)                              \
                     .release());                                                                            \
    } while (false)
...
ShaderStructTests::ShaderStructTests(tcu::TestContext &testCtx) : TestCaseGroup(testCtx, "struct")
{
}

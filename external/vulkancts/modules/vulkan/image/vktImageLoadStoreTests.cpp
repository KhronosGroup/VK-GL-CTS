...
tcu::TestCaseGroup *createImageLoadStoreTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> testGroupWithoutAnyFormat(new tcu::TestCaseGroup(
        testCtx, "without_any_format", "Do not declare a format layout qualifier for read or write images"));

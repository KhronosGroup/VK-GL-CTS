...
{
public:
    AstcDecodeModeCase(TestContext &testCtx, const std::string &name, const TestParameters &parameters);
...
AstcDecodeModeCase::AstcDecodeModeCase(TestContext &testCtx, const std::string &name, const TestParameters &parameters)

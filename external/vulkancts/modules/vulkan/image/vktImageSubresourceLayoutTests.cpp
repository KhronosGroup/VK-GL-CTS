...
public:
    ...
    ImageSubresourceLayoutCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
...
ImageSubresourceLayoutInstance::ImageSubresourceLayoutInstance(Context &context,
                                                               const ImageSubresourceLayoutCase::TestParams &params)
...
{
    de::MovePtr<tcu::TestCaseGroup> layoutTestGroup(
        new tcu::TestCaseGroup(testCtx, "subresource_layout", "Tests for vkGetImageSubresourceLayout"));
    ...
    struct
    {
        ...
        {std::numeric_limits<uint32_t>::max(), "all_levels", "All possible levels"},
    };

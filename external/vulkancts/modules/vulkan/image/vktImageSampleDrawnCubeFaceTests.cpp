...
{
public:
    SampleDrawnCubeFaceTest(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
...
SampleDrawnCubeFaceTest::SampleDrawnCubeFaceTest(tcu::TestContext &testCtx, const std::string &name,
                                                 const std::string &description, const tcu::IVec2 &size,
                                                 const VkFormat format)
...
tcu::TestCaseGroup *createImageSampleDrawnCubeFaceTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> testGroup(
        new tcu::TestCaseGroup(testCtx, "sample_cubemap", "Sample cube map faces that has been rendered to tests"));

...
public:
    DepthTestCase(tcu::TestContext &testCtx, const char *name, const char *description, bool useCustomDevice,
...

{
    ...
    DepthTestCase *testCase =
        new DepthTestCase(testCtx, testInfo.name.c_str(), testInfo.desc.c_str(), !testInfo.unrestricted, readFilename);
...
static void createTests(tcu::TestCaseGroup *g)
{
    static const std::vector<TestInfo> tests = {
        ...
        {"out_of_range_unrestricted",
         "Test late clamping of out-of-range depth values",

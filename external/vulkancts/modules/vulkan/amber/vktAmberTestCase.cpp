...
static bool isFeatureSupported(const vkt::Context &ctx, const std::string &feature)
{
    ...
    if (feature == "Storage16BitFeatures.uniformAndStorageBuffer16BitAccess")
        return ctx.get16BitStorageFeatures().uniformAndStorageBuffer16BitAccess;
    ...
    if (feature == "Storage8BitFeatures.uniformAndStorageBuffer8BitAccess")
        return ctx.get8BitStorageFeatures().uniformAndStorageBuffer8BitAccess;

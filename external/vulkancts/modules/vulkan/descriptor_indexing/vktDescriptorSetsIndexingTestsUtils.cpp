...
std::string buildShaderName(VkShaderStageFlagBits stage, VkDescriptorType descriptorType, bool updateAfterBind,
                            bool calculateInLoop, bool performWritesInVertex)
{
                                                             ...
                                                             bool reserveUniformTexelBuffer) const
{
    ...
    else
    {
        ...
        inputAttachments      = deMinu32(deviceProps.limits.maxPerStageDescriptorInputAttachments,
                                         deviceProps.limits.maxDescriptorSetInputAttachments); // 1048576
    }

...
void DynamicStateBaseClass::initialize(void)
{
    ...
    m_pipelineLayout = vk::makePipelineLayout(m_vk, device, de::sizeU32(rawSetLayouts), de::dataOrNull(rawSetLayouts),
...
void DynamicStateBaseClass::initPipeline(const vk::VkDevice device)
{
    ...
    const vk::Move<vk::VkShaderModule> vs(m_isMesh ?
                                              vk::Move<vk::VkShaderModule>() :

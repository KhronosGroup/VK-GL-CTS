...
void DynamicStateClearTests::init(void)
{
    ...
    addChild(new InstanceFactory<ClearTestInstance>(m_testCtx, "clear", "Clear attachment after setting dynamic states",
                                                    m_pipelineConstructionType, shaderPaths));
    addChild(new InstanceFactory<BlitTestInstance>(m_testCtx, "blit", "Blit image after setting dynamic states",
                                                   m_pipelineConstructionType, shaderPaths));
    addChild(new InstanceFactory<CopyTestInstance>(m_testCtx, "copy", "Copy image after setting dynamic states",
                                                   m_pipelineConstructionType, shaderPaths));
    addChild(new InstanceFactory<ResolveTestInstance>(
        m_testCtx, "resolve", "Resolve image after setting dynamic states", m_pipelineConstructionType, shaderPaths));
}

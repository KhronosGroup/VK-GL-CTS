                                             ...
                                             VkImageFormatProperties2 &imageProperties)
{
    ...
    return vki.getPhysicalDeviceImageFormatProperties2(physicalDevice, &imageFormatInfo, &imageProperties) !=
           VK_ERROR_FORMAT_NOT_SUPPORTED;
}
...
tcu::TestStatus listModifiersCase(Context &context, VkFormat format)
{
    ...
    for (uint32_t m = 0; m < drmFormatModifiers.size(); m++)
    {
        VkImageFormatProperties2 imageProperties{};
        bool isCompatible =
            isModifierCompatibleWithImageProperties(vki, context.getPhysicalDevice(), &format, 1u, VK_IMAGE_TYPE_2D,
                                                    (VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT | VK_IMAGE_USAGE_SAMPLED_BIT),

...
{
public:
    GeometryOutputCountTest(TestContext &testCtx, const char *name, const char *description, const vector<int> pattern);
...
GeometryOutputCountTest::GeometryOutputCountTest(TestContext &testCtx, const char *name, const char *description,
...
{
public:
    VaryingOutputCountCase(TestContext &testCtx, const char *name, const char *description, const VaryingSource test,
                           const ShaderInstancingMode mode);
    void initPrograms(SourceCollections &sourceCollections) const;
    virtual TestInstance *createInstance(Context &context) const;
    virtual void checkSupport(Context &context) const;
...
VaryingOutputCountCase::VaryingOutputCountCase(TestContext &testCtx, const char *name, const char *description,
                                               const VaryingSource test, const ShaderInstancingMode mode)
    : TestCase(testCtx, name, description)
    , m_test(test)
    , m_mode(mode)
...
{
public:
    BuiltinVariableRenderTest(TestContext &testCtx, const char *name, const char *desc, const VariableTest test,
...
BuiltinVariableRenderTest::BuiltinVariableRenderTest(TestContext &testCtx, const char *name, const char *description,
                                                     const VariableTest test, const bool flag)
    : TestCase(testCtx, name, description)
    , m_test(test)
    , m_flag(flag)
{
...
TestCaseGroup *createBasicGeometryShaderTests(TestContext &testCtx)
{
    ...
    basicGroup->addChild(new GeometryOutputCountTest(
        testCtx, "output_10_and_100", "Output 10 and 100 vertices in two invocations", createPattern(10, 100)));
    basicGroup->addChild(new GeometryOutputCountTest(
        testCtx, "output_100_and_10", "Output 100 and 10 vertices in two invocations", createPattern(100, 10)));
    basicGroup->addChild(new GeometryOutputCountTest(
        testCtx, "output_0_and_128", "Output 0 and 128 vertices in two invocations", createPattern(0, 128)));
    basicGroup->addChild(new GeometryOutputCountTest(
        testCtx, "output_128_and_0", "Output 128 and 0 vertices in two invocations", createPattern(128, 0)));

    basicGroup->addChild(new VaryingOutputCountCase(testCtx, "output_vary_by_attribute",
                                                    "Output varying number of vertices", READ_ATTRIBUTE,
                                                    MODE_WITHOUT_INSTANCING));
    basicGroup->addChild(new VaryingOutputCountCase(
        testCtx, "output_vary_by_uniform", "Output varying number of vertices", READ_UNIFORM, MODE_WITHOUT_INSTANCING));
    basicGroup->addChild(new VaryingOutputCountCase(
        testCtx, "output_vary_by_texture", "Output varying number of vertices", READ_TEXTURE, MODE_WITHOUT_INSTANCING));
    basicGroup->addChild(new VaryingOutputCountCase(testCtx, "output_vary_by_attribute_instancing",
                                                    "Output varying number of vertices", READ_ATTRIBUTE,
                                                    MODE_WITH_INSTANCING));
    basicGroup->addChild(new VaryingOutputCountCase(testCtx, "output_vary_by_uniform_instancing",
                                                    "Output varying number of vertices", READ_UNIFORM,
                                                    MODE_WITH_INSTANCING));
    basicGroup->addChild(new VaryingOutputCountCase(testCtx, "output_vary_by_texture_instancing",
                                                    "Output varying number of vertices", READ_TEXTURE,
                                                    MODE_WITH_INSTANCING));

    basicGroup->addChild(new BuiltinVariableRenderTest(testCtx, "point_size", "test gl_PointSize", TEST_POINT_SIZE));
    basicGroup->addChild(
        new BuiltinVariableRenderTest(testCtx, "primitive_id_in", "test gl_PrimitiveIDIn", TEST_PRIMITIVE_ID_IN));
    basicGroup->addChild(new BuiltinVariableRenderTest(testCtx, "primitive_id_in_restarted",
                                                       "test gl_PrimitiveIDIn with primitive restart",
                                                       TEST_PRIMITIVE_ID_IN, true));
    basicGroup->addChild(
        new BuiltinVariableRenderTest(testCtx, "primitive_id", "test gl_PrimitiveID", TEST_PRIMITIVE_ID));

...
vk::VkImageCreateInfo makeImageCreateInfo(const tcu::IVec2 &size, const vk::VkFormat format,
                                          const vk::VkImageUsageFlags usage, const uint32_t numArrayLayers = 1u);
vk::VkBufferImageCopy makeBufferImageCopy(const vk::VkDeviceSize &bufferOffset,
...
void fillBuffer(const vk::DeviceInterface &vk, const vk::VkDevice device, const vk::Allocation &alloc,
                const vk::VkDeviceSize size, const vk::VkDeviceSize offset, const vk::VkFormat format,

...
Move<VkDevice> createTestDevice(const vk::Platform &platform, const PlatformInterface &vkp, const VkInstance instance,
...
SwapchainCounterTestInstance::SwapchainCounterTestInstance(Context &context)
    ...
    , m_device(createTestDevice(context.getTestContext().getPlatform().getVulkanPlatform(), m_vkp, m_instance, m_vki,

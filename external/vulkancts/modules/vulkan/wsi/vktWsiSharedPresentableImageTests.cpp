...
std::vector<vk::VkSwapchainCreateInfoKHR> generateSwapchainConfigs(
    vk::VkSurfaceKHR surface, uint32_t queueFamilyIndex, Scaling scaling,
    ...
    vk::VkImageUsageFlags supportedImageUsage, const vk::VkSurfaceTransformFlagsKHR transform,
                                                                  ...
                                                                  vk::VkImageUsageFlags *usage)
{
    ...
    capabilities.sType = vk::VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_2_KHR, capabilities.pNext = &sharedCapabilities;
...
SharedPresentableImageTestInstance::SharedPresentableImageTestInstance(Context &context, const TestConfig &testConfig)
    ...
    , m_swapchainConfigs(generateSwapchainConfigs(
          *m_surface, m_queueFamilyIndex, testConfig.scaling, m_surfaceProperties, m_surfaceFormats, m_presentModes,
          testConfig.presentMode, m_supportedUsageFlags, testConfig.transform, testConfig.alpha))
        ...
        if (error.getError() == vk::VK_ERROR_OUT_OF_DATE_KHR)
        {
            m_swapchainConfigs =
                generateSwapchainConfigs(*m_surface, m_queueFamilyIndex, m_testConfig.scaling, m_surfaceProperties,
                                         m_surfaceFormats, m_presentModes, m_testConfig.presentMode,
                                         m_supportedUsageFlags, m_testConfig.transform, m_testConfig.alpha);

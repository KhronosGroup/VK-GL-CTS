...
void FConvertTestCase::initPrograms(vk::SourceCollections &programCollection) const
{
    ...
    case FLOAT_TYPE_E2M1:
        ...
        case 2:
            ...
            if (m_params.bitcastExtract)
                s("    fe2m1vec2 f = bitcastExtractfe2m1EXT(u * 2, 1);");
            else
        ...
        case 3:
            ...
            if (m_params.bitcastExtract)
                s("    fe2m1vec3 f = bitcastExtractfe2m1EXT(u * 2, 1).zyx;");
            else
        ...
        case 4:
            ...
            if (m_params.bitcastExtract)
                s("    fe2m1vec4 f = bitcastExtractfe2m1EXT(u * 2, 1);");
            else
    ...
    case FLOAT_TYPE_E3M2:
        ...
        case 2:
            s("    u8vec2 u = issbo.val[gl_WorkGroupID.x];");
            if (m_params.bitcastExtract)
                s("    fe3m2vec2 f = bitcastExtractfe3m2EXT(u * 2, 1);");
            else
        ...
        case 3:
            ...
            if (m_params.bitcastExtract)
                s("    fe3m2vec3 f = bitcastExtractfe3m2EXT(u * 2, 1).zxy;");
            else
        ...
        case 4:
            s("    u8vec4 u = issbo.val[gl_WorkGroupID.x];");
            if (m_params.bitcastExtract)
                s("    fe3m2vec4 f = bitcastExtractfe3m2EXT(u * 2, 1);");
            else
    ...
    case FLOAT_TYPE_E2M3:
        ...
        case 2:
            s("    u8vec2 u = issbo.val[gl_WorkGroupID.x];");
            if (m_params.bitcastExtract)
                s("    fe2m3vec2 f = bitcastExtractfe2m3EXT(u * 2, 1);");
            else
        ...
        case 3:
            ...
            if (m_params.bitcastExtract)
                s("    fe2m3vec3 f = bitcastExtractfe2m3EXT(u * 2, 1);");
            else
        ...
        case 4:
            ...
            if (m_params.bitcastExtract)
                s("    fe2m3vec4 f = bitcastExtractfe2m3EXT(u * 2, 1).wzyx;");
            else

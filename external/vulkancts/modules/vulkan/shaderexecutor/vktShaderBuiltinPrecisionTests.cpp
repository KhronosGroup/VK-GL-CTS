...
protected:
    ...
    IVal doEvaluate(const EvalContext &ctx) const
    {
        return ctx.format.roundOut(makeIVal(m_value), true);
    }
...
BuiltinPrecisionTests::BuiltinPrecisionTests(tcu::TestContext &testCtx) : tcu::TestCaseGroup(testCtx, "precision")
{
}

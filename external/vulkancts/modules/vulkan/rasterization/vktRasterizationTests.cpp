...
public:
    BaseLineTestInstance(Context &context, VkPrimitiveTopology primitiveTopology, PrimitiveWideness wideness,
                         ...
                         VkLineRasterizationModeEXT lineRasterizationMode, const uint32_t additionalRenderSize = 0,
                         const uint32_t renderSize = RESOLUTION_POT, const float narrowLineWidth = 1.0f);
    virtual tcu::TestStatus iterate(void);
    virtual float getLineWidth(void) const;
    ...
    virtual bool getLineStippleDynamic(void) const
    {
        return m_stipple == LINESTIPPLE_DYNAMIC;
    };
...
BaseLineTestInstance::BaseLineTestInstance(Context &context, VkPrimitiveTopology primitiveTopology,
                                           ...
                                           const uint32_t additionalRenderSize, const uint32_t renderSize,
...
const VkPipelineRasterizationLineStateCreateInfoEXT *BaseLineTestInstance::getLineRasterizationStateCreateInfo(
    void) const
{
    if (m_lineRasterizationMode == VK_LINE_RASTERIZATION_MODE_EXT_LAST)
        return DE_NULL;
...
PointTestInstance::PointTestInstance(Context &context, PrimitiveWideness wideness, PrimitiveStrictness strictness,
                                     VkSampleCountFlagBits sampleCount, LineStipple stipple,
                                     VkLineRasterizationModeEXT lineRasterizationMode, uint32_t additionalRenderSize,
    ...
    std::vector<TriangleSceneSpec::SceneTriangle> &triangles, tcu::Surface &resultImage)
{
    ...
    if (m_conservativeRasterizationProperties.degenerateTrianglesRasterized)
    {
        if (getIteration() != 0)
        {
            log << tcu::TestLog::Message << "Triangles expected to be rasterized with one pixel of white color each"
                << tcu::TestLog::EndMessage;
...
const VkPipelineRasterizationLineStateCreateInfoEXT *ConservativeTraingleTestInstance::
    getLineRasterizationStateCreateInfo(void) const
{
    return DE_NULL;
}
...
ConservativeLineTestInstance::ConservativeLineTestInstance(Context &context,
    ...
    : BaseLineTestInstance(context, conservativeTestConfig.primitiveTopology, PRIMITIVEWIDENESS_NARROW,
                           ...
                           VK_LINE_RASTERIZATION_MODE_DEFAULT_EXT, 0, conservativeTestConfig.resolution,
...
public:
    ConservativePointTestInstance(Context &context, ConservativeTestConfig conservativeTestConfig,
        ...
        : PointTestInstance(context, PRIMITIVEWIDENESS_NARROW, PRIMITIVESTRICTNESS_IGNORE, sampleCount,
                            LINESTIPPLE_DISABLED, VK_LINE_RASTERIZATION_MODE_DEFAULT_EXT, 0,
...
public:
    WidenessTestCase(tcu::TestContext &context, const std::string &name, const std::string &description,
                     ...
                     VkSampleCountFlagBits sampleCount, LineStipple stipple,
                     VkLineRasterizationModeEXT lineRasterizationMode, uint32_t additionalRenderSize = 0)
        : BaseRenderingTestCase(context, name, description, sampleCount)
        , m_wideness(wideness)
    ...
    virtual TestInstance *createInstance(Context &context) const
    {
        return new ConcreteTestInstance(context, m_wideness, m_strictness, m_sampleCount, m_stipple,
                                        m_lineRasterizationMode, m_additionalRenderSize);
    }
...
public:
    LinesTestInstance(Context &context, PrimitiveWideness wideness, PrimitiveStrictness strictness,
        ...
        : BaseLineTestInstance(context, VK_PRIMITIVE_TOPOLOGY_LINE_LIST, wideness, strictness, sampleCount, stipple,
                               lineRasterizationMode, additionalRenderSize)
    {
    }
...
public:
    LineStripTestInstance(Context &context, PrimitiveWideness wideness, PrimitiveStrictness strictness,
                          VkSampleCountFlagBits sampleCount, LineStipple stipple,
                          VkLineRasterizationModeEXT lineRasterizationMode, uint32_t)
...
void createRasterizationTests(tcu::TestCaseGroup *rasterizationTests)
{
    ...
    // .primitives
    {
        ...
        for (int i = 0; i < 3; ++i)
        {
            ...
            g->addChild(new WidenessTestCase<LinesTestInstance>(
                testCtx, "lines", "Render primitives as VK_PRIMITIVE_TOPOLOGY_LINE_LIST, verify rasterization result",
                PRIMITIVEWIDENESS_NARROW, PRIMITIVESTRICTNESS_IGNORE, true, VK_SAMPLE_COUNT_1_BIT, stipple,
                VK_LINE_RASTERIZATION_MODE_DEFAULT_EXT, i == 0 ? RESOLUTION_NPOT : 0));
    ...
    // .provoking_vertex
    {
        tcu::TestCaseGroup *const provokingVertex =
            new tcu::TestCaseGroup(testCtx, "provoking_vertex", "Test provoking vertex");
        ...
        for (uint32_t primitiveTypeIdx = 0; primitiveTypeIdx < DE_LENGTH_OF_ARRAY(primitiveTypes); primitiveTypeIdx++)
        {
            ...
            cts_amber::AmberTestCase *testCase =
                cts_amber::createAmberTestCase(testCtx, params.type, "", "provoking_vertex", file);

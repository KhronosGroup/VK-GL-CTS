...
public:
    ...
    InstanceFactory1(tcu::TestContext &testCtx, tcu::TestNodeType type, const std::string &name, const Programs &progs,
                     const Arg0 &arg0)
        : TestCase(testCtx, type, name)
        , m_progs(progs)
        , m_arg0(arg0)
...
public:
    ...
    InstanceFactory1WithSupport(tcu::TestContext &testCtx, tcu::TestNodeType type, const std::string &name,
                                const Programs &progs, const Arg0 &arg0, const Support &support)
        : TestCase(testCtx, type, name)
        , m_progs(progs)
        , m_arg0(arg0)
        , m_support(support)
                                    ...
                                    FunctionSupport0::Function checkSupport, FunctionInstance0::Function testFunction)
{
    return new InstanceFactory1WithSupport<FunctionInstance0, FunctionInstance0::Function, FunctionSupport0>(
        testCtx, type, name, testFunction, checkSupport);
}

inline TestCase *createFunctionCaseWithPrograms(tcu::TestContext &testCtx, tcu::TestNodeType type,
                                                const std::string &name, FunctionPrograms0::Function initPrograms,
                                                FunctionInstance0::Function testFunction)
{
...
{
    return new InstanceFactory1<FunctionInstance1<Arg0>, typename FunctionInstance1<Arg0>::Args,
                                FunctionPrograms1<Arg0>>(testCtx, type, name, FunctionPrograms1<Arg0>(initPrograms),
                                         ...
                                         typename FunctionInstance1<Arg0>::Function testFunction, Arg0 arg0)
{
    return new InstanceFactory1WithSupport<FunctionInstance1<Arg0>, typename FunctionInstance1<Arg0>::Args,
        ...
        testCtx, type, name, FunctionPrograms1<Arg0>(initPrograms),
        typename FunctionInstance1<Arg0>::Args(testFunction, arg0),
        typename FunctionSupport1<Arg0>::Args(checkSupport, arg0));
}
...
{
    group->addChild(
        createFunctionCase(group->getTestContext(), tcu::NODETYPE_SELF_VALIDATE, name, checkSupport, testFunc));
}
...
{
    group->addChild(createFunctionCaseWithPrograms(group->getTestContext(), tcu::NODETYPE_SELF_VALIDATE, name,
...
{
    group->addChild(
        createFunctionCase<Arg0>(group->getTestContext(), tcu::NODETYPE_SELF_VALIDATE, name, testFunc, arg0));
}
...
void addFunctionCase(tcu::TestCaseGroup *group, const std::string &name,
                     ...
                     typename FunctionInstance1<Arg0>::Function testFunc, Arg0 arg0)
{
    group->addChild(createFunctionCase<Arg0>(group->getTestContext(), tcu::NODETYPE_SELF_VALIDATE, name, checkSupport,
                                             testFunc, arg0));
}
...
{
    group->addChild(createFunctionCaseWithPrograms<Arg0>(group->getTestContext(), tcu::NODETYPE_SELF_VALIDATE, name,
                                                         checkSupport, initPrograms, testFunc, arg0));
}

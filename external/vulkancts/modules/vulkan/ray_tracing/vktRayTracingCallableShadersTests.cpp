...
CallableShaderTestCase::CallableShaderTestCase(tcu::TestContext &context, const char *name, const char *desc,
...
tcu::TestCaseGroup *createCallableShadersTests(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "callable_shader", "Tests veryfying callable shaders"));
    ...
    {
        TestParams testParams{TEST_WIDTH, TEST_HEIGHT, callableShaderTestTypes[shaderTestNdx].shaderTestType,

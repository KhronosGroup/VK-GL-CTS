...
de::MovePtr<BufferWithMemory> RayTracingComplexControlFlowInstance::runTest(void)
{
    ...
    beginCommandBuffer(vkd, *cmdBuffer, 0u);
    {
        ...
        cmdPipelineImageMemoryBarrier(vkd, *cmdBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT, ALL_RAY_TRACING_STAGES,
                                      &postImageBarrier);
        ...
        cmdPipelineMemoryBarrier(vkd, *cmdBuffer, VK_PIPELINE_STAGE_TRANSFER_BIT, ALL_RAY_TRACING_STAGES,
        ...
        cmdPipelineMemoryBarrier(vkd, *cmdBuffer, ALL_RAY_TRACING_STAGES, VK_PIPELINE_STAGE_TRANSFER_BIT,
...
ComplexControlFlowTestCase::ComplexControlFlowTestCase(tcu::TestContext &context, const char *name, const char *desc,
                                                       const CaseDef data)
...
tcu::TestCaseGroup *createComplexControlFlowTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "complexcontrolflow", "Ray tracing complex control flow tests"));

...
tcu::TestCaseGroup *createBarycentricCoordinatesTests(tcu::TestContext &testCtx)
{
    ...
    mainGroup->addChild(
        new BarycentricCoordinatesCase(testCtx, "ahit", "", TestParams{VK_SHADER_STAGE_ANY_HIT_BIT_KHR, seed++}));
    mainGroup->addChild(
        new BarycentricCoordinatesCase(testCtx, "chit", "", TestParams{VK_SHADER_STAGE_CLOSEST_HIT_BIT_KHR, seed++}));

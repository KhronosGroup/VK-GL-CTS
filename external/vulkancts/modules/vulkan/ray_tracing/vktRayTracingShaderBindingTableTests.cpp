...
{
public:
    ShaderGroupHandleAlignmentCase(tcu::TestContext &testCtx, const std::string &name,
...
tcu::TestCaseGroup *createShaderBindingTableTests(tcu::TestContext &testCtx)
{
...

    {
        ...
        // Test allowed handle alignments
        de::MovePtr<tcu::TestCaseGroup> handleAlignmentGroup(new tcu::TestCaseGroup(testCtx, "handle_alignment"));

...
void initFrameBufferPrograms(SourceCollections &programCollection, CaseDefinition caseDef)
{
    ...
    const string extensionHeader =
        (caseDef.extShaderSubGroupBallotTests ? "OpExtension \"SPV_KHR_shader_ballot\"\n" : "");
    const string capabilityBallotHeader =
        (caseDef.extShaderSubGroupBallotTests ? "OpCapability SubgroupBallotKHR\n" :
    ...
    if (VK_SHADER_STAGE_VERTEX_BIT == caseDef.shaderStage)
    {
        ...
        */
        const string vertex = "; SPIR-V\n"
                              ...
                              capabilityBallotHeader + extensionHeader +
                              ...
                              "OpStore %8 %9\n"
                              "%15 = " +
                              (caseDef.extShaderSubGroupBallotTests ? "OpSubgroupBallotKHR %10 %13" :
                                                                      "OpGroupNonUniformBallot %10 %14 %13") +
                              "\n"
                              ...
                              "%41 = OpLoad %12 %28\n"
                              "%42 = " +
                              (caseDef.extShaderSubGroupBallotTests ? "OpSubgroupBallotKHR %10 %41" :
                                                                      "OpGroupNonUniformBallot %10 %14 %41") +
                              "\n"
                              ...
                              "OpStore %8 %50\n"
                              "%52 = " +
                              (caseDef.extShaderSubGroupBallotTests ? "OpSubgroupBallotKHR %10 %51" :
                                                                      "OpGroupNonUniformBallot %10 %14 %51") +
                              "\n"
    ...
    else if (VK_SHADER_STAGE_GEOMETRY_BIT == caseDef.shaderStage)
    {
        ...
        */
        ...
        geometry << "; SPIR-V\n"
                 ...
                 << "OpCapability GroupNonUniform\n"
                 << capabilityBallotHeader.c_str() << extensionHeader.c_str()
                 << "%1 = OpExtInstImport \"GLSL.std.450\"\n"
                 << "OpMemoryModel Logical GLSL450\n"
                 ...
                 << (*caseDef.geometryPointSizeSupported ? "%80 = OpTypePointer Input %60\n"
                 ...
                 << "OpStore %79 %77\n"
                 << (*caseDef.geometryPointSizeSupported ? "%82 = OpAccessChain %80 %74 %22 %21\n"
                                                           "%83 = OpLoad %60 %82\n"
    ...
    else if (VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT == caseDef.shaderStage)
    {
        ...
        */
        const string controlSource = "; SPIR-V\n"
                                     ...
                                     "OpStore %27 %28\n"
                                     "%33 = " +
                                     (caseDef.extShaderSubGroupBallotTests ? "OpSubgroupBallotKHR %29 %31" :
                                                                             "OpGroupNonUniformBallot %29 %32 %31") +
                                     "\n"
                                     ...
                                     "%56 = OpLoad %11 %43\n"
                                     "%57 = " +
                                     (caseDef.extShaderSubGroupBallotTests ? "OpSubgroupBallotKHR %29 %56" :
                                                                             "OpGroupNonUniformBallot %29 %32 %56") +
                                     "\n"
                                     ...
                                     "OpStore %27 %65\n"
                                     "%67 = " +
                                     (caseDef.extShaderSubGroupBallotTests ? "OpSubgroupBallotKHR %29 %66" :
                                                                             "OpGroupNonUniformBallot %29 %32 %66") +
                                     "\n"
...
{
    const string extensionHeader =
        (caseDef.extShaderSubGroupBallotTests ? "#extension GL_ARB_shader_ballot: enable\n"
    ...
    if (VK_SHADER_STAGE_COMPUTE_BIT == caseDef.shaderStage)
    {
        ...
        src << "#version 450\n"
            ...
            << "  uint tempResult = 0;\n"
            << "  tempResult |= sharedMemoryBallot(true) == "
            << (caseDef.extShaderSubGroupBallotTests ? "ballotARB" : "subgroupBallot") << "(true) ? 0x1 : 0;\n"
            << "  bool bData = data[gl_SubgroupInvocationID] != 0;\n"
            << "  tempResult |= sharedMemoryBallot(bData) == "
            << (caseDef.extShaderSubGroupBallotTests ? "ballotARB" : "subgroupBallot") << "(bData) ? 0x2 : 0;\n"
            << "  tempResult |= "
            << (caseDef.extShaderSubGroupBallotTests ? "uint64_t(0) == ballotARB" : "uvec4(0) == subgroupBallot")
            << "(false) ? 0x4 : 0;\n"
    ...
    else
    {
        const string cmpStr =
            (caseDef.extShaderSubGroupBallotTests ? "uint64_t(0) == ballotARB" : "uvec4(0) == subgroupBallot");
        const string testSrc = "  uint tempResult = 0;\n"
                               "  tempResult |= !bool(" +
                               cmpStr +
                               "(true)) ? 0x1 : 0;\n"
                               "  bool bData = data[gl_SubgroupInvocationID] != 0;\n"
...
tcu::TestCaseGroup *createSubgroupsBallotTests(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> graphicGroup(
        new tcu::TestCaseGroup(testCtx, "graphics", "Subgroup ballot category tests: graphics"));
    de::MovePtr<tcu::TestCaseGroup> computeGroup(
        new tcu::TestCaseGroup(testCtx, "compute", "Subgroup ballot category tests: compute"));
    de::MovePtr<tcu::TestCaseGroup> framebufferGroup(
        new tcu::TestCaseGroup(testCtx, "framebuffer", "Subgroup ballot category tests: framebuffer"));

    de::MovePtr<tcu::TestCaseGroup> graphicGroupEXT(
        new tcu::TestCaseGroup(testCtx, "graphics", "VK_EXT_shader_subgroups_ballot category tests: graphics"));
    de::MovePtr<tcu::TestCaseGroup> computeGroupEXT(
        new tcu::TestCaseGroup(testCtx, "compute", "VK_EXT_shader_subgroups_ballot category tests: compute"));
    de::MovePtr<tcu::TestCaseGroup> framebufferGroupEXT(
        new tcu::TestCaseGroup(testCtx, "framebuffer", "VK_EXT_shader_subgroups_ballot category tests: framebuffer"));

    const VkShaderStageFlags stages[] = {VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT,
                                         VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT, VK_SHADER_STAGE_GEOMETRY_BIT,
                                         VK_SHADER_STAGE_VERTEX_BIT};

    {
        CaseDefinition caseDef = {VK_SHADER_STAGE_COMPUTE_BIT, de::SharedPtr<bool>(new bool), false, false};
        addFunctionCaseWithPrograms(computeGroup.get(), getShaderStageName(caseDef.shaderStage), "", supportedCheck,
                                    initPrograms, test, caseDef);
        caseDef.extShaderSubGroupBallotTests = true;
        addFunctionCaseWithPrograms(computeGroupEXT.get(), getShaderStageName(caseDef.shaderStage), "", supportedCheck,
                                    initPrograms, test, caseDef);

        caseDef.requiredSubgroupSize         = true;
        caseDef.extShaderSubGroupBallotTests = false;
        addFunctionCaseWithPrograms(computeGroup.get(),
                                    getShaderStageName(caseDef.shaderStage) + "_requiredsubgroupsize", "",
                                    supportedCheck, initPrograms, test, caseDef);
        caseDef.extShaderSubGroupBallotTests = true;
        addFunctionCaseWithPrograms(computeGroupEXT.get(),
                                    getShaderStageName(caseDef.shaderStage) + "_requiredsubgroupsize", "",
                                    supportedCheck, initPrograms, test, caseDef);
    }

    {
        CaseDefinition caseDef = {VK_SHADER_STAGE_ALL_GRAPHICS, de::SharedPtr<bool>(new bool), false, false};
    ...
    {
        CaseDefinition caseDef = {stages[stageIndex], de::SharedPtr<bool>(new bool), false, false};
        addFunctionCaseWithPrograms(framebufferGroup.get(), getShaderStageName(caseDef.shaderStage), "", supportedCheck,
    ...
    de::MovePtr<tcu::TestCaseGroup> groupEXT(
        new tcu::TestCaseGroup(testCtx, "ext_shader_subgroup_ballot", "VK_EXT_shader_subgroups_ballot category tests"));
    ...
    de::MovePtr<tcu::TestCaseGroup> group(new tcu::TestCaseGroup(testCtx, "ballot", "Subgroup ballot category tests"));

...
string getMaskTypeName(const MaskType maskType)
{
    ...
    default:
        TCU_THROW(InternalError, "Unsupported mask type");
    }
}

string getBodySource(const CaseDefinition &caseDef)
{
    string body = "  uint64_t value = " + getMaskTypeName(caseDef.maskType) +
                  ";\n"
                  "  bool temp = true;\n";
...
{
    return "#extension GL_ARB_shader_ballot: enable\n"
    ...
    if (isAllComputeStages(caseDef.shaderStage))
    {
        ...
        case MASKTYPE_EQ:
            compute += "; SPIR-V\n"
                       ...
                       "%gl_SubGroupEqMaskARB %gl_SubGroupInvocationARB\n"
        ...
        case MASKTYPE_GE:
            compute += "; SPIR-V\n"
                       ...
                       "OpMemoryModel Logical GLSL450\n"
                       "OpEntryPoint GLCompute %main \"main\" %gl_NumWorkGroups %gl_GlobalInvocationID "
                       "%gl_SubGroupGeMaskARB %gl_SubGroupSizeARB %gl_SubGroupInvocationARB\n"
                       "OpExecutionMode %main LocalSize 1 1 1\n"
                       "OpSource GLSL 450\n"
                       "OpSourceExtension \"GL_ARB_gpu_shader_int64\"\n"
                       "OpSourceExtension \"GL_ARB_shader_ballot\"\n"
        ...
        case MASKTYPE_GT:
            compute += "; SPIR-V\n"
                       ...
                       "OpMemoryModel Logical GLSL450\n"
                       "OpEntryPoint GLCompute %main \"main\" %gl_NumWorkGroups %gl_GlobalInvocationID "
                       "%gl_SubGroupGtMaskARB %gl_SubGroupSizeARB %gl_SubGroupInvocationARB\n"
                       "OpExecutionMode %main LocalSize 1 1 1\n"
                       "OpSource GLSL 450\n"
                       "OpSourceExtension \"GL_ARB_gpu_shader_int64\"\n"
                       "OpSourceExtension \"GL_ARB_shader_ballot\"\n"
        ...
        case MASKTYPE_LE:
            compute += "; SPIR-V\n"
                       ...
                       "OpMemoryModel Logical GLSL450\n"
                       "OpEntryPoint GLCompute %main \"main\" %gl_NumWorkGroups %gl_GlobalInvocationID "
                       "%gl_SubGroupLeMaskARB %gl_SubGroupSizeARB %gl_SubGroupInvocationARB\n"
                       "OpExecutionMode %main LocalSize 1 1 1\n"
                       "OpSource GLSL 450\n"
                       "OpSourceExtension \"GL_ARB_gpu_shader_int64\"\n"
                       "OpSourceExtension \"GL_ARB_shader_ballot\"\n"
        ...
        case MASKTYPE_LT:
            compute += "; SPIR-V\n"
                       ...
                       "OpMemoryModel Logical GLSL450\n"
                       "OpEntryPoint GLCompute %main \"main\" %gl_NumWorkGroups %gl_GlobalInvocationID "
                       "%gl_SubGroupLtMaskARB %gl_SubGroupSizeARB %gl_SubGroupInvocationARB\n"
                       "OpExecutionMode %main LocalSize 1 1 1\n"
                       "OpSource GLSL 450\n"
                       "OpSourceExtension \"GL_ARB_gpu_shader_int64\"\n"
                       "OpSourceExtension \"GL_ARB_shader_ballot\"\n"
...
TestCaseGroup *createSubgroupsBallotMasksTests(TestContext &testCtx)
{
    de::MovePtr<TestCaseGroup> group(
        new TestCaseGroup(testCtx, "ballot_mask", "VK_EXT_shader_subgroup_ballot mask category tests"));
    de::MovePtr<TestCaseGroup> groupARB(
        new TestCaseGroup(testCtx, "ext_shader_subgroup_ballot", "VK_EXT_shader_subgroup_ballot masks category tests"));
    de::MovePtr<TestCaseGroup> graphicGroup(
        new TestCaseGroup(testCtx, "graphics", "VK_EXT_shader_subgroup_ballot masks category tests: graphics"));
    de::MovePtr<TestCaseGroup> computeGroup(
        new TestCaseGroup(testCtx, "compute", "VK_EXT_shader_subgroup_ballot masks category tests: compute"));
    de::MovePtr<TestCaseGroup> framebufferGroup(
        new TestCaseGroup(testCtx, "framebuffer", "VK_EXT_shader_subgroup_ballot masks category tests: framebuffer"));
#ifndef CTS_USES_VULKANSC
    de::MovePtr<TestCaseGroup> raytracingGroup(
        new TestCaseGroup(testCtx, "ray_tracing", "VK_EXT_shader_subgroup_ballot masks category tests: ray tracing"));
    de::MovePtr<TestCaseGroup> meshGroup(
        new TestCaseGroup(testCtx, "mesh", "VK_EXT_shader_subgroup_ballot masks category tests: mesh shaders"));
#endif // CTS_USES_VULKANSC
    ...
    for (int maskTypeIndex = 0; maskTypeIndex < MASKTYPE_LAST; ++maskTypeIndex)
    {
        ...
        for (size_t groupSizeNdx = 0; groupSizeNdx < DE_LENGTH_OF_ARRAY(boolValues); ++groupSizeNdx)
        {
            for (const auto &stage : meshStages)
            {
                ...
                addFunctionCaseWithPrograms(meshGroup.get(), testName + "_" + getShaderStageName(stage), supportedCheck,

...
tcu::TestCaseGroup *createSubgroupsBuiltinMaskVarTests(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> graphicGroup(
        new tcu::TestCaseGroup(testCtx, "graphics", "Subgroup builtin mask category    tests: graphics"));
    de::MovePtr<tcu::TestCaseGroup> computeGroup(
        new tcu::TestCaseGroup(testCtx, "compute", "Subgroup builtin mask category tests: compute"));
    de::MovePtr<tcu::TestCaseGroup> framebufferGroup(
        new tcu::TestCaseGroup(testCtx, "framebuffer", "Subgroup builtin mask category tests: framebuffer"));
    ...
    for (int a = 0; a < DE_LENGTH_OF_ARRAY(all_stages_vars); ++a)
    {
...

        {
            ...
            addFunctionCaseWithPrograms(computeGroup.get(), varLower, "", supportedCheck, initPrograms, test, caseDef);
            caseDef.requiredSubgroupSize = true;
            addFunctionCaseWithPrograms(computeGroup.get(), varLower + "_requiredsubgroupsize", "", supportedCheck,
    ...
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "builtin_mask_var", "Subgroup builtin mask variable tests"));

...
TestStatus noSSBOtest(Context &context, const CaseDefinition caseDef)
{
    ...
    case VK_SHADER_STAGE_VERTEX_BIT:
        return makeVertexFrameBufferTest(context, VK_FORMAT_R32_UINT, nullptr, 0, nullptr, checkVertexPipelineStages);
    case VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT:
        return makeTessellationEvaluationFrameBufferTest(context, VK_FORMAT_R32_UINT, nullptr, 0, nullptr,
                                                         checkVertexPipelineStages);
    case VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT:
        return makeTessellationEvaluationFrameBufferTest(context, VK_FORMAT_R32_UINT, nullptr, 0, nullptr,
                                                         checkVertexPipelineStages);
    case VK_SHADER_STAGE_GEOMETRY_BIT:
        return makeGeometryFrameBufferTest(context, VK_FORMAT_R32_UINT, nullptr, 0, nullptr, checkVertexPipelineStages);
    default:
...
TestStatus test(Context &context, const CaseDefinition caseDef)
{
    ...
    if (isCompute || isMesh)
    {
        ...
        {
            if (isCompute)
                return makeComputeTest(context, VK_FORMAT_R32_UINT, nullptr, 0, nullptr, checkComputeOrMeshStage);
            else

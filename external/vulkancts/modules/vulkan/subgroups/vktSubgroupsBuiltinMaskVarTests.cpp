...
static bool checkComputeStage(const void *internalData, vector<const void *> datas, const uint32_t numWorkgroups[3],
...
TestStatus test(Context &context, const CaseDefinition caseDef)
{
    if (isAllComputeStages(caseDef.shaderStage))
    {
        ...
        {
            TestStatus result =
                subgroups::makeComputeTest(context, VK_FORMAT_R32_UINT, DE_NULL, 0, DE_NULL, checkComputeStage, size,

...
struct Case
{
    Case(const char *b, const char *d, bool sw, bool use_ssc, vk::VkShaderStageFlagBits s,
         vk::VkSubgroupFeatureFlagBits o)
        : basename(b)
        , description(d)
        , small_workgroups(sw)
...
struct CaseGroup
{
    ...
    void add(const char *basename, const char *description, bool small_workgroups, bool use_subgroup_size_control,
             vk::VkShaderStageFlagBits stage,
...
{
public:
    SubgroupUniformControlFlowTestCase(tcu::TestContext &testCtx, const char *name, const char *description,
                                       const std::string &readFilename, bool small_workgroups,
                                       bool use_subgroup_size_control, vk::VkShaderStageFlagBits stage,
                                       vk::VkSubgroupFeatureFlagBits operation)
...
void addTestsForAmberFiles(tcu::TestCaseGroup *tests, CaseGroup group)
{
    ...
    for (unsigned i = 0; i < cases.size(); ++i)
    {
        ...
        SubgroupUniformControlFlowTestCase *testCase = new SubgroupUniformControlFlowTestCase(
            testCtx, cases[i].basename, cases[i].description, readFilename, cases[i].small_workgroups,
            cases[i].use_subgroup_size_control, cases[i].stage, cases[i].operation);
...
tcu::TestCaseGroup *createSubgroupUniformControlFlowTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> uniformControlFlowTests(new tcu::TestCaseGroup(
        testCtx, "subgroup_uniform_control_flow", "VK_KHR_shader_subgroup_uniform_control_flow tests"));
    ...
    for (unsigned c = 0; c < controls.size(); ++c)
    {
        ...
        group.add("subgroup_reconverge06", "while true with volatile conditional break and early return", small,
                  control, stage);
        ...
        group.add("subgroup_reconverge18", "if/else subgroup all equal", small, control, stage,
                  vk::VK_SUBGROUP_FEATURE_VOTE_BIT);
        group.add("subgroup_reconverge19", "if/else subgroup any nested return", small, control, stage,
                  vk::VK_SUBGROUP_FEATURE_VOTE_BIT);
        ...
        uniformControlFlowTests->addChild(
            createTestGroup(testCtx, group_name, "Large Full subgroups",
        ...
        group.add("subgroup_reconverge_partial06", "while true with volatile conditional break and early return", small,
                  control, stage);
        ...
        group.add("subgroup_reconverge_partial18", "if/else subgroup all equal", small, control, stage,
                  vk::VK_SUBGROUP_FEATURE_VOTE_BIT);
        group.add("subgroup_reconverge_partial19", "if/else subgroup any nested return", small, control, stage,
                  vk::VK_SUBGROUP_FEATURE_VOTE_BIT);
        ...
        uniformControlFlowTests->addChild(
            createTestGroup(testCtx, group_name, "Large Partial subgroups",
                            control ? addTestsForAmberFiles<true> : addTestsForAmberFiles<false>, group));
    }
    ...
    for (unsigned c = 0; c < controls.size(); ++c)
    {
        ...
        group.add("small_subgroup_reconverge06", "while true with volatile conditional break and early return", small,
                  control, stage);
        ...
        group.add("small_subgroup_reconverge18", "if/else subgroup all equal", small, control, stage,
                  vk::VK_SUBGROUP_FEATURE_VOTE_BIT);
        group.add("small_subgroup_reconverge19", "if/else subgroup any nested return", small, control, stage,
                  vk::VK_SUBGROUP_FEATURE_VOTE_BIT);
        ...
        uniformControlFlowTests->addChild(
            createTestGroup(testCtx, group_name, "Small Full subgroups",
                            control ? addTestsForAmberFiles<true> : addTestsForAmberFiles<false>, group));
        ...
        group.add("small_subgroup_reconverge_partial06", "while true with volatile conditional break and early return",
                  small, control, stage);
        group.add("small_subgroup_reconverge_partial07", "while true return and break", small, control, stage);
        group.add("small_subgroup_reconverge_partial08", "for loop atomics with conditional break", small, control,
                  stage);
        ...
        group.add("small_subgroup_reconverge_partial13", "early return, divergent switch more cases", small, control,
                  stage);
        group.add("small_subgroup_reconverge_partial14", "divergent switch, some subgroups terminate", small, control,
                  stage);
        ...
        group.add("small_subgroup_reconverge_partial18", "if/else subgroup all equal", small, control, stage,
                  vk::VK_SUBGROUP_FEATURE_VOTE_BIT);
        group.add("small_subgroup_reconverge_partial19", "if/else subgroup any nested return", small, control, stage,
                  vk::VK_SUBGROUP_FEATURE_VOTE_BIT);
        ...
        uniformControlFlowTests->addChild(
            createTestGroup(testCtx, group_name, "Small Partial subgroups",
                            control ? addTestsForAmberFiles<true> : addTestsForAmberFiles<false>, group));
    }
    ...
    uniformControlFlowTests->addChild(
        createTestGroup(testCtx, "discard", "Discard tests", addTestsForAmberFiles<false>, group));

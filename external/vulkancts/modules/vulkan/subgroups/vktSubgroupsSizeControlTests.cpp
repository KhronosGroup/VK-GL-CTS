					   ...
					   uint32_t	numWorkGroupInvocations)
{
	...
	const deUint32 localSizeX = gcd(numWorkGroupInvocations, maxWorkGroupSize[0]);
	const deUint32 localSizeY = gcd(deMax32(numWorkGroupInvocations / localSizeX, 1u), maxWorkGroupSize[1]);

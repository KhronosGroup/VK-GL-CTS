...
{
public:
    ConditionalIgnoreClearTestCase(tcu::TestContext &context, const std::string &name, const std::string &description,
...
void ConditionalIgnoreTests::init(void)
{
    for (int conditionNdx = 0; conditionNdx < DE_LENGTH_OF_ARRAY(conditional::s_testsData); conditionNdx++)
    {
        ...
        addChild(new ConditionalIgnoreClearTestCase(m_testCtx,
                                                    std::string("clear_") + de::toString(conditionData).c_str(),

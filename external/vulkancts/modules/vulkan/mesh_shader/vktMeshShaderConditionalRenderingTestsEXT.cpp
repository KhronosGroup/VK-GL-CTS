...
{
public:
    ConditionalRenderingCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
...
tcu::TestStatus ConditionalRenderingInstance::iterate()
{
    ...
    const auto conditionalRenderingFlags = (m_params.inverted ? VK_CONDITIONAL_RENDERING_INVERTED_BIT_EXT :
...
{
    GroupPtr mainGroup(
        new tcu::TestCaseGroup(testCtx, "conditional_rendering", "Mesh Shader with Conditional Rendering"));

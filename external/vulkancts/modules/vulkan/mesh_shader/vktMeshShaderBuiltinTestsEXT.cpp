...
{
public:
    MeshShaderBuiltinCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
                          bool taskNeeded)
...
{
public:
    LayerCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description, bool writeVal,
              bool shareVertices)
        : MeshShaderBuiltinCase(testCtx, name, description, false /*taskNeeded*/)
...
{
public:
    ViewportIndexCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description, bool writeVal,
                      bool shareVertices)
        : MeshShaderBuiltinCase(testCtx, name, description, false /*taskNeeded*/)
        , m_shareVertices(shareVertices)
        , m_writeVal(writeVal)
...
{
public:
    LocalInvocationCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
                        bool taskNeeded, LocalInvocation variable)
        : MeshShaderBuiltinCase(testCtx, name, description, taskNeeded)
        , m_extent(getLinearExtent())
        , m_variable(variable)
    {
...
{
public:
    NumWorkgroupsCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
                      const tcu::Maybe<tcu::UVec3> &taskGroups, const tcu::UVec3 &meshGroups)
...
{
public:
    GlobalInvocationIdCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
                           bool taskNeeded)
        : MeshShaderBuiltinCase(testCtx, name, description, taskNeeded)
...
{
public:
    PrimitiveShadingRateCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
                             FragmentSize topSize, FragmentSize bottomSize)
        : MeshShaderBuiltinCase(testCtx, name, description, false /*taskNeeded*/)
        , m_topSize(topSize)
...
tcu::TestCaseGroup *createMeshShaderBuiltinTestsEXT(tcu::TestContext &testCtx)
{
    ...
    mainGroup->addChild(
        new ViewportIndexCase(testCtx, "viewport_index", "", true /*writeVal*/, false /*shareVertices*/));
    mainGroup->addChild(
    ...
    mainGroup->addChild(
        new NumWorkgroupsCase(testCtx, "num_work_groups_mesh", "", tcu::Nothing, tcu::UVec3(5u, 6u, 7u)));

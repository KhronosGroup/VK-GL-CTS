...
vk::VkGeneratedCommandsMemoryRequirementsInfoNV makeGeneratedCommandsMemoryRequirementsInfoNV (vk::VkPipelineBindPoint, vk::VkPipeline, vk::VkIndirectCommandsLayoutNV, uint32_t);

// These are useful because it's easy to forget to initialize the sType and pNext members of VkMemoryRequirements2.
vk::VkMemoryRequirements getPipelineIndirectMemoryRequirementsNV (const vk::DeviceInterface&, vk::VkDevice, const vk::VkComputePipelineCreateInfo*);
vk::VkMemoryRequirements getGeneratedCommandsMemoryRequirementsNV (const vk::DeviceInterface&, vk::VkDevice, const vk::VkGeneratedCommandsMemoryRequirementsInfoNV*);
...
public:
	...
	MetaDataLocation getMetaDataLocation (const vk::DeviceInterface& vkd, vk::VkDevice device, vk::Allocator& allocator, const vk::VkComputePipelineCreateInfo& createInfo);
...
public:
	DGCComputePipeline (
		...
		vk::VkPipelineShaderStageCreateFlags	shaderFlags,
		vk::VkShaderModule						module,
		const vk::VkSpecializationInfo*			specializationInfo = nullptr,
		vk::VkDeviceAddress						pipelineDeviceAddressCaptureReplay = 0ull,
		vk::VkPipeline							basePipelineHandle = VK_NULL_HANDLE,
...
public:
	...
	void addPushConstantToken (uint32_t stream, uint32_t offset, vk::VkPipelineLayout, vk::VkShaderStageFlags, uint32_t pcOffset, uint32_t pcSize);
	...
	vk::Move<vk::VkIndirectCommandsLayoutNV> build (const vk::DeviceInterface& vkd, vk::VkDevice device, const vk::VkAllocationCallbacks* pAllocator = nullptr) const;
...
{
public:
	PreprocessBuffer (const vk::DeviceInterface&      vkd,
	                  vk::VkDevice                    device,
	                  vk::Allocator&                  alloc,
	                  vk::VkPipelineBindPoint         bindPoint,
	                  vk::VkPipeline                  pipeline,
	                  vk::VkIndirectCommandsLayoutNV  cmdLayout,
	                  uint32_t                        maxSequences);

	const vk::VkBuffer&    get            (void) const { return *m_buffer; }
	const vk::VkBuffer&    operator*      (void) const { return get(); }
	const vk::Allocation&  getAllocation  (void) const { return *m_bufferAllocation; }
	vk::VkDeviceSize       getSize        (void) const { return m_memReqs.size; }

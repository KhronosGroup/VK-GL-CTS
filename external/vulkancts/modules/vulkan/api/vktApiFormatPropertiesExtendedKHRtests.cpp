...
tcu::TestStatus test(Context &context, const VkFormat format)
{
    ...
    bool allPass = true;
    allPass      = allPass && ((formatProperties.bufferFeatures & requiredProperties.bufferFeatures) ==
                          requiredProperties.bufferFeatures);
    allPass      = allPass && ((formatProperties.linearTilingFeatures & requiredProperties.linearTilingFeatures) ==
                          requiredProperties.linearTilingFeatures);
    allPass      = allPass && ((formatProperties.optimalTilingFeatures & requiredProperties.optimalTilingFeatures) ==

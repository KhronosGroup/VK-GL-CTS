...
static const uint32_t knownDriverIds[] = {
...
static const VkConformanceVersionKHR knownConformanceVersions[] = {
    makeConformanceVersion(1, 2, 2, 1), makeConformanceVersion(1, 2, 2, 0), makeConformanceVersion(1, 2, 1, 1),
...
{
    for (const uint32_t *pDriverId = knownDriverIds; pDriverId != DE_ARRAY_END(knownDriverIds); ++pDriverId)
    {

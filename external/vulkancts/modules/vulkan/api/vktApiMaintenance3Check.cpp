...
LimitsVector buildLimitsVector(const DevProp1 &prop1, const DevIubProp &iubProp, const MaintDevProp3 &maintProp3)
{
    ...
    static const TypeSet allTypes = {
        vk::VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, vk::VK_DESCRIPTOR_TYPE_SAMPLER,
        vk::VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER,         vk::VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC,
        vk::VK_DESCRIPTOR_TYPE_STORAGE_BUFFER,         vk::VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC,
        vk::VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,          vk::VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER,
        vk::VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,          vk::VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER,
        vk::VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT,       vk::VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK_EXT,
    };
...
vector<vk::VkDescriptorSetLayoutBinding> calculateBindings(const DevProp1 &prop1, const DevIubProp &iubProp,
    ...
    virtual tcu::TestStatus iterate(void)
    {
        ...
        for (size_t combSize = 1; combSize <= descriptorTypes.size(); ++combSize)
        {
            ...
            do
            {
                ...
                vector<vk::VkDescriptorSetLayoutBinding> bindings =
                    calculateBindings(prop2.properties, devIubProp, maintProp3, types);
...
{
    de::MovePtr<tcu::TestCaseGroup> main3Tests(
        new tcu::TestCaseGroup(testCtx, "maintenance3_check", "Maintenance3 Tests"));

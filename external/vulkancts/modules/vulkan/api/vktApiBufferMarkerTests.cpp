                               ...
                               size_t offset)
{
    ...
    wd.allocator     = MovePtr<Allocator>(
        new SimpleAllocator(*wd.deviceDriver, *wd.logicalDevice,
                                getPhysicalDeviceMemoryProperties(instanceDriver, physicalDevice), offset));
        ...
        for (size_t memNdx = 0; memNdx < DE_LENGTH_OF_ARRAY(memoryTypes); ++memNdx)
        {
            ...
            for (size_t stageNdx = 0; stageNdx < DE_LENGTH_OF_ARRAY(stages); ++stageNdx)
            {
...

                {
                    ...
                    addFunctionCase(sequentialGroup, getTestCaseName("64", base.offset),
                    ...
                    addFunctionCase(sequentialGroup, getTestCaseName("65536", base.offset),
...

                {
                    ...
                    addFunctionCase(overwriteGroup, getTestCaseName("64", base.offset),

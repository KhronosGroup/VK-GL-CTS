...
static inline void addFunctionCaseInNewSubgroup(tcu::TestContext &testCtx, tcu::TestCaseGroup *group,
                                                const std::string &subgroupName, const std::string &subgroupDescription,
                                                FunctionInstance0::Function testFunc)
{
    de::MovePtr<tcu::TestCaseGroup> subgroup(
        new tcu::TestCaseGroup(testCtx, subgroupName.c_str(), subgroupDescription.c_str()));
                                         ...
                                         typename FunctionInstance1<Arg0>::Function testFunc, Arg0 arg0)
{
    de::MovePtr<tcu::TestCaseGroup> subgroup(
        new tcu::TestCaseGroup(testCtx, subgroupName.c_str(), subgroupDescription.c_str()));
    subgroup->addChild(
        createFunctionCase<Arg0>(testCtx, tcu::NODETYPE_SELF_VALIDATE, "basic", "", checkSupport, testFunc, arg0));
    group->addChild(subgroup.release());
}
...
tcu::TestCaseGroup *createDeviceInitializationTests(tcu::TestContext &testCtx)
{
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subgroup(
            new tcu::TestCaseGroup(testCtx, "create_device_unsupported_features", ""));

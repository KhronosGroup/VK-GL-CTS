...
tcu::TestStatus validateLimitsExtVertexAttributeDivisor(Context &context)
{
    ...
    const InstanceInterface &vki          = context.getInstanceInterface();
    const VkPhysicalDevice physicalDevice = context.getPhysicalDevice();
    vk::VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT vertexAttributeDivisorProperties =
...
tcu::TestCaseGroup *createFeatureInfoTests(tcu::TestContext &testCtx)
{
...

    {
        ...
        addFunctionCase(limitsValidationTests.get(), "ext_vertex_attribute_divisor",
                        checkSupportExtVertexAttributeDivisorEXT, validateLimitsExtVertexAttributeDivisor);
        addFunctionCase(limitsValidationTests.get(), "khr_vertex_attribute_divisor",
                        checkSupportExtVertexAttributeDivisorKHR, validateLimitsExtVertexAttributeDivisor);
#ifndef CTS_USES_VULKANSC

...
tcu::TestCaseGroup *createGranularityQueryTests(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> inDynamicRenderPass(new tcu::TestCaseGroup(
        testCtx, "in_dynamic_render_pass", "Single texture granularity tests, inside dynamic render pass"));

                                     ...
                                     ++clearColorIndex)
                                {
                                    ...
                                    if (!imageLayerParamsToTest[imageLayerParamsIndex].twoStep)
                                    {
                                        ...
                                        if (imageTilingsToTest[imageTilingIndex] == VK_IMAGE_TILING_OPTIMAL)
                                        {
                                            ...
                                            imageLayersGroup->addChild(
                                                new InstanceFactory1<
                                                    ClearColorImageMultipleSubresourceRangeTestInstance, TestParams>(
                                                    testCtx, testCaseName, testParams));
                                        }
                                    }
                                    else
                                    ...
                                    hasDepth && hasStencil)
                                {
                                    ...
                                    imageLayersGroup->addChild(
                                        new InstanceFactory1<ClearDepthStencilImageMultipleSubresourceRangeTestInstance,
                                                             TestParams>(testCtx, testCaseNameRanges, testParams));
                                }
                            }
                            else
                            {
                         ...
                         ++imageFormatIndex)
                    {
                        ...
                        for (size_t clearColorIndex = 0; clearColorIndex < numOfClearColorsToTest; ++clearColorIndex)
                        {
                            ...
                            colorAttachmentClearLayersGroup->addChild(
                                new InstanceFactory1<ClearAttachmentTestInstance, TestParams>(testCtx, testCaseName,
                                                                                              testParams));

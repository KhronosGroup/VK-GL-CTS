...
void CopiesAndBlittingTestInstance::setupDeviceWithTransferQueue(void)
{
    ...
    if (!g_deviceWithTransferQueue)
    {
        ...
        g_deviceWithTransferQueue->device    = createCustomDevice(m_context, QueueSelectionOptions::TransferOnly,
                                                                  g_deviceWithTransferQueue->queueFamilyIndex);
        g_deviceWithTransferQueue->allocator = de::MovePtr<Allocator>(new SimpleAllocator(
            vk, *g_deviceWithTransferQueue->device, getPhysicalDeviceMemoryProperties(vki, physDevice)));
    }
...
tcu::TestStatus CopyCompressedImageToBuffer::iterate(void)
{
    ...
    if (useTwoQueues)
    {
        ...
        m_deviceDriver = de::MovePtr<DeviceDriver>(new DeviceDriver(
            m_context.getPlatformInterface(), m_context.getInstance(), m_device, m_context.getUsedApiVersion()));
#else
...
#ifndef CTS_USES_VULKANSC
        m_deviceDriver = de::MovePtr<DeviceDriver>(new DeviceDriver(
            context.getPlatformInterface(), m_context.getInstance(), m_device, m_context.getUsedApiVersion()));
#else
        m_deviceDriver = de::MovePtr<DeviceDriverSC, DeinitDeviceDeleter>(
...
void addImageToImageAllFormatsColorTests(tcu::TestCaseGroup *group, TestGroupParamsPtr testGroupParams)
{
    ...
    // 1D to 2D tests.
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "1d_to_2d", "1D to 2D copies"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "1d_to_3d", "1D to 3D copies"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "2d_to_1d", "2D to 1D copies"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "2d_to_2d", "2D to 2D copies"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "2d_to_3d", "2D to 3D copies"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "3d_to_1d", "3D to 1D copies"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "3d_to_2d", "3D to 2D copies"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "3d_to_3d", "3D to 3D copies"));
...
void addImageToImageAllFormatsDepthStencilTests(tcu::TestCaseGroup *group, TestGroupParamsPtr testGroupParams)
{
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> subGroup(
            new tcu::TestCaseGroup(group->getTestContext(), "1d_to_1d", "1D to 1D copies"));
...
{
    TestGroupParamsPtr universalGroupParams(
        new TestGroupParams{allocationKind, extensionFlags, QueueSelectionOptions::Universal});
    ...
    {
        TestGroupParamsPtr transferGroupParams(
            new TestGroupParams{allocationKind, extensionFlags, QueueSelectionOptions::TransferOnly});
...
tcu::TestCaseGroup *createCopiesAndBlittingTests(tcu::TestContext &testCtx)
{
    ...
    copiesAndBlittingTests->addChild(
        createTestGroup(testCtx, "copy_commands2", addExtensionCopiesAndBlittingTests, cleanupGroup));

										...
										, m_pixelDataSize				(m_renderSize.x() * m_renderSize.y() * mapVkFormat(m_colorFormat).getPixelSize())
{
	...
	// Create descriptors
	{
		...
		BufferSuballocation().createTestBuffer(uniformSize, testCase.createUsage, m_context, memAlloc, m_uniformBuffer, MemoryRequirement::HostVisible, m_uniformBufferAlloc);
										...
										, m_bufferFormat				(testCase.format)
{
	...
	// Create descriptors
	{
		...
		BufferSuballocation().createTestBuffer(sourceBuffer.size(), testCase.createUsage, m_context, memAlloc, m_uniformBuffer, MemoryRequirement::HostVisible, m_uniformBufferAlloc);

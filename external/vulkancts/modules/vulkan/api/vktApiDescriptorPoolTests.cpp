...
tcu::TestCaseGroup *createDescriptorPoolTests(tcu::TestContext &testCtx)
{
    ...
    addFunctionCase(descriptorPoolTests.get(), "repeated_reset_short",
                    ...
                    checkSupportFreeDescriptorSets, resetDescriptorPoolTest, ResetDescriptorPoolTestParams(2U));
    ...
    addFunctionCase(
        ...
        checkSupportFreeDescriptorSets, resetDescriptorPoolTest, ResetDescriptorPoolTestParams(2U, true));
    addFunctionCase(descriptorPoolTests.get(), "repeated_free_reset_long",
                    ...
                    checkSupportFreeDescriptorSets, resetDescriptorPoolTest,
                    ResetDescriptorPoolTestParams(numIterationsHigh, true));
    ...
    addFunctionCase(descriptorPoolTests.get(), "zero_pool_size_count",

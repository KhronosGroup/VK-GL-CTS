...
tcu::TestCaseGroup *createCommandBuffersTests(tcu::TestContext &testCtx)
{
    ...
    addFunctionCase(commandBuffersTests.get(), "trim_command_pool", "", trimCommandPoolTest,
                    VK_COMMAND_BUFFER_LEVEL_PRIMARY);
    addFunctionCase(commandBuffersTests.get(), "trim_command_pool_secondary", "", trimCommandPoolTest,
    ...
    addFunctionCase(commandBuffersTests.get(), "record_one_time_submit_primary", "",
    ...
    addFunctionCase(commandBuffersTests.get(), "submit_two_buffers_one_buffer_null_with_fence", "",

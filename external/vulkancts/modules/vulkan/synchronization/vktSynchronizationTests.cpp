...
const std::pair<std::string, std::string> getGroupName(SynchronizationType type,
                                                       VideoCodecOperationFlags videoCodecOperation)
{
    ...
    {
    case vk::VK_VIDEO_CODEC_OPERATION_ENCODE_H264_BIT_EXT:
        return std::pair<std::string, std::string>("encode_h264", "");
    case vk::VK_VIDEO_CODEC_OPERATION_ENCODE_H265_BIT_EXT:
        return std::pair<std::string, std::string>("encode_h265", "");
    case vk::VK_VIDEO_CODEC_OPERATION_DECODE_H264_BIT_KHR:
        return std::pair<std::string, std::string>("decode_h264", "");
    case vk::VK_VIDEO_CODEC_OPERATION_DECODE_H265_BIT_KHR:
        return std::pair<std::string, std::string>("decode_h265", "");
    default:
                                        ...
                                        VideoCodecOperationFlags videoCodecOperation)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> testGroup(
        new tcu::TestCaseGroup(testCtx, groupName.first.c_str(), groupName.second.c_str()));
                                               ...
                                               synchronization::VideoCodecOperationFlags videoCodecOperation)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> testGroup(
        createTestsInternal(testCtx, SynchronizationType::LEGACY, videoCodecOperation));
                                                ...
                                                synchronization::VideoCodecOperationFlags videoCodecOperation)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> testGroup(
        createTestsInternal(testCtx, SynchronizationType::SYNCHRONIZATION2, videoCodecOperation));

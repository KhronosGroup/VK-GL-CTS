...
public:
    ...
    OperationContext(Context &context, PipelineCacheData &pipelineCacheData, const vk::DeviceInterface &vk,
                     const vk::VkDevice device, vk::Allocator &allocator);

    OperationContext(Context &context, const vk::InstanceInterface &vki, const vk::DeviceInterface &vkd,

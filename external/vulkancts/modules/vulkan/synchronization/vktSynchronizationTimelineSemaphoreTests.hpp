#ifndef _VKTSYNCHRONIZATIONTIMELINESEMAPHORETESTS_HPP
#define _VKTSYNCHRONIZATIONTIMELINESEMAPHORETESTS_HPP
/*------------------------------------------------------------------------
...
#endif // _VKTSYNCHRONIZATIONTIMELINESEMAPHORETESTS_HPP

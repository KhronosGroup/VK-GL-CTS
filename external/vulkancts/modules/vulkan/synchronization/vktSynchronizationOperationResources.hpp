...
static const ResourceDescription s_resources[] = {
    ...
    {RESOURCE_TYPE_IMAGE, tcu::IVec4(128, 0, 0, 0), vk::VK_IMAGE_TYPE_1D, vk::VK_FORMAT_R32_UINT,
    ...
    {RESOURCE_TYPE_IMAGE, tcu::IVec4(128, 128, 0, 0), vk::VK_IMAGE_TYPE_2D, vk::VK_FORMAT_D16_UNORM,
     vk::VK_IMAGE_ASPECT_DEPTH_BIT, vk::VK_SAMPLE_COUNT_1_BIT},
    {RESOURCE_TYPE_IMAGE, tcu::IVec4(128, 128, 0, 0), vk::VK_IMAGE_TYPE_2D, vk::VK_FORMAT_D32_SFLOAT,
     vk::VK_IMAGE_ASPECT_DEPTH_BIT, vk::VK_SAMPLE_COUNT_1_BIT},
    {RESOURCE_TYPE_IMAGE, tcu::IVec4(128, 128, 0, 0), vk::VK_IMAGE_TYPE_2D, vk::VK_FORMAT_S8_UINT,
     vk::VK_IMAGE_ASPECT_STENCIL_BIT, vk::VK_SAMPLE_COUNT_1_BIT},

    // \note Special resources, when test case isn't strictly a copy and comparison of some data
    {RESOURCE_TYPE_INDIRECT_BUFFER_DRAW, tcu::IVec4(sizeof(vk::VkDrawIndirectCommand), 0, 0, 0), vk::VK_IMAGE_TYPE_LAST,
    ...
    {RESOURCE_TYPE_IMAGE, tcu::IVec4(64, 64, 0, 0), vk::VK_IMAGE_TYPE_2D, vk::VK_FORMAT_R32_UINT,
     vk::VK_IMAGE_ASPECT_COLOR_BIT, vk::VK_SAMPLE_COUNT_4_BIT},
};

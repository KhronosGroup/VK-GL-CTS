...
tcu::TestCaseGroup *createBasicFenceTests(tcu::TestContext &testCtx, VideoCodecOperationFlags videoCodecOperationFlags)
{
    ...
    addFunctionCase(basicFenceTests.get(), "one", "Basic one fence tests", checkVideoSupport, basicOneFenceCase,
                    FenceConfig{0u, videoCodecOperationFlags});
    addFunctionCase(basicFenceTests.get(), "multi", "Basic multi fence tests", checkCommandBufferSimultaneousUseSupport,
                    basicMultiFenceCase, FenceConfig{0u, videoCodecOperationFlags});
    addFunctionCase(basicFenceTests.get(), "empty_submit", "Signal a fence after an empty queue submission",
                    checkVideoSupport, emptySubmitCase, FenceConfig{0u, videoCodecOperationFlags});
    addFunctionCase(basicFenceTests.get(), "multi_waitall_false", "Basic multi fence test without waitAll",
                    checkCommandBufferSimultaneousUseSupport, basicMultiFenceWaitAllFalseCase,
                    FenceConfig{0u, videoCodecOperationFlags});
    addFunctionCase(basicFenceTests.get(), "one_signaled", "Create a single signaled fence and wait on it",
                    checkVideoSupport, basicSignaledCase, FenceConfig{1u, videoCodecOperationFlags});
    addFunctionCase(basicFenceTests.get(), "multiple_signaled", "Create multiple signaled fences and wait on them",
                    checkCommandBufferSimultaneousUseSupport, basicSignaledCase,
                    FenceConfig{10u, videoCodecOperationFlags});

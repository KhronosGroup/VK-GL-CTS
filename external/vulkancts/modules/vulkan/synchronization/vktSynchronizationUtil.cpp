...
public:
    ...
    void addSubmitInfo(uint32_t waitSemaphoreInfoCount, const VkSemaphoreSubmitInfoKHR *pWaitSemaphoreInfos,
...
VkSemaphoreSubmitInfoKHR makeCommonSemaphoreSubmitInfo(VkSemaphore semaphore, uint64_t value,
...
VkDependencyInfoKHR makeCommonDependencyInfo(const VkMemoryBarrier2KHR *pMemoryBarrier,
                                             const VkBufferMemoryBarrier2KHR *pBufferMemoryBarrier,
                                             const VkImageMemoryBarrier2KHR *pImageMemoryBarrier)
{
    return {
...
vk::Move<VkPipelineCache> PipelineCacheData::createPipelineCache(const vk::DeviceInterface &vk,

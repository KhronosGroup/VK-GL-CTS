...
public:
        ...
        : m_context(context)
    {
        ...
        if (config.memoryHandleType == vk::VK_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_BIT_KHR ||
            ...
            config.semaphoreHandleType == vk::VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_DRM_SYNCOBJ_BIT_EXT)
        {
        ...
        if (config.semaphoreHandleType == vk::VK_EXTERNAL_SEMAPHORE_HANDLE_TYPE_DRM_SYNCOBJ_BIT_EXT)
        {
            m_context.requireDeviceFunctionality("VK_EXT_external_semaphore_drm_syncobj");
        }
...
{
    const vk::VkCommandPoolCreateInfo createInfo = {vk::VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO, nullptr,
...
tcu::TestStatus SharingTestInstance::iterate(void)
{
    ...
    try
    {
...

        {
            ...
            synchronizationWrapperA->addSubmitInfo(0u, nullptr, 1u, &cmdBufferInfos, 1u, &signalSemaphoreSubmitInfo,
        ...
        }
        {
            ...
            synchronizationWrapperB->addSubmitInfo(1u, &waitSemaphoreSubmitInfo, 1u, &cmdBufferInfos, 0u, nullptr,
                                                   isTimelineSemaphore);

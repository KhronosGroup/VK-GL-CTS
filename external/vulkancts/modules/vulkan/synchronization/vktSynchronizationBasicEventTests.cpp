...
tcu::TestCaseGroup *createBasicEventTests(tcu::TestContext &testCtx)
{
    ...
    addFunctionCase(basicTests.get(), "host_set_reset", "Basic event tests set and reset on host",
    ...
    addFunctionCase(basicTests.get(), "single_submit_multi_command_buffer",
                    "Wait and set event single submission on device", singleSubmissionCase);
    addFunctionCase(basicTests.get(), "multi_submit_multi_command_buffer",
                    "Wait and set event mutli submission on device", multiSubmissionCase);

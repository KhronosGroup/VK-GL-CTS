...
inline TestCase *createFunctionCaseWithPrograms2(tcu::TestContext &testCtx, tcu::TestNodeType type,
                                                 const std::string &name, FunctionSupport0::Function checkSupport,
                                                 ...
                                                 FunctionInstance0::Function testFunction)
{
    return new InstanceFactory1WithSupport<FunctionInstance0, FunctionInstance0::Function, FunctionSupport0,
                                           FunctionPrograms0>(testCtx, type, name, FunctionPrograms0(initPrograms),

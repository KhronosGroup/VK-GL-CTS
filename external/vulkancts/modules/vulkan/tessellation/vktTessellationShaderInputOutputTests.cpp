...
tcu::TestCaseGroup *createShaderInputOutputTests(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> group(new tcu::TestCaseGroup(
        testCtx, "shader_input_output", "Test tessellation control and evaluation shader inputs and outputs"));
    ...
    // Per patch data
    {
        static const PerPatchData::CaseDefinition cases[] = {
            ...
            {PerPatchData::CASETYPE_PRIMITIVE_ID_TES, "primitive_id_tes", true,
             "vulkan/data/tessellation/primitive_id_tes_ref.png", "Read gl_PrimitiveID in TES"},

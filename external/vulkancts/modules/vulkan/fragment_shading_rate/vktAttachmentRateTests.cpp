...
private:
    ...
    Move<VkPipeline> buildGraphicsPipeline(uint32_t subpass, VkRenderPass renderPass, VkPipelineLayout layout,
                                                               ...
                                                               bool useShadingRate) const
{
    ...
    const VkGraphicsPipelineCreateInfo pipelineCreateInfo{
        ...
        useShadingRate ? &shadingRateStateCreateInfo :
                         DE_NULL,                   // const void*                                        pNext
    ...
    for (uint32_t tileWidth = m_minTileSize.width; tileWidth <= m_maxTileSize.width; tileWidth *= 2)
        for (uint32_t tileHeight = m_minTileSize.height; tileHeight <= m_maxTileSize.height; tileHeight *= 2)
        {
            ...
            Move<VkPipeline> graphicsPipeline =
                buildGraphicsPipeline(0, *renderPass, *graphicsPipelineLayout, *vertShader, *fragShader);
...
bool AttachmentRateInstance::runFragmentShaderMode(void)
{
    ...
    for (uint32_t tileWidth = m_minTileSize.width; tileWidth <= m_maxTileSize.width; tileWidth *= 2)
        for (uint32_t tileHeight = m_minTileSize.height; tileHeight <= m_maxTileSize.height; tileHeight *= 2)
        {
            ...
            Move<VkPipeline> setupPipeline = buildGraphicsPipeline(0, *setupRenderPass, *setupPipelineLayout,
                                                                   *vertSetupShader, *fragSetupShader, false);
            Move<VkPipeline> ratePipeline =
                buildGraphicsPipeline(0, *rateRenderPass, *ratePipelineLayout, *vertShader, *fragShader);
...
bool AttachmentRateInstance::runCopyModeOnTransferQueue(void)
{
    ...
    // create custom device
    {
        ...
        VkPhysicalDeviceImagelessFramebufferFeaturesKHR ifbFeatures{
...
bool AttachmentRateInstance::runTwoSubpassMode(void)
{
    ...
    Move<VkPipeline> graphicsPipeline0 =
        buildGraphicsPipeline(0, *renderPass, *pipelineLayout, *vertShader0, *fragShader);
    Move<VkPipeline> graphicsPipeline1 =
        buildGraphicsPipeline(1, *renderPass, *pipelineLayout, *vertShader1, *fragShader);
...
void createAttachmentRateTests(tcu::TestContext &testCtx, tcu::TestCaseGroup *parentGroup)
{
    ...
    for (const auto &testModeParam : testModeParams)
    {
        ...
        for (const auto &srFormat : srFormats)
        {
            ...
            {
                formatGroup->addChild(new AttachmentRateTestCase(testCtx, srRate.name,

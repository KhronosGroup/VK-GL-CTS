...
void createPipelineConstructionTypePermutations(tcu::TestCaseGroup *parentGroup, SharedGroupParams baseGroupParams)
{
    ...
    TestGroupPtr monolithic(createTestGroup(testCtx, "monolithic", "Monolithic pipeline tests", createTests,
    ...
    TestGroupPtr pipelineLibrary(
        createTestGroup(testCtx, "pipeline_library", "Graphics pipeline library tests", createTests,
                        constructGroupParams(vk::PIPELINE_CONSTRUCTION_TYPE_LINK_TIME_OPTIMIZED_LIBRARY)));
    TestGroupPtr fastLinkedLibrary(
        createTestGroup(testCtx, "fast_linked_library", "Fast linked graphics pipeline library tests", createTests,
...
void createDynamicRenderingPermutations(tcu::TestCaseGroup *parentGroup)
{
    ...
    typedef de::MovePtr<tcu::TestCaseGroup> TestGroupPtr;
    TestGroupPtr drPrimaryCmdBuffGroup(
        createTestGroup(testCtx, "primary_cmd_buff", "Draw using Draw commands are recorded in primary command buffer",
                        createPipelineConstructionTypePermutations, constructGroupParams(false, false)));
    TestGroupPtr drPartialSecondaryCmdBuffGroup(createTestGroup(
        testCtx, "partial_secondary_cmd_buff", "Secondary command buffer doesn't include begin/endRendering",
        createTests, constructGroupParams(true, false)));
    TestGroupPtr drCompleteSecondaryCmdBuffGroup(createTestGroup(
        testCtx, "complete_secondary_cmd_buff", "Secondary command buffer contains completely dynamic renderpass",
...
tcu::TestCaseGroup *createTests(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> mainGroup(
        new tcu::TestCaseGroup(testCtx, "fragment_shading_rate", "Fragment shading rate tests"));
...
#ifndef CTS_USES_VULKANSC
    de::MovePtr<tcu::TestCaseGroup> dynamicRenderingGroup(createTestGroup(
        testCtx, "dynamic_rendering", "Draw using VK_KHR_dynamic_rendering", createDynamicRenderingPermutations));

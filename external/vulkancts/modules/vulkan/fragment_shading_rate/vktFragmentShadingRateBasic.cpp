            ...
            for (uint32_t srTexelHeight = minFragmentShadingRateAttachmentTexelSize.height;
                ...
                for (uint32_t formatIdx = 0; formatIdx < numFillFormats; ++formatIdx)
                {
                    ...
                    for (uint32_t i = 0; i < derivNumLevels; ++i)
                    {
                        ...
                        vk.cmdClearColorImage(*cmdBuffer, **derivImage, VK_IMAGE_LAYOUT_GENERAL, &clearLevelColor.color,
                                              1, &range);
                    }
                    ...
                    else
                    {
                        ...
                        beginRenderPass(vk, *cmdBuffer, *renderPass, *framebuffer, renderArea, 0, DE_NULL,

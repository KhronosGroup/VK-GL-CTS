...
struct AnisotropyParams : public ReferenceParams
{
    AnisotropyParams(const TextureType texType_, const float maxAnisotropy_, const Sampler::FilterMode minFilter_,
                     const Sampler::FilterMode magFilter_, const bool mipMap_ = false)
...
public:
    ...
    tcu::TestStatus iterate(void)
    {
        ...
        TestTexture2DSp texture = TestTexture2DSp(new pipeline::TestTexture2D(
...
{
public:
    FilteringAnisotropyTests(tcu::TestContext &testCtx, const string &name, const string &description,
...
{
    de::MovePtr<tcu::TestCaseGroup> filteringAnisotropyTests(
        new tcu::TestCaseGroup(testCtx, "filtering_anisotropy", "Filtering anisotropy tests"));
    ...
    de::MovePtr<tcu::TestCaseGroup> mipmapTests(
        new tcu::TestCaseGroup(testCtx, "mipmap", "Filtering anisotropy tests"));
...

    {
        ...
        for (int anisotropyNdx = 0; anisotropyNdx < DE_LENGTH_OF_ARRAY(maxAnisotropy); anisotropyNdx++)
        {
            de::MovePtr<tcu::TestCaseGroup> levelAnisotropyGroups(
                new tcu::TestCaseGroup(testCtx, valueName[anisotropyNdx], "Filtering anisotropy tests"));

...
void populateSubgroupLodTests(tcu::TestCaseGroup *group)
{
    ...
    cts_amber::AmberTestCase *testCaseLod =
        cts_amber::createAmberTestCase(testCtx, "texturelod", "", "texture_subgroup_lod", "texture_lod.amber");
    cts_amber::AmberTestCase *testCaseGrad =
        cts_amber::createAmberTestCase(testCtx, "texturegrad", "", "texture_subgroup_lod", "texture_grad.amber");
    cts_amber::AmberTestCase *testCaseFetch =
        cts_amber::createAmberTestCase(testCtx, "texelfetch", "", "texture_subgroup_lod", "texel_fetch.amber");

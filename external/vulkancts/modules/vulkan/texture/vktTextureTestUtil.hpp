...
void initializePrograms(vk::SourceCollections &programCollection, glu::Precision texCoordPrecision,
                        ...
                        glu::Precision fragOutputPrecision = glu::Precision::PRECISION_MEDIUMP);
...
public:
    ...
    void updateTextureViewMipLevels(uint32_t baseLevel, uint32_t maxLevel);
...
{
public:
    TextureTestCase(tcu::TestContext &context, const std::string &name, const std::string &description,

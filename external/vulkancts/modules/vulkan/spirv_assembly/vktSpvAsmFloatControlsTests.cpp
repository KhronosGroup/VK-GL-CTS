...
TypeValuesBase::TypeValuesBase() : pi(3.14159265358979323846)
{
}
...
TypeValues<float>::TypeValues() : TypeValuesBase()
{
    ...
    vm[V_CONV_TO_FP32_RTZ_RESULT] =
        exactByteEquivalent<uint32_t>(0x3f9c968d); // result of conversion from double(1.22334455)
    ...
    vm[V_CONV_TO_FP32_RTE_RESULT] =
        exactByteEquivalent<uint32_t>(0x3f9c968e); // result of conversion from double(1.22334455)
...
void TypeSnippetsBase::updateSpirvSnippets()
{
    ...
    const string constantsDefinitionsTemplate = "%c_float_n1             = OpConstant %type_float -1\n"
                                                ...
                                                epsilon +
                                                "\n"
                                                "%c_float_denorm_base    = OpConstant %type_float " +
                                                denormBase + "\n";
...
TypeTestResults<deFloat16>::TypeTestResults()
{
    ...
    const BinaryCase binaryOpFTZArr[] = {
        ...
        {O_ADD, V_ONE, V_ZERO_OR_DENORM_TIMES_TWO, V_INF, V_UNUSED},
        ...
        {O_VEC_MUL_M, V_ZERO_OR_DENORM_TIMES_TWO, V_ZERO, V_UNUSED, V_UNUSED},
        ...
        {O_DOT, V_ZERO_OR_DENORM_TIMES_TWO, V_ZERO, V_UNUSED, V_UNUSED},
    ...
    const UnaryCase unaryOpDenormPreserveArr[] = {
        //operation            op den
        {O_RETURN_VAL, V_DENORM},      {O_D_EXTRACT, V_DENORM},     {O_D_INSERT, V_DENORM}, {O_SHUFFLE, V_DENORM},
        {O_COMPOSITE, V_DENORM},       {O_COMPOSITE_INS, V_DENORM}, {O_COPY, V_DENORM},     {O_TRANSPOSE, V_DENORM},
        {O_NEGATE, V_DENORM},          {O_ABS, V_DENORM},           {O_SIGN, V_ONE},        {O_RADIANS, V_DENORM},
...
TypeTestResults<float>::TypeTestResults()
{
    ...
    const BinaryCase binaryOpDenormPreserveArr[] = {
        //operation            den op one            den op den                den op inf        den op nan
        {O_PHI, V_DENORM, V_DENORM, V_DENORM, V_DENORM},  {O_SELECT, V_DENORM, V_DENORM, V_DENORM, V_DENORM},
        {O_ADD, V_ONE, V_DENORM_TIMES_TWO, V_INF, V_NAN}, {O_SUB, V_MINUS_ONE, V_ZERO, V_MINUS_INF, V_NAN},
        {O_MUL, V_DENORM, V_ZERO, V_INF, V_NAN},          {O_VEC_MUL_S, V_DENORM, V_ZERO, V_INF, V_NAN},
        {O_VEC_MUL_M, V_DENORM, V_ZERO, V_INF, V_NAN},    {O_MAT_MUL_S, V_DENORM, V_ZERO, V_INF, V_NAN},
        {O_MAT_MUL_V, V_DENORM, V_ZERO, V_INF, V_NAN},    {O_MAT_MUL_M, V_DENORM, V_ZERO, V_INF, V_NAN},
        {O_OUT_PROD, V_DENORM, V_ZERO, V_INF, V_NAN},     {O_DOT, V_DENORM_TIMES_TWO, V_ZERO, V_INF, V_NAN},
        {O_MIX, V_HALF, V_DENORM, V_INF, V_NAN},          {O_FMA, V_HALF, V_HALF, V_INF, V_NAN},
        {O_MIN, V_DENORM, V_DENORM, V_DENORM, V_UNUSED},  {O_MAX, V_ONE, V_DENORM, V_INF, V_UNUSED},
        {O_CLAMP, V_ONE, V_DENORM, V_INF, V_UNUSED},      {O_NMIN, V_DENORM, V_DENORM, V_DENORM, V_DENORM},
        {O_NMAX, V_ONE, V_DENORM, V_INF, V_DENORM},       {O_NCLAMP, V_ONE, V_DENORM, V_INF, V_DENORM},
    };
...
TypeTestResults<double>::TypeTestResults()
{
    ...
    const UnaryCase unaryOpDenormPreserveArr[] = {
        ...
        {O_RETURN_VAL, V_DENORM}, {O_D_EXTRACT, V_DENORM},     {O_D_INSERT, V_DENORM}, {O_SHUFFLE, V_DENORM},
        {O_COMPOSITE, V_DENORM},  {O_COMPOSITE_INS, V_DENORM}, {O_COPY, V_DENORM},     {O_TRANSPOSE, V_DENORM},
        {O_NEGATE, V_DENORM},     {O_ABS, V_DENORM},           {O_SIGN, V_ONE},
    };
...
public:
    ...
    OperationTestCase(const char *_baseName, BehaviorFlags _behaviorFlags, OperationId _operatinId, ValueId _input1,
...
void TestCasesBuilder::init()
{
    ...
    mo[O_NEGATE]        = Op("negate", FLOAT_ARITHMETIC, "%result             = OpFNegate %type_float %arg1\n",
    ...
    mo[O_COPY]          = Op("copy", FLOAT_STORAGE_ONLY, "%result             = OpCopyObject %type_float %arg1\n",
                             B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    ...
    mo[O_ATAN2] =
        Op("atan2", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Atan2 %arg1 %arg2\n",
           B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_POW] = Op("pow", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Pow %arg1 %arg2\n",
                   B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    ...
    mo[O_FMA] = Op("fma", FLOAT_ARITHMETIC,
                   ...
                   B_STATEMENT_USAGE_COMMANDS_CONST_FLOAT | B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_MIN] = Op("min", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 FMin %arg1 %arg2\n",
                   B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_MAX] = Op("max", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 FMax %arg1 %arg2\n",
                   B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_CLAMP] =
        Op("clamp", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 FClamp %arg1 %arg2 %arg2\n",
           B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_STEP]  = Op("step", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Step %arg1 %arg2\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    ...
    mo[O_FACE_FWD] = Op("face_fwd", FLOAT_ARITHMETIC,
                        ...
                        B_STATEMENT_USAGE_COMMANDS_CONST_FLOAT | B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_NMIN] = Op("nmin", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 NMin %arg1 %arg2\n",
                    B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_NMAX] = Op("nmax", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 NMax %arg1 %arg2\n",
                    B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_NCLAMP] =
        Op("nclamp", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 NClamp %arg2 %arg1 %arg2\n",
           B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);

    mo[O_ROUND] = Op("round", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Round %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_ROUND_EV] =
        Op("round_ev", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 RoundEven %arg1\n",
           B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_TRUNC] = Op("trunc", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Trunc %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_ABS]   = Op("abs", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 FAbs %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_SIGN]  = Op("sign", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 FSign %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_FLOOR] = Op("floor", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Floor %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_CEIL]  = Op("ceil", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Ceil %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_FRACT] = Op("fract", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Fract %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_RADIANS] =
    ...
    mo[O_DEGREES] =
        Op("degrees", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Degrees %arg1\n",
           B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_SIN]   = Op("sin", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Sin %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_COS]   = Op("cos", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Cos %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_TAN]   = Op("tan", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Tan %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_ASIN]  = Op("asin", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Asin %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_ACOS]  = Op("acos", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Acos %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_ATAN]  = Op("atan", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Atan %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_SINH]  = Op("sinh", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Sinh %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_COSH]  = Op("cosh", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Cosh %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_TANH]  = Op("tanh", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Tanh %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_ASINH] = Op("asinh", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Asinh %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_ACOSH] = Op("acosh", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Acosh %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_ATANH] = Op("atanh", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Atanh %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_EXP]   = Op("exp", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Exp %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_LOG]   = Op("log", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Log %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_EXP2]  = Op("exp2", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Exp2 %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_LOG2]  = Op("log2", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Log2 %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_SQRT]  = Op("sqrt", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Sqrt %arg1\n",
                     B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_INV_SQRT] =
    ...
    mo[O_FREXP_ST] = Op("frexp_st", FLOAT_ARITHMETIC,
                        ...
                        "%result             = OpLoad %type_float %tmpLoc\n",
                        B_STATEMENT_USAGE_TYPES_TYPE_FLOAT | B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    mo[O_LENGHT] = Op("length", FLOAT_ARITHMETIC, "%result             = OpExtInst %type_float %std450 Length %arg1\n",
                      B_STATEMENT_USAGE_COMMANDS_TYPE_FLOAT);
    ...
    mo[O_UPD_DENORM_FLUSH]    = Op("upd_denorm", FLOAT_STORAGE_ONLY, "", unpackDouble2x32Types,
                                   "%c_p1               = OpConstant %type_u32 0\n"
    ...
    mo[O_UPD_DENORM_PRESERVE] = Op("upd_denorm", FLOAT_STORAGE_ONLY, "", unpackDouble2x32Types,
                                   "%c_p1               = OpConstant %type_u32 1008\n"
                                   "%c_p2               = OpConstant %type_u32 0\n",
                                   "", "", unpackDouble2x32Source,
                                   B_STATEMENT_USAGE_COMMANDS_CONST_FP64 | B_STATEMENT_USAGE_COMMANDS_TYPE_FP64);

    mo[O_ORTE_ROUND] = Op("orte_round", FLOAT_STORAGE_ONLY, FP32, "OpDecorate %result FPRoundingMode RTE\n", "", "",
                          "%result             = OpFConvert %type_f16 %arg1\n", B_STATEMENT_USAGE_COMMANDS_TYPE_FP16);
    mo[O_ORTZ_ROUND] = Op("ortz_round", FLOAT_STORAGE_ONLY, FP32, "OpDecorate %result FPRoundingMode RTZ\n", "", "",
                          "%result             = OpFConvert %type_f16 %arg1\n", B_STATEMENT_USAGE_COMMANDS_TYPE_FP16);
}
                             ...
                             bool argumentsFromInput)
{
    ...
    for (size_t i = 0; i < typeTestResults->binaryOpFTZ.size(); ++i)
    {
        ...
        testCases.push_back(
            OTC("denorm_op_var_flush_to_zero", B_DENORM_FLUSH, operation, V_DENORM, V_ONE, binaryCase.opVarResult));
        testCases.push_back(OTC("denorm_op_denorm_flush_to_zero", B_DENORM_FLUSH, operation, V_DENORM, V_DENORM,
                                binaryCase.opDenormResult));
        testCases.push_back(OTC("denorm_op_inf_flush_to_zero", B_DENORM_FLUSH | B_ZIN_PRESERVE, operation, V_DENORM,
                                V_INF, binaryCase.opInfResult));
        testCases.push_back(OTC("denorm_op_nan_flush_to_zero", B_DENORM_FLUSH | B_ZIN_PRESERVE, operation, V_DENORM,
                                V_NAN, binaryCase.opNanResult));

        if (isFP16)
        {
            testCases.push_back(OTC("denorm_op_var_flush_to_zero_nostorage", B_DENORM_FLUSH, operation, V_DENORM, V_ONE,
                                    binaryCase.opVarResult, true));
            testCases.push_back(OTC("denorm_op_denorm_flush_to_zero_nostorage", B_DENORM_FLUSH, operation, V_DENORM,
                                    V_DENORM, binaryCase.opDenormResult, true));
            testCases.push_back(OTC("denorm_op_inf_flush_to_zero_nostorage", B_DENORM_FLUSH | B_ZIN_PRESERVE, operation,
                                    V_DENORM, V_INF, binaryCase.opInfResult, true));
            testCases.push_back(OTC("denorm_op_nan_flush_to_zero_nostorage", B_DENORM_FLUSH | B_ZIN_PRESERVE, operation,
                                    V_DENORM, V_NAN, binaryCase.opNanResult, true));
        }
    }
    ...
    for (size_t i = 0; i < typeTestResults->unaryOpFTZ.size(); ++i)
    {
        ...
        testCases.push_back(
            OTC("op_denorm_flush_to_zero", B_DENORM_FLUSH, operation, V_DENORM, V_UNUSED, unaryCase.result));
        if (isFP16)
            testCases.push_back(OTC("op_denorm_flush_to_zero_nostorage", B_DENORM_FLUSH, operation, V_DENORM, V_UNUSED,
                                    unaryCase.result, true));
    }
    ...
    for (size_t i = 0; i < typeTestResults->binaryOpDenormPreserve.size(); ++i)
    {
        ...
        OperationId operation        = binaryCase.operationId;
        testCases.push_back(
            OTC("denorm_op_var_preserve", B_DENORM_PRESERVE, operation, V_DENORM, V_ONE, binaryCase.opVarResult));
        ...
        if (isFP16)
        {
            testCases.push_back(OTC("denorm_op_var_preserve_nostorage", B_DENORM_PRESERVE, operation, V_DENORM, V_ONE,
                                    binaryCase.opVarResult, true));
            testCases.push_back(OTC("denorm_op_denorm_preserve_nostorage", B_DENORM_PRESERVE, operation, V_DENORM,
                                    V_DENORM, binaryCase.opDenormResult, true));
            testCases.push_back(OTC("denorm_op_inf_preserve_nostorage", B_DENORM_PRESERVE | B_ZIN_PRESERVE, operation,
                                    V_DENORM, V_INF, binaryCase.opInfResult, true));
            testCases.push_back(OTC("denorm_op_nan_preserve_nostorage", B_DENORM_PRESERVE | B_ZIN_PRESERVE, operation,
                                    V_DENORM, V_NAN, binaryCase.opNanResult, true));
        }
    }
    ...
    for (size_t i = 0; i < typeTestResults->unaryOpDenormPreserve.size(); ++i)
    {
        ...
        OperationId operation      = unaryCase.operationId;
        testCases.push_back(
            OTC("op_denorm_preserve", B_DENORM_PRESERVE, operation, V_DENORM, V_UNUSED, unaryCase.result));
        if (isFP16)
            testCases.push_back(OTC("op_denorm_preserve_nostorage", B_DENORM_PRESERVE, operation, V_DENORM, V_UNUSED,
                                    unaryCase.result, true));
    }
    ...
    for (size_t i = 0; i < DE_LENGTH_OF_ARRAY(binaryOpZINPreserve); ++i)
    {
        ...
        testCases.push_back(OTC("zero_op_var_preserve", B_ZIN_PRESERVE, zc.operationId, V_ZERO, zc.secondArgument,
                                zc.preserveZeroResult));
        testCases.push_back(OTC("signed_zero_op_var_preserve", B_ZIN_PRESERVE, zc.operationId, V_MINUS_ZERO,
                                zc.secondArgument, zc.preserveSZeroResult));
        testCases.push_back(
            OTC("inf_op_var_preserve", B_ZIN_PRESERVE, zc.operationId, V_INF, zc.secondArgument, zc.preserveInfResult));
        testCases.push_back(OTC("signed_inf_op_var_preserve", B_ZIN_PRESERVE, zc.operationId, V_MINUS_INF,
                                zc.secondArgument, zc.preserveSInfResult));
        testCases.push_back(
            OTC("nan_op_var_preserve", B_ZIN_PRESERVE, zc.operationId, V_NAN, zc.secondArgument, zc.preserveNanResult));

        if (isFP16)
        {
            testCases.push_back(OTC("zero_op_var_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_ZERO,
                                    zc.secondArgument, zc.preserveZeroResult, true));
            testCases.push_back(OTC("signed_zero_op_var_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId,
                                    V_MINUS_ZERO, zc.secondArgument, zc.preserveSZeroResult, true));
            testCases.push_back(OTC("inf_op_var_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_INF,
                                    zc.secondArgument, zc.preserveInfResult, true));
            testCases.push_back(OTC("signed_inf_op_var_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_MINUS_INF,
                                    zc.secondArgument, zc.preserveSInfResult, true));
            testCases.push_back(OTC("nan_op_var_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_NAN,
                                    zc.secondArgument, zc.preserveNanResult, true));
        }
    }
    ...
    for (size_t i = 0; i < DE_LENGTH_OF_ARRAY(unaryOpZINPreserve); ++i)
    {
        ...
        testCases.push_back(
            OTC("op_zero_preserve", B_ZIN_PRESERVE, zc.operationId, V_ZERO, V_UNUSED, zc.preserveZeroResult));
        testCases.push_back(OTC("op_signed_zero_preserve", B_ZIN_PRESERVE, zc.operationId, V_MINUS_ZERO, V_UNUSED,
                                zc.preserveSZeroResult));
        testCases.push_back(
            OTC("op_inf_preserve", B_ZIN_PRESERVE, zc.operationId, V_INF, V_UNUSED, zc.preserveInfResult));
        testCases.push_back(OTC("op_signed_inf_preserve", B_ZIN_PRESERVE, zc.operationId, V_MINUS_INF, V_UNUSED,
                                zc.preserveSInfResult));
        testCases.push_back(
            OTC("op_nan_preserve", B_ZIN_PRESERVE, zc.operationId, V_NAN, V_UNUSED, zc.preserveNanResult));

        if (isFP16)
        {
            testCases.push_back(OTC("op_zero_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_ZERO, V_UNUSED,
                                    zc.preserveZeroResult, true));
            testCases.push_back(OTC("op_signed_zero_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_MINUS_ZERO,
                                    V_UNUSED, zc.preserveSZeroResult, true));
            testCases.push_back(OTC("op_inf_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_INF, V_UNUSED,
                                    zc.preserveInfResult, true));
            testCases.push_back(OTC("op_signed_inf_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_MINUS_INF,
                                    V_UNUSED, zc.preserveSInfResult, true));
            testCases.push_back(OTC("op_nan_preserve_nostorage", B_ZIN_PRESERVE, zc.operationId, V_NAN, V_UNUSED,
                                    zc.preserveNanResult, true));
        }
    }
    ...
    const ComparisonCase comparisonCases[] = {// operation    denorm
                                              {O_ORD_EQ, V_ZERO},  {O_UORD_EQ, V_ZERO}, {O_ORD_NEQ, V_ONE},
                                              {O_UORD_NEQ, V_ONE}, {O_ORD_LS, V_ONE},   {O_UORD_LS, V_ONE},
                                              {O_ORD_GT, V_ZERO},  {O_UORD_GT, V_ZERO}, {O_ORD_LE, V_ONE},
                                              {O_UORD_LE, V_ONE},  {O_ORD_GE, V_ZERO},  {O_UORD_GE, V_ZERO}};
    for (int op = 0; op < DE_LENGTH_OF_ARRAY(comparisonCases); ++op)
    {
        ...
        if (isFP16)
            testCases.push_back(OTC("denorm_op_var_preserve_nostorage", B_DENORM_PRESERVE, cc.operationId, V_DENORM,
                                    V_ONE, cc.denormPreserveResult, true));
    }
    ...
    if (argumentsFromInput)
    {
        ...
        for (int c = 0; c < DE_LENGTH_OF_ARRAY(roundingCases); ++c)
        {
            ...
            if (isFP16)
            {
                testCases.push_back(OTC("rounding_rte_op_nostorage", B_RTE_ROUNDING, rmc.operationId, rmc.arg1,
                                        rmc.arg2, rmc.expectedRTEResult, true));
                testCases.push_back(OTC("rounding_rtz_op_nostorage", B_RTZ_ROUNDING, rmc.operationId, rmc.arg1,
                                        rmc.arg2, rmc.expectedRTZResult, true));
            }
        }
    }
    ...
    if (typeTestResults->floatType() == FP16)
    {
        if (argumentsFromInput)
        {
            testCases.push_back(OTC("rounding_rte_conv_from_fp32", B_RTE_ROUNDING, O_CONV_FROM_FP32,
                                    V_CONV_FROM_FP32_ARG, V_UNUSED, V_CONV_TO_FP16_RTE_RESULT));
            testCases.push_back(OTC("rounding_rtz_conv_from_fp32", B_RTZ_ROUNDING, O_CONV_FROM_FP32,
                                    V_CONV_FROM_FP32_ARG, V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT));
            testCases.push_back(OTC("rounding_rte_conv_from_fp64", B_RTE_ROUNDING, O_CONV_FROM_FP64,
                                    V_CONV_FROM_FP64_ARG, V_UNUSED, V_CONV_TO_FP16_RTE_RESULT));
            testCases.push_back(OTC("rounding_rtz_conv_from_fp64", B_RTZ_ROUNDING, O_CONV_FROM_FP64,
                                    V_CONV_FROM_FP64_ARG, V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT));

            testCases.push_back(OTC("rounding_rte_sconst_conv_from_fp32", B_RTE_ROUNDING,
                                    O_SCONST_CONV_FROM_FP32_TO_FP16, V_UNUSED, V_UNUSED, V_CONV_TO_FP16_RTE_RESULT));
            testCases.push_back(OTC("rounding_rtz_sconst_conv_from_fp32", B_RTZ_ROUNDING,
                                    O_SCONST_CONV_FROM_FP32_TO_FP16, V_UNUSED, V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT));
            testCases.push_back(OTC("rounding_rte_sconst_conv_from_fp64", B_RTE_ROUNDING,
                                    O_SCONST_CONV_FROM_FP64_TO_FP16, V_UNUSED, V_UNUSED, V_CONV_TO_FP16_RTE_RESULT));
            testCases.push_back(OTC("rounding_rtz_sconst_conv_from_fp64", B_RTZ_ROUNDING,
                                    O_SCONST_CONV_FROM_FP64_TO_FP16, V_UNUSED, V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT));

            testCases.push_back(OTC("rounding_rte_conv_from_fp32_nostorage", B_RTE_ROUNDING, O_CONV_FROM_FP32,
                                    V_CONV_FROM_FP32_ARG, V_UNUSED, V_CONV_TO_FP16_RTE_RESULT, true));
            testCases.push_back(OTC("rounding_rtz_conv_from_fp32_nostorage", B_RTZ_ROUNDING, O_CONV_FROM_FP32,
                                    V_CONV_FROM_FP32_ARG, V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT, true));
            testCases.push_back(OTC("rounding_rte_conv_from_fp64_nostorage", B_RTE_ROUNDING, O_CONV_FROM_FP64,
                                    V_CONV_FROM_FP64_ARG, V_UNUSED, V_CONV_TO_FP16_RTE_RESULT, true));
            testCases.push_back(OTC("rounding_rtz_conv_from_fp64_nostorage", B_RTZ_ROUNDING, O_CONV_FROM_FP64,
                                    V_CONV_FROM_FP64_ARG, V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT, true));

            testCases.push_back(OTC("rounding_rte_sconst_conv_from_fp32_nostorage", B_RTE_ROUNDING,
                                    O_SCONST_CONV_FROM_FP32_TO_FP16, V_UNUSED, V_UNUSED, V_CONV_TO_FP16_RTE_RESULT,
                                    true));
            testCases.push_back(OTC("rounding_rtz_sconst_conv_from_fp32_nostorage", B_RTZ_ROUNDING,
                                    O_SCONST_CONV_FROM_FP32_TO_FP16, V_UNUSED, V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT,
                                    true));
            testCases.push_back(OTC("rounding_rte_sconst_conv_from_fp64_nostorage", B_RTE_ROUNDING,
                                    O_SCONST_CONV_FROM_FP64_TO_FP16, V_UNUSED, V_UNUSED, V_CONV_TO_FP16_RTE_RESULT,
                                    true));
            testCases.push_back(OTC("rounding_rtz_sconst_conv_from_fp64_nostorage", B_RTZ_ROUNDING,
                                    O_SCONST_CONV_FROM_FP64_TO_FP16, V_UNUSED, V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT,
                                    true));
            ...
            testCases.push_back(OTC("rounding_rte_override", B_RTE_ROUNDING, O_ORTZ_ROUND, V_CONV_FROM_FP32_ARG,
                                    V_UNUSED, V_CONV_TO_FP16_RTZ_RESULT));
            testCases.push_back(OTC("rounding_rtz_override", B_RTZ_ROUNDING, O_ORTE_ROUND, V_CONV_FROM_FP32_ARG,
                                    V_UNUSED, V_CONV_TO_FP16_RTE_RESULT));
        }
        ...
        createUnaryTestCases(testCases, O_CONV_FROM_FP32, V_CONV_DENORM_SMALLER, V_ZERO, true);
        createUnaryTestCases(testCases, O_CONV_FROM_FP64, V_CONV_DENORM_BIGGER, V_ZERO, true);
    }
    else if (typeTestResults->floatType() == FP32)
    {
        if (argumentsFromInput)
        {
            ...
            testCases.push_back(OTC("rounding_rte_conv_from_fp64", B_RTE_ROUNDING, O_CONV_FROM_FP64,
                                    V_CONV_FROM_FP64_ARG, V_UNUSED, V_CONV_TO_FP32_RTE_RESULT));
            testCases.push_back(OTC("rounding_rtz_conv_from_fp64", B_RTZ_ROUNDING, O_CONV_FROM_FP64,
                                    V_CONV_FROM_FP64_ARG, V_UNUSED, V_CONV_TO_FP32_RTZ_RESULT));

            testCases.push_back(OTC("rounding_rte_sconst_conv_from_fp64", B_RTE_ROUNDING,
                                    O_SCONST_CONV_FROM_FP64_TO_FP32, V_UNUSED, V_UNUSED, V_CONV_TO_FP32_RTE_RESULT));
            testCases.push_back(OTC("rounding_rtz_sconst_conv_from_fp64", B_RTZ_ROUNDING,
                                    O_SCONST_CONV_FROM_FP64_TO_FP32, V_UNUSED, V_UNUSED, V_CONV_TO_FP32_RTZ_RESULT));
        }
        else
        {
            // PackHalf2x16 - verification done in SPIR-V
            testCases.push_back(
                OTC("pack_half_denorm_preserve", B_DENORM_PRESERVE, O_PH_DENORM, V_UNUSED, V_UNUSED, V_ONE));

            // UnpackHalf2x16 - custom arguments defined as constants
            testCases.push_back(
                OTC("upack_half_denorm_flush_to_zero", B_DENORM_FLUSH, O_UPH_DENORM, V_UNUSED, V_UNUSED, V_ZERO));
            testCases.push_back(OTC("upack_half_denorm_preserve", B_DENORM_PRESERVE, O_UPH_DENORM, V_UNUSED, V_UNUSED,
                                    V_CONV_DENORM_SMALLER));
        }

        createUnaryTestCases(testCases, O_CONV_FROM_FP16, V_CONV_DENORM_SMALLER, V_ZERO_OR_FP16_DENORM_TO_FP32);
        createUnaryTestCases(testCases, O_CONV_FROM_FP16, V_CONV_DENORM_SMALLER, V_ZERO_OR_FP16_DENORM_TO_FP32, true);
        createUnaryTestCases(testCases, O_CONV_FROM_FP64, V_CONV_DENORM_BIGGER, V_ZERO);
    }
    else // FP64
    {
        if (!argumentsFromInput)
        {
            ...
            testCases.push_back(
                OTC("pack_double_denorm_preserve", B_DENORM_PRESERVE, O_PD_DENORM, V_UNUSED, V_UNUSED, V_DENORM));

            // UnpackDouble2x32 - verification done in SPIR-V
            testCases.push_back(OTC("upack_double_denorm_flush_to_zero", B_DENORM_FLUSH, O_UPD_DENORM_FLUSH, V_DENORM,
                                    V_UNUSED, V_ONE));
            testCases.push_back(OTC("upack_double_denorm_preserve", B_DENORM_PRESERVE, O_UPD_DENORM_PRESERVE, V_DENORM,
                                    V_UNUSED, V_ONE));
        }

        createUnaryTestCases(testCases, O_CONV_FROM_FP16, V_CONV_DENORM_SMALLER, V_ZERO_OR_FP16_DENORM_TO_FP64);
        createUnaryTestCases(testCases, O_CONV_FROM_FP16, V_CONV_DENORM_SMALLER, V_ZERO_OR_FP16_DENORM_TO_FP64, true);
                                            ...
                                            bool fp16WithoutStorage) const
{
    ...
    {
        // Denom - Preserve
        testCases.push_back(OTC("op_denorm_preserve_nostorage", B_DENORM_PRESERVE, operationId, V_DENORM, V_UNUSED,
                                denormPreserveResult, true));

        // Denorm - FlushToZero
        testCases.push_back(OTC("op_denorm_flush_to_zero_nostorage", B_DENORM_FLUSH, operationId, V_DENORM, V_UNUSED,
                                denormFTZResult, true));

        // Signed Zero Inf Nan - Preserve
        testCases.push_back(
            OTC("op_zero_preserve_nostorage", B_ZIN_PRESERVE, operationId, V_ZERO, V_UNUSED, V_ZERO, true));
        testCases.push_back(OTC("op_signed_zero_preserve_nostorage", B_ZIN_PRESERVE, operationId, V_MINUS_ZERO,
                                V_UNUSED, V_MINUS_ZERO, true));
        testCases.push_back(
            OTC("op_inf_preserve_nostorage", B_ZIN_PRESERVE, operationId, V_INF, V_UNUSED, V_INF, true));
        testCases.push_back(
            OTC("op_nan_preserve_nostorage", B_ZIN_PRESERVE, operationId, V_NAN, V_UNUSED, V_NAN, true));
    }
    else
    {
        // Denom - Preserve
        testCases.push_back(
            OTC("op_denorm_preserve", B_DENORM_PRESERVE, operationId, V_DENORM, V_UNUSED, denormPreserveResult));

        // Denorm - FlushToZero
        testCases.push_back(
            OTC("op_denorm_flush_to_zero", B_DENORM_FLUSH, operationId, V_DENORM, V_UNUSED, denormFTZResult));

        // Signed Zero Inf Nan - Preserve
        testCases.push_back(OTC("op_zero_preserve", B_ZIN_PRESERVE, operationId, V_ZERO, V_UNUSED, V_ZERO));
        testCases.push_back(
            OTC("op_signed_zero_preserve", B_ZIN_PRESERVE, operationId, V_MINUS_ZERO, V_UNUSED, V_MINUS_ZERO));
...
template <>
double getFloatTypeAsDouble(deFloat16 param)
{
...
protected:
    ...
    void setupVulkanFeatures(FloatType inFloatType, FloatType outFloatType, BehaviorFlags behaviorFlags,
                             bool float64FeatureRequired, VulkanFeatures &features) const;
...
void TestGroupBuilderBase::setupVulkanFeatures(FloatType inFloatType, FloatType outFloatType,
                                               BehaviorFlags behaviorFlags, bool float64FeatureRequired,
...
void ComputeTestGroupBuilder::fillShaderSpec(const OperationTestCaseInfo &testCaseInfo, ComputeShaderSpec &csSpec) const
{
    ...
    setupVulkanFeatures(inFloatTypeForCaps, // usualy same as inFloatType - different only for UnpackHalf2x16
                        outFloatType, testCase.behaviorFlags, float64FeatureRequired, csSpec.requestedVulkanFeatures);
                                                    ...
                                                    FloatType floatType, bool argumentsFromInput)
{
    ...
    while (currTestCase != lastTestCase)
    {
        ...
        OperationTestCaseInfo testCaseInfo = {floatType, argumentsFromInput, VK_SHADER_STAGE_VERTEX_BIT,
    ...
    while (currTestCase != lastTestCase)
    {
        ...
        OperationTestCaseInfo testCaseInfo = {floatType, argumentsFromInput, VK_SHADER_STAGE_FRAGMENT_BIT,
                                              m_testCaseBuilder.getOperation(testCase.operationId), testCase};
...
InstanceContext GraphicsTestGroupBuilder::createInstanceContext(const OperationTestCaseInfo &testCaseInfo) const
{
    ...
    setupVulkanFeatures(inFloatTypeForCaps, // usualy same as inFloatType - different only for UnpackHalf2x16
                        outFloatType, testCase.behaviorFlags, float64FeatureRequired, vulkanFeatures);
...
tcu::TestCaseGroup *createFloatControlsTestGroup(TestContext &testCtx, TestGroupBuilderBase *groupBuilder)
{
    de::MovePtr<TestCaseGroup> group(
        new TestCaseGroup(testCtx, "float_controls", "Tests for VK_KHR_shader_float_controls extension"));

...
SpvAsmLoopControlDependencyLengthCase::SpvAsmLoopControlDependencyLengthCase(tcu::TestContext &testCtx,
                                                                             const char *name)
...
void SpvAsmLoopControlDependencyLengthCase::initPrograms(SourceCollections &programCollection) const
{
    ...
    programCollection.spirvAsmSources.add("compute")
        << SpirVAsmBuildOptions(programCollection.usedVulkanVersion, SPIRV_VERSION_1_3) << comp;
}

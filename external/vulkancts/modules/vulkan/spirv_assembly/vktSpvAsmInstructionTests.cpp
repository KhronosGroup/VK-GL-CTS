...
{
	// Test the OpNop instruction
	de::MovePtr<tcu::TestCaseGroup>	group			(new tcu::TestCaseGroup(testCtx, "opnop"));
	ComputeShaderSpec				spec;
	de::Random						rnd				(deStringHash(group->getName()));
	...
	// OpNop appearing at different places
...
{
	// Compute shaders with unused variables
	de::MovePtr<tcu::TestCaseGroup>	group			(new tcu::TestCaseGroup(testCtx, "unused_variables"));
	de::Random						rnd				(deStringHash(group->getName()));
	const int						numElements		= 100;
	vector<float>					positiveFloats	(numElements, 0);
	vector<float>					negativeFloats	(numElements, 0);
	...
	cases.push_back(OpFUnordCase(#NAME, OPCODE, compare_##NAME::compare)); \
			...
			tcu::TestCaseGroup* createOpFUnordGroup (tcu::TestContext& testCtx, const bool testWithNan)
			{
				...
				for (size_t caseNdx = 0; caseNdx < cases.size(); ++caseNdx)
				{
					...
					group->addChild(new SpvAsmComputeShaderCase(testCtx, cases[caseNdx].name, spec));
				}
...
#undef ADD_OPATOMIC_CASE_N
			...
			{
				// Test the OpLine instruction
				de::MovePtr<tcu::TestCaseGroup>	group			(new tcu::TestCaseGroup(testCtx, "opline"));
				ComputeShaderSpec				spec;
				de::Random						rnd				(deStringHash(group->getName()));
				const int						numElements		= 100;
				vector<float>					positiveFloats	(numElements, 0);
...
// Copy contents in the input buffer to the output buffer.
			tcu::TestCaseGroup* createOpCopyMemoryGroup (tcu::TestContext& testCtx)
			{
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "vector", spec1));
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "array", spec2));
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "struct", spec3));
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "float", spec4));
...
// }
			...
			tcu::TestCaseGroup* createSpecConstantGroup (tcu::TestContext& testCtx)
			{
				...
				for (size_t caseNdx = 0; caseNdx < cases.size(); ++caseNdx)
				{
					...
					group->addChild(new SpvAsmComputeShaderCase(testCtx, cases[caseNdx].caseName.c_str(), spec));
				}
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "vector_related", spec));
			...
			void createOpPhiVartypeTests (de::MovePtr<tcu::TestCaseGroup>& group, tcu::TestContext& testCtx)
			{
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "vartype_vec3", specVec3));
...
// branch.
			...
			tcu::TestCaseGroup* createOpPhiGroup (tcu::TestContext& testCtx)
			{
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "block", spec1));
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "induction", spec2));
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "swap", spec3));
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "wide", spec4));
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "nested", spec5));
...
// }
			...
			tcu::TestCaseGroup* createMultipleShaderGroup (tcu::TestContext& testCtx)
			{
				...
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "shader1", spec1));
				group->addChild(new SpvAsmComputeShaderCase(testCtx, "shader2", spec2));
...
// }
			tcu::TestCaseGroup* createLoopControlGroup (tcu::TestContext& testCtx)
			{
				...
				group->addChild(new SpvAsmLoopControlDependencyLengthCase(testCtx, "dependency_length"));
				group->addChild(new SpvAsmLoopControlDependencyInfiniteCase(testCtx, "dependency_infinite"));
...
// }
			...
			tcu::TestCaseGroup* createOpNameGroup (tcu::TestContext& testCtx)
			{
...

				{
					...
					abuseGroup->addChild(new SpvAsmComputeShaderCase(testCtx, "main_has_multiple_names", spec));
				}
						...
						commonShaderFooter;
				{
					...
					abuseGroup->addChild(new SpvAsmComputeShaderCase(testCtx, "everything_named", spec));
				}
						...
						commonShaderFooter;
				{
					...
					abuseGroup->addChild(new SpvAsmComputeShaderCase(testCtx, "everything_named_the_same", spec));
				}
				...
				for (size_t ndx = 0; ndx < abuseCases.size(); ++ndx)
				{
					...
					abuseGroup->addChild(new SpvAsmComputeShaderCase(testCtx, (std::string("main") + abuseCases[ndx].name).c_str(), spec));
				}
				...
				for (size_t ndx = 0; ndx < abuseCases.size(); ++ndx)
				{
					...
					abuseGroup->addChild(new SpvAsmComputeShaderCase(testCtx, (std::string("x") + abuseCases[ndx].name).c_str(), spec));
				}
				...
				for(size_t fNdx = 0; fNdx < testFunc.size(); ++fNdx)
				{
					for(size_t ndx = 0; ndx < cases.size(); ++ndx)
					{
						...
						entryMainGroup->addChild(new SpvAsmComputeShaderCase(testCtx, (testFunc[fNdx] + cases[ndx].name).c_str(), spec));
					}
				}
				...
				for(size_t fNdx = 0; fNdx < testFunc.size(); ++fNdx)
				{
					for(size_t ndx = 0; ndx < cases.size(); ++ndx)
					{
						...
						entryNotGroup->addChild(new SpvAsmComputeShaderCase(testCtx, (testFunc[fNdx] + cases[ndx].name).c_str(), spec));
					}
				}
			...
			tcu::TestCaseGroup* createOpMemberNameGroup (tcu::TestContext& testCtx)
			{
						...
						commonShaderFooter;
				{
					...
					abuseGroup->addChild(new SpvAsmComputeShaderCase(testCtx, "u3str_x_has_multiple_names", spec));
				}
				...
				for (size_t ndx = 0; ndx < abuseCases.size(); ++ndx)
				{
					...
					abuseGroup->addChild(new SpvAsmComputeShaderCase(testCtx, (std::string("u3str_x") + abuseCases[ndx].name).c_str(), spec));
				}
...
// Data generator for complex matrix functions like determinant and inverse
		...
		tcu::TestCaseGroup* createOpCompositeInsertGroup (tcu::TestContext& testCtx)
		{
			...
			for (int type = NUMBERTYPE_INT32; type != NUMBERTYPE_END32; ++type)
			{
				...
				de::MovePtr<tcu::TestCaseGroup>	subGroup		(new tcu::TestCaseGroup(testCtx, typeName.c_str()));
				...
				for (vector<map<string, string> >::const_iterator test = testCases.begin(); test != testCases.end(); ++test)
				{
					...
					spec.numWorkGroups = IVec3(1, 1, 1);
					subGroup->addChild(new SpvAsmComputeShaderCase(testCtx, test->at("name").c_str(), spec));
				}
			...
			for (int type = NUMBERTYPE_INT32; type != NUMBERTYPE_END32; ++type)
			{
				...
				for (int subCase = 0; subCase < 2; ++subCase)
				{
					...
					if (!subCase)
					{
						...
						subGroup->addChild(new SpvAsmComputeShaderCase(testCtx, "initialized", spec));
					}
					...
					else
					{
						...
						subGroup->addChild(new SpvAsmComputeShaderCase(testCtx, "uninitialized", spec));
					}
				}
				group->addChild(subGroup.release());
			}

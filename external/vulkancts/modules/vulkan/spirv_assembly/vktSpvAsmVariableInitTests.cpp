...
void addComputeVariableInitPrivateTest(tcu::TestCaseGroup *group)
{
    ...
    tcu::TestCaseGroup *privateGroup =
        new tcu::TestCaseGroup(testCtx, "private", "Tests OpVariable initialization in private storage class.");
...
void addGraphicsVariableInitOutputTest(tcu::TestCaseGroup *group)
{
    ...
    map<string, string> fragments;
    RGBA defaultColors[4];
    tcu::TestCaseGroup *outputGroup =
        new tcu::TestCaseGroup(testCtx, "output", "Tests OpVariable initialization in output storage class.");
...
tcu::TestCaseGroup *createVariableInitComputeGroup(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "variable_init", "Compute tests for OpVariable initialization."));
...
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "variable_init", "Graphics tests for OpVariable initialization."));

...
static T dotProduct(vector<LHSOperandT> lhs, vector<RHSOperandT> rhs)
{
    ...
    {
        res += static_cast<int64_t>(lhs[i]) * static_cast<int64_t>(rhs[i]);
    }
...
tcu::TestCaseGroup *createOpSDotKHRComputeGroup(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "opsdotkhr", "Test the OpSDotKHR instruction"));
...
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "opudotkhr", "Test the OpUDotKHR instruction"));
    de::Random rnd(deStringHash(group->getName()));
...
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "opsudotkhr", "Test the OpSUDotKHR instruction"));
    de::Random rnd(deStringHash(group->getName()));
...
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "opsdotaccsatkhr", "Test the OpSDotAccSatKHR instruction"));
    de::Random rnd(deStringHash(group->getName()));
    ...
    add8bitOpSDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("limits-neg"), (int8_t)(-20), (int8_t)(-12),
                                       false);
    add8bitOpSDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("small"), (int8_t)-20, (int8_t)20);
    add16bitOpSDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("all"), std::numeric_limits<int16_t>::min(),
                                        std::numeric_limits<int16_t>::max());
    add16bitOpSDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("limits"),
                                        (int16_t)(std::numeric_limits<int8_t>::max() - 20),
                                        (int16_t)(std::numeric_limits<int8_t>::max() + 20));
    add16bitOpSDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("limits-neg"),
                                        (int16_t)(std::numeric_limits<int8_t>::min() - 20),
                                        (int16_t)(std::numeric_limits<int8_t>::min() + 20), false);
    ...
    add32bitOpSDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("limits"),
                                        (int32_t)(std::numeric_limits<int16_t>::max() - 20),
                                        (int32_t)(std::numeric_limits<int16_t>::max() + 20));
    add32bitOpSDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("limits-neg"),
                                        (int32_t)(std::numeric_limits<int16_t>::min() - 20),
                                        (int32_t)(std::numeric_limits<int16_t>::min() + 20), false);
...
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "opudotaccsatkhr", "Test the OpUDotAccSatKHR instruction"));
    de::Random rnd(deStringHash(group->getName()));
    ...
    add8bitOpUDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("small"), (uint8_t)0, (uint8_t)20);
    add16bitOpUDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("all"), std::numeric_limits<uint16_t>::min(),
                                        std::numeric_limits<uint16_t>::max());
    add16bitOpUDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("limits"),
                                        (uint16_t)(std::numeric_limits<uint8_t>::max() - 40),
                                        (uint16_t)(std::numeric_limits<uint8_t>::max() - 20));
    ...
    add32bitOpUDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("limits"),
                                        (uint32_t)(std::numeric_limits<uint16_t>::max() - 40),
                                        (uint32_t)(std::numeric_limits<uint16_t>::max() - 20));
...
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "opsudotaccsatkhr", "Test the OpSUDotAccSatKHR instruction"));
    de::Random rnd(deStringHash(group->getName()));
    ...
    add8bitOpSUDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("small"), (int8_t)-20, (int8_t)20, (uint8_t)0,
                                        (uint8_t)20);
    add16bitOpSUDotAccSatKHRComputeTests(testCtx, group.get(), rnd, string("all"), std::numeric_limits<int16_t>::min(),
                                         std::numeric_limits<int16_t>::max(), std::numeric_limits<uint16_t>::min(),
                                         std::numeric_limits<uint16_t>::max());
    add16bitOpSUDotAccSatKHRComputeTests(
        testCtx, group.get(), rnd, string("limits"), (int16_t)(std::numeric_limits<int8_t>::max() - 20),
        (int16_t)(std::numeric_limits<int8_t>::max() + 20), (uint16_t)(std::numeric_limits<uint8_t>::max() - 40),
        (uint16_t)(std::numeric_limits<uint8_t>::max() - 20));
    add16bitOpSUDotAccSatKHRComputeTests(
        testCtx, group.get(), rnd, string("limits-neg"), (int16_t)(std::numeric_limits<int8_t>::min() - 20),
        (int16_t)(std::numeric_limits<int8_t>::min() + 20), (uint16_t)(std::numeric_limits<uint8_t>::max() - 40),
        (uint16_t)(std::numeric_limits<uint8_t>::max() - 20), false);
    ...
    add32bitOpSUDotAccSatKHRComputeTests(
        testCtx, group.get(), rnd, string("limits"), (int32_t)(std::numeric_limits<int16_t>::max() - 20),
        (int32_t)(std::numeric_limits<int16_t>::max() + 20), (uint32_t)(std::numeric_limits<uint16_t>::max() - 40),
        (uint32_t)(std::numeric_limits<uint16_t>::max() - 20));
    add32bitOpSUDotAccSatKHRComputeTests(
        testCtx, group.get(), rnd, string("limits-neg"), (int32_t)(std::numeric_limits<int16_t>::min() - 20),
        (int32_t)(std::numeric_limits<int16_t>::min() + 20), (uint32_t)(std::numeric_limits<uint16_t>::max() - 40),
        (uint32_t)(std::numeric_limits<uint16_t>::max() - 20), false);

...
Move<VkImage> createImageAndBindMemory(const DeviceInterface &vkdi, const VkDevice &device, VkDescriptorType dtype,
                                       Allocator &allocator, uint32_t queueFamilyIndex, AllocationMp *outMemory)
{
...
SpvAsmComputeShaderCase::SpvAsmComputeShaderCase(tcu::TestContext &testCtx, const char *name, const char *description,
...
void SpvAsmComputeShaderCase::initPrograms(SourceCollections &programCollection) const
{
    programCollection.spirvAsmSources.add("compute")
        ...
        << SpirVAsmBuildOptions(programCollection.usedVulkanVersion, m_shaderSpec.spirvVersion);
}
...
tcu::TestStatus SpvAsmComputeShaderInstance::iterate(void)
{
    ...
    // Core features
    {
        ...
        localRequiredCoreFeatures.fullDrawIndexUint32                    = false;
        localRequiredCoreFeatures.independentBlend                       = false;
        localRequiredCoreFeatures.geometryShader                         = false;
        localRequiredCoreFeatures.tessellationShader                     = false;
        localRequiredCoreFeatures.sampleRateShading                      = false;
        localRequiredCoreFeatures.dualSrcBlend                           = false;
        localRequiredCoreFeatures.logicOp                                = false;
        localRequiredCoreFeatures.multiDrawIndirect                      = false;
        localRequiredCoreFeatures.drawIndirectFirstInstance              = false;
        localRequiredCoreFeatures.depthClamp                             = false;
        localRequiredCoreFeatures.depthBiasClamp                         = false;
        localRequiredCoreFeatures.fillModeNonSolid                       = false;
        localRequiredCoreFeatures.depthBounds                            = false;
        localRequiredCoreFeatures.wideLines                              = false;
        localRequiredCoreFeatures.largePoints                            = false;
        localRequiredCoreFeatures.alphaToOne                             = false;
        localRequiredCoreFeatures.multiViewport                          = false;
        localRequiredCoreFeatures.occlusionQueryPrecise                  = false;
        localRequiredCoreFeatures.vertexPipelineStoresAndAtomics         = false;
        localRequiredCoreFeatures.fragmentStoresAndAtomics               = false;
        localRequiredCoreFeatures.shaderTessellationAndGeometryPointSize = false;
        localRequiredCoreFeatures.shaderClipDistance                     = false;
        localRequiredCoreFeatures.shaderCullDistance                     = false;
        localRequiredCoreFeatures.sparseBinding                          = false;
        localRequiredCoreFeatures.variableMultisampleRate                = false;
    ...
    // Extension features
    {
        ...
        {
            if (!isVariablePointersFeaturesSupported(m_context,
                                                     m_shaderSpec.requestedVulkanFeatures.extVariablePointers))
        ...
        {
            if (!isVulkanMemoryModelFeaturesSupported(m_context,
                                                      m_shaderSpec.requestedVulkanFeatures.extVulkanMemoryModel))
    ...
    for (uint32_t inputNdx = 0; inputNdx < m_shaderSpec.inputs.size(); ++inputNdx)
    {
        ...
        else if (hasImage)
        {
            ...
            ImageHandleUp *image = new ImageHandleUp(
                createImageAndBindMemory(vkdi, device, descType, allocator, queueFamilyIndex, &imageAlloc));

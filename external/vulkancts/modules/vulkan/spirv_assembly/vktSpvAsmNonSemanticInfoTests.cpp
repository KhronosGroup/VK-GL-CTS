...
void SpvAsmSpirvNonSemanticInfoBasicCase::initPrograms(SourceCollections &programCollection) const
{
    ...
    case TT_DUMMY_INSTRUCTION_SET:
        ...
        extendedInstructions = "%extInstSet = OpExtInstImport \"NonSemantic.P.B.DummySet\"\n";
...
tcu::TestCaseGroup *createNonSemanticInfoGroup(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "non_semantic_info", "Test for VK_KHR_shader_non_semantic_info"));

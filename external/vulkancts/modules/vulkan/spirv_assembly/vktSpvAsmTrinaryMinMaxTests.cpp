...
public:
    ...
    TrinaryMinMaxCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
...
TrinaryMinMaxCase::TrinaryMinMaxCase(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
                                     const TestParams &params)
...
tcu::TestCaseGroup *createTrinaryMinMaxGroup(tcu::TestContext &testCtx)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> group{
        new tcu::TestCaseGroup{testCtx, "amd_trinary_minmax", "Tests for VK_AMD_trinary_minmax operations"}};
        ...
        for (const auto &baseType : baseTypes)
            for (const auto &typeSize : typeSizes)
            {
                ...
                de::MovePtr<tcu::TestCaseGroup> typeGroup{
                    new tcu::TestCaseGroup{testCtx, typeName.c_str(), typeDesc.c_str()}};

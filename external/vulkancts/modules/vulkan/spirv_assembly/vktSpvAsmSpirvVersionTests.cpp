...
{
public:
    SpvAsmSpirvVersionsCase(tcu::TestContext &testCtx, const char *name, const char *description,
                            const TestParameters &testParameters);
...
SpvAsmSpirvVersionsCase::SpvAsmSpirvVersionsCase(tcu::TestContext &testCtx, const char *name, const char *description,
                                                 const TestParameters &testParameters)
...
tcu::TestCaseGroup *createSpivVersionCheckTests(tcu::TestContext &testCtx, const bool compute)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> group(
        new tcu::TestCaseGroup(testCtx, "spirv_version", "Test SPIR-V version is supported"));

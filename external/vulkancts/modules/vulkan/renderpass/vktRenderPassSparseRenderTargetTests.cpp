                                      ...
                                      const BinaryCollection &binaryCollection, uint32_t width, uint32_t height)
{
    ...
    VkPipelineRenderingCreateInfoKHR *pNext = nullptr;
...
tcu::TestStatus SparseRenderTargetTestInstance::iterateInternal(void)
{
    ...
    const VkRenderPassBeginInfo beginInfo{
        VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO, nullptr, *m_renderPass, *m_framebuffer, renderArea, 0u, nullptr};
    ...
    const VkPipelineStageFlags stageBits[] = {VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT};

...
{
public:
    DepthStencilWriteConditionsTest(tcu::TestContext &testCtx, const std::string &name, const std::string &description,
                                    const BufferType bufferType, const DiscardType discardType,
                                    const MutationMode mutationMode, const VkFormat bufferFormat);
...
DepthStencilWriteConditionsTest::DepthStencilWriteConditionsTest(
    tcu::TestContext &testCtx, const std::string &name, const std::string &description, const BufferType bufferType,
    const DiscardType discardType, const MutationMode mutationMode, const VkFormat bufferFormat)
...
tcu::TestCaseGroup *createDepthStencilWriteConditionsTests(tcu::TestContext &testCtx)
{
    de::MovePtr<tcu::TestCaseGroup> testGroup(
        new tcu::TestCaseGroup(testCtx, "depth_stencil_write_conditions", "Depth/Stencil Write conditions tests"));
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        testGroup->addChild(new DepthStencilWriteConditionsTest(testCtx, "depth_kill_write" + postfix, "",

                                                  ...
                                                  const SharedGroupParams groupParams)
{
    ...
    case RENDERING_TYPE_RENDERPASS_LEGACY:
        ...
        // Test clears in a renderpass with no drawing commands
        noDrawGroup->addChild(
            new RenderPassNoDrawLoadStoreTestCase(testCtx, "render_pass_no_draw_clear_load_store", false));
    ...
    case RENDERING_TYPE_RENDERPASS2:
        ...
        // Test clears in a renderpass with no drawing commands
        noDrawGroup->addChild(
            new RenderPassNoDrawLoadStoreTestCase(testCtx, "render_pass2_no_draw_clear_load_store", true));

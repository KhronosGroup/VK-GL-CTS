    ...
    , m_testParams(testParams)
{
    ...
    if (testParams.dynamicDensityMap)
    {
        ...
        if (isDynamicRendering)
        {
            ...
            const VkImageSubresourceRange subresourceRange =
                makeImageSubresourceRange(VK_IMAGE_ASPECT_COLOR_BIT, 0u, densityMapImageLayers, 0u, 1u);
            ...
            VkRenderingInfoKHR renderingInfo{
                ...
                densityMapImageLayers,       // uint32_t layerCount;
        ...
        if (isDynamicRendering)
        {
            ...
            VkImageMemoryBarrier densityMapImageBarrier =
...
tcu::TestCaseGroup *createFragmentDensityMapTests(tcu::TestContext &testCtx, RenderingType renderingType)
{
    return createTestGroup(testCtx, "fragment_density_map",
                           ...
                           createChildren, renderingType, cleanupGroup);
}

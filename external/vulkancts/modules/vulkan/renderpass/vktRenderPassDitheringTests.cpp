...
{
public:
    DitheringTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
...
DitheringTest::DitheringTest(tcu::TestContext &testContext, const std::string &name, const std::string &description,
                             TestParams testParams)
...
void DitheringTestInstance::render(const VkViewport &vp, bool useDithering)
{
    ...
    // Clear color and transition image to desired layout.
    {
        ...
        const auto layout    = (m_testParams.renderingType == RENDERING_TYPE_DYNAMIC_RENDERING) ?
            ...
            for (const auto &imageView : m_drawResources[resourceNdx].imageViews)
            {
                VkRenderingAttachmentInfoKHR attachment = {
                    ...
                    *imageView,                                      // VkImageView imageView;
                    ...
                    m_testParams.blending ? VK_ATTACHMENT_LOAD_OP_LOAD :
...
tcu::TestCaseGroup *createRenderPassDitheringTests(tcu::TestContext &testCtx, const RenderingType renderingType)
{
    ...
    de::MovePtr<tcu::TestCaseGroup> ditheringTests(
        new tcu::TestCaseGroup(testCtx, "dithering", "Tests for VK_EXT_legacy_dithering"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> baseTests(
            new tcu::TestCaseGroup(testCtx, "base", "Test dithering works and values are withing one ULP"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> depthStencilTests(new tcu::TestCaseGroup(
            testCtx, "depth_stencil", "Test dithering works with depth/stencil and it does not affect depth/stencil"));
    ...
    {
        de::MovePtr<tcu::TestCaseGroup> blendTests(
            new tcu::TestCaseGroup(testCtx, "blend", "Test dithering works with blending"));

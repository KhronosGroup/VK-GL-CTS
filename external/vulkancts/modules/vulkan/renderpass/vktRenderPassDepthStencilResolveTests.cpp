...
{
public:
    PropertiesTestCase(tcu::TestContext &testCtx, const std::string &name) : vkt::TestCase(testCtx, name)
    {
    }
                            ...
                            for (int unusedIdx = 0; unusedIdx < 2; ++unusedIdx)
                            {
                                ...
                                if (hasDepth)
                                {
                                    ...
                                    formatGroup->addChild(new DSResolveTestInstance(
                                        testCtx, tcu::NODETYPE_SELF_VALIDATE, testName, testConfig, checkSupport));
                                ...
                                if (hasStencil)
                                {
                                    ...
                                    if (dResolve.flag == VK_RESOLVE_MODE_SAMPLE_ZERO_BIT)
                                    {
                                        ...
                                        formatGroup->addChild(new DSResolveTestInstance(
                                            ...
                                            samplemaskTestConfig, checkSupport));
                                    }

                            ...
                            for (int unusedIdx = 0; unusedIdx < 2; ++unusedIdx)
                            {
                                ...
                                if (hasDepth)
                                {
                                    ...
                                    formatGroup->addChild(
                                        new DSResolveTestInstance(testCtx, tcu::NODETYPE_SELF_VALIDATE, testName,
                                                                  testName, testConfig, checkSupport));
                                        ...
                                        dResolve.flag != VK_RESOLVE_MODE_NONE)
                                    {
                                        ...
                                        if (compatibleFormat != VK_FORMAT_UNDEFINED)
                                        {
                                            ...
                                            formatGroup->addChild(new DSResolveTestInstance(
                                                ...
                                                compatibilityTestName.c_str(), compatibilityTestConfig, checkSupport));
                                        }
                                    }
                                }
                                if (hasStencil)
                                {
                                    ...
                                    if (dResolve.flag == VK_RESOLVE_MODE_SAMPLE_ZERO_BIT)
                                    {
                                        ...
                                        formatGroup->addChild(new DSResolveTestInstance(
                                            ...
                                            samplemaskTestName.c_str(), samplemaskTestConfig, checkSupport));
                                    }

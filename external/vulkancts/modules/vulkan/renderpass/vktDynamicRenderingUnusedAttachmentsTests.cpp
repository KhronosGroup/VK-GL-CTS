...
tcu::TestCaseGroup *createDynamicRenderingUnusedAttachmentsTests(tcu::TestContext &testCtx, bool useSecondaries)
{
    ...
    GroupPtr combGroup(new tcu::TestCaseGroup(
        testCtx, "comb", "VK_EXT_dynamic_rendering_unused_attachments with different combinations"));
    GroupPtr colorGroup(new tcu::TestCaseGroup(testCtx, "color"));
    GroupPtr dsGroup(new tcu::TestCaseGroup(testCtx, "depth_stencil"));
    GroupPtr badFmtGrp(
        new tcu::TestCaseGroup(testCtx, "bad_formats", "Test using wrong formats when the handle is VK_NULL_HANDLE"));
                                    ...
                                    for (const auto &layerMask : masksToTest)
                                    {
                                        ...
                                        for (const auto multiview : {false, true})
                                        {
                                            ...
                                            const TestParams params(
                                                ...
                                                stencilDefined, stencilValidHandle, useSecondaries, false);

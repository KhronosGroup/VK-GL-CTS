...
struct ExternalTestConfig
{
    ExternalTestConfig(VkFormat format_, UVec2 imageSize_, vector<RenderPass> renderPasses_,
                       RenderPassType renderPassType_, uint32_t blurKernel_ = 4)
        : format(format_)
                                                                                 ...
                                                                                 const RenderPassType renderPassType)
{
    ...
    for (size_t renderPassNdx = 0; renderPassNdx < renderPassInfos.size(); renderPassNdx++)
    {
        renderPasses.push_back(
            makeSharedPtr(createRenderPass(vkd, device, renderPassInfos[renderPassNdx], renderPassType)));
    }
    ...
    // Test external subpass dependencies
    {
        ...
        for (size_t renderSizeNdx = 0; renderSizeNdx < DE_LENGTH_OF_ARRAY(renderSizes); renderSizeNdx++)
        {
                 ...
                 renderPassCountNdx++)
            {
                ...
                const ExternalTestConfig testConfig(VK_FORMAT_R8G8B8A8_UNORM, renderSizes[renderSizeNdx], renderPasses,
                                                    renderPassType, blurKernel);

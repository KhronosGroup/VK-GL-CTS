                                  ...
                                  const VkAttachmentLoadOp colorLoadOp, const VkFormat dsFormat)
{
    ...
    const VkAccessFlags dstAccessMask =
        dsAttachmentAvailable ? VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT :
    ...
    for (uint32_t subpassNdx = 0u; subpassNdx < subpassCount; ++subpassNdx)
    {
        ...
        const SubpassDep
            ...
            (
                ...
                VK_ACCESS_COLOR_ATTACHMENT_READ_BIT | VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT,  //  VkAccessFlags dstAccessMask; || VkAccessFlags dstAccessMask;
                dependencyFlags, //  VkDependencyFlags dependencyFlags; || VkDependencyFlags dependencyFlags;
                0                //    || int32_t viewOffset;
            );
        subpassDependencies.push_back(subpassDependency);

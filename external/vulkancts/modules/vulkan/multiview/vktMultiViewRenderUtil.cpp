                                  ...
                                  const VkAttachmentLoadOp colorLoadOp, const VkFormat dsFormat)
{
    ...
    const AttachmentRef
        ...
        (
            //  ||  VkStructureType sType;
            DE_NULL,                                          //   ||  const void* pNext;
            dsAttacmentAvailable ? 1u : VK_ATTACHMENT_UNUSED, //  uint32_t attachment; ||  uint32_t attachment;
    ...
    const VkAccessFlags srcAccessMask =
        dsAttacmentAvailable ? VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT : VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
    ...
    const RenderPassCreateInfo
        ...
        (
            ...
            dsAttacmentAvailable ? 2u : 1u, //  uint32_t attachmentCount; ||  uint32_t attachmentCount;

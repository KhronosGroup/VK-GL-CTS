    ...
    def isAvailable (self):
        if sys.platform == 'win32' and _winreg != None:
            ...
            keyMap = {
                ...
                18: [(_winreg.HKEY_CLASSES_ROOT, "VisualStudio.DTE.18.0"), (_winreg.HKEY_LOCAL_MACHINE, "Software\\Microsoft\\VCExpress\\18.0")]
            }
...
VS2026_X32_GENERATOR = VSProjectGenerator(18, VSProjectGenerator.ARCH_32BIT)
VS2026_X64_GENERATOR = VSProjectGenerator(18, VSProjectGenerator.ARCH_64BIT)

...
MAIN_EGL_PKG					= Package(module = EGL_MODULE, configurations = [
		...
		Configuration(name			= "master-2023-03-01",
					  ...
					  surfacetype	= "window",
					  required		= True,
					  filters		= [include("egl-master-2023-03-01.txt")],
					  runtime		= "5m"),
...
MAIN_GLES2_PKG				= Package(module = GLES2_MODULE, configurations = [
		...
		Configuration(name			= "master-2023-03-01",
					  ...
					  surfacetype	= "window",
					  required		= True,
					  filters		= [include("gles2-master-2023-03-01.txt")],
					  runtime		= "10m"),
		Configuration(name			= "master-2024-03-01",
					  glconfig		= "rgba8888d24s8ms0",
					  rotation		= "unspecified",
...
MAIN_GLES3_PKG				= Package(module = GLES3_MODULE, configurations = [
		...
		Configuration(name			= "master-2023-03-01",
					  ...
					  surfacetype	= "window",
					  required		= True,
					  filters		= [include("gles3-master-2023-03-01.txt")],
					  runtime		= "10m"),
		Configuration(name			= "master-2024-03-01",
					  glconfig		= "rgba8888d24s8ms0",
					  rotation		= "unspecified",
...
MAIN_GLES31_PKG				= Package(module = GLES31_MODULE, configurations = [
		...
		Configuration(name			= "master-2023-03-01",
					  ...
					  surfacetype	= "window",
					  required		= True,
					  filters		= [include("gles31-master-2023-03-01.txt")],
					  runtime		= "10m"),
		Configuration(name			= "master-2024-03-01",
					  glconfig		= "rgba8888d24s8ms0",
					  rotation		= "unspecified",

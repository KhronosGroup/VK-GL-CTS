...
ENUM_GROUPS = [
    ...
    ("FramebufferAttachment", ["COLOR_ATTACHMENT0", "COLOR_ATTACHMENT1", "COLOR_ATTACHMENT2", "COLOR_ATTACHMENT3",
                                         ...
                                         "BACK", "FRONT_LEFT", "FRONT_RIGHT", "BACK_LEFT", "BACK_RIGHT", "LEFT", "RIGHT",
                                         "DEPTH", "STENCIL"]),
    # *missing*
    ...
    ("FramebufferStatus", ["FRAMEBUFFER_COMPLETE", "FRAMEBUFFER_INCOMPLETE_ATTACHMENT", "FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT",
                                         ...
                                         "FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS", "FRAMEBUFFER_UNDEFINED",
    ...
    # Enable-disable bit
    ("EnableCap", [
        "TEXTURE_2D", "CULL_FACE", "BLEND", "DITHER", "STENCIL_TEST", "DEPTH_TEST", "SCISSOR_TEST",
        "POLYGON_OFFSET_FILL", "SAMPLE_ALPHA_TO_COVERAGE", "SAMPLE_COVERAGE", "STEREO",
        "PRIMITIVE_RESTART_FIXED_INDEX", "RASTERIZER_DISCARD", "FRAMEBUFFER_SRGB", "SAMPLE_SHADING", "DEPTH_CLAMP",
        "PRIMITIVE_RESTART", "SAMPLE_MASK", "DEBUG_OUTPUT", "DEBUG_OUTPUT_SYNCHRONOUS",
        "BLEND_ADVANCED_COHERENT_KHR", "MULTISAMPLE", "SAMPLE_ALPHA_TO_ONE", "VERTEX_PROGRAM_POINT_SIZE",
    ...
    ("Hint", ["GENERATE_MIPMAP_HINT", "TEXTURE_COMPRESSION_HINT"]),
    ...
    # Textures
    ("TextureTarget", ["TEXTURE_1D", "TEXTURE_1D_ARRAY", "PROXY_TEXTURE_1D", "PROXY_TEXTURE_1D_ARRAY",
                             "TEXTURE_2D", "TEXTURE_RECTANGLE", "PROXY_TEXTURE_2D", "TEXTURE_CUBE_MAP",
                             "PROXY_TEXTURE_CUBE_MAP", "PROXY_TEXTURE_CUBE_MAP_ARRAY",
                             "TEXTURE_CUBE_MAP_POSITIVE_X", "TEXTURE_CUBE_MAP_NEGATIVE_X",
                             "TEXTURE_CUBE_MAP_POSITIVE_Y", "TEXTURE_CUBE_MAP_NEGATIVE_Y",
                             "TEXTURE_CUBE_MAP_POSITIVE_Z", "TEXTURE_CUBE_MAP_NEGATIVE_Z",
                             "TEXTURE_3D", "PROXY_TEXTURE_3D", "TEXTURE_2D_ARRAY", "PROXY_TEXTURE_2D_ARRAY",
                             "TEXTURE_2D_MULTISAMPLE", "PROXY_TEXTURE_2D_MULTISAMPLE", "TEXTURE_2D_MULTISAMPLE_ARRAY",
                             "PROXY_TEXTURE_2D_MULTISAMPLE_ARRAY", "PROXY_TEXTURE_RECTANGLE",
    ...
    ("UncompressedTextureFormat", [
        ...
        "RGB5_A1",
        "RGB565",
        "R3_G3_B2", "RGB5", "RGB12", "RGBA2", "RGBA12",
        "DEPTH_COMPONENT16",
        "STENCIL_INDEX1",
        "STENCIL_INDEX4",
        "STENCIL_INDEX8",
    ...
    ("GettableState", [
        ...
        "TEXTURE_BINDING_1D_ARRAY", "TEXTURE_BINDING_2D", "TEXTURE_BINDING_RECTANGLE", "TEXTURE_BINDING_3D", "TEXTURE_BINDING_2D_ARRAY",
        "TEXTURE_BINDING_CUBE_MAP", "TEXTURE_BINDING_CUBE_MAP_ARRAY", "SAMPLER_BINDING", "SCISSOR_BOX", "STENCIL_FUNC", "STENCIL_VALUE_MASK",
        ...
        "DRAW_BUFFER12", "DRAW_BUFFER13", "DRAW_BUFFER14", "DRAW_BUFFER15", "READ_BUFFER", "DRAW_BUFFER",
        ...
        "MAX_CUBE_MAP_TEXTURE_SIZE", "MAX_RECTANGLE_TEXTURE_SIZE", "MAX_RENDERBUFFER_SIZE", "MAX_DRAW_BUFFERS", "MAX_DUAL_SOURCE_DRAW_BUFFERS", "MAX_COLOR_ATTACHMENTS", "MAX_VIEWPORT_DIMS",
        ...
        "MAX_TRANSFORM_FEEDBACK_INTERLEAVED_COMPONENTS", "MAX_TRANSFORM_FEEDBACK_SEPARATE_ATTRIBS", "MAX_TRANSFORM_FEEDBACK_SEPARATE_COMPONENTS", "INTERLEAVED_ATTRIBS", "SEPARATE_ATTRIBS",
        ...
        "MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS", "PATCH_VERTICES", "PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED", "BUFFER_MAP_POINTER", "POINT_SIZE", "POINT_SIZE_RANGE", "POINT_SIZE_GRANULARITY",
        "BLEND_DST", "BLEND_SRC", "LOGIC_OP_MODE", "COLOR_LOGIC_OP", "TEXTURE_LOD_BIAS", "QUADS_FOLLOW_PROVOKING_VERTEX_CONVENTION",
        "MAX_SUBROUTINES", "MAX_SUBROUTINE_UNIFORM_LOCATIONS", "NUM_COMPATIBLE_SUBROUTINES", "COMPATIBLE_SUBROUTINES",
        "PATCH_DEFAULT_INNER_LEVEL", "PATCH_DEFAULT_OUTER_LEVEL", "MAX_TRANSFORM_FEEDBACK_BUFFERS",
    ]),
    ...
    ("GettablePackState", [
        "PACK_SWAP_BYTES", "PACK_LSB_FIRST", "PACK_ROW_LENGTH", "PACK_IMAGE_HEIGHT", "PACK_SKIP_ROWS", "PACK_SKIP_PIXELS", "PACK_SKIP_IMAGES",
        "PACK_ALIGNMENT", "UNPACK_SWAP_BYTES", "UNPACK_LSB_FIRST", "UNPACK_ROW_LENGTH", "UNPACK_IMAGE_HEIGHT", "UNPACK_SKIP_ROWS", "UNPACK_SKIP_PIXELS",
        "UNPACK_SKIP_IMAGES", "UNPACK_ALIGNMENT",
    ]),
    ...
    ("ClampColorTarget", ["CLAMP_READ_COLOR", "FIXED_ONLY"]),
    ...
    ("PrimSizeParam", [
        "ALIASED_POINT_SIZE_RANGE", "POINT_SIZE", "POINT_FADE_THRESHOLD_SIZE",
        "SMOOTH_POINT_SIZE_RANGE", "SMOOTH_POINT_SIZE_GRANULARITY", "POINT_SPRITE_COORD_ORIGIN",
        "SMOOTH_LINE_WIDTH_RANGE", "SMOOTH_LINE_WIDTH_GRANULARITY", "ALIASED_LINE_WIDTH_RANGE",
    ]),

...
void ResourceListTestCase::init(void)
{
    ...
    if (m_programDefinition->hasStage(glu::SHADERTYPE_GEOMETRY) && !supportsES32 &&
    ...
    if (programContainsIOBlocks(m_programDefinition) && !supportsES32 &&
...
void AtomicCounterReferencedByCase::init(void)
{
    ...
    if ((m_presentStagesMask & tessellationMask) != 0 && !supportsES32 &&
        !m_context.getContextInfo().isExtensionSupported("GL_EXT_tessellation_shader"))
        throw tcu::NotSupportedError("Test requires GL_EXT_tessellation_shader extension");
    if ((m_presentStagesMask & geometryMask) != 0 && !supportsES32 &&
        !m_context.getContextInfo().isExtensionSupported("GL_EXT_geometry_shader"))
        throw tcu::NotSupportedError("Test requires GL_EXT_geometry_shader extension");
...
AtomicCounterReferencedByCase::IterateResult AtomicCounterReferencedByCase::iterate(void)
{
    ...
    const struct
    {
        ...
        {GL_REFERENCED_BY_TESS_CONTROL_SHADER, glu::SHADERTYPE_TESSELLATION_CONTROL,
         (supportsES32 ? DE_NULL : "GL_EXT_tessellation_shader")},
        ...
        {GL_REFERENCED_BY_GEOMETRY_SHADER, glu::SHADERTYPE_GEOMETRY,
         (supportsES32 ? DE_NULL : "GL_EXT_geometry_shader")},
    };
...
void ProgramInputOutputReferencedByCase::init(void)
{
    ...
    if (hasTessellationShader && !supportsES32 &&
        !m_context.getContextInfo().isExtensionSupported("GL_EXT_tessellation_shader"))
        throw tcu::NotSupportedError("Test requires GL_EXT_tessellation_shader extension");
    if (hasGeometryShader && !supportsES32 &&
        !m_context.getContextInfo().isExtensionSupported("GL_EXT_geometry_shader"))
        throw tcu::NotSupportedError("Test requires GL_EXT_geometry_shader extension");
                                  ...
                                  ProgramInterface interface, const char *blockName))
{
    ...
    // .named_block
    {
        ...
        const ResourceDefinition::Node::SharedPtr dummyVariable(
...
void ProgramInputTestGroup::init(void)
{
    ...
    // .resource_list
    {
        tcu::TestCaseGroup *const blockGroup = new tcu::TestCaseGroup(m_testCtx, "resource_list", "Resource list");
        addChild(blockGroup);
        generateProgramInputOutputShaderCaseBlocks(m_context, blockGroup, glslVersion, true, true,
    ...
    // .array_size
    {
        ...
        generateProgramInputOutputShaderCaseBlocks(
            m_context, blockGroup, glslVersion, false, true,
    ...
    // .location
    {
        ...
        addChild(blockGroup);
        generateProgramInputOutputShaderCaseBlocks(m_context, blockGroup, glslVersion, false, true,
...
void ProgramOutputTestGroup::init(void)
{
    ...
    // .resource_list
    {
        tcu::TestCaseGroup *const blockGroup = new tcu::TestCaseGroup(m_testCtx, "resource_list", "Resource list");
        addChild(blockGroup);
        generateProgramInputOutputShaderCaseBlocks(m_context, blockGroup, glslVersion, true, false,
    ...
    // .array_size
    {
        ...
        addChild(blockGroup);
        generateProgramInputOutputShaderCaseBlocks(
            m_context, blockGroup, glslVersion, false, false,
    ...
    // .location
    {
        tcu::TestCaseGroup *const blockGroup = new tcu::TestCaseGroup(m_testCtx, "location", "Location");
        addChild(blockGroup);
        generateProgramInputOutputShaderCaseBlocks(m_context, blockGroup, glslVersion, false, false,

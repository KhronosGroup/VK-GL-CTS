...
void bind_buffer_range(NegativeTestContext &ctx)
{
    ...
    ctx.beginSection("GL_INVALID_VALUE is generated if target is GL_TRANSFORM_FEEDBACK_BUFFER and size or offset are "
                     "not multiples of 4.");
    ...
    ctx.beginSection("GL_INVALID_VALUE is generated if target is GL_UNIFORM_BUFFER and offset is not a multiple of "
    ...
    ctx.beginSection("GL_INVALID_VALUE is generated if target is GL_ATOMIC_COUNTER_BUFFER and index is greater than or "
                     "equal to GL_MAX_ATOMIC_COUNTER_BUFFER_BINDINGS.");
    ...
    ctx.beginSection("GL_INVALID_VALUE is generated if target is GL_SHADER_STORAGE_BUFFER and index is greater than or "
                     "equal to GL_MAX_SHADER_STORAGE_BUFFER_BINDINGS.");
    ...
    if (ssAlignment != 1)
    {
        ctx.beginSection("GL_INVALID_VALUE is generated if target is GL_SHADER_STORAGE_BUFFER and offset is not a "
                         "multiple of the value of GL_SHADER_STORAGE_BUFFER_OFFSET_ALIGNMENT.");
...
void map_buffer_range(NegativeTestContext &ctx)
{
    ...
    ctx.beginSection("GL_INVALID_OPERATION is generated if GL_MAP_READ_BIT is set and any of "
                     "GL_MAP_INVALIDATE_RANGE_BIT, GL_MAP_INVALIDATE_BUFFER_BIT, or GL_MAP_UNSYNCHRONIZED_BIT is set.");
...
void copy_image_sub_data(NegativeTestContext &ctx)
{
    if (contextSupports(ctx.getRenderContext().getType(), glu::ApiType::es(3, 2)))
    {
        ...
        ctx.glCopyImageSubData(texture[0], GL_TEXTURE_2D, 0, 0, 0, 0, texture[1], GL_TEXTURE_2D, 0, 0, 0, 0, 1, -1, -1);
        ctx.expectError(GL_INVALID_VALUE);
        ctx.glCopyImageSubData(texture[0], GL_TEXTURE_2D, 0, 0, 0, 0, texture[1], GL_TEXTURE_2D, 0, 0, 0, 0, -1, -1,
                               -1);
        ctx.expectError(GL_INVALID_VALUE);
        ctx.endSection();

        ctx.beginSection("GL_INVALID_VALUE is generated if srcLevel and dstLevel are not valid levels for the "

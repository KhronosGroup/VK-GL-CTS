...
{
public:
    ShaderLinkageTests(Context &context) : TestCaseGroup(context, "linkage", "Linkage Tests")
    {
    }
    ...
    void init(void)
    {
...

        {
            ...
            addChild(new ShaderLibraryGroup(m_context, "arrays_of_arrays", "Arrays of Arras Tests",
                                            DE_LENGTH_OF_ARRAY(s_arraysOfArraysFiles), s_arraysOfArraysFiles));
        }
...

        {
            ...
            addChild(
                new ShaderLibraryGroup(m_context, "implicit_conversions", "GL_EXT_shader_implicit_conversions Tests",
                                       DE_LENGTH_OF_ARRAY(s_implicitConversionsFiles), s_implicitConversionsFiles));
        }

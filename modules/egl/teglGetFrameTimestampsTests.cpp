...
void GetFrameTimestampTest::executeForConfig(EGLDisplay display, EGLConfig config)
{
    ...
    try
    {
        ...
        for (size_t i = 0; i < frameCount; i++)
        {
            ...
            check_lt(m_result, frame.compositeToPresentLatency, frame.compositeInterval * 3,
                     "Composite to present latency is more than 3 vsyncs.");
            ...
            if (i >= frameDelay)
            {
                ...
                CHECK_NAKED_EGL_CALL(egl,
                                     m_eglGetFrameTimestampsANDROID(display, *surface, frame5ago.frameId,

...
public:
    ...
    GLES2ImageApi(const Library &egl, const glw::Functions &gl, int contextId, tcu::TestLog &log, EGLDisplay display,
                  EGLSurface surface, EGLConfig config);
    ~GLES2ImageApi(void);
...
GLES2ImageApi::GLES2ImageApi(const Library &egl, const glw::Functions &gl, int contextId, tcu::TestLog &log,
    ...
    , m_gl(gl)
{
    ...
    getLog() << tcu::TestLog::Message << "Creating gles2 context with config id: " << configId
...
bool GLES2ImageApi::RenderTexture2D::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
...
bool GLES2ImageApi::RenderExternalTexture::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
                                                       tcu::Texture2D &reference) const
{
    const glw::Functions &gl = api.m_gl;
    tcu::TestLog &log        = api.getLog();
...
bool GLES2ImageApi::RenderExternalTextureSamplerArray::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
                                                                   tcu::Texture2D &reference) const
{
    const glw::Functions &gl = api.m_gl;
    tcu::TestLog &log        = api.getLog();
...
bool GLES2ImageApi::RenderDepthbuffer::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
                                                   tcu::Texture2D &reference) const
{
    const glw::Functions &gl = api.m_gl;
    tcu::TestLog &log        = api.getLog();
...
bool GLES2ImageApi::RenderStencilbuffer::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
                                                     tcu::Texture2D &reference) const
{
    // Branch only taken in TryAll case
...
bool GLES2ImageApi::RenderReadPixelsRenderbuffer::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
                                                              tcu::Texture2D &reference) const
{
    const glw::Functions &gl  = api.m_gl;
...
bool GLES2ImageApi::RenderTryAll::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
                                              tcu::Texture2D &reference) const
{
...
bool GLES2ImageApi::ModifyTexSubImage::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
                                                   tcu::Texture2D &reference) const
{
    const glw::Functions &gl = api.m_gl;
    tcu::TestLog &log        = api.getLog();
...
bool GLES2ImageApi::ModifyRenderbuffer::invokeGLES2(GLES2ImageApi &api, MovePtr<UniqueImage> &img,
                                                    tcu::Texture2D &reference) const
{
    const glw::Functions &gl = api.m_gl;
    tcu::TestLog &log        = api.getLog();
...
void GLES2ImageApi::ModifyRenderbufferClearColor::initializeRbo(GLES2ImageApi &api, GLuint renderbuffer,
                                                                tcu::Texture2D &reference) const
{
    const glw::Functions &gl = api.m_gl;
...
void GLES2ImageApi::ModifyRenderbufferClearDepth::initializeRbo(GLES2ImageApi &api, GLuint renderbuffer,
                                                                tcu::Texture2D &reference) const
{
    const glw::Functions &gl = api.m_gl;
...
void GLES2ImageApi::ModifyRenderbufferClearStencil::initializeRbo(GLES2ImageApi &api, GLuint renderbuffer,
                                                                  tcu::Texture2D &reference) const
{
    const glw::Functions &gl = api.m_gl;
...
{
    m_createActions.add(name, MovePtr<Action>(new GLES2ImageApi::Create(
...
bool isCompatibleCreateAndModifyActions(const Action &create, const Action &modify)
{
    if (const GLES2ImageApi::Create *gles2Create = dynamic_cast<const GLES2ImageApi::Create *>(&create))
    {
        ...
        if (const GLES2ImageApi::ModifyTexSubImage *gles2TexSubImageModify =
                dynamic_cast<const GLES2ImageApi::ModifyTexSubImage *>(&modify))
        {
...
{
    m_clearActions.add("clear_color", MovePtr<Action>(new GLES2ImageApi::ModifyRenderbufferClearColor(
    ...
    for (int createNdx = 0; createNdx < m_createActions.size(); createNdx++)
        for (int renderNdx = 0; renderNdx < m_renderActions.size(); renderNdx++)
            for (int clearNdx = 0; clearNdx < m_clearActions.size(); clearNdx++)
            {
                ...
                const GLES2ImageApi::Create *gles2Create =
                    dynamic_cast<const GLES2ImageApi::Create *>(createAction.action.get());
...
void ModifyTests::addModifyActions(void)
{
    m_modifyActions.add("tex_subimage_rgb8",
                        MovePtr<Action>(new GLES2ImageApi::ModifyTexSubImage(GL_RGB, GL_UNSIGNED_BYTE)));
    m_modifyActions.add("tex_subimage_rgb565",
                        MovePtr<Action>(new GLES2ImageApi::ModifyTexSubImage(GL_RGB, GL_UNSIGNED_SHORT_5_6_5)));
    m_modifyActions.add("tex_subimage_rgba8",
                        MovePtr<Action>(new GLES2ImageApi::ModifyTexSubImage(GL_RGBA, GL_UNSIGNED_BYTE)));
    m_modifyActions.add("tex_subimage_rgb5_a1",
                        MovePtr<Action>(new GLES2ImageApi::ModifyTexSubImage(GL_RGBA, GL_UNSIGNED_SHORT_5_5_5_1)));
    m_modifyActions.add("tex_subimage_rgba4",
                        MovePtr<Action>(new GLES2ImageApi::ModifyTexSubImage(GL_RGBA, GL_UNSIGNED_SHORT_4_4_4_4)));

    m_modifyActions.add("renderbuffer_clear_color", MovePtr<Action>(new GLES2ImageApi::ModifyRenderbufferClearColor(
                                                        tcu::Vec4(0.3f, 0.5f, 0.3f, 1.0f))));
    m_modifyActions.add("renderbuffer_clear_depth",
                        MovePtr<Action>(new GLES2ImageApi::ModifyRenderbufferClearDepth(0.7f)));
    m_modifyActions.add("renderbuffer_clear_stencil",
                        MovePtr<Action>(new GLES2ImageApi::ModifyRenderbufferClearStencil(78)));
}

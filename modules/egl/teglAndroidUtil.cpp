...
MovePtr<ImageSource> createAndroidNativeImageSource(GLenum format, uint32_t numLayers)
{
    DE_UNREF(numLayers);
...
{
public:
    AndroidNativeClientBuffer(const Library &egl, GLenum format, uint32_t numLayers);
...
AndroidNativeClientBuffer::AndroidNativeClientBuffer(const Library &egl, GLenum format, uint32_t numLayers) : m_egl(egl)
{
...
{
public:
    AndroidNativeImageSource(GLenum format, uint32_t numLayers) : m_format(format), m_numLayers(numLayers)
    {
    }

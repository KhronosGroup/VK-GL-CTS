...
ES2Checker::ES2Checker(const glu::RenderContext &ctx) : Checker(ctx), m_width(-1), m_height(-1)
{
}
...
{
public:
    Checker *createChecker(const glu::RenderContext &ctx)
    {
        return new ES2Checker(ctx);
    }
};

...
GLW_APICALL void GLW_APIENTRY glVertexAttribLPointer (GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid* pointer)
{
	DE_UNREF(index);
	DE_UNREF(size);
	DE_UNREF(type);
...
GLW_APICALL void GLW_APIENTRY glPopDebugGroup ()
{
}

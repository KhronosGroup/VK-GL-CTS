...
{
public:
    VulkanVideoDecodeParserLibrary(void) : m_library("nvidia-vkvideo-parser.dll")
    {
    }
...
vk::Library *VulkanPlatform::createLibrary(LibraryType libraryType, const char *libraryPath) const
{
    ...
    case LIBRARY_TYPE_VULKAN_VIDEO_DECODE_PARSER:
        return new VulkanVideoDecodeParserLibrary();
    default:

...
{
	if (m_enableLog)
		m_log << TestLog::Message << "glGetInternalformatSampleivNV(" << toHex(target) << ", " << toHex(internalformat) << ", " << samples << ", " << toHex(pname) << ", " << bufSize << ", " << toHex(reinterpret_cast<uintptr_t>(static_cast<const void*>(params))) << ");" << TestLog::EndMessage;
...
{
	if (m_enableLog)
		m_log << TestLog::Message << "glGetInternalformati64v(" << toHex(target) << ", " << toHex(internalformat) << ", " << toHex(pname) << ", " << bufSize << ", " << toHex(reinterpret_cast<uintptr_t>(static_cast<const void*>(params))) << ");" << TestLog::EndMessage;
...
{
	if (m_enableLog)
		m_log << TestLog::Message << "glGetInternalformativ(" << getInternalFormatTargetStr(target) << ", " << getUncompressedTextureFormatStr(internalformat) << ", " << getInternalFormatParameterStr(pname) << ", " << bufSize << ", " << toHex(reinterpret_cast<uintptr_t>(static_cast<const void*>(params))) << ");" << TestLog::EndMessage;
...
{
	if (m_enableLog)
		m_log << TestLog::Message << "glGetSynciv(" << sync << ", " << toHex(pname) << ", " << bufSize << ", " << toHex(reinterpret_cast<uintptr_t>(static_cast<const void*>(length))) << ", " << toHex(reinterpret_cast<uintptr_t>(static_cast<const void*>(values))) << ");" << TestLog::EndMessage;

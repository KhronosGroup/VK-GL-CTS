...
static void sampleTextureNonProjected(const tcu::SurfaceAccess &dst, const tcu::Texture2DView &rawSrc,
...
static void sampleTextureProjected(const tcu::SurfaceAccess &dst, const tcu::Texture2DView &rawSrc, const tcu::Vec4 &sq,
                             ...
                             qpWatchDog *watchDog)
{
    ...
    std::vector<tcu::ConstPixelBufferAccess> srcLevelStorage;
    const tcu::Texture1DView src = getEffectiveTextureView(
        getSubView(baseView, sampleParams.baseLevel, sampleParams.maxLevel), srcLevelStorage, sampleParams.sampler);
                             ...
                             qpWatchDog *watchDog)
{
    ...
    std::vector<tcu::ConstPixelBufferAccess> srcLevelStorage;
    const tcu::Texture2DView src = getEffectiveTextureView(
        getSubView(baseView, sampleParams.baseLevel, sampleParams.maxLevel), srcLevelStorage, sampleParams.sampler);
                             ...
                             qpWatchDog *watchDog)
{
    ...
    std::vector<tcu::ConstPixelBufferAccess> srcLevelStorage;
    const tcu::TextureCubeView src = getEffectiveTextureView(
        getSubView(baseView, sampleParams.baseLevel, sampleParams.maxLevel), srcLevelStorage, sampleParams.sampler);
                             ...
                             qpWatchDog *watchDog)
{
    ...
    std::vector<tcu::ConstPixelBufferAccess> srcLevelStorage;
    const tcu::Texture3DView src = getEffectiveTextureView(
        getSubView(baseView, sampleParams.baseLevel, sampleParams.maxLevel), srcLevelStorage, sampleParams.sampler);
                             ...
                             const tcu::LodPrecision &lodPrec, qpWatchDog *watchDog)
{
    ...
    std::vector<tcu::ConstPixelBufferAccess> srcLevelStorage;
    const tcu::TextureCubeArrayView src = getEffectiveTextureView(
        getSubView(baseView, sampleParams.baseLevel, sampleParams.maxLevel), srcLevelStorage, sampleParams.sampler);

...
{
    static const uint32_t s_typeMap[] = {GL_VERTEX_SHADER,
                                         GL_FRAGMENT_SHADER,
                                         GL_GEOMETRY_SHADER,
...
{
    static const uint32_t s_typebitMap[] = {GL_VERTEX_SHADER_BIT,
...
qpShaderType getLogShaderType(ShaderType shaderType)
{
    static const qpShaderType s_typeMap[] = {
        QP_SHADER_TYPE_VERTEX,       QP_SHADER_TYPE_FRAGMENT,        QP_SHADER_TYPE_GEOMETRY,
        QP_SHADER_TYPE_TESS_CONTROL, QP_SHADER_TYPE_TESS_EVALUATION, QP_SHADER_TYPE_COMPUTE,
        QP_SHADER_TYPE_RAYGEN,       QP_SHADER_TYPE_ANY_HIT,         QP_SHADER_TYPE_CLOSEST_HIT,
        QP_SHADER_TYPE_MISS,         QP_SHADER_TYPE_INTERSECTION,    QP_SHADER_TYPE_CALLABLE,
    };
    DE_STATIC_ASSERT(DE_LENGTH_OF_ARRAY(s_typeMap) == SHADERTYPE_LAST);
    DE_ASSERT(de::inBounds<int>(shaderType, 0, DE_LENGTH_OF_ARRAY(s_typeMap)));
    return s_typeMap[shaderType];

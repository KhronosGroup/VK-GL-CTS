 ...
 */
typedef GLW_APICALL GLsync			(GLW_APIENTRY* glCreateSyncFromCLeventARBFunc)						(struct _cl_context* context, struct _cl_event* event, GLbitfield flags);
typedef GLW_APICALL void			(GLW_APIENTRY* glBlendBarrierKHRFunc)								();
...
typedef GLW_APICALL void			(GLW_APIENTRY* glTexImage1DFunc)									(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid* pixels);
typedef GLW_APICALL void			(GLW_APIENTRY* glTexImage2DFunc)									(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid* pixels);
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawBufferFunc)									(GLenum mode);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glFinishFunc)										();
typedef GLW_APICALL void			(GLW_APIENTRY* glFlushFunc)											();
...
typedef GLW_APICALL void			(GLW_APIENTRY* glReadBufferFunc)									(GLenum mode);
typedef GLW_APICALL void			(GLW_APIENTRY* glReadPixelsFunc)									(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid* pixels);
typedef GLW_APICALL void			(GLW_APIENTRY* glGetBooleanvFunc)									(GLenum pname, GLboolean* params);
typedef GLW_APICALL void			(GLW_APIENTRY* glGetDoublevFunc)									(GLenum pname, GLdouble* params);
typedef GLW_APICALL GLenum			(GLW_APIENTRY* glGetErrorFunc)										();
typedef GLW_APICALL void			(GLW_APIENTRY* glGetFloatvFunc)										(GLenum pname, GLfloat* params);
typedef GLW_APICALL void			(GLW_APIENTRY* glGetIntegervFunc)									(GLenum pname, GLint* params);
typedef GLW_APICALL const GLubyte*	(GLW_APIENTRY* glGetStringFunc)										(GLenum name);
typedef GLW_APICALL void			(GLW_APIENTRY* glGetTexImageFunc)									(GLenum target, GLint level, GLenum format, GLenum type, GLvoid* pixels);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawElementsFunc)									(GLenum mode, GLsizei count, GLenum type, const GLvoid* indices);
typedef GLW_APICALL void			(GLW_APIENTRY* glGetPointervFunc)									(GLenum pname, GLvoid** params);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glTexSubImage1DFunc)									(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid* pixels);
typedef GLW_APICALL void			(GLW_APIENTRY* glTexSubImage2DFunc)									(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid* pixels);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawRangeElementsFunc)								(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid* indices);
typedef GLW_APICALL void			(GLW_APIENTRY* glTexImage3DFunc)									(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid* pixels);
typedef GLW_APICALL void			(GLW_APIENTRY* glTexSubImage3DFunc)									(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid* pixels);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glCompressedTexImage3DFunc)							(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid* data);
typedef GLW_APICALL void			(GLW_APIENTRY* glCompressedTexImage2DFunc)							(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid* data);
typedef GLW_APICALL void			(GLW_APIENTRY* glCompressedTexImage1DFunc)							(GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid* data);
typedef GLW_APICALL void			(GLW_APIENTRY* glCompressedTexSubImage3DFunc)						(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid* data);
typedef GLW_APICALL void			(GLW_APIENTRY* glCompressedTexSubImage2DFunc)						(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid* data);
typedef GLW_APICALL void			(GLW_APIENTRY* glCompressedTexSubImage1DFunc)						(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid* data);
typedef GLW_APICALL void			(GLW_APIENTRY* glGetCompressedTexImageFunc)							(GLenum target, GLint level, GLvoid* img);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glMultiDrawElementsFunc)								(GLenum mode, const GLsizei* count, GLenum type, const GLvoid* const* indices, GLsizei drawcount);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glBufferDataFunc)									(GLenum target, GLsizeiptr size, const GLvoid* data, GLenum usage);
typedef GLW_APICALL void			(GLW_APIENTRY* glBufferSubDataFunc)									(GLenum target, GLintptr offset, GLsizeiptr size, const GLvoid* data);
typedef GLW_APICALL void			(GLW_APIENTRY* glGetBufferSubDataFunc)								(GLenum target, GLintptr offset, GLsizeiptr size, GLvoid* data);
typedef GLW_APICALL GLvoid*			(GLW_APIENTRY* glMapBufferFunc)										(GLenum target, GLenum access);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glGetBufferPointervFunc)								(GLenum target, GLenum pname, GLvoid** params);
...
typedef GLW_APICALL GLuint			(GLW_APIENTRY* glCreateProgramFunc)									();
...
typedef GLW_APICALL void			(GLW_APIENTRY* glGetAttachedShadersFunc)							(GLuint program, GLsizei maxCount, GLsizei* count, GLuint* obj);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glGetVertexAttribPointervFunc)						(GLuint index, GLenum pname, GLvoid** pointer);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glVertexAttribPointerFunc)							(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid* pointer);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glEndTransformFeedbackFunc)							();
...
typedef GLW_APICALL void			(GLW_APIENTRY* glEndConditionalRenderFunc)							();
typedef GLW_APICALL void			(GLW_APIENTRY* glVertexAttribIPointerFunc)							(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid* pointer);
...
typedef GLW_APICALL GLvoid*			(GLW_APIENTRY* glMapBufferRangeFunc)								(GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawElementsInstancedFunc)							(GLenum mode, GLsizei count, GLenum type, const GLvoid* indices, GLsizei instancecount);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawElementsBaseVertexFunc)						(GLenum mode, GLsizei count, GLenum type, const GLvoid* indices, GLint basevertex);
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawRangeElementsBaseVertexFunc)					(GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid* indices, GLint basevertex);
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawElementsInstancedBaseVertexFunc)				(GLenum mode, GLsizei count, GLenum type, const GLvoid* indices, GLsizei instancecount, GLint basevertex);
typedef GLW_APICALL void			(GLW_APIENTRY* glMultiDrawElementsBaseVertexFunc)					(GLenum mode, const GLsizei* count, GLenum type, const GLvoid* const* indices, GLsizei drawcount, const GLint* basevertex);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glGetInteger64vFunc)									(GLenum pname, GLint64* params);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glTexImage2DMultisampleFunc)							(GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLboolean fixedsamplelocations);
typedef GLW_APICALL void			(GLW_APIENTRY* glTexImage3DMultisampleFunc)							(GLenum target, GLsizei samples, GLint internalformat, GLsizei width, GLsizei height, GLsizei depth, GLboolean fixedsamplelocations);
typedef GLW_APICALL void			(GLW_APIENTRY* glGetMultisamplefvFunc)								(GLenum pname, GLuint index, GLfloat* val);
typedef GLW_APICALL void			(GLW_APIENTRY* glSampleMaskiFunc)									(GLuint index, GLbitfield mask);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawArraysIndirectFunc)							(GLenum mode, const GLvoid* indirect);
typedef GLW_APICALL void			(GLW_APIENTRY* glDrawElementsIndirectFunc)							(GLenum mode, GLenum type, const GLvoid* indirect);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glPauseTransformFeedbackFunc)						();
typedef GLW_APICALL void			(GLW_APIENTRY* glResumeTransformFeedbackFunc)						();
...
typedef GLW_APICALL void			(GLW_APIENTRY* glReleaseShaderCompilerFunc)							();
typedef GLW_APICALL void			(GLW_APIENTRY* glShaderBinaryFunc)									(GLsizei count, const GLuint* shaders, GLenum binaryformat, const GLvoid* binary, GLsizei length);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glGetProgramBinaryFunc)								(GLuint program, GLsizei bufSize, GLsizei* length, GLenum* binaryFormat, GLvoid* binary);
typedef GLW_APICALL void			(GLW_APIENTRY* glProgramBinaryFunc)									(GLuint program, GLenum binaryFormat, const GLvoid* binary, GLsizei length);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glVertexAttribLPointerFunc)							(GLuint index, GLint size, GLenum type, GLsizei stride, const GLvoid* pointer);
...
typedef GLW_APICALL void			(GLW_APIENTRY* glPopDebugGroupFunc)									();

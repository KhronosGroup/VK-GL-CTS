...
void generateDummyVoidExtentBlocks(uint8_t *dst, size_t numBlocks);
void generateDummyNormalBlocks(uint8_t *dst, size_t numBlocks, int blockWidth, int blockHeight);

...
inline int channelToInt(const uint8_t *value, TextureFormat::ChannelType type)
{
    ...
    {
    case TextureFormat::SNORM_INT8:
        return (int)*((const int8_t *)value);
    case TextureFormat::SNORM_INT16:
        return (int)*((const int16_t *)value);
    case TextureFormat::SNORM_INT32:
        return (int)*((const int32_t *)value);
    case TextureFormat::UNORM_INT8:
        return (int)*((const uint8_t *)value);
    case TextureFormat::UNORM_INT16:
        return (int)*((const uint16_t *)value);
    case TextureFormat::UNORM_INT24:
        return (int)readUint24(value);
    case TextureFormat::UNORM_INT32:
        return (int)*((const uint32_t *)value);
    case TextureFormat::SIGNED_INT8:
        return (int)*((const int8_t *)value);
    case TextureFormat::SIGNED_INT16:
        return (int)*((const int16_t *)value);
    ...
    case TextureFormat::UNSIGNED_INT32:
        return (int)*((const uint32_t *)value);
    case TextureFormat::HALF_FLOAT:
        return (int)deFloat16To32(*(const deFloat16 *)value);
    case TextureFormat::FLOAT:
        return (int)*((const float *)value);
    case TextureFormat::FLOAT64:
        return (int)*((const double *)value);
    case TextureFormat::UNORM_SHORT_10:
        return (int)((*(((const uint16_t *)value))) >> 6u);
    case TextureFormat::UNORM_SHORT_12:
        return (int)((*(((const uint16_t *)value))) >> 4u);
    case TextureFormat::USCALED_INT8:
        return (int)*((const uint8_t *)value);
    case TextureFormat::USCALED_INT16:
        return (int)*((const uint16_t *)value);
...
#define SN32(OFFS, COUNT) channelToSnormFloat(UI32(OFFS, COUNT), (COUNT))
    ...
    case TextureFormat::UNORM_SHORT_565:
        return swizzleRB(Vec4(UN16(11, 5), UN16(5, 6), UN16(0, 5), 1.0f), m_format.order, TextureFormat::RGB);
    case TextureFormat::UNSIGNED_SHORT_565:
        return swizzleRB(UVec4(UI16(11, 5), UI16(5, 6), UI16(0, 5), 1u), m_format.order, TextureFormat::RGB)
            .cast<float>();
    case TextureFormat::UNORM_SHORT_555:
        return swizzleRB(Vec4(UN16(10, 5), UN16(5, 5), UN16(0, 5), 1.0f), m_format.order, TextureFormat::RGB);
    case TextureFormat::UNORM_SHORT_4444:
        return swizzleRB(Vec4(UN16(12, 4), UN16(8, 4), UN16(4, 4), UN16(0, 4)), m_format.order, TextureFormat::RGBA);
    case TextureFormat::UNSIGNED_SHORT_4444:
        return swizzleRB(UVec4(UI16(12, 4), UI16(8, 4), UI16(4, 4), UI16(0, 4)), m_format.order, TextureFormat::RGBA)
            .cast<float>();
    case TextureFormat::UNORM_SHORT_5551:
        return swizzleRB(Vec4(UN16(11, 5), UN16(6, 5), UN16(1, 5), UN16(0, 1)), m_format.order, TextureFormat::RGBA);
    case TextureFormat::UNSIGNED_SHORT_5551:
        return swizzleRB(UVec4(UI16(11, 5), UI16(6, 5), UI16(1, 5), UI16(0, 1)), m_format.order, TextureFormat::RGBA)
            .cast<float>();
    case TextureFormat::UNORM_INT_101010:
        return Vec4(UN32(22, 10), UN32(12, 10), UN32(2, 10), 1.0f);
    case TextureFormat::UNORM_INT_1010102_REV:
        return swizzleRB(Vec4(UN32(0, 10), UN32(10, 10), UN32(20, 10), UN32(30, 2)), m_format.order,
                         TextureFormat::RGBA);
    case TextureFormat::SNORM_INT_1010102_REV:
        return swizzleRB(Vec4(SN32(0, 10), SN32(10, 10), SN32(20, 10), SN32(30, 2)), m_format.order,
                         TextureFormat::RGBA);
    case TextureFormat::USCALED_INT_1010102_REV:
    case TextureFormat::UNSIGNED_INT_1010102_REV:
        return swizzleRB(UVec4(UI32(0, 10), UI32(10, 10), UI32(20, 10), UI32(30, 2)), m_format.order,
                         TextureFormat::RGBA)
            .cast<float>();
    case TextureFormat::SSCALED_INT_1010102_REV:
    case TextureFormat::SIGNED_INT_1010102_REV:
        return swizzleRB(UVec4(SI32(0, 10), SI32(10, 10), SI32(20, 10), SI32(30, 2)), m_format.order,
                         TextureFormat::RGBA)
            .cast<float>();
    case TextureFormat::UNSIGNED_INT_999_E5_REV:
...
#define S32(OFFS, COUNT) signExtend(U32(OFFS, COUNT), (COUNT))
    ...
    case TextureFormat::UNORM_SHORT_565:
        return swizzleRB(UVec4(U16(11, 5), U16(5, 6), U16(0, 5), 1).cast<int>(), m_format.order, TextureFormat::RGB);
    case TextureFormat::UNORM_SHORT_555:
        return swizzleRB(UVec4(U16(10, 5), U16(5, 5), U16(0, 5), 1).cast<int>(), m_format.order, TextureFormat::RGB);
    case TextureFormat::UNSIGNED_SHORT_4444: // Fall-through
    case TextureFormat::UNORM_SHORT_4444:
        return swizzleRB(UVec4(U16(12, 4), U16(8, 4), U16(4, 4), U16(0, 4)).cast<int>(), m_format.order,
                         TextureFormat::RGBA);
    case TextureFormat::UNSIGNED_SHORT_5551: // Fall-through
    case TextureFormat::UNORM_SHORT_5551:
        return swizzleRB(UVec4(U16(11, 5), U16(6, 5), U16(1, 5), U16(0, 1)).cast<int>(), m_format.order,
                         TextureFormat::RGBA);
    case TextureFormat::UNORM_INT_101010:
    ...
    case TextureFormat::UNSIGNED_INT_1010102_REV:
        return swizzleRB(UVec4(U32(0, 10), U32(10, 10), U32(20, 10), U32(30, 2)), m_format.order, TextureFormat::RGBA)
            .cast<int>();
    case TextureFormat::SNORM_INT_1010102_REV:   // Fall-through
    case TextureFormat::SSCALED_INT_1010102_REV: // Fall-through
    case TextureFormat::SIGNED_INT_1010102_REV:
        return swizzleRB(IVec4(S32(0, 10), S32(10, 10), S32(20, 10), S32(30, 2)), m_format.order, TextureFormat::RGBA);
...
#define PI(VAL, OFFS, BITS) (intToChannel((VAL), (BITS)) << (OFFS))
    ...
    case TextureFormat::UNSIGNED_SHORT_565:
    {
        const UVec4 swizzled    = swizzleRB(color.cast<uint32_t>(), TextureFormat::RGB, m_format.order);
    ...
    case TextureFormat::UNSIGNED_SHORT_4444:
    {
        const UVec4 swizzled = swizzleRB(color.cast<uint32_t>(), TextureFormat::RGBA, m_format.order);
        *((uint16_t *)pixelPtr) =
    ...
    case TextureFormat::USCALED_INT_1010102_REV:
    {
        const UVec4 u           = swizzleRB(color.cast<uint32_t>(), TextureFormat::RGBA, m_format.order);
    ...
    case TextureFormat::SSCALED_INT_1010102_REV:
    {
        const IVec4 u           = swizzleRB(color.cast<int32_t>(), TextureFormat::RGBA, m_format.order);
...
{
    const char *const orderStrings[] = {"R",  "A",   "I",    "L",     "LA",   "RG",
                                        "RA", "RGB", "RGBA", "ARGB",  "BGR",  "BGRA",

...
void registerOptions(de::cmdline::Parser &parser)
{
    ...
    parser << Option<CasePath>("n", "deqp-case", "Test case(s) to run, supports wildcards (e.g. dEQP-GLES2.info.*)")
           ...
           << Option<Visibility>(DE_NULL, "deqp-visibility", "Default test window visibility", s_visibilites,
                                 "windowed")
           ...
           << Option<VKDeviceGroupID>(DE_NULL, "deqp-vk-device-group-id", "Vulkan device Group ID (IDs start from 1)",
                                      "1")
           << Option<LogImages>(DE_NULL, "deqp-log-images", "Enable or disable logging of result images", s_enableNames,
                                "enable")
           << Option<LogShaderSources>(DE_NULL, "deqp-log-shader-sources",
                                       "Enable or disable logging of shader sources", s_enableNames, "enable")
           ...
           << Option<LogEmptyLoginfo>(DE_NULL, "deqp-log-empty-loginfo",
                                      "Logging of empty shader compile/link log info", s_enableNames, "enable")
           ...
           << Option<ShaderCache>(DE_NULL, "deqp-shadercache", "Enable or disable shader cache", s_enableNames,
                                  "enable")
 ...
 *//*--------------------------------------------------------------------*/
CommandLine::CommandLine(void) : m_logFlags(0)
{
}
 ...
 *//*--------------------------------------------------------------------*/
CommandLine::CommandLine(int argc, const char *const *argv) : m_logFlags(0)
{
    if (argc > 1)
    {
 ...
 *//*--------------------------------------------------------------------*/
CommandLine::CommandLine(const std::string &cmdLine) : m_initialCmdLine(cmdLine)
{
    if (!parse(cmdLine))
        throw Exception("Failed to parse command line");
}

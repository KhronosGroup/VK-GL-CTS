...
DE_INLINE int deFloatIsInf(float x)
{
    return (x > FLT_MAX) - (x < -FLT_MAX);
}
DE_INLINE bool deFloatIsNaN(float x)
{
    return (x != x);
}

DE_INLINE int deIsInf(double x)
{
    return (x > DBL_MAX) - (x < -DBL_MAX);
}
DE_INLINE bool deIsNaN(double x)
{
    return (x != x);
}
...
DE_INLINE bool deFloatCmpEQ(float a, float b)
{
    return (a == b);
}
DE_INLINE bool deFloatCmpNE(float a, float b)
{
    return (a != b);
}
DE_INLINE bool deFloatCmpLT(float a, float b)
{
    return (a < b);
}
DE_INLINE bool deFloatCmpLE(float a, float b)
{
    return (a <= b);
}
DE_INLINE bool deFloatCmpGT(float a, float b)
{
    return (a > b);
}
DE_INLINE bool deFloatCmpGE(float a, float b)
{
    return (a >= b);
}
